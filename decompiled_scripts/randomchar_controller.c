...
int func_9() // Position - 0x74C Hash - 0x3C5423D7 ^0x3C5423D7
{
	func_10();
...
BOOL func_12(int iParam0) // Position - 0x870 Hash - 0x8907F004 ^0x8907F004
{
	return iParam0 < 3;
}

int func_13(Ped pedParam0) // Position - 0x87C Hash - 0xAC4E9801 ^0xB379A75F
{
	int i;
	Hash entityModel;
...
Hash func_14(int iParam0) // Position - 0x8B9 Hash - 0xADCB9755 ^0xADCB9755
{
	if (func_12(iParam0))
...
Hash func_15(int iParam0) // Position - 0x8DE Hash - 0xE4CEEC2C ^0xE4CEEC2C
{
...
void func_57(int iParam0) // Position - 0x2FDA Hash - 0xEC7DB104 ^0xEC7DB104
{
	int i;
	var unk;
...
void func_58(int iParam0) // Position - 0x3093 Hash - 0xEC7DB104 ^0xEC7DB104
{
	int i;
	var unk;
...
void func_59(int iParam0) // Position - 0x315B Hash - 0xDBA91FA2 ^0x62041168
{
	int i;
	int num;
	int j;
...
int func_62(int iParam0) // Position - 0x3382 Hash - 0xE624B23E ^0x73975030
{
	int num;
...
void func_63(int iParam0, int iParam1) // Position - 0x33D8 Hash - 0x5207FAC0 ^0x6E316FC
{
	int num;
...
void func_64(int iParam0, int iParam1, int iParam2) // Position - 0x340D Hash - 0xAB9B6CC ^0x1B5EEB55
{
...
void func_65(int iParam0, int iParam1, int iParam2) // Position - 0x3452 Hash - 0xAB9B6CC ^0x80AE0F15
{
	if (iParam1 < 0 || iParam1 > 4)
		return;
...
int func_66(int iParam0, int iParam1) // Position - 0x3497 Hash - 0x97DCD8A1 ^0xF8178EDD
{
	if (iParam1 < 0 || iParam1 > 4)
		return 0;
...
void func_67(int iParam0, int iParam1, int iParam2) // Position - 0x34C1 Hash - 0xB4ABC33 ^0x67322EDD
{
...
int func_68(int iParam0, int iParam1) // Position - 0x34F2 Hash - 0x97DCD8A1 ^0xFBF2A354
{
	if (iParam1 < 0 || iParam1 > 4)
		return 0;
...
void func_69(int iParam0) // Position - 0x351C Hash - 0x4FA51D98 ^0x238D4E50
{
	int i;
	int num;
	var unk;
...
BOOL func_74(BOOL bParam0) // Position - 0x38B7 Hash - 0x15889021 ^0xE7262364
{
...
BOOL func_75() // Position - 0x38DF Hash - 0x44DD83CC ^0x6D2C8335
{
	int profileSetting;
...
BOOL func_94(int iParam0, int iParam1) // Position - 0x487B Hash - 0x4FE139C4 ^0x4FE139C4
{
	switch (iParam1)
	{
		case 0:
...
void func_99(int iParam0, int iParam1) // Position - 0x4D4C Hash - 0x84F576C1 ^0xFD8BF020
{
	int num;
...
void func_107(int iParam0, int iParam1) // Position - 0x5061 Hash - 0x4FE65956 ^0x4FE65956
{
	int num;
...
void func_108(int iParam0) // Position - 0x514E Hash - 0xF9254656 ^0xECCFDFAF
{
...
void func_109(int iParam0) // Position - 0x5199 Hash - 0xE7EE45FB ^0x26036F0B
{
	Vector3 vector;
	BOOL unk;
	BOOL unk2;
...
BOOL func_112(int iParam0) // Position - 0x5905 Hash - 0x5A075A23 ^0x27F6B86F
{
	Hash entityModel;
...
BOOL func_129(int iParam0) // Position - 0x9395 Hash - 0x3D43FEFC ^0x3D43FEFC
{
	int i;
...
int func_131(int iParam0) // Position - 0x9406 Hash - 0x3BAB94E9 ^0x3BAB94E9
{
	if (Global_43257 == 15)
		return 0;
...
BOOL func_132(int iParam0) // Position - 0x9428 Hash - 0xECB6C71B ^0xECB6C71B
{
