...
BOOL func_2(Any* panParam0) // Hash - 0xDE97F4EA ^0xC17F97F7
{
	const char* str;
	var unk32;
...
struct<2> func_9(int iParam0) // Hash - 0x323E6781 ^0x93F01690
{
	var unk;
	var unk3;
...
void func_19() // Hash - 0x429A4038 ^0x4C03B844
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("MISSION_STAT_WATCHER")) > 0)
	{
		if (func_20())
...
void func_23(char* sParam0, int iParam1, Ped pedParam2) // Hash - 0xB566D143 ^0x89A39440
{
...
BOOL func_44(int iParam0, int iParam1, char* sParam2, var uParam3) // Hash - 0x8E372EAA ^0xF0EA400A
{
...
void func_109(int iParam0) // Hash - 0x35AC36F2 ^0xD11C8205
{
	int num;
	var textLabel;
...
void func_112(char* sParam0, Any anParam1, int iParam2) // Hash - 0x817AB180 ^0x34EBE28F
{
...
struct<2> func_114(int iParam0) // Hash - 0x975AC8C9 ^0x63521628
{
	var unk;
...
void func_115(int iParam0, var uParam1) // Hash - 0x2D8E3F8 ^0x26D70F95
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_148(const char* sParam0) // Hash - 0x16488C7A ^0x1713B15F
{
...
void func_177(int iParam0, var uParam1) // Hash - 0x16CCAA18 ^0x7CF82034
{
	if (iParam0 == 1)
	{
		if (!func_135(uParam1))
...
BOOL func_179(int iParam0) // Hash - 0x97844555 ^0xADCD6DAA
{
	int num;
...
BOOL func_180() // Hash - 0x4228A1C2 ^0x952FE30F
{
	return Global_100720.f_1;
}

BOOL func_181() // Hash - 0xC20DBA70 ^0xAC4006FB
{
	if (Global_97603 != -1)
...
BOOL func_182() // Hash - 0x3CA1BB47 ^0xB78A1ACB
{
...
BOOL func_183() // Hash - 0xE663B8F6 ^0xE663B8F6
{
	if (Global_78819)
		return true;
...
BOOL func_184() // Hash - 0xD56328D2 ^0xD56328D2
{
...
BOOL func_186() // Hash - 0x47FF56D2 ^0x47FF56D2
{
...
int func_188(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Hash - 0xA74186BF ^0x512FC932
{
	var unk;
...
void func_189(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Hash - 0xF7ECDFD9 ^0x6B079C3E
{
...
void func_191(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Hash - 0x6C235EE0 ^0x9E57F206
{
...
float func_192(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Hash - 0xC22B942A ^0xE0DB8793
{
...
BOOL func_197() // Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_97990;
}

void func_198(var uParam0) // Hash - 0x8EEB5116 ^0x2325FF68
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_199(uParam0);
...
void func_199(var uParam0) // Hash - 0x1C509C5B ^0x1C509C5B
{
	BOOL flag;
	int num;
	int i;
...
void func_200(int iParam0) // Hash - 0xD347101A ^0xCC220E7F
{
	if (iParam0 == -1)
		iParam0 = func_171();
...
void func_201(var uParam0) // Hash - 0x2E98ABB1 ^0xFF31A41F
{
	int i;
	int taskSequenceId;
...
void func_202(Vehicle veParam0) // Hash - 0xAD821AF8 ^0xB1BC7B82
{
	int taskSequenceId;
...
void func_203(Object* pobParam0) // Hash - 0x4EAFEE58 ^0x34D7ECA6
{
...
BOOL func_204(float fParam0, float fParam1, float fParam2, var uParam3, var uParam4, var uParam5, int iParam6) // Hash - 0xBD36EF52 ^0x26B42458
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
BOOL func_206(Any* panParam0, BOOL bParam1) // Hash - 0x7D86F6E4 ^0xB5C42C74
{
	var unk;
...
BOOL func_234(int iParam0) // Hash - 0x6F2BC7EE ^0x6F2BC7EE
{
	if (iParam0 == -1)
		iParam0 = func_171();
...
BOOL func_235(int iParam0) // Hash - 0xDE7BA54D ^0xDE7BA54D
{
...
BOOL func_236() // Hash - 0x29CB2928 ^0xE369A18D
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_237() // Hash - 0x98CCC132 ^0x97B0D6ED
{
	if (Global_97603 != -1)
...
BOOL func_238(int iParam0) // Hash - 0xC2630182 ^0xFBD23031
{
...
BOOL func_239() // Hash - 0x25806CBF ^0x25806CBF
{
...
BOOL func_240(int iParam0) // Hash - 0x1156B580 ^0x34C7FA05
{
	if (func_113(false))
...
BOOL func_241(var uParam0) // Hash - 0x14648AE3 ^0x73392F86
{
	if (!func_242(uParam0))
		return false;
...
BOOL func_242(var uParam0) // Hash - 0xC3652FE7 ^0x5C73031C
{
	int num;
	int i;
	int sceneID;
...
void func_243(Object* pobParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Hash - 0x61F651EE ^0x2FE58679
{
	func_203(pobParam0);
...
BOOL func_246(Ped* ppedParam0, int iParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Hash - 0x5E27D69A ^0xE8A3C3CE
{
...
BOOL func_247(Ped* ppedParam0, int iParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Hash - 0xC57592AD ^0x9AA0BE7
{
	Hash model;
...
int func_248(var uParam0, int iParam1) // Hash - 0x5AC42C11 ^0x5AC42C11
{
	int num;
...
BOOL func_249(var uParam0) // Hash - 0xC42B20E0 ^0x728F1DAE
{
	int i;
...
BOOL func_250(int iParam0) // Hash - 0x3D43FEFC ^0x3D43FEFC
{
	int i;
...
BOOL func_251(int iParam0) // Hash - 0x59D2F680 ^0x59D2F680
{
	var unk;
	int num;
...
BOOL func_252(int iParam0) // Hash - 0xC6B32843 ^0x88A9F791
{
	const char* string2;
...
BOOL func_253(int iParam0) // Hash - 0x791D84F4 ^0x791D84F4
{
	var unk;
...
BOOL func_254(int iParam0) // Hash - 0xDEAD9A68 ^0xDEAD9A68
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_255(int iParam0, char* sParam1) // Hash - 0xC64245F ^0xCFE6F275
{
...
BOOL func_256(int iParam0) // Hash - 0x5ADD7F05 ^0x5ADD7F05
{
...
BOOL func_257(int iParam0) // Hash - 0xBB053D24 ^0xBB053D24
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_258(int iParam0) // Hash - 0x5D95A044 ^0x5D95A044
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_259(int iParam0) // Hash - 0x9FFC81CD ^0x47A2AB8B
{
	if (func_235(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
void func_260() // Hash - 0x5631C87C ^0x7D94A9F1
{
...
BOOL func_261(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Hash - 0x5B983661 ^0x5B983661
{
	int i;
...
BOOL func_262(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Hash - 0xC6B7068B ^0xB9A971A4
{
	int num;
	char* str;
...
BOOL func_263(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Hash - 0x1FB736D4 ^0x234AEAB7
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_264(var uParam0, BOOL bParam1) // Hash - 0xC0CD6556 ^0xCD1BCD8F
{
	if (bParam1)
	{
...
void func_265(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Hash - 0x5BE1D1E3 ^0x5BE1D1E3
{
...
void func_266(var uParam0, BOOL bParam1) // Hash - 0xEDC3BD2D ^0xE0B6F056
{
	func_267(&(uParam0->f_41), bParam1);
	return;
}

void func_267(var uParam0, BOOL bParam1) // Hash - 0x9E80EA71 ^0x9E80EA71
{
	int i;
...
void func_268(Object* pobParam0, BOOL bParam1) // Hash - 0xD7EE3E27 ^0xC5769B29
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_269(var uParam0, BOOL bParam1) // Hash - 0xEDC3BD2D ^0xE2474F74
{
	func_270(&(uParam0->f_35), bParam1);
	return;
}

void func_270(var uParam0, BOOL bParam1) // Hash - 0xA98F6284 ^0xA98F6284
{
	int i;
...
void func_271(Vehicle* pveParam0) // Hash - 0xC50F9886 ^0x638B6124
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_272(var uParam0, int iParam1) // Hash - 0xEDC3BD2D ^0xA9A19095
{
	func_273(&(uParam0->f_28), iParam1);
	return;
}

void func_273(var uParam0, int iParam1) // Hash - 0xB72ACFD2 ^0xB72ACFD2
{
	int i;
...
void func_274(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Hash - 0x34362197 ^0xC592197
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_275(Ped* ppedParam0) // Hash - 0xCA79453F ^0x7BA88177
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
void func_276(int iParam0) // Hash - 0x995C9E2 ^0x995C9E2
{
	if (*iParam0 == -1)
		return;
...
void func_277(char* sParam0) // Hash - 0x54B64147 ^0x56EEAFB9
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_278(var uParam0) // Hash - 0x4CD8BCE8 ^0xCB2CFA07
{
	*uParam0 = -1;
...
void func_279() // Hash - 0x554DA35 ^0x6991ECCC
{
...
Hash func_280(int iParam0) // Hash - 0xBF0B24A5 ^0xBF0B24A5
{
	if (!func_36(iParam0))
		return func_47(iParam0);
	else
