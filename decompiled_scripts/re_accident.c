...
void main() // Position - 0x0 Hash - 0x5D84F89F ^0x5D84F89F
{
	...
	uLocal_305 = { uScriptParam_571.f_1[0 /*3*/] };
...
BOOL func_4(Player plParam0, int iParam1) // Position - 0x4D9 Hash - 0x5A3B86CC ^0x2CFA58CE
{
	BOOL flag;
...
int func_5(int iParam0, BOOL bParam1) // Position - 0x524 Hash - 0x1DCD393E ^0x1DCD393E
{
	int num;
	int num2;
...
int func_6() // Position - 0x565 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1574918;
}

BOOL func_7(Player plParam0) // Position - 0x571 Hash - 0x68897CDD ^0x62820466
{
...
BOOL func_8() // Position - 0x5B0 Hash - 0xA525B2F4 ^0xA525B2F4
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_9(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5BE Hash - 0x3167F4C7 ^0xCE6B9B6A
{
	int num;
...
BOOL func_10() // Position - 0x5F1 Hash - 0xD140D54A ^0xE638D98F
{
...
void func_11(int iParam0) // Position - 0x618 Hash - 0x1B2EEE72 ^0xEDBC1F9D
{
	if (iParam0 == 1)
...
void func_12() // Position - 0x63B Hash - 0xC5F1AB23 ^0x9FAAD7C1
{
	if (iLocal_352 == -1)
...
void func_13() // Position - 0x69D Hash - 0x80A09607 ^0x22BAA323
{
...
void func_14() // Position - 0x6C1 Hash - 0x20A699E1 ^0xA7519398
{
	int i;
	Vector3 outPosition;
	float unk;
...
void func_15(int iParam0, BOOL bParam1) // Position - 0x8F9 Hash - 0xD119AFCC ^0xD119AFCC
{
	int num;
...
void func_16(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x962 Hash - 0x7DE4E0AC ^0xC7BA34ED
{
	if (iLocal_223 == 0)
		bParam3 = false;
...
void func_17() // Position - 0x9D9 Hash - 0xA4A76592 ^0x4D67F0E9
{
	int i;
	int weaponHash;
	float distanceBetweenCoords;
					...
					if (!bLocal_46)
					{
						...
						if (num < 2f)
						{
							if (iLocal_52 != -1)
							{
								...
								if (num2 < 13)
								{
									if (func_18(iLocal_229[num2 + 1 /*5*/]))
									{
										if (HUD::DOES_BLIP_EXIST(iLocal_229[num2 /*5*/].f_3))
										{
											if (HUD::GET_BLIP_ALPHA(iLocal_229[num2 /*5*/].f_3) > 0)
...
BOOL func_18(float fParam0, var uParam1, var uParam2) // Position - 0xCAE Hash - 0x16E871AD ^0x10C54C39
{
...
Vector3 func_19() // Position - 0xCD8 Hash - 0x9643C622 ^0xC48176B0
{
...
void func_20() // Position - 0xD48 Hash - 0x8B6163E7 ^0xC8C57670
{
	int i;
...
void func_21() // Position - 0xDC1 Hash - 0xDE604780 ^0xDE604780
{
	if (!bLocal_49)
		bLocal_49 = true;
...
void func_22() // Position - 0xDD2 Hash - 0x9D501811 ^0x548838DC
{
	switch (iLocal_302)
	{
		case 0:
			...
			func_111(&uLocal_537, 349680864);
			func_111(&uLocal_537, -415509317);
			func_111(&uLocal_537, 94130617);
			func_108(&uLocal_537);
			...
			if (AUDIO::REQUEST_SCRIPT_AUDIO_BANK("CONSTRUCTION_ACCIDENT_1", false, -1) && STREAMING::HAS_ANIM_DICT_LOADED("re@construction") && func_104(&uLocal_537))
			{
				...
				{
					pedLocal_317 = PED::CREATE_PED_INSIDE_VEHICLE(veLocal_319, PED_TYPE_MISSION, 349680864, -1, true, true);
					...
					obLocal_340 = OBJECT::CREATE_OBJECT(94130617, -455.6561f, -985.8071f, 22.4868f, true, true, false);
					...
					func_103(&uLocal_358, 3, pedLocal_317, "RECONACWorker", 0, 1);
					AUDIO::SET_AMBIENT_VOICE_NAME(pedLocal_317, "S_M_Y_GENERICWORKER_01_WHITE_01");
					pedLocal_318 = PED::CREATE_PED(PED_TYPE_MISSION, 349680864, -462.2982f, -978.3272f, 65f, 221.4041f, true, true);
					...
					EVENT::SET_DECISION_MAKER(pedLocal_317, -1143637011);
					EVENT::CLEAR_DECISION_MAKER_EVENT_RESPONSE(-1143637011, EVENT_FIRE_NEARBY);
					EVENT::CLEAR_DECISION_MAKER_EVENT_RESPONSE(-1143637011, EVENT_ON_FIRE);
					EVENT::CLEAR_DECISION_MAKER_EVENT_RESPONSE(-1143637011, EVENT_POTENTIAL_WALK_INTO_FIRE);
					EVENT::CLEAR_DECISION_MAKER_EVENT_RESPONSE(-1143637011, EVENT_VEHICLE_ON_FIRE);
					EVENT::CLEAR_DECISION_MAKER_EVENT_RESPONSE(-1143637011, EVENT_PED_TO_FLEE);
					obLocal_339 = OBJECT::CREATE_OBJECT(-415509317, fLocal_526, fLocal_526.f_1 + 0.5f, fLocal_526.f_2 - 0.25f, true, true, false);
			...
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				if (!bLocal_342)
				{
					if (!PED::IS_PED_INJURED(pedLocal_317))
					{
						...
						if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), -473.1686f, -984.6405f, 22.487f, 40f, 40f, 5f, false, true, 0) && !PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()) && func_94(true, false, true) && STREAMING::HAS_MODEL_LOADED(525797972))
						{
							if (!func_134())
							{
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_320, false))
				{
					if (iLocal_353 >= 3)
					{
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && PED::IS_PED_IN_MODEL(PLAYER::PLAYER_PED_ID(), 1886712733))
						{
							if (HUD::DOES_BLIP_EXIST(blLocal_325))
							{
								HUD::REMOVE_BLIP(&blLocal_325);
...
BOOL func_23() // Position - 0x153C Hash - 0x152DA0B2 ^0x220E93E9
{
...
int func_24(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x155E Hash - 0x384540C1 ^0x384540C1
{
...
int func_25(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x15AC Hash - 0x77297D51 ^0x40DC584A
{
	Global_21726 = 0;
...
void func_26() // Position - 0x187A Hash - 0xF42BEB19 ^0xA29557DA
{
	if (!func_27())
		return;
...
BOOL func_27() // Position - 0x18B1 Hash - 0x7B74B45F ^0xCE052A5D
{
...
BOOL func_28(Player plParam0) // Position - 0x1914 Hash - 0x6E46BC72 ^0x6E46BC72
{
	return func_29(plParam0, 20);
}

BOOL func_29(Player plParam0, int iParam1) // Position - 0x1924 Hash - 0x7CD5054C ^0x870BEA81
{
	return IS_BIT_SET(Global_1894573[plParam0 /*608*/].f_10.f_4, iParam1);
}

Player func_30() // Position - 0x193C Hash - 0x478900E4 ^0x478900E4
{
	return -1;
}

void func_31() // Position - 0x1945 Hash - 0x6056DAC ^0xEDC10140
{
	int i;
...
void func_32() // Position - 0x1976 Hash - 0xCD8A4D28 ^0xCD8A4D28
{
...
BOOL func_33() // Position - 0x1A0B Hash - 0x9A999369 ^0x4033F7BF
{
	int num;
	int weaponHash;
...
void func_34() // Position - 0x1AA4 Hash - 0x98476CE1 ^0x250FEB7C
{
	if (func_41(14))
	{
...
int func_35() // Position - 0x1B46 Hash - 0x3C5423D7 ^0x3C5423D7
{
	func_36();
	return Global_113648.f_2365.f_539.f_4321;
}

void func_36() // Position - 0x1B5F Hash - 0xD1F2D853 ^0xF9F5FD4D
{
	int num;
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_39(Global_113648.f_2365.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_37(num) && !func_41(14) || Global_112599)
			{
...
BOOL func_37(int iParam0) // Position - 0x1C5C Hash - 0x8907F004 ^0x8907F004
{
	return iParam0 < 3;
}

int func_38(Ped pedParam0) // Position - 0x1C68 Hash - 0xAC4E9801 ^0xB379A75F
{
	int i;
	Hash entityModel;
...
Hash func_39(int iParam0) // Position - 0x1CA5 Hash - 0xADCB9755 ^0xADCB9755
{
	if (func_37(iParam0))
...
Hash func_40(int iParam0) // Position - 0x1CCA Hash - 0xE4CEEC2C ^0xE4CEEC2C
{
	return Global_2028[iParam0 /*29*/];
}

BOOL func_41(int iParam0) // Position - 0x1CD9 Hash - 0x937D8816 ^0x937D8816
{
	return Global_43257 == iParam0;
}

void func_42() // Position - 0x1CE7 Hash - 0x989CDED ^0xD019AD27
{
	int i;
...
BOOL func_43(int iParam0, int iParam1) // Position - 0x1D3E Hash - 0xA14C4D3F ^0xA6034F77
{
	switch (iParam0)
	{
		case 5:
...
void func_44() // Position - 0x1D76 Hash - 0xE32CF1EF ^0xB9A7BEB2
{
...
void func_45(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x1DCD Hash - 0xC6B752B2 ^0xC6B752B2
{
...
void func_46() // Position - 0x1E23 Hash - 0xC536DD5 ^0xC536DD5
{
	Global_20591 = 0;
	func_47();
	return;
...
void func_47() // Position - 0x1E33 Hash - 0xF6D04E68 ^0x80AE5309
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22736 = 0;
...
void func_48() // Position - 0x1E54 Hash - 0xA7EC3101 ^0xBCA91365
{
	switch (iLocal_353)
	{
		case 0:
...
void func_49() // Position - 0x202A Hash - 0xD4DF4A06 ^0x155F766C
{
	switch (iLocal_349)
	{
		case 0:
...
void func_50() // Position - 0x220D Hash - 0x75B8A4F5 ^0x75B8A4F5
{
	bLocal_48 = true;
	return;
}

BOOL func_51() // Position - 0x2218 Hash - 0xADD1C343 ^0xADD1C343
{
	if (bLocal_222 == true)
		return true;
...
void func_52() // Position - 0x222B Hash - 0x5097CA3A ^0xA9105315
{
	Vector3 vector;
		...
		case 5:
			if (MISC::GET_GAME_TIMER() - iLocal_351 > 3000)
			{
				...
				if (!PED::IS_PED_INJURED(pedLocal_317))
				{
					...
					EVENT::SET_DECISION_MAKER(pedLocal_317, -455129387);
...
void func_53() // Position - 0x2833 Hash - 0x49F3087F ^0xC985472A
{
	while (!func_80())
	{
		SYSTEM::WAIT(0);
...
void func_54() // Position - 0x2863 Hash - 0xD765C186 ^0xD765C186
{
	func_55();
	return;
}

int func_55() // Position - 0x2870 Hash - 0x9482CBBF ^0x8B17A994
{
	if (func_56(false))
		return 0;
...
BOOL func_56(BOOL bParam0) // Position - 0x28BB Hash - 0x15889021 ^0xE7262364
{
...
void func_57(int iParam0, int iParam1) // Position - 0x28E3 Hash - 0x207C13D1 ^0xD1CFBEA4
{
	if (iParam0 == -1)
		iParam0 = func_74();
	...
	if (iParam1 <= func_73(iParam0))
	{
		...
		if (!func_71(51))
		{
			func_67(_("Some Random Events will reward the player with stat boosts or money."), 1, 0, 4000, 10000, func_70(), 0, 138, 0);
			func_66(51);
		}
...
void func_58(int iParam0) // Position - 0x29E7 Hash - 0xE49C42EC ^0xE49C42EC
{
	Global_113634 = iParam0;
	return;
}

void func_59(int iParam0, var uParam1, var uParam2) // Position - 0x29F5 Hash - 0xEC2439E7 ^0x1B67A713
{
	BOOL flag;
...
void func_60() // Position - 0x2ADB Hash - 0x9F269E94 ^0x9F269E94
{
	int num;
	float num2;
	float num3;
...
int func_61() // Position - 0x2F99 Hash - 0x21D64237 ^0x21D64237
{
	return Global_32163;
}

BOOL func_62(int iParam0, int iParam1) // Position - 0x2FA4 Hash - 0x77E0C72A ^0x80DA2A54
{
...
void func_63(int iParam0, int iParam1, int iParam2) // Position - 0x2FF5 Hash - 0xCF91FBA1 ^0xC4FE4CB6
{
	if (iParam2 == -1)
		iParam2 = func_6();
...
int func_64(int iParam0, int iParam1) // Position - 0x3013 Hash - 0xE97012CD ^0x68FBF85A
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_65(int iParam0) // Position - 0x3387 Hash - 0xBF3EFB31 ^0xBF3EFB31
{
	switch (iParam0)
	{
		case 29:
...
void func_66(int iParam0) // Position - 0x33B6 Hash - 0x12249850 ^0x46987D7A
{
	int offset;
	int i;
...
void func_67(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x33F8 Hash - 0x6C5A40D1 ^0x6C5A40D1
{
	func_68(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
	return;
}

void func_68(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x3419 Hash - 0xA155C85B ^0x4C499A0E
{
	int i;
...
void func_69() // Position - 0x35EC Hash - 0xCF8881D1 ^0x40507183
{
	int i;
...
int func_70() // Position - 0x3703 Hash - 0x35BC7314 ^0x35BC7314
{
	func_36();
...
BOOL func_71(int iParam0) // Position - 0x3749 Hash - 0x3F44A899 ^0x7041C53
{
	int num;
	int i;
...
void func_72(int iParam0, int iParam1) // Position - 0x3789 Hash - 0xE2246457 ^0xD5018049
{
	MISC::SET_BIT(&Global_113648.f_24997.f_8[iParam0], iParam1);
	return;
}

int func_73(int iParam0) // Position - 0x37A4 Hash - 0xAA02DAD0 ^0xAA02DAD0
{
	int num;
...
int func_74() // Position - 0x3855 Hash - 0x7AC1007E ^0x4E7D4F54
{
	var unk;
	int unk2;
...
int func_75(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x3872 Hash - 0x6DA57317 ^0x57A32A43
{
...
void func_76(int iParam0, int iParam1, int iParam2) // Position - 0x3A4C Hash - 0xF0BE1C2C ^0xB42E6E17
{
	int num;
	int num2;
	...
	switch (iParam0)
	{
		...
		case 3:
			...
			if (num2 != 14192)
			{
				num = func_79(num2, -1, 0);
				num = num + iParam2;
			
				if (num > 100)
					num = 100;
			
				func_77(num2, num, -1, true, false);
			}
			break;
	}
...
void func_77(int iParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x3B3C Hash - 0x7D768555 ^0x693A841
{
	Hash statName;
...
int func_78(int iParam0) // Position - 0x3B6C Hash - 0x1A3F3220 ^0x1A3F3220
{
	int num;
	int num2;
...
int func_79(int iParam0, int iParam1, int iParam2) // Position - 0x3BA0 Hash - 0x4BC84F7B ^0x370D7D6F
{
	Hash statHash;
	int outValue;
...
BOOL func_80() // Position - 0x3BDD Hash - 0xFD255207 ^0xFD255207
{
	return true;
}

Blip func_81(Ped pedParam0, BOOL bParam1, int iParam2) // Position - 0x3BE6 Hash - 0xA714218A ^0xAD0F82BD
{
	Blip blip;
...
Blip func_82(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3C30 Hash - 0x2E5A72B ^0x64F26CC0
{
	Blip blip;
...
var func_83(BOOL bParam0, var uParam1, var uParam2) // Position - 0x3CD4 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
int func_84(BOOL bParam0) // Position - 0x3CEB Hash - 0x3A78A0E1 ^0x967BAB5B
{
	if (func_88())
	{
		Global_113638 = true;
...
void func_85(int iParam0) // Position - 0x3D3E Hash - 0x3B4E6AAB ^0xDE553B62
{
	switch (iParam0)
	{
		case 0:
...
void func_86(char* sParam0, int iParam1) // Position - 0x3E19 Hash - 0xCBB0D91 ^0x21070E5C
{
...
char* func_87(int iParam0) // Position - 0x3E30 Hash - 0x7EEC0515 ^0xCF6B324E
{
	char* str;
...
BOOL func_88() // Position - 0x3E73 Hash - 0x8129EEA4 ^0x48B13301
{
...
int func_89(var uParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0x3EA9 Hash - 0x8F9349A ^0xC5C097C1
{
	int i;
...
void func_90(var uParam0, int iParam1) // Position - 0x3FE0 Hash - 0xDB87CEC2 ^0xDB87CEC2
{
	int i;
...
BOOL func_91(int iParam0) // Position - 0x4030 Hash - 0xECB6C71B ^0xECB6C71B
{
	return func_92(iParam0, Global_43257);
}

BOOL func_92(int iParam0, int iParam1) // Position - 0x4041 Hash - 0x1FD727E0 ^0x1FD727E0
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_93(int iParam0) // Position - 0x4222 Hash - 0x3BAB94E9 ^0x3BAB94E9
{
	if (Global_43257 == 15)
		return false;
...
BOOL func_94(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4244 Hash - 0xF0D380FF ^0x29DD7336
{
...
void func_95() // Position - 0x4329 Hash - 0x9D4F6557 ^0x80E7F8A
{
	AUDIO::TRIGGER_MUSIC_EVENT("RE14A_FAIL");
	iLocal_301 = 2;
	return;
...
Blip func_96(Vehicle veParam0, BOOL bParam1, BOOL bParam2) // Position - 0x433D Hash - 0x177BFEFF ^0x177BFEFF
{
	return func_82(veParam0, !bParam1, bParam2);
}

void func_97() // Position - 0x4350 Hash - 0x95A23108 ^0x516C5A27
{
	if (func_100(1000))
	{
		func_46();
	...
	switch (iLocal_303)
	{
		...
		case 8:
			...
			uLocal_327[1] = OBJECT::CREATE_OBJECT_NO_OFFSET(525797972, -457.8815f, -988.9059f, 22.9554f, true, true, false);
			ENTITY::SET_ENTITY_ROTATION(uLocal_327[1], -0.1939f, 105.0058f, 77.3964f, 2, true);
			uLocal_327[2] = OBJECT::CREATE_OBJECT_NO_OFFSET(525797972, -451.5131f, -986.8079f, 24.6947f, true, true, false);
			ENTITY::SET_ENTITY_ROTATION(uLocal_327[2], 24.3941f, 32.5423f, 80.6862f, 2, true);
			uLocal_327[3] = OBJECT::CREATE_OBJECT_NO_OFFSET(525797972, -450.8099f, -985.9972f, 24.7104f, true, true, false);
			ENTITY::SET_ENTITY_ROTATION(uLocal_327[3], 24.1841f, 110.287f, 78.4357f, 2, true);
			uLocal_327[4] = OBJECT::CREATE_OBJECT_NO_OFFSET(525797972, -456.6558f, -987.3979f, 22.9537f, true, true, false);
			ENTITY::SET_ENTITY_ROTATION(uLocal_327[4], -0.0264f, 29.5754f, 79.1811f, 2, true);
			uLocal_327[5] = OBJECT::CREATE_OBJECT_NO_OFFSET(525797972, -456.1279f, -988.4162f, 22.9889f, true, true, false);
			ENTITY::SET_ENTITY_ROTATION(uLocal_327[5], -0.6337f, 108.4339f, 77.9539f, 2, true);
			uLocal_327[6] = OBJECT::CREATE_OBJECT_NO_OFFSET(525797972, -457.0807f, -987.3059f, 23.7564f, true, true, false);
			ENTITY::SET_ENTITY_ROTATION(uLocal_327[6], 0.0929f, 74.2657f, 79.3839f, 2, true);
			uLocal_327[7] = OBJECT::CREATE_OBJECT_NO_OFFSET(525797972, -456.6558f, -983.7804f, 22.9712f, true, true, false);
			ENTITY::SET_ENTITY_ROTATION(uLocal_327[7], -0.0264f, 29.5754f, 80.9061f, 2, true);
			uLocal_327[8] = OBJECT::CREATE_OBJECT_NO_OFFSET(525797972, -455.3279f, -983.1712f, 22.9564f, true, true, false);
			ENTITY::SET_ENTITY_ROTATION(uLocal_327[8], -0.1087f, 109.7339f, 80.9789f, 2, true);
			uLocal_327[9] = OBJECT::CREATE_OBJECT_NO_OFFSET(525797972, -456.1632f, -983.9359f, 23.7964f, true, true, false);
			ENTITY::SET_ENTITY_ROTATION(uLocal_327[9], -0.3321f, 74.1907f, 81.6089f, 2, true);
			uLocal_327[10] = OBJECT::CREATE_OBJECT_NO_OFFSET(525797972, -454.644f, -994.1709f, 23.3329f, true, true, false);
...
void func_98(Cam caParam0) // Position - 0x4E9C Hash - 0x513A637 ^0x8EEA3090
{
...
void func_99() // Position - 0x4EB4 Hash - 0x1FAB512B ^0xDEDC2B21
{
...
BOOL func_100(int iParam0) // Position - 0x4EC4 Hash - 0x7FAC01B4 ^0x9388B6EC
{
...
BOOL func_101() // Position - 0x4F0E Hash - 0x57459B9C ^0x9A36D842
{
...
int func_102(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) // Position - 0x4F40 Hash - 0xD593C051 ^0xD593C051
{
	func_45(uParam0, 145, sParam1, iParam4, iParam5, iParam6);
...
void func_103(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x4F93 Hash - 0x6C235EE0 ^0x9E57F206
{
...
BOOL func_104(var uParam0) // Position - 0x502E Hash - 0x20D4198E ^0x54291DEA
{
	int i;
...
BOOL func_105(var uParam0) // Position - 0x508A Hash - 0xC32864D ^0xACB9E803
{
	return func_106(*uParam0, "NULL", uParam0->f_1);
}

BOOL func_106(int iParam0, char* sParam1, Hash hParam2) // Position - 0x509F Hash - 0x8008FEBF ^0xF0538B20
{
...
int func_107(int iParam0) // Position - 0x518A Hash - 0x3A85B246 ^0x3A85B246
{
	int i;
...
void func_108(var uParam0) // Position - 0x51B3 Hash - 0x58E13B05 ^0x58E13B05
{
	func_109(uParam0, 9, -1, 0);
	return;
}

void func_109(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x51C5 Hash - 0xC6A50A87 ^0xC6A50A87
{
	int i;
...
BOOL func_110(int iParam0) // Position - 0x527F Hash - 0x4B6B929B ^0x4B6B929B
{
	switch (iParam0)
	{
		case -1:
...
void func_111(var uParam0, int iParam1) // Position - 0x531E Hash - 0xA8A6A9F9 ^0xA8A6A9F9
{
	func_109(uParam0, 0, iParam1, 0);
	return;
}

void func_112(var uParam0) // Position - 0x5330 Hash - 0x849AE4BE ^0x14577356
{
	int i;
...
void func_113(int* piParam0) // Position - 0x53AE Hash - 0x4B478A31 ^0x2BE84DD6
{
	func_114(piParam0, "NULL", piParam0->f_1);
	return;
}

void func_114(int* piParam0, char* sParam1, Hash hParam2) // Position - 0x53C2 Hash - 0xCB81CA4C ^0xCD422589
{
...
void func_115() // Position - 0x5493 Hash - 0xE08021A6 ^0xFC0FEE79
{
	int i;

	func_111(&uLocal_537, 1886712733);
	func_111(&uLocal_537, 887537515);
	func_111(&uLocal_537, 1668676931);

	if (func_104(&uLocal_537))
	{
		VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(887537515, true);
		...
		veLocal_319 = VEHICLE::CREATE_VEHICLE(887537515, uLocal_308, 80f, true, true, false);
		...
		veLocal_320 = VEHICLE::CREATE_VEHICLE(1886712733, -472.9444f, -966.671f, 22.5534f, 181.8365f, true, true, false);
		MISC::CLEAR_AREA(uLocal_308, 10f, true, false, false, false);
		uLocal_327[0] = OBJECT::CREATE_OBJECT_NO_OFFSET(1668676931, -453.2f, -986.1f, 59.45f, true, true, false);
...
void func_116(var uParam0, BOOL bParam1) // Position - 0x5779 Hash - 0x16045BFE ^0x66440F01
{
	int i;
...
void func_117(var uParam0) // Position - 0x57B9 Hash - 0x916F6652 ^0x26C41FA1
{
	*uParam0 = 0;
	uParam0->f_1 = -1;
	return;
...
void func_118(var uParam0) // Position - 0x57CA Hash - 0xB4367EF0 ^0x1A0632ED
{
	int i;
...
void func_119(var uParam0) // Position - 0x5800 Hash - 0xF8F4AA76 ^0x3513BC1B
{
	func_120(*uParam0, "NULL", uParam0->f_1);
	return;
}

void func_120(int iParam0, char* sParam1, Hash hParam2) // Position - 0x5815 Hash - 0x2AE0929C ^0x571E5810
{
	if (IS_BIT_SET(iParam0, 30))
	{
		switch (func_107(iParam0))
...
BOOL func_121() // Position - 0x58CF Hash - 0xC05B0E62 ^0x94C54EFE
{
...
int func_122(float fParam0, BOOL bParam1) // Position - 0x5955 Hash - 0xA169FFDC ^0x284941E0
{
	var unk;
	int unk2;
	int unk3;
...
void func_123(int iParam0, var uParam1) // Position - 0x5A06 Hash - 0x7228097F ^0x68B65601
{
	switch (iParam0)
	{
		case 0:
		...
		case 5:
			func_124(uParam1, "Barry3A", func_126(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, _("Areas where you can find vehicles with a hidden stash have been marked on the map. Collect these vehicles for Barry."), 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_125(iParam0), 0, 1);
			break;
		...
		case 8:
			func_124(uParam1, "Dreyfuss1", func_126(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, _("The killer's identity and location have been revealed."), 106, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_125(iParam0), 0, 0);
			break;
		...
		case 38:
			func_124(uParam1, "Nigel1A", func_126(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, _("Areas where you can find celebrity items have been marked on the map. Steal these items for Nigel and Mrs. Thornhill."), 100, 0, "", 0, 0, 42, 4, 4, 0, 2359, func_125(iParam0), 1, 1);
			break;
		...
		case 49:
			func_124(uParam1, "Paparazzo3A", func_126(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, _("Areas where you can find celebrity photo opportunities have been marked on the map. Track down and photograph these celebrities for Beverly."), 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_125(iParam0), 0, 1);
			break;
		...
		case 58:
			func_124(uParam1, "Tonya1", func_126(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, _("Strangers and Freaks can be found throughout San Andreas at ~HUD_COLOUR_FRANKLIN~~BLIP_RANDOM_CHARACTER~~s~"), -1, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_125(iParam0), 0, 1);
			break;
...
int func_125(int iParam0) // Position - 0x6C4C Hash - 0xC999F6B2 ^0xC999F6B2
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_126(int iParam0) // Position - 0x6F92 Hash - 0x680676D4 ^0x8D10F3A1
{
	var unk;
	var unk2;
...
struct<2> func_127(int iParam0) // Position - 0x6FC9 Hash - 0x40B9A0AA ^0x2508AE54
{
	var unk;
...
BOOL func_128() // Position - 0x7415 Hash - 0x7055FFB1 ^0x7055FFB1
{
...
BOOL func_129() // Position - 0x7447 Hash - 0x79CF7679 ^0x79CF7679
{
	return Global_113366 > 0;
}

BOOL func_130() // Position - 0x7455 Hash - 0xCF2296C0 ^0xCF2296C0
{
	if (Global_97603 != -1)
		return true;
...
BOOL func_131() // Position - 0x746A Hash - 0x98CCC132 ^0x97B0D6ED
{
	if (Global_97603 != -1)
...
BOOL func_132() // Position - 0x748D Hash - 0x29CB2928 ^0xE369A18D
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_133() // Position - 0x74AA Hash - 0xF2B7F534 ^0x7F3EC4F9
{
	if (!func_91(5))
		return true;
...
BOOL func_134() // Position - 0x750C Hash - 0x1121F6F2 ^0x90CE37A6
{
...
void func_135(int iParam0) // Position - 0x7537 Hash - 0xA62BD46A ^0x1E050688
{
	if (iParam0 == -1)
		iParam0 = func_74();
...
void func_136() // Position - 0x756D Hash - 0x178BF2A7 ^0x744062F5
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
...
void func_137(int iParam0) // Position - 0x75AA Hash - 0xE49C42EC ^0xE49C42EC
{
	Global_113637 = iParam0;
	return;
}

BOOL func_138(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x75B8 Hash - 0xC601B4EA ^0xC601B4EA
{
	BOOL flag;
...
BOOL func_139(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x7952 Hash - 0x2D46096D ^0xEA41378F
{
	if (bParam6)
...
BOOL func_140(int iParam0) // Position - 0x7999 Hash - 0x687D9246 ^0x687D9246
{
	int num;
...
BOOL func_141(int iParam0) // Position - 0x79BA Hash - 0x2D75E13A ^0x2D75E13A
{
	return func_142(iParam0, 1);
}

int func_142(int iParam0, int iParam1) // Position - 0x79C9 Hash - 0x1F92FEBC ^0x1F92FEBC
{
	var unk;
	var unk2;
	int num;
...
void func_143(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x7A1C Hash - 0x2BEE335D ^0x2BEE335D
{
	func_144(func_155(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
	return;
}

void func_144(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x7A3A Hash - 0xB807819C ^0xB807819C
{
	int num;
	int num2;
	int num3;
...
float func_145(float fParam0, float fParam1, float fParam2) // Position - 0x7C3B Hash - 0xDB08F514 ^0x78C0BF6F
{
	float num;
...
int func_146(int iParam0, int iParam1) // Position - 0x7C7D Hash - 0xD3EBACB3 ^0xD3EBACB3
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_147(int iParam0) // Position - 0x7D1F Hash - 0x90B520AB ^0x257AC1C4
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_148(int iParam0) // Position - 0x7D32 Hash - 0xC188C91C ^0x48884C7
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_149(int iParam0) // Position - 0x7D45 Hash - 0x626AEC54 ^0xDB28E416
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_150(int iParam0) // Position - 0x7D58 Hash - 0x826C592F ^0xDEC5AA46
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_151(int iParam0) // Position - 0x7D6A Hash - 0xE1B0542C ^0x127A471E
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_152(BOOL bParam0, var uParam1, var uParam2) // Position - 0x7D8C Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
int func_153(int iParam0) // Position - 0x7DA3 Hash - 0x2D4DB85F ^0x2D4DB85F
{
	return iParam0 & 15;
}

BOOL func_154(int iParam0, int iParam1) // Position - 0x7DB0 Hash - 0xEA08B1 ^0xEA08B1
{
	int num;
	int num2;
...
int func_155() // Position - 0x7EBC Hash - 0x9E44C35 ^0xB9993D58
{
	var unk;
...
void func_156(var uParam0, int iParam1) // Position - 0x7F02 Hash - 0x15B9927E ^0x4A4674
{
	if (iParam1 <= 0)
		return;
...
void func_157(var uParam0, int iParam1) // Position - 0x7F88 Hash - 0x4C70B2C3 ^0x4C70B2C3
{
...
void func_158(var uParam0, int iParam1) // Position - 0x7FBB Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_159(var uParam0, int iParam1) // Position - 0x800E Hash - 0x864304A8 ^0x1F5003E2
{
...
void func_160(var uParam0, int iParam1) // Position - 0x8048 Hash - 0x76860AE7 ^0x32308FFF
{
...
void func_161(var uParam0, int iParam1) // Position - 0x8083 Hash - 0xDB8A72C0 ^0x4F6D426D
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_162(int iParam0) // Position - 0x80BF Hash - 0x57D8E518 ^0xD297DD35
{
	int num;
	int num2;
	int num3;
...
BOOL func_163(int iParam0, int iParam1) // Position - 0x819B Hash - 0x577FB514 ^0xAAF8B538
{
...
BOOL func_164(int iParam0) // Position - 0x81BB Hash - 0x97844555 ^0xADCD6DAA
{
	int num;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_172() || Global_112695 || Global_32166 || func_171() || func_43(8, -1) || func_170() || func_169() || func_168() || func_167() || Global_113648.f_7690.f_919[num] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_172() || Global_32166 || func_171() || func_43(8, -1) || func_168() || func_170() || func_169() || func_167() || Global_113648.f_7690.f_919[num] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_172() || Global_112695 || Global_32166 || func_171() || func_43(8, -1) || func_168() || func_170() || func_169() || func_167() || Global_113648.f_7690.f_919[num] == 5 || Global_43804 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_172() || Global_112695 || Global_32166 || func_171() || func_43(8, -1) || func_170() || func_169() || func_167() || Global_113648.f_7690.f_919[num] == 5)
							return false;
						break;
				
					case 4:
						if (func_172() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_43(8, -1) || func_167() || func_166() || Global_113648.f_7690.f_919[num] == 5)
							return false;
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_172() || Global_32166 || func_171() || func_43(8, -1) || func_169() || func_168() || func_167() || Global_113648.f_7690.f_919[num] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_172() || func_169() || Global_112695 || Global_32166 || func_171() || Global_44446 || func_43(8, -1) || func_168() || func_166() || func_167() || Global_113648.f_7690.f_919[num] == 5)
							return false;
						break;
...
BOOL func_165() // Position - 0x88D8 Hash - 0x4228A1C2 ^0x952FE30F
{
	return Global_100720.f_1;
}

BOOL func_166() // Position - 0x88E6 Hash - 0xC20DBA70 ^0xAC4006FB
{
	if (Global_97603 != -1)
...
BOOL func_167() // Position - 0x8909 Hash - 0x3CA1BB47 ^0xB78A1ACB
{
...
BOOL func_168() // Position - 0x8923 Hash - 0xE663B8F6 ^0xE663B8F6
{
	if (Global_78819)
		return true;
...
BOOL func_169() // Position - 0x894D Hash - 0xD56328D2 ^0xD56328D2
{
	return Global_100733.f_388 > 0;
}

BOOL func_170() // Position - 0x895E Hash - 0xD56328D2 ^0xD56328D2
{
	return Global_100733.f_387 > 0;
}

BOOL func_171() // Position - 0x896F Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1575060;
}

BOOL func_172() // Position - 0x897B Hash - 0x7FE517FE ^0x128A3BC8
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
BOOL func_173() // Position - 0x8997 Hash - 0xB12DEAA2 ^0xB12DEAA2
{
	func_34();
...
BOOL func_174(int iParam0) // Position - 0x89BF Hash - 0xCDB90269 ^0xCDB90269
{
	return func_154(func_155(), iParam0);
}

BOOL func_175(int iParam0, int iParam1, int iParam2) // Position - 0x89D1 Hash - 0xBEEFD79C ^0xBEEFD79C
{
	BOOL num;
	int num2;
...
int func_176(int iParam0) // Position - 0x8AB5 Hash - 0x45FC9D61 ^0x45FC9D61
{
	if (!func_37(iParam0))
		return 7;
...
BOOL func_177(int iParam0) // Position - 0x8AD9 Hash - 0xF2A54181 ^0xF2A54181
{
	int num;
	BOOL flag;
...
BOOL func_178() // Position - 0x8B31 Hash - 0xB72C022E ^0x452A7B6D
{
	Vehicle vehiclePedIsIn;
...
BOOL func_179() // Position - 0x8B75 Hash - 0x44DD83CC ^0x6D2C8335
{
	int profileSetting;
...
void func_180() // Position - 0x8C2D Hash - 0x2982E797 ^0xD7C4612C
{
	if (bLocal_534)
	{
		if (!bLocal_535)
...
void func_181(int iParam0) // Position - 0x8E1A Hash - 0xE6B11918 ^0x37AF2AD2
{
	var name;
...
void func_182(var uParam0) // Position - 0x8ECC Hash - 0x995C9E2 ^0x995C9E2
{
	if (*uParam0 == -1)
		return;
...
char* func_183(int iParam0, BOOL bParam1) // Position - 0x8F09 Hash - 0x959319CB ^0x5F3F39B2
{
	switch (iParam0)
	{
		case 0:
...
void func_184(int iParam0) // Position - 0x9152 Hash - 0xC0234809 ^0x4FD853DC
{
	Global_43808 = MISC::GET_GAME_TIMER() + iParam0;
	return;
}

void func_185(int iParam0) // Position - 0x9164 Hash - 0x881273A8 ^0x881273A8
{
	func_186(iParam0, 0, func_191(iParam0));
	return;
}

void func_186(int iParam0, int iParam1, int iParam2) // Position - 0x9179 Hash - 0xA7DBC311 ^0xA7DBC311
{
	int unk;
	var unk2;
...
struct<16> func_187(var uParam0) // Position - 0x91A8 Hash - 0xDA1B281D ^0xB09CC603
{
	var unk;
	int unk2;
...
void func_188(int iParam0, var uParam1) // Position - 0x9278 Hash - 0x63EF72B0 ^0xC612AA53
{
	Global_113648.f_24997.f_43[iParam0] = *uParam1;
	return;
}

void func_189(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x9290 Hash - 0xB28A4507 ^0xB28A4507
{
	int num;
	int i;
	int num2;
...
void func_190(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x9412 Hash - 0x733BFBA2 ^0x733BFBA2
{
...
int func_191(int iParam0) // Position - 0x944A Hash - 0x4219564C ^0x4219564C
{
	int num;
...
int func_192(Vehicle veParam0, int iParam1, int iParam2) // Position - 0x95ED Hash - 0xBB1BDF97 ^0xC3A3101
{
	var script;
	...
	func_193(veParam0, iParam2);
	return 1;
}

void func_193(Vehicle veParam0, int iParam1) // Position - 0x962D Hash - 0x403E4E98 ^0x34F9BF63
{
...
void func_194(Vehicle veParam0, var uParam1) // Position - 0x982F Hash - 0x5E84B52A ^0xEF20F807
{
	int i;
...
int func_195(int iParam0) // Position - 0x9ADA Hash - 0xEE599357 ^0xEE599357
{
	switch (iParam0)
	{
		case 1:
...
int func_196(var uParam0, var uParam1, var uParam2) // Position - 0x9B8A Hash - 0x4455160E ^0x8E5B3F28
{
	int i;
	int modType;
...
BOOL func_197(int iParam0) // Position - 0x9D7D Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case -1775728740:
...
void func_198(var uParam0) // Position - 0x9D9D Hash - 0xB95AF921 ^0x4DC7C61C
{
	int i;
...
BOOL func_199(Vehicle veParam0) // Position - 0x9E4D Hash - 0x835CB3EF ^0xB88368F0
{
...
BOOL func_200(Hash hParam0) // Position - 0x9F2A Hash - 0x66FE4A4A ^0x10D5195D
{
	if (hParam0 == 0)
		return false;
...
BOOL func_201(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0xA0DC Hash - 0x9BD8A1CC ^0xA5081522
{
	int i;
	Hash outData;
...
BOOL func_202(Hash hParam0) // Position - 0xA25E Hash - 0xC7E3100C ^0x34FBFA3F
{
	int num;
	var unk;
	var unk2;
...
BOOL func_203() // Position - 0xA32A Hash - 0x2E0B1DC1 ^0xD2D0A3D9
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_204(Hash hParam0, int iParam1) // Position - 0xA341 Hash - 0x2FF24ACC ^0x92A5C100
{
	BOOL num;
	int cloudTimeAsInt;
...
BOOL func_205() // Position - 0xD973 Hash - 0x4C81F065 ^0x26D68D51
{
	return MISC::IS_ORBIS_VERSION() || unk_0xEE17703CF2C2875A();
}

BOOL func_206() // Position - 0xD989 Hash - 0x4C81F065 ^0x60494CEC
{
	return MISC::IS_DURANGO_VERSION() || unk_0x14F62099DEBAEA33();
}

BOOL func_207() // Position - 0xD99F Hash - 0x98B7EFDD ^0x98B7EFDD
{
	return false;
}

BOOL func_208() // Position - 0xD9A8 Hash - 0xFD255207 ^0xFD255207
{
	return true;
}

BOOL func_209() // Position - 0xD9B1 Hash - 0xFD255207 ^0xFD255207
{
	return true;
}

BOOL func_210() // Position - 0xD9BA Hash - 0x64659D79 ^0xC3C726F6
{
...
BOOL func_211(Vehicle veParam0) // Position - 0xD9D3 Hash - 0xC71C0264 ^0x936D1A30
{
	Hash entityModel;
...
BOOL func_212(Vehicle veParam0) // Position - 0xDA1A Hash - 0xA5B9FC6B ^0x23EADD90
{
	int i;
...
BOOL func_213(Vehicle veParam0) // Position - 0xDA55 Hash - 0xB4CAAE6F ^0x153EF8BE
{
	int i;
...
BOOL func_214(Vehicle veParam0) // Position - 0xDAD1 Hash - 0x7BB181DF ^0x17C4552A
{
	int i;
...
int func_215(Vehicle veParam0) // Position - 0xDBB9 Hash - 0x593067C2 ^0x2918B7DD
{
	int i;
...
BOOL func_216(Vehicle veParam0, int iParam1, BOOL bParam2) // Position - 0xDC1C Hash - 0xBCC62924 ^0x77695844
{
	int i;
	var garageName;
	int unk;
...
BOOL func_217(int iParam0, int iParam1, char* sParam2, var uParam3) // Position - 0xDC8A Hash - 0xA77A379E ^0x980AD61
{
...
void func_218() // Position - 0xDD62 Hash - 0xC536DD5 ^0xC536DD5
{
	Global_20591 = 0;
	func_219();
	return;
...
void func_219() // Position - 0xDD72 Hash - 0x21027D29 ^0xBEB9ECFD
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
