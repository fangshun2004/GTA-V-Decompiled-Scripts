...
void func_178()
{
	if ((BitTest(uLocal_103, 0) && Global_44869 == 15) && !func_211())
	{
		if (iLocal_36 == 0)
		{
...
void func_227()
{
	...
	if (((((((Global_44869 == 15 && iLocal_35 != 3) && BitTest(uLocal_103, 5)) && !func_211()) && Global_80277 == -1) && !func_237()) && !func_86(9)) || func_105(35))
	{
		func_236();
		func_234();
		switch (iLocal_37)
