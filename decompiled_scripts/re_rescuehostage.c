...
void func_33(int iParam0, int iParam1)
{
	...
	if (iParam1 <= func_50(iParam0))
	{
		...
		{
			func_35(func_41(iParam0, iParam1), Local_42.f_0, Local_42.f_1);
		}
...
void func_36()
{
	...
	{
		func_38(13, SYSTEM::FLOOR(Global_114904.f_10201.f_3853));
	}
...
void func_58()
{
	if (((((((((((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -91.30704f, 6391.854f, 30.6403f, -102.5595f, 6403.103f, 32.45444f, 8.5f, false, true, 0) && PED::CAN_PED_SEE_HATED_PED(iLocal_50, PLAYER::PLAYER_PED_ID())) || (func_68(iLocal_50, &uLocal_60, &iLocal_61, 0, 0, 1077936128, 0) && PED::CAN_PED_SEE_HATED_PED(iLocal_50, PLAYER::PLAYER_PED_ID()))) || (func_67(1) && PED::CAN_PED_SEE_HATED_PED(iLocal_50, PLAYER::PLAYER_PED_ID()))) || func_65()) || func_64()) || func_4()) || func_63()) || PED::IS_PED_RAGDOLL(iLocal_50)) || func_62()) || func_61()) || func_59(iLocal_50))
	{
...
void func_75()
{
	...
	{
		iLocal_55 = func_86(iLocal_50, 1, 0);
		if (HUD::DOES_BLIP_EXIST(iLocal_55))
		{
...
int func_76(int iParam0)
{
	if (func_80())
	{
		...
		if (iParam0 && func_42(Global_114893))
		{
...
int func_80()
{
	switch (func_81(&Global_33835, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
void func_106()
{
	...
	if (iLocal_78)
	{
		if (!WEAPON::HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(iLocal_52, joaat("weapon_pistol"), 0) && PED::IS_PED_INJURED(iLocal_50))
		{
			...
			else if (func_108(&Local_99, "RERHOAU", "RERHO_BLAME", "RERHO_BLAME_3", 4, iLocal_264, 0))
			{
				iLocal_45 = 2;
			}
		}
		else
		{
			if (!PED::IS_PED_INJURED(iLocal_52))
			{
				...
				if (!bLocal_98)
				{
					if (func_108(&Local_99, "RERHOAU", "RERHO_BLAME", "RERHO_BLAME_3", 4, iLocal_264, 0))
					{
					}
					else
					{
						func_107(iLocal_52, "GENERIC_SHOCKED_HIGH", 24);
					}
				}
				else
				{
...
int func_113()
{
	...
	if (((STREAMING::HAS_MODEL_LOADED(iVar0) && STREAMING::HAS_MODEL_LOADED(iVar2)) && STREAMING::HAS_MODEL_LOADED(iVar1)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_265))
	{
		...
		func_115(&Local_99, 0, PLAYER::PLAYER_PED_ID(), sLocal_88, 0, 1);
		func_115(&Local_99, 1, iLocal_50, "RHCriminal", 0, 1);
		func_115(&Local_99, 2, iLocal_51, "RHHostage", 0, 1);
		func_115(&Local_99, 3, iLocal_52, "RHBystander", 0, 1);
		PED::SET_CREATE_RANDOM_COPS(false);
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_156()) || Global_33778) || func_155()) || func_26(8, -1)) || func_152()) || func_154()) || func_153()) || func_151()) || Global_114904.f_7695.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_156()) || Global_113951) || Global_33778) || func_155()) || func_26(8, -1)) || func_152()) || func_154()) || func_153()) || func_151()) || Global_114904.f_7695.f_919[iVar0] == 5) || Global_45416 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_156()) || Global_113951) || Global_33778) || func_155()) || func_26(8, -1)) || func_154()) || func_153()) || func_151()) || Global_114904.f_7695.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_156() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_26(8, -1)) || func_151()) || func_150()) || Global_114904.f_7695.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_156()) || Global_33778) || func_155()) || func_26(8, -1)) || func_153()) || func_152()) || func_151()) || Global_114904.f_7695.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
...
void func_165(int iParam0)
{
	...
	if (func_102())
	{
		...
		func_168(30000);
		StringCopy(&cVar0, func_167(Global_114893, 1), 64);
