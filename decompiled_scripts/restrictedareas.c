...
void __EntryFunction__()
{
	...
	func_43();
	func_42(&uLocal_85, 8, 0, "TANNOY", 0, 1);
	while (true)
	{
		SYSTEM::WAIT(0);
		func_41();
					...
					else
					{
						if (iLocal_56)
						{
							...
							while (iLocal_66 < 8)
							{
								...
								{
									if (func_39(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), iLocal_66 + 1, 0, 0))
									{
						...
						if (SYSTEM::TIMERA() > 125)
						{
							...
							if (func_36(bLocal_35, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false)))
							{
								if (!iLocal_36[iLocal_68])
								{
									iLocal_36[iLocal_68] = 1;
								}
								if (func_35(bLocal_35))
								{
									if (!iLocal_45[iLocal_68])
									{
										iLocal_45[iLocal_68] = 1;
									}
									Local_70 = { func_34(bLocal_35) };
									if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(MISC::GET_HASH_KEY(&Local_70)) == 0)
									{
										if (!Global_33991[bLocal_35])
										{
											func_33(bLocal_35, Global_33991[bLocal_35]);
										}
									}
								}
								else if (!Global_33991[bLocal_35])
								{
									if (PED::IS_PED_IN_FLYING_VEHICLE(PLAYER::PLAYER_PED_ID()))
									{
										...
										if (!bLocal_54)
										{
											if (func_39(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), bLocal_35, 0, 0))
											{
