	...
	while (true)
	{
		...
		switch (iVar1)
		{
					...
					if (iVar1 != 2)
					{
						if ((!MISC::IS_MINIGAME_IN_PROGRESS() && !bVar0) && !func_77(5))
						{
							...
							if (func_73())
							{
								...
								switch (iLocal_123)
								{
									case 0:
										if (func_71() == 0)
										{
											if (!func_66(&iLocal_135))
											{
												func_65(&iLocal_135);
											}
											if (func_66(&iLocal_138))
											{
												func_88(&iLocal_138);
											}
											if (func_62(&iLocal_135) > 20f)
											{
												if (!HUD::IS_HELP_MESSAGE_BEING_DISPLAYED() && func_61())
												{
													iLocal_124 = 9;
													StringCopy(&Local_116, "Taxi_Procedural", 24);
													func_60(&uLocal_141, 8, 0, "TaxiDispatch", 0, 1);
													func_59(&uLocal_141, "OJTXAUD", "OJTX_PRO_OFF", 2, 0, 0, 0);
													func_80(&iLocal_135);
													iLocal_123 = 1;
												}
												else if (!func_61())
									...
									case 2:
										...
										if (func_62(&iLocal_135) > 15f)
										{
											...
											fLocal_128 = (MISC::GET_RANDOM_FLOAT_IN_RANGE(10f, 40f) + func_62(&iLocal_135));
											iLocal_123 = 3;
										}
										else if (iLocal_129)
										{
									...
									case 3:
										...
										if (func_62(&iLocal_135) > fLocal_128)
										{
											func_88(&iLocal_135);
											iLocal_123 = 0;
										}
								...
								if (((PAD::IS_CONTROL_PRESSED(0, 86) && !ENTITY::IS_ENTITY_UPSIDEDOWN(PLAYER::PLAYER_PED_ID())) && !Global_33968) && (MISC::GET_GAME_TIMER() - iLocal_126) > 3000)
								{
									iVar4 = func_71();
									if (iVar4 == 0)
									{
										if (iLocal_123 == 0 || iLocal_123 == 3)
										{
											func_82(&uLocal_141);
											iLocal_124 = 9;
											func_35(iLocal_124, &Local_116, &uLocal_141, 0);
											iLocal_132 = 1;
											iVar1 = 4;
										}
										else
										...
										SCRIPT::REQUEST_SCRIPT(&Local_116);
										func_88(&iLocal_135);
										iVar2 = 0;
									}
									else if (iVar4 == 2)
							...
							else
							{
								...
								{
									if (func_62(&iLocal_138) < 10f)
									{
										if ((MISC::GET_GAME_TIMER() % 1000) < 50)
										{
										}
									}
									if (func_62(&iLocal_138) > 10f && iLocal_123 != 0)
									{
										iLocal_123 = 0;
									}
								}
								...
								if (((MISC::GET_GAME_TIMER() - iLocal_127) > 60000 && !func_67("TC_HOWTOSTART")) && iLocal_133)
								{
									iLocal_133 = 0;
								}
								if (bLocal_131)
			...
			case 4:
				...
				if (SCRIPT::HAS_SCRIPT_LOADED(&Local_116))
				{
					iVar5 = func_26(&iLocal_125, 2, 9, 0, 0);
					if (iVar5 == 1)
					{
						Global_114018 = 1;
						if (iLocal_132)
			...
			case 5:
				...
				func_24(&Var6, 1);
				func_59(&uLocal_141, "OJTXAUD", &Var6, 8, 0, 0, 0);
				iVar1 = 6;
				break;
			...
			case 6:
				if (!func_23())
				{
					func_59(&uLocal_141, "OJTXAUD", "OJTX_DIS_JOB", 8, 0, 0, 0);
					iVar1 = 7;
				}
				break;
			...
			case 7:
				if (!func_23())
				{
					...
					func_24(&Var12, 1);
					func_82(&uLocal_141);
					func_59(&uLocal_141, "OJTXAUD", &Var12, 8, 0, 0, 0);
					iVar1 = 8;
				}
				break;
			...
			case 8:
				if (func_73())
				{
					if (!func_23())
					{
						...
						iLocal_115 = SYSTEM::START_NEW_SCRIPT(&Local_116, 64500);
						SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED(&Local_116);
...
void func_12()
{
	...
	while (iVar0 < 10)
	{
		Global_114963.f_19106.f_1[iVar0 /*2*/].f_1 = 0;
		iVar0++;
	}
}
...
void func_50()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		...
		{
			iVar0 = func_87(PLAYER::PLAYER_PED_ID());
			if (func_51(iVar0) && (!func_77(14) || Global_113909))
			{
...
void func_92()
{
	...
	if (HUD::GET_LENGTH_OF_LITERAL_STRING(&Local_116) != 0)
	{
		SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED(&Local_116);
	}
	if (HUD::DOES_BLIP_EXIST(iLocal_122))
