...
void __EntryFunction__()
{
	...
	if (!func_135(uLocal_111, 8))
	{
		if (!func_133(iLocal_117))
		{
	...
	if (func_135(uLocal_111, 8388608))
	{
		func_144(1);
	}
	if (func_135(uLocal_111, 524288) && (func_131() && !func_130()))
	{
		func_144(1);
	}
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_135(uLocal_111, 4194304))
	{
		if (iLocal_122 != 263)
		{
			func_129(iLocal_122, 1, 0);
			iLocal_122 = 263;
		}
		func_128(10);
	}
	while (true)
	{
		...
		iLocal_102 = PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID());
		if (func_135(uLocal_111, 1048576))
		{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_102) && !ENTITY::IS_ENTITY_DEAD(iLocal_102, false))
		{
			...
			{
				case 0:
					if (func_133(iLocal_117) || (func_135(uLocal_111, 16) && !func_135(uLocal_111, 524288)))
					{
						iLocal_115 = -1;
						func_124();
						func_128(1);
				...
				case 3:
					...
					if (!func_135(uLocal_111, 4))
					{
						func_119();
						func_118(&uLocal_111, 4);
					}
					...
					{
						Local_86 = { Local_70 };
						bVar2 = !func_135(uLocal_111, 64);
						func_142(&uLocal_111, 128);
						if (!func_115(3) && !Global_102520)
						{
							if (func_135(uLocal_111, 2097152))
							{
								if ((!func_135(uLocal_111, 1) || !ENTITY::DOES_ENTITY_EXIST(func_114())) && !Global_102520)
								{
									func_128(10);
									break;
								}
						...
						if (bVar2)
						{
							...
							if (bVar2)
							{
								...
								if (func_94(uLocal_103))
								{
									if (iLocal_113 == -1)
									{
										func_93(&iLocal_113, 4, sLocal_118, 0, 0, 0, 0);
										func_101(&uLocal_111, 2048);
									}
									else if (!func_135(uLocal_111, 2048) || !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED())
									{
										func_92(&iLocal_113);
										func_142(&uLocal_111, 2048);
									}
									if (func_90(iLocal_113, 1))
									{
				...
				case 5:
					...
					if (SCRIPT::HAS_SCRIPT_LOADED(&Local_86))
					{
						...
						if (iVar3 != 1)
						{
							iVar3 = func_84(&iLocal_115, 6, iLocal_117, 0, 0);
						}
						if (iVar3 == 1)
						{
				...
				case 6:
					...
					if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_69))
					{
						...
						func_11(&iLocal_124);
						func_142(&uLocal_111, 256);
						func_8();
						if (bVar0)
						{
							func_142(&uLocal_111, 2);
						}
						else if (func_135(uLocal_111, 2))
						{
						...
						if (iLocal_116 != -1)
						{
							if (func_135(Global_113609, 0))
							{
								...
								func_6(func_20(iLocal_116), 0, Global_102523, 1, 0);
							}
							else
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_20(iLocal_116), 0, Global_102523, 0);
								func_6(func_20(iLocal_116), 0, Global_102523, 0, 0);
							}
						}
						func_5();
						func_142(&Global_113609, 0);
						if (func_135(uLocal_111, 16777216))
						{
							func_144(1);
						}
						if (iLocal_116 != -1)
					...
					if ((iLocal_121 % 150) == 0)
					{
						if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
						{
							if (iLocal_123 == 2)
							{
								if (iLocal_123 == 2)
								{
									if (func_133(iLocal_117) && func_132(0, iLocal_116))
									{
										func_136();
										if (iLocal_122 != 263)
										{
...
int func_26()
{
	...
	iVar0 = SYSTEM::START_NEW_SCRIPT_WITH_ARGS(&Local_70, &Local_140, 170, iLocal_114);
...
void func_27(bool bParam0)
{
	...
	Var12 = { func_73(iLocal_139) };
	Var12 = { func_72(SYSTEM::COS(Var12.f_2), SYSTEM::SIN(Var12.f_2), MISC::TAN(Var12.f_0)) };
	STREAMING::NEW_LOAD_SCENE_START(func_71(iLocal_139), Var12, 5000f, 0);
	...
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		{
			Var6 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) - ENTITY::GET_ENTITY_COORDS(iLocal_314, false) };
			Var6.f_2 = 0f;
			...
			if (fVar15 > 0.8f)
			{
				...
				Var9 = { ENTITY::GET_ENTITY_COORDS(iLocal_314, false) + Var6 };
				if (iLocal_139 == 12)
				{
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Var9, 1f, 20000, 0.25f, 0, func_68(Var9, ENTITY::GET_ENTITY_COORDS(iLocal_314, false)));
				}
				else
				{
					TASK::TASK_GO_STRAIGHT_TO_COORD(0, Var9, 1f, -1, func_68(Var9, ENTITY::GET_ENTITY_COORDS(iLocal_314, false)), 0.5f);
				}
			}
			else if (fVar15 > 0.15f)
			{
				TASK::TASK_ACHIEVE_HEADING(0, func_68(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iLocal_314, false)), 0);
			}
	...
	func_25(&iLocal_310);
	while ((func_12(&iLocal_310) < 6f && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false)) && !ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), "pickup_object", "pickup_low", 3))
	{
		PED::SET_PED_RESET_FLAG(PLAYER::PLAYER_PED_ID(), 177, true);
		SYSTEM::WAIT(0);
	}
	...
	while ((func_12(&iLocal_310) < 6f && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false)) && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(PLAYER::PLAYER_PED_ID(), "pickup_object", "pickup_low") < 0.22f)
	{
		PED::SET_PED_RESET_FLAG(PLAYER::PLAYER_PED_ID(), 177, true);
	...
	if (bParam0)
	{
		...
		{
			TASK::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
			TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(PLAYER::PLAYER_PED_ID(), func_36(iLocal_139), 1f, -1, 0.25f, 0, 40000f);
		}
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_314))
		{
			OBJECT::DELETE_OBJECT(&iLocal_314);
		}
		iVar4 = CAM::CREATE_CAMERA_WITH_PARAMS(26379945, func_34(iLocal_139), func_33(iLocal_139), func_32(iLocal_139), true, 2);
		iVar5 = CAM::CREATE_CAMERA_WITH_PARAMS(26379945, func_31(iLocal_139), func_30(iLocal_139), func_29(iLocal_139), false, 2);
		...
		CAM::SET_CAM_ACTIVE_WITH_INTERP(iVar5, iVar4, func_28(iLocal_139), 1, 1);
		func_23(&iVar0);
		while (func_12(&iVar0) < ((SYSTEM::TO_FLOAT(func_28(iLocal_139)) / 1000f) + 0.3f))
		{
			if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
			{
				PED::SET_PED_RESET_FLAG(PLAYER::PLAYER_PED_ID(), 177, true);
...
void func_38()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_41(Global_114963.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_39(iVar0) && (!func_117(14) || Global_113909))
			{
...
void func_43()
{
	...
	func_51(0, 0, 1);
	iLocal_314 = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("p_parachute_s"), func_50(iLocal_139), true, true, false, 0);
	ENTITY::SET_ENTITY_ROTATION(iLocal_314, func_49(iLocal_139), 2, true);
	func_44(&Var0, &uVar3);
	Var4 = { 0f, 0f, uVar3 };
	iVar7 = PED::CREATE_SYNCHRONIZED_SCENE(Var0, Var4, 2);
	ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_314, iVar7, "puton_parachute_bag", "oddjobs@basejump@ig_15", 1000f, -1000f, 1, 1000f);
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
	{
		TASK::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
...
void func_88()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_314))
	{
		Var1 = { ENTITY::GET_ENTITY_COORDS(iLocal_314, true) };
		if (SYSTEM::VDIST2(Var1, Local_107) > 25f)
		{
			func_89(0);
		}
	}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_112()) || Global_33818) || func_111()) || func_97(8, -1)) || func_108()) || func_110()) || func_109()) || func_99()) || Global_114963.f_7697.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_112()) || Global_114010) || Global_33818) || func_111()) || func_97(8, -1)) || func_110()) || func_109()) || func_99()) || Global_114963.f_7697.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_112() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_97(8, -1)) || func_99()) || func_107()) || Global_114963.f_7697.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
	...
	if (bLocal_313)
	{
		switch (iLocal_139)
		{
			...
			case 8:
				iLocal_314 = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("p_parachute_s"), func_50(iLocal_139), true, true, false, 0);
				ENTITY::SET_ENTITY_ROTATION(iLocal_314, func_49(iLocal_139), 2, true);
				ENTITY::FREEZE_ENTITY_POSITION(iLocal_314, true);
				break;
			...
			case 12:
				iLocal_314 = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("p_parachute_s"), func_50(iLocal_139), true, true, false, 0);
				ENTITY::SET_ENTITY_ROTATION(iLocal_314, func_49(iLocal_139), 2, true);
				OBJECT::PLACE_OBJECT_ON_GROUND_PROPERLY(iLocal_314);
				Var0 = { func_121(iLocal_139) };
				if (!func_35(Var0))
				{
					iLocal_315 = VEHICLE::CREATE_VEHICLE(joaat("bati"), Var0, func_120(iLocal_139), true, true, false);
...
void func_136()
{
	if (ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
	{
		func_101(&uLocal_111, 8388608);
		return;
	}
	StringCopy(&Local_70, "bj", 64);
	iLocal_139 = func_140(Local_107, 0);
	switch (iLocal_139)
	{
		case 4:
			iLocal_122 = 129;
	...
	func_101(&uLocal_111, 4194304);
	iLocal_116 = 0;
	fLocal_119 = (SYSTEM::TO_FLOAT(func_137(iLocal_122)) + 5f);
	fLocal_134 = 1.1f;
	sLocal_118 = "PLAY_BASEJUMP_G";
	if (iLocal_122 != 263)
	{
		if (!func_132(0, iLocal_116))
		{
	...
	{
		func_101(&uLocal_111, 8);
	}
	else
	{
		func_142(&uLocal_111, 8);
	}
	if (func_117(12))
	{
		func_101(&uLocal_111, 8);
