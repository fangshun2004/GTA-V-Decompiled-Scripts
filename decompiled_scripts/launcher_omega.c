...
void __EntryFunction__()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_113991[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_296(&(Global_113991[Var0.f_0 /*10*/].f_9));
			}
		}
		func_280(&Var0, 1);
	}
	...
	while (true)
	{
		...
		func_215(Var0.f_0);
		func_208(&iLocal_91, &(Var0.f_9), Var61);
		if (Var0.f_0 == 44)
		{
			func_200(&Var0, Var61, "SCRAPAU", "SCRAP_1_AMB", 3, "OMEGA", &uLocal_92);
			func_199();
		}
		else if (Var0.f_0 == 45)
		{
			func_200(&Var0, Var61, "SCRAPAU", "SCRAP_2_AMB", 3, "OMEGA", &uLocal_93);
			func_197(&Var0);
		}
		if (func_182(&Var0, 0))
		{
...
int func_216(int iParam0, bool bParam1)
{
	...
	func_121(*iParam0, &Var0);
	if ((func_253(*iParam0) || func_251(*iParam0)) || Global_80526 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
