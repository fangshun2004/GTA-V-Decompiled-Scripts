...
void main() // Position - 0x0 Hash - 0x5D84F89F ^0x5D84F89F
{
	...
	iLocal_457 = 49;
	iLocal_458 = 64;
	uLocal_242 = { uScriptParam_510.f_1[0 /*3*/] };
	func_118();
...
void func_2(var uParam0) // Position - 0x1319 Hash - 0xFE5630E8 ^0xFE5630E8
{
	int num;
...
void func_6(var uParam0, int iParam1, char* sParam2, int iParam3, const char* sParam4, int iParam5, int iParam6) // Position - 0x14BA Hash - 0xC67F23A2 ^0xEFF6309F
{
	int i;
...
int func_16() // Position - 0x173D Hash - 0x3C5423D7 ^0x3C5423D7
{
	func_17();
...
BOOL func_19(int iParam0) // Position - 0x1861 Hash - 0x8907F004 ^0x8907F004
{
	return iParam0 < 3;
}

int func_20(Ped pedParam0) // Position - 0x186D Hash - 0xAC4E9801 ^0xB379A75F
{
	int i;
	Hash entityModel;
...
Hash func_21(int iParam0) // Position - 0x18AA Hash - 0xADCB9755 ^0xADCB9755
{
	if (func_19(iParam0))
...
Hash func_22(int iParam0) // Position - 0x18CF Hash - 0xE4CEEC2C ^0xE4CEEC2C
{
...
BOOL func_33(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x1C4C Hash - 0x384540C1 ^0x384540C1
{
...
Player func_39() // Position - 0x202A Hash - 0x478900E4 ^0x478900E4
{
	return -1;
}
...
void func_44() // Position - 0x21B8 Hash - 0x98476CE1 ^0x250FEB7C
{
	if (func_18(14))
	{
...
void func_47(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x22E8 Hash - 0xC6B752B2 ^0xC6B752B2
{
...
void func_49(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x2379 Hash - 0x6C235EE0 ^0x9E57F206
{
...
BOOL func_61() // Position - 0x2679 Hash - 0x152DA0B2 ^0x220E93E9
{
...
BOOL func_102(Ped pedParam0) // Position - 0x3283 Hash - 0x3D210083 ^0xF7E7C389
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
		if (!ENTITY::IS_ENTITY_DEAD(pedParam0, false))
			return true;
...
void func_104() // Position - 0x32B0 Hash - 0x61150AC4 ^0x393F57D5
{
	...
	pedLocal_448 = PED::CREATE_PED(PED_TYPE_CIVMALE, 2120901815, 396.8498f, 143.3195f, 101.4659f, 360f, true, true);
...
void func_105() // Position - 0x3363 Hash - 0xCA964F97 ^0x9ED2F1F3
{
	...
	bLocal_436 = true;
	iLocal_252 = 14;
	sLocal_303 = _("Press ~INPUT_CONTEXT~ to talk to Pamela Drake.");
