...
void func_1() // Hash - 0x28EF777 ^0x5C2599CA
{
...
int func_15() // Hash - 0x23E9AF7F ^0x23E9AF7F
{
	int num;
...
void func_24(char* sParam0) // Hash - 0x2C5C83C1 ^0x6121EFC4
{
	int num;
...
void func_25(char* sParam0) // Hash - 0x3372085F ^0xF0660BAF
{
	int num;
...
void func_26(int iParam0, char* sParam1) // Hash - 0xC4958D46 ^0x3EA265BA
{
	switch (iParam0)
	{
		case 0:
...
void func_27(char* sParam0) // Hash - 0x3018B517 ^0xD825C8DA
{
	var unk;
...
void func_29(char* sParam0) // Hash - 0x3BD51041 ^0xBB613A58
{
...
void func_31(char* sParam0) // Hash - 0xE431A142 ^0xF03956E0
{
	int num;
...
void func_50(char* sParam0) // Hash - 0xB19D680C ^0x8A593679
{
	int num;
...
void func_57(int iParam0, char* sParam1, char* sParam2) // Hash - 0xA1B3AA65 ^0xEEC647D4
{
...
void func_64(char* sParam0) // Hash - 0xD55EAE22 ^0x70EA1A69
{
	var unk;
...
void func_66(char* sParam0) // Hash - 0x217F514E ^0x3AB7CB79
{
...
void func_73(char* sParam0) // Hash - 0x2E18739A ^0x665B9307
{
...
char* func_74(int iParam0) // Hash - 0xE6862179 ^0x1656B1D4
{
	switch (iParam0)
	{
		case 0:
...
void func_104() // Hash - 0x61150AC4 ^0x393F57D5
{
...
void func_105() // Hash - 0xCA964F97 ^0x9ED2F1F3
{
...
int func_112(const char* sParam0) // Hash - 0xD5121E5F ^0xC55CEF25
{
...
void func_117() // Hash - 0x2362FFA ^0x59AD1845
{
	if (!Global_3)
		return;
