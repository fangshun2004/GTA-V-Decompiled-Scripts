...
void __EntryFunction__()
{
	...
	iLocal_54 = 0;
	func_33(&uLocal_55);
	func_32(&uLocal_55, 1701.78f, 3225.148f, 40.0202f);
	func_32(&uLocal_55, 1678.909f, 3287.602f, 39.9648f);
	func_32(&uLocal_55, 1710.438f, 3326.499f, 40.1797f);
	func_32(&uLocal_55, 1738.879f, 3335.25f, 40.1493f);
	func_32(&uLocal_55, 1768.387f, 3312.101f, 40.2875f);
	func_32(&uLocal_55, 1819.241f, 3225.449f, 42.9019f);
	func_31(&uLocal_55);
	while (true)
	{
		switch (iLocal_54)
...
void func_12(int iParam0)
{
	...
	while (iVar15 < Global_114963.f_7697.f_198)
	{
		...
		{
			func_13(Global_114963.f_7697.f_137[iVar15 /*15*/].f_6);
			iVar16 = iVar15;
...
void func_26()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_29(Global_114963.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_10(iVar0) && (!func_27(14) || Global_113909))
			{
