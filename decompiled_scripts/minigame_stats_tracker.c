...
BOOL func_5(int* piParam0) // Hash - 0xA8A91C80 ^0xA8A91C80
{
	return IS_BIT_SET(*piParam0, 1);
}

void func_6(int iParam0, int iParam1) // Hash - 0xF55E891F ^0xF55E891F
{
	func_7(iParam0, iParam1);
	return;
}

void func_7(int iParam0, int iParam1) // Hash - 0xF23F5A1A ^0xF23F5A1A
{
...
void func_9(int* piParam0) // Hash - 0x227D76A6 ^0x227D76A6
{
	if (!func_5(piParam0))
		func_10(piParam0);
...
void func_10(int* piParam0) // Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_11(piParam0, 0f);
	return;
}

void func_11(int* piParam0, float fParam1) // Hash - 0xED66BE55 ^0x9F6586C1
{
...
void func_18(const char* sParam0) // Hash - 0x8E2F5FE2 ^0x29D9D432
{
...
void func_19() // Hash - 0xB1B90BA4 ^0x5CCB8FEC
{
