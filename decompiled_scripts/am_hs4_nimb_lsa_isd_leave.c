...
void func_1() // Hash - 0x46C3DB41 ^0x1F460EEF
{
...
void func_55() // Hash - 0x529C5807 ^0x529C5807
{
...
void func_56() // Hash - 0xAC0A1713 ^0x6F711EEF
{
...
void func_57(char* sParam0) // Hash - 0xB68448D6 ^0x347C7A62
{
...
BOOL func_58(Ped pedParam0) // Hash - 0x3D210083 ^0xF7E7C389
{
...
void func_59(char* sParam0) // Hash - 0x6120981 ^0xF163D9FD
{
...
BOOL func_60(var uParam0) // Hash - 0x40A83095 ^0x40A83095
{
	func_276();
...
BOOL func_61(var uParam0) // Hash - 0xD322D0A9 ^0x53289261
{
	func_62();
...
void func_62() // Hash - 0x87A141AF ^0x16CB1AC
{
	STREAMING::SET_FOCUS_POS_AND_VEL(CAM::GET_FINAL_RENDERED_CAM_COORD(), 0f, 0f, 0f);
	return;
}

void func_63(var uParam0) // Hash - 0x89DB6FD5 ^0xC4C4D280
{
	BOOL flag;
...
void func_64(Vehicle veParam0) // Hash - 0xEF285B16 ^0x4EEAF74B
{
...
BOOL func_65(Vehicle veParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Hash - 0xB51BA07A ^0xBC168CA
{
	int i;
	int num;
	Ped ped;
...
Ped func_67(Vehicle veParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Hash - 0x6D404137 ^0x121AA864
{
	Ped pedInVehicleSeat;
...
void func_68(var uParam0, int iParam1) // Hash - 0x3D5489B0 ^0x3D5489B0
{
	*uParam0 = iParam1;
	return;
}

BOOL func_69() // Hash - 0x57459B9C ^0x9A36D842
{
...
void func_70(var uParam0) // Hash - 0xFBA41A3 ^0xB52A1886
{
	char* cutsceneHandle;
...
BOOL func_71(var uParam0) // Hash - 0xA0E0D491 ^0xFC7D8537
{
	if (uParam0->f_20 == 0)
		return true;
...
Hash func_72() // Hash - 0xDED80B4D ^0x529AE3F0
{
	return ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID());
}

var func_73(BOOL bParam0, var uParam1, var uParam2) // Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_74(var uParam0) // Hash - 0x5F6DFD9C ^0xAFD0211D
{
	func_62();
...
void func_75(var uParam0) // Hash - 0xBE33FE84 ^0xA4C22384
{
	func_158(uParam0);
...
void func_76(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Hash - 0xE3CC3A88 ^0x5ABD8789
{
	func_78();
	func_48(true);
	HUD::CLEAR_HELP(true);
...
void func_77() // Hash - 0x9E0EB620 ^0x9E0EB620
{
	func_33(0);
	func_34(4, 1, -1);
	func_34(6, true, -1);
...
void func_78() // Hash - 0x62DDA6FB ^0xDB8789E6
{
	Global_1574747 = true;
...
void func_79(var uParam0) // Hash - 0xBF25B0D4 ^0x95D4BBC1
{
	var unk;
...
void func_80(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Hash - 0x39770099 ^0x6B621F26
{
	Hash entityModel;
	float num;
...
BOOL func_81(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) // Hash - 0x4709BB10 ^0xDD69BC9A
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0, 13);
}

BOOL func_82(Hash hParam0) // Hash - 0x3E978ED3 ^0x3E978ED3
{
	return func_133(hParam0);
}

BOOL func_83(Hash hParam0) // Hash - 0xE48228D0 ^0xE48228D0
{
	switch (hParam0)
	{
		case joaat("POUNDER2"):
...
void func_84(Vehicle veParam0) // Hash - 0x81BE1D25 ^0x49ACF3EE
{
	Hash entityModel;
...
void func_85(var uParam0, var uParam1, var uParam2) // Hash - 0x96D2C2D8 ^0x57DF276B
{
	int eventData;
	...
	SCRIPT::TRIGGER_SCRIPT_EVENT(SCRIPT_EVENT_QUEUE_NETWORK, &eventData, 5, func_86(true, true));
	return;
}

int func_86(BOOL bParam0, BOOL bParam1) // Hash - 0x28809950 ^0x99E2BCBE
{
	int address;
	int i;
	Player player;
...
BOOL func_87(int iParam0) // Hash - 0x79C8C36C ^0x79C8C36C
{
	int i;
...
BOOL func_88(int iParam0) // Hash - 0x902ED9DB ^0x902ED9DB
{
	return func_89(iParam0, 6, true);
}

BOOL func_89(int iParam0, int iParam1, BOOL bParam2) // Hash - 0xA45BEB30 ^0x6033D2A2
{
	if (iParam0 == -1)
		return false;
...
int func_90(int iParam0, int iParam1, int iParam2) // Hash - 0x4BC84F7B ^0x370D7D6F
{
	Hash statHash;
	int outValue;
...
int func_92(int iParam0) // Hash - 0x28E83966 ^0x9E37924F
{
	switch (iParam0)
	{
		case 0:
...
int func_93() // Hash - 0x21D64237 ^0x21D64237
{
	return Global_32163;
}

int func_94(int iParam0) // Hash - 0x1BE0B176 ^0x1BE0B176
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_95() // Hash - 0xD56328D2 ^0xD56328D2
{
	return Global_100733.f_388 > 0;
}

int func_96(Vehicle veParam0, Any* panParam1) // Hash - 0x26C20EE4 ^0x1E36FFB2
{
...
BOOL func_97(Vehicle veParam0) // Hash - 0x5F209CA0 ^0x2B0580FA
{
	int vehicleCrewEmblemRequestState;
	int networkTime;
	int num;
...
void func_98(Vehicle veParam0) // Hash - 0x23A221D2 ^0x56A173D2
{
	int int;
...
BOOL func_99(var uParam0, Player plParam1) // Hash - 0xBC57DF9D ^0xD82E46D0
{
	func_103();
...
BOOL func_100(var uParam0, Player plParam1, int iParam2, Vector3 vParam3, var uParam4, var uParam5, Vector3 vParam6, var uParam7, var uParam8, Vector3 vParam9, var uParam10, var uParam11, float fParam12, int iParam13, int iParam14) // Hash - 0x947E8C7E ^0xD061037E
{
...
int func_101(Vehicle veParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Hash - 0xE4E90FE6 ^0x93F39EE7
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
		return 0;
...
BOOL func_102(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Hash - 0x2D46096D ^0xEA41378F
{
	if (bParam6)
...
void func_103() // Hash - 0x27D28D2 ^0x4A8E83FA
{
	Global_1949998 = 0;
...
BOOL func_104(Vehicle veParam0) // Hash - 0x3805EC88 ^0xC1D38CC2
{
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
...
BOOL func_105(Vehicle veParam0) // Hash - 0x69692E89 ^0x59A9D2B1
{
	int int;
...
BOOL func_106(Vehicle veParam0, Any* panParam1) // Hash - 0xC9297803 ^0xB20BA146
{
	Player playerFromGamerHandle;
	BOOL flag;
...
BOOL func_107(Vehicle veParam0) // Hash - 0x760B040D ^0x601BFA7E
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return true;
...
int func_108(Vehicle veParam0) // Hash - 0xF0DD4307 ^0x13C45C81
{
...
int func_109(Player plParam0) // Hash - 0xE627570A ^0xE627570A
{
...
int func_110(Player plParam0) // Hash - 0x48014DA ^0xC49B9410
{
...
BOOL func_113(BOOL bParam0) // Hash - 0xCA2EA26D ^0x45E6CA28
{
	return func_114(PLAYER::PLAYER_ID(), bParam0);
}

BOOL func_114(Player plParam0, BOOL bParam1) // Hash - 0xB4D52F0E ^0xB4D52F0E
{
	return func_115(plParam0, bParam1, 1);
}

BOOL func_115(Player plParam0, BOOL bParam1, int iParam2) // Hash - 0xE1283130 ^0x8DFB78AD
{
	Player player;
...
BOOL func_116(Player plParam0, int iParam1) // Hash - 0xECFEB130 ^0x65196460
{
	if (plParam0 != func_66())
...
BOOL func_117(int iParam0, BOOL bParam1) // Hash - 0xA9E9B748 ^0x9CB5A15C
{
	int num;
	int num2;
...
int func_118(int iParam0) // Hash - 0x9042BAD4 ^0x9042BAD4
{
	return iParam0 % 32;
}

int func_119(int iParam0) // Hash - 0x74EE5629 ^0x74EE5629
{
	int num;
...
int func_120(int iParam0) // Hash - 0xAA02C235 ^0x95A75FBF
{
	int num;
	int num2;
...
int func_121(int iParam0) // Hash - 0x195EBE32 ^0x195EBE32
{
	return iParam0 / 32;
}

BOOL func_122(Player plParam0) // Hash - 0x440D1C81 ^0x15AA607B
{
	if (plParam0 != func_66())
...
BOOL func_123(Player plParam0) // Hash - 0xA4C8B8D7 ^0xE5015FA1
{
	if (plParam0 != func_66())
...
int func_124(int iParam0) // Hash - 0xEE599357 ^0xEE599357
{
	switch (iParam0)
	{
		case 0:
...
void func_125(Vehicle veParam0, int iParam1) // Hash - 0x47F85C31 ^0xDC10F2C1
{
	int num;
	int num2;
...
BOOL func_126(int iParam0, var uParam1) // Hash - 0x39DFC5A3 ^0x39DFC5A3
{
	*uParam1 = -1;
...
int func_127(int iParam0) // Hash - 0xACC8EE50 ^0xACC8EE50
{
	switch (iParam0)
	{
		case 0:
...
int func_128(int iParam0, int iParam1, int iParam2) // Hash - 0x8C841BCD ^0x8C841BCD
{
...
BOOL func_129() // Hash - 0x285908BA ^0xA62DB84A
{
	var gamerHandle;
...
struct<13> func_130() // Hash - 0xC50E1118 ^0xB1CB2F5D
{
	var gamerHandle;
...
BOOL func_131(Vehicle veParam0) // Hash - 0xEB13AB9D ^0x4B8E20DB
{
	switch (ENTITY::GET_ENTITY_MODEL(veParam0))
	{
		case joaat("DEATHBIKE2"):
...
BOOL func_132(int iParam0, var uParam1) // Hash - 0x1B3B2773 ^0x1B3B2773
{
	*uParam1 = -1f;
...
BOOL func_133(Hash hParam0) // Hash - 0xE48228D0 ^0xE48228D0
{
	switch (hParam0)
	{
		case joaat("DEITY"):
...
void func_134(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Hash - 0x3234A2AB ^0xBABA9C12
{
	int num;
	int num2;
	int i;
...
BOOL func_135() // Hash - 0x599C0723 ^0x588DCD1B
{
...
BOOL func_136(int iParam0) // Hash - 0x16FCD261 ^0xC786AD29
{
	int num;
...
BOOL func_137(int iParam0) // Hash - 0xE40D6326 ^0xE40D6326
{
	int num;
...
BOOL func_138(int iParam0, int iParam1) // Hash - 0x7CD5054C ^0x870BEA81
{
	return IS_BIT_SET(Global_1894573[iParam0 /*608*/].f_10.f_4, iParam1);
}

BOOL func_139(int iParam0) // Hash - 0x7F5F619C ^0x6E554E82
{
	return func_140(&(Global_2672505.f_183), iParam0);
}

BOOL func_140(var uParam0, int iParam1) // Hash - 0x1995C9E6 ^0x1995C9E6
{
	int num;
	int num2;
	int num3;
...
int func_141(var uParam0, var uParam1, var uParam2) // Hash - 0x5C9EC0F7 ^0xAEA0C62F
{
	int i;
	int modType;
...
BOOL func_142(Vehicle veParam0) // Hash - 0x4E83583B ^0x79F702A8
{
	int i;
	int modType;
	Hash hashKey;
...
void func_143(var uParam0) // Hash - 0x2806D680 ^0xEA5BC67
{
...
int func_144(Vehicle veParam0, int iParam1) // Hash - 0xFE64EDC0 ^0x4504AA95
{
	int value;
	int value2;
	float num;
...
int func_145(Vehicle veParam0, int iParam1) // Hash - 0x51ABE917 ^0xA6E9215C
{
	int i;
...
BOOL func_146(Hash hParam0, int iParam1) // Hash - 0xFE274898 ^0xFE274898
{
	switch (hParam0)
	{
		case joaat("FACTION2"):
...
BOOL func_147(Vehicle veParam0, int iParam1, int iParam2) // Hash - 0x206208ED ^0x243B2D10
{
...
BOOL func_148() // Hash - 0x98B7EFDD ^0x98B7EFDD
{
	return false;
}

void func_149(Vehicle veParam0, int iParam1) // Hash - 0x4F43FC2B ^0x7F7B0D9C
{
	int vehicleMod;
...
BOOL func_151() // Hash - 0x11DC3931 ^0x2E8F2A7A
{
	return DLC::IS_DLC_PRESENT(joaat("MPINDEPENDENCE"));
}

BOOL func_152(Vehicle veParam0) // Hash - 0xA5C374DF ^0xE604ECD9
{
	int int;
...
int func_153(var uParam0) // Hash - 0xF0601AB8 ^0xF0601AB8
{
...
BOOL func_154(int iParam0) // Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
		case 161:
...
int func_155(int iParam0) // Hash - 0xEE599357 ^0xEE599357
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_156(Vehicle veParam0) // Hash - 0x57A74E37 ^0x4772878C
{
...
BOOL func_157(Player plParam0, int iParam1) // Hash - 0x1C7D021F ^0xC08A6119
{
...
void func_158(var uParam0) // Hash - 0x7EE00C2D ^0xC4582566
{
...
void func_159(var uParam0) // Hash - 0x534A4BC7 ^0xD585ED5A
{
...
Vector3 func_160(float fParam0, var uParam1, var uParam2) // Hash - 0x6F4648E7 ^0x44C762D3
{
	return -SYSTEM::SIN(fParam0.f_2) * SYSTEM::COS(fParam0), SYSTEM::COS(fParam0.f_2) * SYSTEM::COS(fParam0), SYSTEM::SIN(fParam0);
}

BOOL func_161(var uParam0) // Hash - 0x285FAE81 ^0x387F5153
{
	Player player;
...
void func_162(Ped pedParam0, var uParam1, BOOL bParam2, int iParam3) // Hash - 0x318B1EA4 ^0x92A400F4
{
	var unk;
	int characterType;
	BOOL flag;
...
void func_163(Ped pedParam0, int iParam1, int iParam2) // Hash - 0xF1FAB61C ^0x2B4AC0E
{
	switch (iParam1)
	{
		case 1841427399:
...
BOOL func_164(Ped pedParam0, const char* sParam1, int iParam2, int iParam3, Hash hParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Hash - 0x69D10458 ^0x71D52412
{
	Hash entityModel;
	int num;
...
BOOL func_165(int iParam0, int iParam1) // Hash - 0x562E4F3B ^0x562E4F3B
{
	int num;
	int num2;
...
int func_166(int iParam0, int iParam1) // Hash - 0x92E3F215 ^0x67CC112C
{
	int num;
	int num2;
...
int func_167() // Hash - 0x21D64237 ^0x21D64237
{
	return Global_32164;
}

int func_168(int iParam0) // Hash - 0xF08C5B2E ^0xA4BC8B65
{
	int num;
	int num2;
...
char* func_169(int iParam0) // Hash - 0xE6862179 ^0xAF0AD1D4
{
	switch (iParam0)
	{
		case 0:
...
int func_170(Hash hParam0, const char* sParam1, int iParam2) // Hash - 0x2D6EA43C ^0x2D6EA43C
{
	switch (iParam2)
	{
		case joaat("CREWLOGO"):
...
BOOL func_171(char* sParam0, int iParam1, int iParam2, Ped pedParam3, int iParam4) // Hash - 0x91D9CCD4 ^0x99E658E6
{
	Hash entityModel;
	int num;
...
void func_172(char* sParam0, int iParam1, int iParam2, int iParam3) // Hash - 0xC0E60EB1 ^0xA6231434
{
	int decorationIndex;
	int numTattooShopDlcItems;
	Hash outComponent;
...
int func_173() // Hash - 0xAF3D3332 ^0xE009CBFC
{
	int outValue;
	int outValue2;
	Hash statHash;
...
int func_174() // Hash - 0xAF10CE31 ^0xCCA83A01
{
	int outValue;
	int outValue2;
	Hash statHash;
...
BOOL func_175() // Hash - 0x44DD83CC ^0x7B62A376
{
	int profileSetting;
...
int func_176() // Hash - 0xFD255207 ^0xFD255207
{
	return 1;
}

int func_177() // Hash - 0xFD255207 ^0xFD255207
{
	return 1;
}

void func_178(char* sParam0, int iParam1, Ped pedParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, int iParam7, int iParam8, int iParam9) // Hash - 0xBE814674 ^0x20110C9C
{
	var unk;
...
BOOL func_179(Ped pedParam0, int iParam1) // Hash - 0xB0832777 ^0x2C8325D4
{
...
Hash func_180(Hash hParam0, int iParam1, int iParam2, int iParam3) // Hash - 0x3B4EF0B2 ^0x11322F71
{
	var outProp;
	int componentId;
	int num;
...
int func_181(Hash hParam0, int iParam1) // Hash - 0x765E2190 ^0x765E2190
{
	switch (hParam0)
	{
...
ePedComponentType func_182(int iParam0) // Hash - 0xF91DA7A7 ^0xF91DA7A7
{
	switch (iParam0)
	{
		case 0:
...
int func_183(Hash hParam0) // Hash - 0xC0824942 ^0x8EB5258
{
	switch (hParam0)
	{
		case joaat("PLAYER_ZERO"):
...
int func_184(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Hash - 0x6AEB8E24 ^0x393FEB8F
{
	int i;
	int j;
...
int func_185(Ped pedParam0, int iParam1) // Hash - 0x5DC76C2F ^0x122A4DD3
{
...
int func_186(Ped pedParam0, int iParam1, int iParam2, int iParam3) // Hash - 0x8F4AAD60 ^0xD2AF7F3D
{
	ePedComponentType componentId;
...
int func_187(Ped pedParam0, ePedComponentType epctParam1) // Hash - 0xA9FF3076 ^0xC030B76B
{
	int pedPropIndex;
...
int func_188(Ped pedParam0, int iParam1, int iParam2, ePedComponentType epctParam3) // Hash - 0x3F809B31 ^0x8E48393
{
	Hash entityModel;
...
int func_189(Ped pedParam0, ePedComponentType epctParam1) // Hash - 0xB8AC6F7F ^0x2249C2B3
{
	Hash entityModel;
...
int func_190(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Hash - 0x37A3B7AE ^0x8CDB7FD1
{
	var outfit;
	int i;
	int num;
...
int func_191(Hash hParam0) // Hash - 0x3694542E ^0xA74289BE
{
	switch (hParam0)
	{
		case joaat("PLAYER_ZERO"):
...
int func_192(ePedComponentType epctParam0) // Hash - 0xEE599357 ^0xEE599357
{
	switch (epctParam0)
	{
		case PV_COMP_HEAD:
...
BOOL func_193(Ped pedParam0, int iParam1, int iParam2) // Hash - 0xEAF08AE1 ^0xBD027042
{
	Hash entityModel;
	int num;
	Hash hash;
...
BOOL func_194(Hash hParam0, int iParam1, int iParam2, var uParam3) // Hash - 0x26B2FF44 ^0xDA957258
{
	Hash componentHash;
...
BOOL func_195(Hash hParam0, int iParam1, int iParam2, var uParam3) // Hash - 0x26B2FF44 ^0xDA957258
{
	Hash componentHash;
	int shopPedApparelVariantComponentCount;
	int i;
...
BOOL func_196(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Hash - 0x9FDCB820 ^0xF3833F7A
{
	switch (hParam0)
	{
		case joaat("MP_F_FREEMODE_01"):
...
BOOL func_197(Hash hParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5) // Hash - 0x4EAC6644 ^0x84ED5CC8
{
	var unk;
	int i;
...
BOOL func_198(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Hash - 0xCC83E9BC ^0xCC83E9BC
{
	switch (hParam0)
	{
		case joaat("PLAYER_ZERO"):
...
BOOL func_199(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Hash - 0x261C127A ^0x57548E07
{
	if (hParam0 == joaat("PLAYER_ZERO"))
	{
		if (iParam1 == 6)
...
BOOL func_200(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Hash - 0xAC33D304 ^0xAC33D304
{
	switch (hParam0)
	{
		case joaat("PLAYER_ZERO"):
...
BOOL func_201(Hash hParam0, int iParam1, int iParam2) // Hash - 0x1194ADFB ^0x1194ADFB
{
	switch (hParam0)
	{
		case joaat("PLAYER_ZERO"):
...
struct<10> func_202(Hash hParam0, int iParam1) // Hash - 0x2A30F768 ^0x18171033
{
	int i;
	var unk;
...
void func_203(var uParam0, Hash hParam1, int iParam2, int iParam3) // Hash - 0xE5FA3D79 ^0xC01023AA
{
	int num;
	Hash itemHash;
	Hash outPropVariant;
...
void func_204(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Hash - 0xF7320378 ^0xF7320378
{
	uParam0->[0] = iParam1;
	uParam0->[1] = iParam2;
	uParam0->[2] = iParam3;
...
struct<17> func_205(Hash hParam0, int iParam1) // Hash - 0x10D20E1D ^0x38BDAFC5
{
	int i;
	var unk;
...
void func_206(var uParam0, Hash hParam1, int iParam2, int iParam3) // Hash - 0xD805D094 ^0x25EDFC78
{
	int num;
	Hash outfit;
...
int func_207(int iParam0) // Hash - 0xF91DA7A7 ^0xF91DA7A7
{
	switch (iParam0)
	{
		case 0:
...
void func_208(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Hash - 0xEC425A3E ^0xEC425A3E
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
	uParam0->[3] = iParam3;
...
struct<14> func_209(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Hash - 0x2257F879 ^0x68AE5A32
{
	func_255();
...
void func_210(int iParam0, int iParam1, Hash hParam2) // Hash - 0x9AF0DF05 ^0x9AF0DF05
{
	switch (iParam0)
	{
		case 2:
...
void func_211(int iParam0) // Hash - 0xB745E49C ^0xB745E49C
{
	BOOL flag;
	int num;
	var unk;
...
void func_212(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Hash - 0xA2DFD38C ^0xCA7EA132
{
	int num;
	int num2;
...
BOOL func_213(int iParam0, int iParam1, var uParam2) // Hash - 0x805F0D09 ^0xD5FF8259
{
	*uParam2 = 979;
...
int func_214(int iParam0, int iParam1) // Hash - 0x4CEDF2DA ^0xD4A47B95
{
	switch (iParam1)
	{
		case 0:
...
int func_215(int iParam0, int iParam1) // Hash - 0x4CEDF2DA ^0x7536052F
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_216(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Hash - 0xDF4F0B01 ^0xAAD287D4
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
BOOL func_217(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Hash - 0x8C42734C ^0x8C42734C
{
	int num;
	int num2;
	int num3;
...
BOOL func_218(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Hash - 0x1B8A3878 ^0x1D07D6A7
{
...
BOOL func_219(int iParam0) // Hash - 0x937D8816 ^0x937D8816
{
	return Global_43257 == iParam0;
}

int func_220(int iParam0) // Hash - 0xE4C61EBD ^0xE4C61EBD
{
	switch (iParam0)
	{
		case -1:
...
void func_221(int iParam0, Hash hParam1) // Hash - 0xEDA496E8 ^0xFA4009F9
{
	int num;
...
void func_222(int iParam0, int iParam1, int iParam2, Hash hParam3) // Hash - 0xE3509264 ^0xCA79B364
{
	int num;
	int num2;
	Hash outfit;
...
void func_223(int iParam0, Hash hParam1) // Hash - 0x5C1D2F91 ^0x5C1D2F91
{
	BOOL flag;
	int num;
	var unk;
...
void func_224(int iParam0, Hash hParam1) // Hash - 0x34BAB0FD ^0x34BAB0FD
{
	BOOL flag;
	int num;
	var unk;
...
void func_225(int iParam0, Hash hParam1) // Hash - 0x859154FC ^0x859154FC
{
	BOOL flag;
	int value;
	var unk;
...
void func_226(int iParam0, Hash hParam1) // Hash - 0x532BD76A ^0x96AC33C9
{
	BOOL flag;
	int num;
	var unk;
...
void func_227(int iParam0, Hash hParam1) // Hash - 0x31CAA5FE ^0x31CAA5FE
{
	BOOL flag;
	int value;
	var unk;
...
void func_228(int iParam0, Hash hParam1) // Hash - 0x8F60B7F6 ^0x8F60B7F6
{
	BOOL flag;
	int value;
	var unk;
...
void func_229(int iParam0, Hash hParam1) // Hash - 0x49FFFA4C ^0x108EA666
{
	BOOL flag;
	int value;
	var unk;
...
void func_230(int iParam0, Hash hParam1) // Hash - 0xB448FE2B ^0xD5BAE134
{
	BOOL flag;
	int value;
	var unk;
...
void func_231(int iParam0, Hash hParam1) // Hash - 0xE0A1579F ^0xE0A1579F
{
	BOOL flag;
	int num;
	var unk;
...
void func_232(int iParam0, Hash hParam1) // Hash - 0x1DB3E93C ^0x1DB3E93C
{
	BOOL flag;
	int num;
	var unk;
...
void func_233(int iParam0, Hash hParam1) // Hash - 0xE646E909 ^0x236129F
{
	BOOL flag;
	int value;
	var unk;
...
BOOL func_234(int iParam0, int iParam1) // Hash - 0x75CF6A28 ^0xC5FFA2E7
{
	int num;
	int num2;
...
int func_235(int iParam0, int iParam1) // Hash - 0xA7B129CF ^0xA7B129CF
{
	int num;
...
int func_236(int iParam0) // Hash - 0xF08C5B2E ^0xA4BC8B65
{
	int num;
	int num2;
...
void func_237(int iParam0, Hash hParam1) // Hash - 0x1A0ED0D0 ^0x1A0ED0D0
{
	BOOL flag;
	int value;
	var unk;
...
void func_238(int iParam0, Hash hParam1) // Hash - 0xA91A09EB ^0xE2448087
{
	BOOL flag;
	int value;
	var unk;
...
void func_239(int iParam0, int iParam1, Hash hParam2) // Hash - 0x9AF0DF05 ^0x9AF0DF05
{
	switch (iParam0)
	{
		case 2:
...
void func_240(int iParam0) // Hash - 0xB745E49C ^0xB745E49C
{
	BOOL flag;
	int num;
	var unk;
...
void func_241(int iParam0, Hash hParam1) // Hash - 0x24B9D800 ^0xDE92F578
{
	int num;
...
void func_242(int iParam0, Hash hParam1) // Hash - 0x5C1D2F91 ^0x5C1D2F91
{
	BOOL flag;
	int num;
	var unk;
...
void func_243(int iParam0, Hash hParam1) // Hash - 0x34BAB0FD ^0x34BAB0FD
{
	BOOL flag;
	int num;
	var unk;
...
void func_244(int iParam0, Hash hParam1) // Hash - 0x859154FC ^0x859154FC
{
	BOOL flag;
	int value;
	var unk;
...
void func_245(int iParam0, Hash hParam1) // Hash - 0x532BD76A ^0x96AC33C9
{
	BOOL flag;
	int num;
	var unk;
...
void func_246(int iParam0, Hash hParam1) // Hash - 0x31CAA5FE ^0x31CAA5FE
{
	BOOL flag;
	int value;
	var unk;
...
void func_247(int iParam0, Hash hParam1) // Hash - 0x8F60B7F6 ^0x8F60B7F6
{
	BOOL flag;
	int value;
	var unk;
...
void func_248(int iParam0, Hash hParam1) // Hash - 0x154FE8B3 ^0x154FE8B3
{
	BOOL flag;
	int value;
	var unk;
...
void func_249(int iParam0, Hash hParam1) // Hash - 0xB448FE2B ^0xBF13E827
{
	BOOL flag;
	int value;
	var unk;
...
void func_250(int iParam0, Hash hParam1) // Hash - 0xE0A1579F ^0xE0A1579F
{
	BOOL flag;
	int num;
	var unk;
...
void func_251(int iParam0, Hash hParam1) // Hash - 0x1DB3E93C ^0x1DB3E93C
{
	BOOL flag;
	int num;
	var unk;
...
void func_252(int iParam0, Hash hParam1) // Hash - 0xE646E909 ^0x62B9EFF6
{
	BOOL flag;
	int value;
	var unk;
...
void func_253(int iParam0, Hash hParam1) // Hash - 0xE6D60F9B ^0xE6D60F9B
{
	BOOL flag;
	int value;
	var unk;
...
void func_254(int iParam0, Hash hParam1) // Hash - 0xA91A09EB ^0xE2448087
{
	BOOL flag;
	int value;
	var unk;
...
void func_255() // Hash - 0xE5F61993 ^0xEFD41040
{
...
BOOL func_256(Ped pedParam0) // Hash - 0xCD74A84A ^0x27173E99
{
	int num;
...
int func_257(int iParam0) // Hash - 0x62D06D8F ^0x62D06D8F
{
	if (func_258(true))
...
BOOL func_258(BOOL bParam0) // Hash - 0x25DF5B1D ^0x9F2B5EB0
{
...
BOOL func_259(int iParam0) // Hash - 0x22B3D50D ^0x22B3D50D
{
	return iParam0 == 87;
}

BOOL func_260() // Hash - 0x39484892 ^0x2FC29187
{
	return func_261(*Global_4718592.f_113724);
}

int func_261(int iParam0) // Hash - 0x9CB2DA77 ^0x9CB2DA77
{
	int i;
...
BOOL func_262(BOOL bParam0) // Hash - 0x54BEFA8F ^0x2645E4C8
{
	if (bParam0)
...
BOOL func_263() // Hash - 0xFEA78839 ^0xAA3D5948
{
...
BOOL func_264(Ped pedParam0, BOOL bParam1) // Hash - 0x84239F5A ^0x5C937669
{
	int pedDrawableVariation;
	int pedTextureVariation;
	int num;
...
int func_265(Hash hParam0, int iParam1, int iParam2, int iParam3) // Hash - 0x4C455E56 ^0x3BFDE16A
{
	Hash componentHash;
...
int func_266(int iParam0, Hash hParam1) // Hash - 0xF58FDC97 ^0x803B7A87
{
...
int func_267(Ped pedParam0) // Hash - 0x48F0132B ^0x6FD5FB98
{
...
Player func_268() // Hash - 0xB2FD1CC3 ^0x65B26EA5
{
	Player player;
...
Player func_269() // Hash - 0xFD2601BF ^0xA8AA969
{
	return Global_1894573[PLAYER::PLAYER_ID() /*608*/].f_10;
}

BOOL func_270(BOOL bParam0) // Hash - 0xCA2EA26D ^0x45E6CA28
{
	return func_271(PLAYER::PLAYER_ID(), bParam0);
}

BOOL func_271(Player plParam0, BOOL bParam1) // Hash - 0xB01293DB ^0xE5AEA938
{
	if (!bParam1)
...
BOOL func_272(Player plParam0) // Hash - 0x240F2609 ^0x5DFCCAA2
{
	if (plParam0 != func_66())
		if (Global_1894573[plParam0 /*608*/].f_10 != func_66())
...
Ped func_273() // Hash - 0x36AF3084 ^0xCC9983BC
{
	Ped playerPed;
...
BOOL func_274(Player plParam0, BOOL bParam1, BOOL bParam2) // Hash - 0xF79838EA ^0xA943B38
{
...
int func_275(var uParam0) // Hash - 0x51136ED0 ^0x51136ED0
{
	return *uParam0;
}

void func_276() // Hash - 0x4AC6005 ^0x23D5613C
{
...
void func_277(int iParam0) // Hash - 0x7E11E9C ^0x544BF257
{
	if (func_45())
		return;
...
void func_278(BOOL bParam0) // Hash - 0x77BBBED5 ^0x77BBBED5
{
	if (bParam0)
		func_280();
...
void func_279(int iParam0, int iParam1) // Hash - 0xD7EC669C ^0xC01D15BF
{
...
void func_280() // Hash - 0x6BEE258E ^0x6BEE258E
{
...
BOOL func_282() // Hash - 0x52E21E9B ^0xD0F85E96
{
...
Hash func_283() // Hash - 0x90B5165C ^0xB8DD5DC8
{
	switch (func_93())
	{
		case 0:
...
Hash func_284() // Hash - 0x61402777 ^0xB9FAC976
{
...
BOOL func_286(int iParam0) // Hash - 0xA28ADBB4 ^0x6EB81E64
{
...
BOOL func_287() // Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_2694524;
}

BOOL func_288() // Hash - 0x974E48B4 ^0x974E48B4
{
	return Global_2683862.f_693;
}

void func_289() // Hash - 0x66E327B2 ^0x39BE3C9E
{
	SYSTEM::WAIT(0);
	return;
}

void func_290() // Hash - 0xAD493D2A ^0xFBB598E0
{
...
void func_291() // Hash - 0x9F9A26D1 ^0xCB75089A
{
	Global_2793044.f_287 = 0;
	func_295(3782, false, -1);
...
void func_292() // Hash - 0x75A09A04 ^0x75A09A04
{
	Global_78530 = 0;
	Global_78531 = -1;
	Global_78532 = -1;
...
BOOL func_293() // Hash - 0x5976C0FC ^0x9A6C2DE6
{
	return func_294(PLAYER::PLAYER_PED_ID());
}

BOOL func_294(Ped pedParam0) // Hash - 0xB37C2EC1 ^0x3119A7F5
{
	int pedDrawableVariation;
...
void func_295(int iParam0, BOOL bParam1, int iParam2) // Hash - 0xCF91FBA1 ^0xAE1D9C41
{
	if (iParam2 == -1)
		iParam2 = func_10();
...
void func_296(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11) // Hash - 0x607C6130 ^0x706A73DE
{
...
void func_297(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4) // Hash - 0x6C5FBB5E ^0xD460273B
{
	uParam0->f_1 = sParam1;
	uParam0->f_2 = iParam3;
...
void func_298(var uParam0, int iParam1, char* sParam2) // Hash - 0x56FFD57E ^0x2EC6E3FD
{
