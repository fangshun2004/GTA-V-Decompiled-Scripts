...
void main() // Hash - 0x5D84F89F ^0x5D84F89F
{
	...
	while (true)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(pedLocal_85) && !ENTITY::IS_ENTITY_DEAD(pedLocal_85, false))
		{
			...
			{
				case 0:
					if (func_84(iLocal_100) || func_86(iLocal_94, 16) && !func_86(iLocal_94, 524288))
					{
						iLocal_98 = -1;
						func_77();
						func_79(1);
...
void func_25() // Hash - 0xA4A2A30E ^0x23D2885A
{
...
void func_39() // Hash - 0xC10546CB ^0x4AEB89A
{
	if (iLocal_119 == 1)
	{
...
BOOL func_40(int iParam0, BOOL bParam1) // Hash - 0xE8E8EFB4 ^0x98461D05
{
	int num;
...
void func_42(var uParam0) // Hash - 0xFE5630E8 ^0xFE5630E8
{
	int num;
...
void func_43(var uParam0, int iParam1, char* sParam2, int iParam3, const char* sParam4, int iParam5, int iParam6) // Hash - 0xC67F23A2 ^0xEFF6309F
{
	int i;
...
BOOL func_44(var uParam0) // Hash - 0x2DF5A077 ^0x2DF5A077
{
	return true;
}

BOOL func_45(int iParam0) // Hash - 0xC95916E2 ^0xC95916E2
{
	func_46();
	return iParam0 == Global_113648.f_2365.f_539.f_4321;
}

void func_46() // Hash - 0xD1F2D853 ^0xF9F5FD4D
{
	int num;
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_49(Global_113648.f_2365.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_47(num) && !func_74(14) || Global_112599)
			{
				if (Global_113648.f_2365.f_539.f_4321 != num && func_47(Global_113648.f_2365.f_539.f_4321))
...
BOOL func_47(int iParam0) // Hash - 0x8907F004 ^0x8907F004
{
	return iParam0 < 3;
}
...
BOOL func_55() // Hash - 0x3CA1BB47 ^0xB78A1ACB
{
...
BOOL func_56(BOOL bParam0) // Hash - 0x1F743529 ^0xDFDFCA73
{
	if (bParam0)
...
void func_57(var uParam0, int iParam1) // Hash - 0xF55E891F ^0xF55E891F
{
...
BOOL func_59() // Hash - 0xFD255207 ^0xFD255207
{
	return true;
}

BOOL func_60() // Hash - 0xC7110B3 ^0x51D25EBB
{
	int weaponHash;
	BOOL flag;
...
BOOL func_61(int iParam0) // Hash - 0x97844555 ^0xADCD6DAA
{
	int num;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_68() || Global_32166 || func_67() || func_53(8, -1) || func_64() || func_66() || func_65() || func_55() || Global_113648.f_7690.f_919[num] == 5)
							return false;
						break;
					...
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_68() || Global_112695 || Global_32166 || func_67() || func_53(8, -1) || func_66() || func_65() || func_55() || Global_113648.f_7690.f_919[num] == 5)
							return false;
						break;
				
					case 4:
						if (func_68() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_53(8, -1) || func_55() || func_63() || Global_113648.f_7690.f_919[num] == 5)
							return false;
						break;
...
BOOL func_62() // Hash - 0x4228A1C2 ^0x952FE30F
{
	return Global_100720.f_1;
}

BOOL func_63() // Hash - 0xC20DBA70 ^0xAC4006FB
{
	if (Global_97603 != -1)
...
BOOL func_64() // Hash - 0xE663B8F6 ^0xE663B8F6
{
	if (Global_78819)
		return true;
...
BOOL func_65() // Hash - 0xD56328D2 ^0xD56328D2
{
	return Global_100733.f_388 > 0;
}

BOOL func_66() // Hash - 0xD56328D2 ^0xD56328D2
{
...
BOOL func_68() // Hash - 0x7FE517FE ^0x128A3BC8
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
BOOL func_70() // Hash - 0x3CA1BB47 ^0x4BFFF917
{
...
Entity func_71() // Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_96513;
}

BOOL func_72(int iParam0) // Hash - 0x6ACD7BFA ^0x6ACD7BFA
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_73(int iParam0) // Hash - 0x7524A8DB ^0x409ED99B
{
	int num;
...
void func_75() // Hash - 0x80357401 ^0x5762ACBA
{
	if (!ENTITY::DOES_ENTITY_EXIST(obLocal_120))
	{
...
BOOL func_76() // Hash - 0xBA7C9F29 ^0x5AB025BE
{
...
void func_77() // Hash - 0xC44FD650 ^0x42238294
{
	if (!STREAMING::IS_MODEL_VALID(obLocal_120.f_1))
		return;
...
void func_79(int iParam0) // Hash - 0x28DF00E8 ^0x28DF00E8
{
	iLocal_95 = iParam0;
	return;
}

void func_80(int iParam0, BOOL bParam1, BOOL bParam2) // Hash - 0x3DFD90D4 ^0xB85FE721
{
	int num;
	BOOL flag;
...
BOOL func_81() // Hash - 0x29CB2928 ^0xE369A18D
{
...
BOOL func_82() // Hash - 0x98CCC132 ^0x97B0D6ED
{
	if (Global_97603 != -1)
...
BOOL func_83(int iParam0, int iParam1) // Hash - 0xDEE74A4E ^0xDEE74A4E
{
	BOOL flag;
...
BOOL func_84(int iParam0) // Hash - 0xECB6C71B ^0xECB6C71B
{
	return func_85(iParam0, Global_43257);
}

BOOL func_85(int iParam0, int iParam1) // Hash - 0x1FD727E0 ^0x1FD727E0
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_86(int iParam0, int iParam1) // Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_87() // Hash - 0x3B2238E3 ^0x56E9968C
{
	TEXT_LABEL_ASSIGN_STRING(&uLocal_53, "Yoga", 64);
	sLocal_101 = _("Press ~INPUT_CONTEXT~ to do Yoga.");
	iLocal_99 = 18;
	fLocal_117 = 2.5f;
	fLocal_102 = 20f;
	essLocal_97 = 54000;
...
int func_88() // Hash - 0x26626B10 ^0x644BC9C9
{
...
void func_89(int iParam0, int iParam1) // Hash - 0xF55E891F ^0xF55E891F
{
	func_90(iParam0, iParam1);
	return;
}

void func_90(var uParam0, int iParam1) // Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_91(BOOL bParam0) // Hash - 0x12400ACB ^0x3A862E90
{
	if (bParam0)
		if (iLocal_105 != 263)
...
void func_92() // Hash - 0xC88B3A8B ^0xCE5EF390
{
	func_89(&iLocal_94, 4);
	func_93();
...
void func_93() // Hash - 0x4301A2BB ^0x15BFFD0B
{
	if (!TASK::IS_SCENARIO_TYPE_ENABLED("WORLD_MOUNTAIN_LION_WANDER"))
	{
