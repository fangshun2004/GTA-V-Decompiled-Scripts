...
void main() // Position - 0x0 Hash - 0x5D84F89F ^0x5D84F89F
{
	...
	iLocal_453 = 49;
	iLocal_454 = 64;
	uLocal_242 = { uScriptParam_506.f_1[0 /*3*/] };
	func_119();
...
int func_23() // Position - 0x1900 Hash - 0x3C5423D7 ^0x3C5423D7
{
	func_24();
...
BOOL func_26(int iParam0) // Position - 0x1A24 Hash - 0x8907F004 ^0x8907F004
{
	return iParam0 < 3;
}

int func_27(Ped pedParam0) // Position - 0x1A30 Hash - 0xAC4E9801 ^0xB379A75F
{
	int i;
	Hash entityModel;
...
Hash func_28(int iParam0) // Position - 0x1A6D Hash - 0xADCB9755 ^0xADCB9755
{
	if (func_26(iParam0))
...
Hash func_29(int iParam0) // Position - 0x1A92 Hash - 0xE4CEEC2C ^0xE4CEEC2C
{
...
BOOL func_34(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x1B3F Hash - 0x384540C1 ^0x384540C1
{
...
Player func_40() // Position - 0x1F1D Hash - 0x478900E4 ^0x478900E4
{
	return -1;
}
...
void func_45() // Position - 0x20AB Hash - 0x98476CE1 ^0x250FEB7C
{
	if (func_25(14))
	{
...
void func_48(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x21DB Hash - 0xC6B752B2 ^0xC6B752B2
{
...
void func_50(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x226C Hash - 0x6C235EE0 ^0x9E57F206
{
...
BOOL func_62() // Position - 0x257D Hash - 0x152DA0B2 ^0x220E93E9
{
...
BOOL func_103(Ped pedParam0) // Position - 0x3187 Hash - 0x3D210083 ^0xF7E7C389
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
		if (!ENTITY::IS_ENTITY_DEAD(pedParam0, false))
			return true;
