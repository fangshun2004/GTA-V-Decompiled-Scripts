...
BOOL func_7() // Hash - 0xFD255207 ^0xFD255207
{
	return true;
}

void func_8() // Hash - 0xD9D84A4B ^0xFCBF3CCF
{
	func_9();
...
void func_9() // Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_10() // Hash - 0xD5E5FC77 ^0xD6C09E94
{
	func_9();
...
void func_11() // Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_12(var uParam0, int iParam1) // Hash - 0xD18CB130 ^0xA0F4C6FD
{
...
void func_14() // Hash - 0xE32CF1EF ^0xB9A7BEB2
{
...
int func_15() // Hash - 0xBA2FE0DB ^0xBA2FE0DB
{
	return func_16();
}

var func_16() // Hash - 0x18CC3780 ^0x18CC3780
{
	return uLocal_276[iLocal_254];
}

void func_17(char* sParam0) // Hash - 0x9923C7DF ^0x6647A95
{
	var unk;
...
void func_18(char* sParam0) // Hash - 0x2B34E328 ^0x54C56A6F
{
	switch (iLocal_254)
	{
		case 0:
...
void func_19(char* sParam0) // Hash - 0x3372085F ^0xE92B226
{
	int num;
...
void func_20(int iParam0, char* sParam1) // Hash - 0xC4958D46 ^0x825C88B7
{
	switch (iParam0)
	{
		case 0:
...
void func_21(char* sParam0) // Hash - 0x3018B517 ^0xD052AAD
{
	var unk;
...
void func_22(char* sParam0) // Hash - 0x79E2B8C7 ^0x4B4BA468
{
	var unk;
	...
	*sParam0 = { unk };
	...
	TEXT_LABEL_APPEND_INT(sParam0, uLocal_299[func_23()], 16);
	return;
}
...
void func_24() // Hash - 0xD1F2D853 ^0xF9F5FD4D
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_28(Global_113648.f_2365.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_26(num) && !func_25(14) || Global_112599)
			{
...
BOOL func_25(int iParam0) // Hash - 0x937D8816 ^0x937D8816
{
...
void func_30(char* sParam0) // Hash - 0x3BD51041 ^0xB03773F6
{
...
void func_32(char* sParam0) // Hash - 0xE431A142 ^0xBDA1A7AC
{
	int num;
...
void func_51(char* sParam0) // Hash - 0xB19D680C ^0x89077B73
{
	int num;
...
void func_53(int iParam0, int iParam1, float fParam2) // Hash - 0xA614141D ^0xA614141D
{
	return;
}
...
void func_58(int iParam0, char* sParam1, char* sParam2) // Hash - 0xA1B3AA65 ^0x9C8E18E6
{
...
void func_65(char* sParam0) // Hash - 0xD55EAE22 ^0x51B1F09B
{
	var unk;
...
void func_67(char* sParam0) // Hash - 0x217F514E ^0x93A850D4
{
...
void func_74(char* sParam0) // Hash - 0x2E18739A ^0x893A0E54
{
...
char* func_75(int iParam0) // Hash - 0xE6862179 ^0xFB60EA1C
{
	switch (iParam0)
	{
		case 0:
...
void func_105() // Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_106() // Hash - 0xA04AAE31 ^0x2C469972
{
	...
	iLocal_252 = 15;
	iLocal_253 = 5;
	sLocal_303 = _("Press ~INPUT_CONTEXT~ to talk to Clinton.");
...
int func_113(const char* sParam0) // Hash - 0xD5121E5F ^0xC9680A92
{
