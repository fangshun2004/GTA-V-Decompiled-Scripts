...
void main() // Position - 0x0 Hash - 0x17B4681A ^0x17B4681A
{
	...
	fLocal_79 = 81.5f;
	uLocal_48 = { uScriptParam_296.f_1[0 /*3*/] };
...
Vector3 func_2(Player plParam0) // Position - 0x23D Hash - 0x6712BF53 ^0x688D5BEC
{
...
BOOL func_28(BOOL bParam0) // Position - 0xA4D Hash - 0x15889021 ^0xE7262364
{
...
void func_35(int iParam0, int iParam1, int iParam2) // Position - 0x1186 Hash - 0xCF91FBA1 ^0xC4FE4CB6
{
	if (iParam2 == -1)
		iParam2 = func_36();
...
BOOL func_46(int iParam0) // Position - 0x19F1 Hash - 0x8907F004 ^0x8907F004
{
	return iParam0 < 3;
}

int func_47(Ped pedParam0) // Position - 0x19FD Hash - 0xAC4E9801 ^0xB379A75F
{
	int i;
	Hash entityModel;
...
Hash func_48(int iParam0) // Position - 0x1A3A Hash - 0xADCB9755 ^0xADCB9755
{
	if (func_46(iParam0))
...
Hash func_49(int iParam0) // Position - 0x1A5F Hash - 0xE4CEEC2C ^0xE4CEEC2C
{
...
BOOL func_56() // Position - 0x1D7A Hash - 0x152DA0B2 ^0x220E93E9
{
...
void func_57(char* sParam0, int iParam1) // Position - 0x1D9C Hash - 0xCBB0D91 ^0x21070E5C
{
...
void func_59(int iParam0) // Position - 0x1E05 Hash - 0x3B4E6AAB ^0xDE553B62
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_64(int iParam0) // Position - 0x20DC Hash - 0xECB6C71B ^0xECB6C71B
{
...
int func_74(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x2CE1 Hash - 0x384540C1 ^0x384540C1
{
...
Player func_80() // Position - 0x30BF Hash - 0x478900E4 ^0x478900E4
{
	return -1;
}
...
void func_85() // Position - 0x324E Hash - 0x98476CE1 ^0x250FEB7C
{
	if (func_45(14))
	{
...
int func_86() // Position - 0x32F0 Hash - 0x3C5423D7 ^0x3C5423D7
{
	func_44();
...
void func_90(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x33EF Hash - 0xC6B752B2 ^0xC6B752B2
{
...
void func_91(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x3445 Hash - 0x6C235EE0 ^0x9E57F206
{
...
BOOL func_95() // Position - 0x3522 Hash - 0xCA10BEA8 ^0xC1E1868D
{
	...
	for (i = 0; i < iLocal_103; i = i + 1)
	{
		if (!PED::IS_PED_INJURED(iLocal_103[i]))
		{
			...
			if (MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_103[i], true), 5f, true) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_103[i], PLAYER::PLAYER_PED_ID(), true) || ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_103[i]) || MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_103[i], true) - { 15f, 15f, 15f }, ENTITY::GET_ENTITY_COORDS(iLocal_103[i], true) + { 15f, 15f, 15f }, -37975472, true) || MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_103[i], true) - { 15f, 15f, 15f }, ENTITY::GET_ENTITY_COORDS(iLocal_103[i], true) + { 15f, 15f, 15f }, -1813897027, true) || MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_103[i], true) - { 15f, 15f, 15f }, ENTITY::GET_ENTITY_COORDS(iLocal_103[i], true) + { 15f, 15f, 15f }, -1568386805, true) || MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_103[i], true) - { 15f, 15f, 15f }, ENTITY::GET_ENTITY_COORDS(iLocal_103[i], true) + { 15f, 15f, 15f }, 741814745, true))
				return true;
		}
	}
...
void func_96() // Position - 0x3795 Hash - 0x5FE7CC3E ^0xE8C5C58A
{
	...
	if (STREAMING::HAS_MODEL_LOADED(663522487) && STREAMING::HAS_MODEL_LOADED(1069929536) && STREAMING::HAS_MODEL_LOADED(1603932804))
	{
		...
		VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(1069929536, true);
		PLAYER::SET_WANTED_LEVEL_MULTIPLIER(0f);
		MISC::ENABLE_DISPATCH_SERVICE(DT_FireDepartment, false);
		iLocal_110[0] = VEHICLE::CREATE_VEHICLE(1069929536, 2209.1704f, 5572.8975f, 52.7565f, 255.5161f, true, true, false);
		...
		iLocal_110[1] = VEHICLE::CREATE_VEHICLE(1069929536, 2195.473f, 5607.5063f, 52.5648f, 168.4012f, true, true, false);
		...
		pkLocal_113 = OBJECT::CREATE_PICKUP_ROTATE(-831529621, uLocal_51, -1.368082f, 0.230633f, 176.87486f, address, MISC::GET_RANDOM_INT_IN_RANGE(40000, 100000), 2, true, 1603932804);
		...
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(3, hLocal_123, -1533126372);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(3, -1533126372, hLocal_123);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, hLocal_123, 1862763509);
	
		for (iLocal_125 = 0; iLocal_125 < 6; iLocal_125 = iLocal_125 + 1)
		{
			iLocal_103[iLocal_125] = PED::CREATE_PED(PED_TYPE_MISSION, 663522487, uLocal_54[iLocal_125 /*3*/], uLocal_80[iLocal_125], true, true);
			...
			if (iLocal_126 == 0)
				WEAPON::GIVE_WEAPON_TO_PED(iLocal_103[iLocal_125], 2017895192, -1, true, true);
			else if (iLocal_126 == 1)
				WEAPON::GIVE_WEAPON_TO_PED(iLocal_103[iLocal_125], 324215364, -1, true, true);
			else
				WEAPON::GIVE_WEAPON_TO_PED(iLocal_103[iLocal_125], -1074790547, -1, true, true);
...
Blip func_97(var uParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x3DCC Hash - 0xF4E99477 ^0xFAB7E8FB
{
...
BOOL func_98() // Position - 0x3DF8 Hash - 0xC05B0E62 ^0x94C54EFE
{
...
int func_99(float fParam0, BOOL bParam1) // Position - 0x3E7E Hash - 0xA169FFDC ^0x284941E0
{
	var unk;
	int unk2;
	int unk3;
...
void func_100(int iParam0, var uParam1) // Position - 0x3F2F Hash - 0x45E5CB0A ^0x45E5CB0A
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_117(int iParam0) // Position - 0x5F8C Hash - 0x687D9246 ^0x687D9246
{
	int num;
...
BOOL func_137(int iParam0, int iParam1, int iParam2) // Position - 0x6C8E Hash - 0xBEEFD79C ^0xBEEFD79C
{
	BOOL num;
	int num2;
...
int func_138(int iParam0) // Position - 0x6D72 Hash - 0x45FC9D61 ^0x45FC9D61
{
	if (!func_46(iParam0))
		return 7;
...
BOOL func_141() // Position - 0x6E32 Hash - 0x44DD83CC ^0x6D2C8335
{
	int profileSetting;
