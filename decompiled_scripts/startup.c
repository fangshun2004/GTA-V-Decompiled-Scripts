...
void func_2() // Position - 0xA25 Hash - 0x420ADB03 ^0x420ADB03
{
	Global_152519 = 1;
	Global_152520 = 1;
	return;
...
void func_3(Any* panParam0, int iParam1) // Position - 0xA37 Hash - 0xFEE02C7D ^0xFEE02C7D
{
...
void func_4(Any* panParam0, int iParam1) // Position - 0xA6F Hash - 0x526F6AF1 ^0x4C2A10FA
{
	var arrayName;
...
void func_5(Any* panParam0, int iParam1) // Position - 0xB39 Hash - 0xCD0A2AD8 ^0x412E2A43
{
	var arrayName;
...
void func_6(Any* panParam0, int iParam1) // Position - 0xBB2 Hash - 0x829A3A38 ^0x3B9E4A33
{
	var arrayName;
...
void func_7(Any* panParam0, int iParam1) // Position - 0xBED Hash - 0xE0AF8A ^0x5AF7E2C9
{
	var arrayName;
...
void func_8(Any* panParam0, int iParam1) // Position - 0xC27 Hash - 0xE0AF8A ^0xD464F4AD
{
	var arrayName;
...
void func_9(Any* panParam0, int iParam1) // Position - 0xC61 Hash - 0x3411E5F0 ^0x9D0C5085
{
	var arrayName;
...
void func_10(Any* panParam0, int iParam1) // Position - 0xC97 Hash - 0x598CB8C9 ^0x387C6996
{
	var structName;
	int unk;
	var unk2;
...
void func_11(Any* panParam0, int iParam1) // Position - 0xE11 Hash - 0xFA873DA ^0x58C40FA4
{
	var structName;
	var unk;
	int unk2;
...
void func_12(Any* panParam0, int iParam1) // Position - 0x1237 Hash - 0x3FAF8E18 ^0x28DE4079
{
	var unk;
...
void func_13(Any* panParam0, const char* sParam1) // Position - 0x1258 Hash - 0x97C45A38 ^0x5660CDE4
{
	int i;
	var name;
	int unk;
...
void func_14(Any* panParam0, int iParam1) // Position - 0x23F7 Hash - 0xB961644E ^0xB961644E
{
	func_15(&(panParam0->f_593), iParam1);
	return;
}

void func_15(Any* panParam0, int iParam1) // Position - 0x240A Hash - 0x8E2CD5DC ^0x2ECDE6D4
{
	var name;
	int unk;
...
void func_16(Any* panParam0, char* sParam1) // Position - 0x25C3 Hash - 0x84B347DA ^0x8738141
{
...
void func_17(Any* panParam0, int iParam1) // Position - 0x277B Hash - 0xDF7B42CB ^0x364BFDD7
{
	var unk;
...
void func_18(Any* panParam0, const char* sParam1) // Position - 0x279B Hash - 0x97C45A38 ^0xD091E4CA
{
	int i;
	var name;
...
void func_19(Any* panParam0, int iParam1) // Position - 0x2B2B Hash - 0xD8FBF65D ^0x32B14A46
{
	var unk;
...
void func_20(Any* panParam0, const char* sParam1) // Position - 0x2B49 Hash - 0x1B760539 ^0x39287F50
{
	int i;
	var name;
...
void func_21(float fParam0) // Position - 0x2BA7 Hash - 0xC1458E09 ^0xC1458E09
{
	func_30();
...
void func_22() // Position - 0x2C09 Hash - 0x2100AD75 ^0x3678395B
{
	Global_113648.f_26436.f_4 = 0;
	return;
}

void func_23() // Position - 0x2C1B Hash - 0x12B91D88 ^0x7553358
{
	int outValue;
	int outValue2;
	int outValue3;
...
void func_24() // Position - 0x2C7A Hash - 0x750C5FAD ^0x76416C8E
{
	int i;
	int j;
	int num;
...
void func_25() // Position - 0x2CE6 Hash - 0x219867CE ^0x74CA5C84
{
...
BOOL func_26(int iParam0) // Position - 0x2D35 Hash - 0x35F9F9C ^0x35F9F9C
{
...
void func_27() // Position - 0x2D61 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_28() // Position - 0x2D69 Hash - 0x10E1CFBD ^0xAAD3434B
{
...
void func_29(int iParam0, int iParam1) // Position - 0x2E89 Hash - 0xAF69B7CA ^0x2B8275AE
{
	var unk;
	var unk2;
	var unk3;
...
void func_30() // Position - 0x308D Hash - 0x8335644F ^0x8335644F
{
	int i;
...
BOOL func_31(int iParam0) // Position - 0x30D8 Hash - 0x8907F004 ^0x8907F004
{
	return iParam0 < 3;
}

void func_32(Hash hParam0, eStackSize essParam1) // Position - 0x30E4 Hash - 0xF4E4A08F ^0xFF44AEEF
{
...
void func_33() // Position - 0x3113 Hash - 0xC42731A ^0xE83AAE9B
{
	unk_0x1632FC7746D55A15(_("No Filter"), 1);
...
int func_34(var uParam0, int iParam1) // Position - 0x3175 Hash - 0x14ADFCA ^0xFEFB0F83
{
	int i;
...
int func_35(int iParam0) // Position - 0x44D2 Hash - 0x95677753 ^0x95677753
{
	switch (iParam0)
	{
		case 1:
...
void func_36(var uParam0, int iParam1) // Position - 0x4A19 Hash - 0xC4015B80 ^0xF4489635
{
	var unk;
	int unk2;
...
void func_37(int iParam0, var uParam1, var uParam2, int iParam3) // Position - 0x71FD Hash - 0x3F59E3D3 ^0x16923DFB
{
	var unk;
...
void func_38(int iParam0, int iParam1, var uParam2, BOOL bParam3) // Position - 0x7698 Hash - 0xA1F236AB ^0x4D5AF257
{
	var unk;
	Vector3 unk2;
...
Vector3 func_39(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x8017 Hash - 0x8959C4D1 ^0x8922A2E2
{
	float num;
	float unk;
	float unk2;
...
struct<6> func_40(int iParam0, int iParam1) // Position - 0x805B Hash - 0x2496BBBB ^0x92F2F3E
{
	var unk;
	BOOL unk2;
	BOOL unk3;
...
BOOL func_41(int iParam0, var uParam1) // Position - 0x809D Hash - 0x7164B50D ^0x19A31E94
{
	switch (iParam0)
	{
		case -1:
...
struct<6> func_42(int iParam0) // Position - 0x81C3 Hash - 0xC73C1158 ^0x2A6D4A6F
{
	var unk;
...
void func_43(var uParam0, int iParam1) // Position - 0x88B9 Hash - 0xBCDD19C ^0xBCDD19C
{
	var unk;
...
BOOL func_44(int iParam0) // Position - 0x8FB5 Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
		case 87:
...
BOOL func_45(int iParam0, int iParam1) // Position - 0x8FE4 Hash - 0x32D9FCC4 ^0x32D9FCC4
{
	if (iParam1 == -1)
	{
		switch (iParam0)
...
// Unhandled jump detected. Output should be considered invalid
int func_46(int iParam0, int iParam1) // Position - 0x90C1 Hash - 0x779DF6B0 ^0x779DF6B0
{
	if (iParam1 == -1)
	{
		switch (iParam0)
...
int func_47(int iParam0) // Position - 0x917D Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
		case 83:
...
void func_48(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x91A6 Hash - 0x91B5CD4A ^0x91B5CD4A
{
	var unk;
	Vector3 unk2;
...
struct<6> func_49(int iParam0, BOOL bParam1) // Position - 0xA660 Hash - 0x293B24C9 ^0x49F602D8
{
	var unk;
...
int func_50(int iParam0) // Position - 0xB216 Hash - 0x85860E9C ^0x85860E9C
{
	switch (iParam0)
	{
		case 1:
...
void func_51(var uParam0, int iParam1) // Position - 0xB453 Hash - 0xDB98DDB7 ^0x6713DF47
{
	switch (iParam1)
	{
		case 2:
...
struct<8> func_52(var uParam0, int iParam1) // Position - 0xBD00 Hash - 0x89718D ^0x979A7007
{
	switch (iParam1)
	{
		case 2:
...
void func_53(var uParam0, int iParam1) // Position - 0xBDC2 Hash - 0x4DEDC2C8 ^0x4C167629
{
	var unk;
...
void func_54(var uParam0, int iParam1) // Position - 0x13DE8 Hash - 0xB7702D83 ^0xB7702D83
{
	switch (iParam1)
	{
		case 1:
...
void func_55(var uParam0, int iParam1) // Position - 0x14594 Hash - 0x4DEDC2C8 ^0x4C167629
{
	var unk;
...
void func_56(var uParam0, int iParam1) // Position - 0x174D9 Hash - 0x4DEDC2C8 ^0x4C167629
{
	var unk;
...
void func_57(var uParam0, int iParam1) // Position - 0x18AF4 Hash - 0xC453A0B7 ^0xD5C79BA0
{
	var unk;
...
void func_58(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0x20614 Hash - 0x1A9A1B3A ^0xAFEB7172
{
	var unk;
	var unk2;
	var unk3;
...
void func_59(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, Vector3 vParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18) // Position - 0x2084A Hash - 0xAF03D6C6 ^0x10EE8207
{
	Vector3 vector;
...
BOOL func_60(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, BOOL bParam6) // Position - 0x209A4 Hash - 0x2D46096D ^0xEA41378F
{
	if (bParam6)
...
int func_61(var uParam0, int iParam1) // Position - 0x209EB Hash - 0x7EA7B171 ^0xE80E6A41
{
	switch (iParam1)
	{
		case 103:
...
void func_62(var uParam0, int iParam1) // Position - 0x20C9B Hash - 0xE0CC43E ^0x9B0FA980
{
	var unk;
	int unk2;
...
int func_63(var uParam0, int iParam1) // Position - 0x20E13 Hash - 0xF04B697 ^0x8F24807C
{
	switch (iParam1)
	{
		case 91:
...
void func_64(var uParam0, int iParam1) // Position - 0x210C3 Hash - 0x9E11C000 ^0x4493326F
{
	switch (iParam1)
	{
		case 91:
...
struct<4> func_65(int iParam0) // Position - 0x21580 Hash - 0x9440B077 ^0x4C5EF751
{
	var unk;
	...
	{
		case 1:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("This luxury triplex is move-in ready! The previous owner was so rich he just left all his furniture. Just bring yourself and be ready for lots of new superficial friends when people find out you live on Eclipse Boulevard in Rockford Hills. Includes 10-car garage."), 16);
			break;
	
		case 2:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("A massive, furnished, luxury triplex at this price? You've gotta love a bargain like this! Snap it up now before President Lawton loses the next election and they tax the hell out of you. Includes 10-car garage."), 16);
			break;
	
		case 3:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("Eclipse Towers on Eclipse Boulevard... this is the best address in Rockford Hills! Stand at your floor-to-ceiling windows, take in the spectacular panoramic views, pour yourself a drink and toast how amazing your life is while you look down on everybody else. Includes 10-car garage."), 16);
			break;
	
		case 4:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("Upper class living at middle class prices! Are you a single-digit millionaire who wants to live like a double-digit millionaire? You'll never find a better deal on a luxury condo in Rockford Hills than this again. Act now, it won't last! Includes 10-car garage."), 16);
			break;
	
		case 5:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("With its own Bean Machine outlet on the ground floor and a short commute to the financial center, this luxury condo on Alta Street in Downtown Los Santos is the perfect pad for the banker who never sleeps because he's having too much fun gambling with other people's money. Includes 10-car garage."), 16);
			break;
	
		case 6:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("Situated at the epicenter of the Los Santos financial, business and high-end shopping districts, you'll never have to see a poor person again at this luxury condo on Alta Street if you don't want to. Everything you need is right on your doorstep. Includes 10-car garage."), 16);
			break;
	
		case 7:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("This luxury condo on Marathon Avenue and Prosperity Street, in one of the most stylish apartment buildings in hip Del Perro, directly opposite the Bahama Mamas nightclub for the perfect release at the end of a hard day's work. Includes 10-car garage."), 16);
			break;
	
		case 8:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("Located steps away from a skate park, this cute-as-a-button one-bedroom in Hawick is perfect for families with teenage children or tragic 30-something hipsters with fixies. Includes 6-car garage."), 16);
			break;
	
		case 9:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("This newly-renovated one-bedroom in Downtown Vinewood is a STEAL!~n~Hurry this one won't last! It did last!~n~$10,000 price reduction!~n~Crazy value!~n~Move NOW the price is right!~n~Everything's negotiable. Motivated seller.~n~Reduced again for quick sale!~n~WILL SOMEONE JUST BUY THIS ALREADY??? Includes 6-car garage."), 16);
			break;
	
		case 10:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("This building has seen better days - the closest thing to a doorman is a homeless guy you sometimes have to step over to get into the lobby at night - but how else are you going to find a Vinewood apartment in your price range? Hope you like the smell of urine.~n~Includes 6-car garage."), 16);
			break;
	
		case 11:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("Cozy one-bedroom in a cute West Vinewood apartment block! You'll only share the building with a few other units, meaning fewer neighbors for you to grow to despise. Includes 6-car garage."), 16);
			break;
	
		case 12:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("The Royale apartment building in West Vinewood might not look regal on the outside but you'll live like a prince on the inside! PS Princes are douches.~n~Includes 6-car garage."), 16);
			break;
	
		case 13:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("This modern, renovated one-bedroom is in a well-maintained building in a great West Vinewood location. Buy now at the bottom of the market! Property values can't go any lower! We're absolutely sure this time! Includes 6-car garage."), 16);
			break;
	
		case 14:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("Hello, sailor! This renovated, fully-furnished apartment is right on the waterfront in Puerto Del Sol. Perfect for picking up other sailors.~n~Includes 6-car garage."), 16);
			break;
	
		case 15:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("Location is in the eye of the beholder! Some might call this a busy traffic junction, we call it a Commuter's Dream! Some might call this Little Seoul, we call it Vespucci so we can up the price!~n~Includes 6-car garage."), 16);
			break;
	
		case 16:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("Join the other creative types flocking to this neighborhood. With easy access to both a movie theater and a church, this apartment in Dream Tower is perfect for lovers of fiction.~n~Includes 6-car garage."), 16);
			break;
	
		case 17:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("What this Hawick apartment lacks in space and all-round condition, it makes up for in proximity to the local liquor store. Drown in debt and your sorrows.~n~Includes 2-car garage."), 16);
			break;
	
		case 18:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("Original features! This cozy apartment in West Vinewood had only one owner, who didn't update a single thing since he moved in there 40 years ago and then passed away – it was days before anyone noticed. Includes 2-car garage."), 16);
			break;
	
		case 19:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("This compact apartment in a 2-story apartment building has been meticulously maintained in its original condition! Semi-partial ocean view! Includes 2-car garage."), 16);
			break;
	
		case 20:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("The apartment building has seen better days but this affordable unit still has a Little Soul and a Lot of Potential! Bring your imagination! And an exterminator.~n~Includes 2-car garage."), 16);
			break;
	
		case 21:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("This fixer-upper offers stunning views of the cemetery to at once remind you of your mortality and motivate you to get your act together and buy a better apartment one day.~n~Includes 2-car garage."), 16);
			break;
	
		case 22:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("With both Wigwam and Up-n-Atom right on your doorstep, burger enthusiasts will be spoiled for choice at this apartment located in Del Perro or Morningwood, depending on which side of the building you stand. Includes 2-car garage."), 16);
			break;
	
		case 23:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("With a funky retro décor and carpeted throughout, you can literally smell the history in this Del Perro apartment that features an almost unobstructed ocean view for an almost unbeatable price. Includes 2-car garage."), 16);
			break;
	
		case 24:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("10-Car Garage - With good access to the major roadways in and out of Los Santos, this spacious garage is perfect for the man or woman who might need to leave town in a hurry. Or is obsessed with cars."), 16);
			break;
	
		case 25:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("6-Car Garage - If you're an individual who likes to keep their business private, look no further than this secluded garage in East Los Santos."), 16);
			break;
	
		case 26:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("10-Car Garage - Spacious garage in prime East Los Santos. Panoramic views of urban blight, walking distance to gang members."), 16);
			break;
	
		case 27:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("10-Car Garage - Newly renovated garage with excellent square footage and direct road access. What better place to keep brand-new vehicles than the neighborhood with the highest crime rate in Los Santos?"), 16);
			break;
	
		case 28:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("6-Car Garage - A good-sized garage in a quiet location within walking distance of the train for those days when you feel extra guilty about your 6-car carbon footprint."), 16);
			break;
	
		case 29:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("2-Car Garage - Located just a few brain-melting steps away from an electrical substation, you'll never have to worry losing power or reaching old age again at this garage in East Los Santos."), 16);
			break;
	
		case 30:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("2-Car Garage - Affluent on the inside, effluent on the outside! This garage offers panoramic views of the Los Santos waterways."), 16);
			break;
	
		case 31:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("2-Car Garage - Calling all bargain hunters! In today's economy, it's all about desirable properties in undesirable areas. East Los Santos? We prefer to call it 'South of Vinewood'! Plus if the economy keeps tanking, you can go live in it!"), 16);
			break;
	
		case 32:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("6-Car Garage - This garage is in a killer area... literally! Be first to gentrify this neighborhood! In 20 years, it will be the next big thing!"), 16);
			break;
	
		case 33:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("6-Car Garage - High standards in real estate, low standards in women? End the day with your own oil change at this garage located across from a strip club!"), 16);
			break;
	
		case 34:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("Luxury Del Perro Heights apartment complex! For all you voyeurs out there! This spectacular condo is one of the lower units so might not boast the best views, but all the buildings around you will have a direct eyeline into your awesome life 24/7. Includes 10-car garage."), 16);
			break;
	
		case 35:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("Calling all actors! This is your chance to live on sought-after Movie Star Way in prime Rockford Hills directly opposite the legendary Richard Majestic film studios. Stagger out of your front door right onto set! Includes 10-car garage."), 16);
			break;
	
		case 36:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("Movie Star Way! Don't miss this opportunity to live in one of the most exclusive apartment complexes in Rockford Hills. Even the janitor earns six figures in this building.~n~Includes 10-car garage."), 16);
			break;
	
		case 37:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("This spectacular condo on Movie Star Way in prime Rockford Hills is move-in ready! Don't worry if you're a rich Los Santos philistine with no taste - it's all been picked out for you. All furniture, appliances, fixtures and art included.~n~Includes 10-car garage."), 16);
			break;
	
		case 38:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("No dropped calls here! This luxury condo is located in the same building as Tinkle Mobile's headquarters in the new real estate hotspot of Downtown Los Santos. This is such an up-and-coming neighborhood, you can literally see the construction from your window!~n~Includes 10-car garage."), 16);
			break;
	
		case 39:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("This beautiful Downtown triplex apartment has spectacular views of Los Santos and the iconic Vinewood Sign in the distance. Watch all the people chasing the dream while you live it! Includes 10-car garage."), 16);
			break;
	
		case 40:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("This breathtaking luxury condo on Movie Star Way in Rockford Hills is a stone's throw from Richards Majestic Movie Studios, AKAN Records and a Sperm Donor Clinic. The ultimate trifecta of dying industries! Includes 10-car garage."), 16);
			break;
	
		case 41:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("A luxury condo on Movie Star Way in Rockford Hills? This is one of the trendiest addresses in Los Santos! Imagine if all your neighbors were hedge fund managers and celebrities? Come on, live the dream. Includes 10-car garage."), 16);
			break;
	
		case 42:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("Your split personality will be right at home in this retro-slash-ultramodern apartment building on Boulevard Del Perro. Go mad in style. Includes 10-car garage."), 16);
			break;
	
		case 43:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("Parquet flooring, granite countertops, floating fireplace, bland modern art, walk-in closet, towel warmers, leather headboard, man cave...this luxury condo in Tinsel Towers on Boulevard Del Perro checks all the boxes on the new-money millionaire ticklist.~n~Includes 10-car garage."), 16);
			break;
	
		case 44:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("2-Car Garage - Annexed to a gas station and within easy distance of a number of cheap motels, this garage on Paleto Blvd in Paleto Bay has all you need for the perfect escape from the city."), 16);
			break;
	
		case 45:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("2-Car Garage - This garage near Paleto Blvd in Paleto Bay has seen better days but there's a barber's, a tattoo parlor and a Cluckin' Bell factory on your doorstep...so what more do you need?"), 16);
			break;
	
		case 46:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("2-Car Garage - The town of Grapeseed offer a unique blend of heavy industry and genetically-modified farming that explains why everyone born there in the last 20 years looks so funny. This small garage on Grapeseed Avenue needs some TLC but is priced to sell."), 16);
			break;
	
		case 47:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("2-Car Garage - This garage is situated on the site of Ron Alternates on N. Senora Way. What better way to feel better about your carbon footprint than by storing your gas-guzzlers inside a wind farm?"), 16);
			break;
	
		case 48:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("2-Car Garage - Across from the beach, ocean views, steps from a delicious seafood restaurant, this property on Great Ocean Highway in North Chumash is in an unbeatable location! The catch? It's a garage..."), 16);
			break;
	
		case 49:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("2-Car Garage - Small one-door garage for sale on Route 68 on Harmony. With a rundown general store, a local arm-wrestling haunt and a seedy motel all nearby, park up and live the dream!"), 16);
			break;
	
		case 50:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("6-Car Garage - Garage in need of some TLC for sale on Senora Rd in the Grand Senora Desert. Nothing of great note in the surrounding area. It's a garage. In a desert."), 16);
			break;
	
		case 51:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("2-Car Garage - Steps from a liquor store, a Dollar Pills pharmacy, a Suburban store, and an Animal Ark pet store, this garage on Route 68 in Harmony is a hipster's dream. Booze, cigarettes, faux-vintage clothing and organic dog food in one!"), 16);
			break;
	
		case 52:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("6-Car Garage - Located behind an Ammu-Nation store and near to the Fort Zancudo Military Base, you won't have to worry about security at this garage on Route 68."), 16);
			break;
	
		case 53:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("6-Car Garage - Calling all Los Santos Panic fans! This garage on Crusade Road is in a prime location just down the road from the Maze Bank Arena!"), 16);
			break;
	
		case 54:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("10-Car Garage - Are you in need of a low-profile lock-up where people won't ask too many questions? Look no further than this garage on South Shambles in Cypress Flats."), 16);
			break;
	
		case 55:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("6-Car Garage - If you're looking for a desolate, industrial lock-up far away from prying eyes, this garage on Dry Dock St in Cypress Flats is the one for you!"), 16);
			break;
	
		case 56:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("10-Car Garage - Garage for sale on Exceptionalists Way. Why would you need a spacious, anonymous, non-descript lock-up with lots of space for storage close to the airport? We won't ask if you don't tell."), 16);
			break;
	
		case 57:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("10-Car Garage - In a prime location near Greenwich parkway in Los Santos International Airport, next door to Bilgeco Shipping services, this garage is perfect for a man or woman who might need to transport something in a hurry or get out of a town in a hurry."), 16);
			break;
	
		case 58:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("2-Car Garage - Garage for sale on Innocence Blvd in La Puerta. How can there be this many garages for sale in Los Santos? We're as puzzled by this real estate boom as you are."), 16);
			break;
	
		case 59:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("2-Car Garage - If you're feeling the pinch of the economic downturn but desperate for a prime Rockford Hills address, this garage on Boulevard Del Perro might be the perfect compromise!"), 16);
			break;
	
		case 60:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("2-Car Garage - Garage for sale on Mirror Park Blvd in East Vinewood. If you're looking for a garage in Los Santos, don't delay! It's an incredible buyer's market right now. They're everywhere!"), 16);
			break;
	
		case 61:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("Part of The High Life Update. Perfectly proportioned, beautifully presented lateral living opportunity on exquisite Eclipse Blvd. This apartment is as unique as the new cheekbones your surgeon just gave you... by that we mean you'll see them all over town. Includes 10-car garage."), 16);
			break;
	
		case 62:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("Part of The High Life Update. Enjoy ocean views far above the fray of tourists and bums on Del Perro Beach with this lateral living opportunity for the super rich. If we can overpay for something, we have, and we're passing the expense on down to you. Includes 10-car garage."), 16);
			break;
	
		case 63:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("Part of The High Life Update. Own a piece of glamorous old Vinewood, albeit a very small and expensive piece that's been made to look just like the other super-rich corners of Los Santos. A contemporary lateral living experience with one foot in the past. Includes 10-car garage."), 16);
			break;
	
		case 64:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("Part of The High Life Update. A picture-perfect lateral living experience in one of Los Santos' most sought-after tower blocks. These gorgeous lateral apartments only become available when hedgefunder residents have massive drug-induced heart attacks or get arrested for killing hookers. Includes 10-car garage."), 16);
			break;
	
		case 65:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("Part of The High Life Update. Live in the clouds while your bank balance hits the floor. An apartment so conspicuously expensive all your friends will immediately know how much you paid for it. The Downtown lateral living experience for people who secretly want to be LC based. Includes 10-car garage."), 16);
			break;
	
		case 66:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("Part of The Independence Day Special. Crazy movie director across the road? Check. Astronomically over-priced property where your car has more square footage than you do? Check. If you're looking for the full Vinewood Hills experience, this modest home ticks all the boxes. Includes 6-car garage."), 16);
			break;
	
		case 67:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("Part of The Independence Day Special. Calling all gentrifiers... El Burro Heights is ripe for hostile takeover! Pack up the espresso machine, labradoodle and deliberately tousled toddler and snap up this property before it's too late! Act now, or you'll be priced out of this neighborhood within a year! Includes 6-car garage."), 16);
			break;
	
		case 68:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("Part of The Independence Day Special. Check out the water feature in the front yard! This is coastal, provincial living at its very finest. Worried about shade? Want easy access to groceries? How about two for the price of one? This house backs right onto the supermarket, blocking out all natural light. Includes 6-car garage."), 16);
			break;
	
		case 69:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("Part of The Independence Day Special. Stunning views of rapidly rising sea levels! And talk about amenities! This Paleto Bay beauty is walking distance to a dive bar, hospital, funeral home, crematorium and gun store, so you can go out on the town secure in the knowledge that you're covered for every eventuality. Includes 6-car garage."), 16);
			break;
	
		case 70:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("Part of The Independence Day Special. Fall asleep to the sounds of the ocean and bums dumpster-diving in the parking lot. This cute-as-a-button property is centrally located on Paleto Bay's main street, a short walk from the coast and next door to the local supermarket. Includes 2-car garage."), 16);
			break;
	
		case 71:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("Part of The Independence Day Special. Beggars CAN be choosers! Waterfront living at a bargain price! Steps away from both a Chinese restaurant and a tattoo parlor, this Sandy Shores location offers no shortage of late-night decisions you'll regret in the morning. Includes 2-car garage."), 16);
			break;
	
		case 72:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("Part of The Independence Day Special. Location, location, location! Across from a feed store, minimart and discount clothes emporium, this house is right in the heart of the action on Grapeseed's main drag. Living on the cutting edge of rural retail! Includes 2-car garage."), 16);
			break;
	
		case 83:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("Is the 1% starting to feel a little crowded? Are you tired of single-digit millionaires cluttering up your elevator and groping your bellboy? Do you need a new way of expressing your bottomless contempt for your fellow man? Look no further: this lavish penthouse suite at the best address in town is expensive enough to keep the riff raff at bay until at least the next federal bailout. Access to our same-day redecorating service included as standard. Part of Executives and Other Criminals."), 16);
			break;
	
		case 84:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("Penthouse living isn't just about mindless luxury. It's about knowing that when you flush a dump you're literally crapping through every single one of the $500K hovels beneath you - and that's something that only money can buy. Access to our same-day redecorating service included as standard. Part of Executives and Other Criminals."), 16);
			break;
	
		case 85:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("Let's face it: we had you at the pricetag. The fact that this happens to be one of the most decadent living spaces for hundreds of miles doesn't really matter. Just like its new owner, something this expensive doesn't need to be 'nice' or 'useful'. You're a perfect match. What are you waiting for? Access to our same-day redecorating service included as standard. Part of Executives and Other Criminals."), 16);
			break;
	
		case 73:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("Welcome to the heights of the Vinewood hills, where the average first time buyer is 24 and the web 2.0 entrepreneurs are only outnumbered by the swarms of fading teenage pop sensations. Buy in now while the price is still ridiculously high - what are you, sensible? Part of Executives and Other Criminals."), 16);
			break;
		...
		case 75:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("The previous owner of this gorgeous cliffside manor died doing a yoga pose on the rear balcony railing... but at least they got the Snapmatic shot. It's a tough act to follow, but if you're rich and stupid enough to buy into this neighborhood you're already most of the way there. Just follow your fragile heart. Part of Executives and Other Criminals."), 16);
			break;
	
		case 76:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("Clinging to the side of the Vinewood hills like a dying oil tycoon clutching his carer-turned-sixth-wife, this three story mansion more than compensates for deep structural flaws with sumptuous interior design. Open plan kitchen, minimalist furnishings, ever-present vertigo: this one really has it all. Part of Executives and Other Criminals."), 16);
			break;
	
		case 77:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("The saps driving through downtown Vinewood on their morning commute need something to aspire to. They don't want to look up and see green, peaceful hills. They want to gaze through your floor-length windows and see you in nothing but a snakeskin posing pouch injecting cold press kale juice with your tantric yoga instructor. That's the kind of status that doesn't come cheap, so dig deep. Part of Executives and Other Criminals."), 16);
			break;
		...
		case 91:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("This little gem is nestled so snugly in the heart of longstanding urban squalor that we'd forgotten it was even on our books. As far as we can tell it's not on any property register, so just give us the cash and make it disappear."), 16);
			break;
	
		case 92:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("This functional ground floor property used to be a soup kitchen, and repossessing that kind of attack on American values isn't just business for us - it's pleasure. Now available for purchase by a patriotic entrepreneur or kingpin, this place will be serving the community again in no time."), 16);
			break;
	
		case 93:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("The repo guys who raided this place died of smallpox three days later, which is almost certainly a coincidence and has in no way affected the valuation of the property. And hey, worst case scenario, you couldn't pay for a more robust security system."), 16);
			break;
	
		case 94:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("We all thought there was a rock bottom, but nope, it turns out the value of a place like this just falls and falls! Get in here before we burn it for kicks. The authorities just want to forget it exists, so go wild."), 16);
			break;
	
		case 95:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("You might assume this is a glass-half-empty kind of place, but the people of Paleto believe the glass is actually half full of cut-price real estate, disenfranchised workers and raw opportunity. That's right, this dingy storage unit is a step towards a brighter future for us all."), 16);
			break;
	
		case 96:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("Are you a real fixer upper? Can you share the cool desert evenings with packs of wild dogs and openly incestuous couples? If so this is the project for you. It's got nothing but potential."), 16);
			break;
	
		case 97:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("The locals assumed it was abandoned, but in fact this spacious warehouse was the heart and soul of the Los Santos snuff industry for years. Now tax hikes are forcing those pioneering filmmakers out of business, so this is your chance to buy your way under the radar and stay there for good."), 16);
			break;
		...
		case 99:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("You know a property must be something really special when the previous occupants have such a hard time letting go. You just can't fake that kind of helpless desperation and rage, and in a world as cynical as this that's the best review of all."), 16);
			break;
	
		case 100:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("If you're looking for somewhere that's off the beaten path you just found it: miles from anywhere, deemed hazardous by the Los Santos Building Standards Commission, and the last occupants died in murder-suicide pact. How many reassurances of total privacy do you need?"), 16);
			break;
	
		case 101:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("Sure, coastal small town America has mile after mile of foreclosed retail premises within fifty feet of a church and a gun store, so why choose this one? Well ask yourself this: can you think of a better way to blend in and disappear? Act now before it stops making sense."), 16);
			break;
	
		case 102:
			TEXT_LABEL_ASSIGN_STRING(&unk, _("You know times are tough when not even a million hipsters getting a tattoo of a swallow in flight on their taint could save this place from going under. Bad news for those who wanted to follow up with that bold yet simple triangle design, but the rock bottom pricetag is good news for you."), 16);
			break;
	}
...
struct<4> func_66(int iParam0) // Position - 0x21C48 Hash - 0x9440B077 ^0x3873237F
{
	var unk;
...
int func_67(int iParam0) // Position - 0x2239B Hash - 0xD720A463 ^0x1563885F
{
	int num;
	BOOL flag;
	var unk;
...
void func_68(char* sParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x22C36 Hash - 0x22B51A7B ^0xBC509729
{
	var unk;
...
BOOL func_69(int iParam0) // Position - 0x22C79 Hash - 0xC283774E ^0xC283774E
{
	if (func_70())
...
BOOL func_70() // Position - 0x22CB6 Hash - 0x3630EC94 ^0x3630EC94
{
	return func_72() || func_71();
}

int func_71() // Position - 0x22CCC Hash - 0x9FCD2A0C ^0x944A169B
{
...
int func_72() // Position - 0x22CFA Hash - 0x9FCD2A0C ^0xB7DCD169
{
...
BOOL func_73(int iParam0) // Position - 0x22D28 Hash - 0x4A424D7C ^0x4A424D7C
{
	if (func_75() && func_74())
		if (iParam0 == 31)
			return true;
...
int func_74() // Position - 0x22D60 Hash - 0xAF3D3332 ^0xE009CBFC
{
	int outValue;
	int outValue2;
	Hash statHash;
...
int func_75() // Position - 0x22E99 Hash - 0x44DD83CC ^0x6D2C8335
{
	int profileSetting;
...
BOOL func_76() // Position - 0x22F51 Hash - 0x2E0B1DC1 ^0xD2D0A3D9
{
...
void func_77() // Position - 0x22F68 Hash - 0xFDE1CC0C ^0x61DB6169
{
	int i;
	BOOL flag;
	int address;
...
BOOL func_78(int iParam0) // Position - 0x22FEE Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
		case 8:
...
BOOL func_79(int iParam0, int iParam1) // Position - 0x23011 Hash - 0x10725834 ^0x10725834
{
	switch (iParam0)
	{
		case 11:
...
Hash func_80(int iParam0) // Position - 0x2304D Hash - 0xB8EC44B7 ^0xA99DCEEB
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_81() // Position - 0x23113 Hash - 0xEDF284C1 ^0xFD1ABEAC
{
...
void func_82(int iParam0) // Position - 0x23148 Hash - 0x8006748D ^0x3C79CCFE
{
	int i;
