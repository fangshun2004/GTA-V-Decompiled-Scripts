...
void func_1(var uParam0) // Hash - 0x91966747 ^0x6CE9840E
{
	var animDict;
	var animName;
...
void func_2(var uParam0, BOOL bParam1) // Hash - 0xA743C8AE ^0x192DADA9
{
...
int func_3(var uParam0) // Hash - 0x8A059B4A ^0xCFB4F139
{
	int num;
...
BOOL func_4() // Hash - 0x5976C0FC ^0xC3C6644E
{
	return func_5(PLAYER::PLAYER_ID());
}

BOOL func_5(Player plParam0) // Hash - 0x2281DC14 ^0xFBEE7D11
{
...
int func_6(int iParam0) // Hash - 0x3133C6A9 ^0x3133C6A9
{
	switch (iParam0)
	{
		case 0:
...
void func_8(var uParam0) // Hash - 0x71FEF6ED ^0x56654229
{
	Vector3 vector;
	float num;
...
BOOL func_9(BOOL bParam0) // Hash - 0xCE5DD307 ^0xCD1D2820
{
...
BOOL func_10(Ped pedParam0) // Hash - 0x6E21113D ^0x5A7BE662
{
	int weaponHash;
...
BOOL func_11() // Hash - 0x8E975DBA ^0xBE61962E
{
...
BOOL func_12(var uParam0) // Hash - 0x8C89182D ^0x306838ED
{
	return func_33(&(uParam0->f_7), 9);
}

void func_13(var uParam0) // Hash - 0x887F29FE ^0x40C14014
{
	var animDict;
	var animnName;
...
void func_14(var uParam0) // Hash - 0xF7CB6D80 ^0xD94DCA00
{
	var animDict;
...
BOOL func_15() // Hash - 0x7C772DD7 ^0xEEB28EBB
{
	return IS_BIT_SET(Global_1950108.f_3, 25);
}

BOOL func_16(float fParam0, float fParam1, float fParam2) // Hash - 0x142F7A4A ^0x142F7A4A
{
	float num;
	float num2;
...
void func_17(var uParam0) // Hash - 0x9B12A959 ^0x85698023
{
	int weaponHash;
...
void func_18() // Hash - 0x9A142650 ^0xE9E53C81
{
	Global_23131.f_6 = 1;
	return;
}

void func_19(BOOL bParam0) // Hash - 0x3BC9F316 ^0x93329F82
{
	if (bParam0)
		if (func_20())
...
BOOL func_20() // Hash - 0xEDAE0057 ^0x5A1A7786
{
	return IS_BIT_SET(Global_2683862.f_2, 11);
}

void func_21() // Hash - 0x4941A993 ^0x296D04CD
{
	MISC::SET_BIT(&Global_8254, 4);
	return;
}

void func_22(int iParam0) // Hash - 0x7E11E9C ^0x544BF257
{
	if (func_28())
		return;
...
void func_23(int iParam0) // Hash - 0x4066FEF5 ^0x9787FBDA
{
	if (func_28())
		return;
...
void func_25(BOOL bParam0, BOOL bParam1) // Hash - 0xF40FC178 ^0xA6F60F17
{
	if (bParam0)
	{
		if (func_27(0))
...
BOOL func_26() // Hash - 0x8DF3D75D ^0x8DF3D75D
{
	return IS_BIT_SET(Global_1962996, 5);
}

BOOL func_27(int iParam0) // Hash - 0xE8921B44 ^0x4F063755
{
	if (iParam0 == 1)
...
BOOL func_28() // Hash - 0xC41437CB ^0xC41437CB
{
	return IS_BIT_SET(Global_1962996, 19);
}

void func_29(int iParam0) // Hash - 0x78EE7F8F ^0x8F4DB782
{
...
Vector3 func_30(var uParam0) // Hash - 0x8B39104F ^0xF54E1DAC
{
	var unk;
...
Vector3 func_31(var uParam0) // Hash - 0x420504C3 ^0xDC7693F8
{
	return uParam0->f_16[uParam0->f_9 /*14*/];
}

void func_32(int* piParam0, int iParam1) // Hash - 0xAEE04633 ^0xC5A9CA3F
{
	MISC::SET_BIT(piParam0, iParam1);
	return;
}

BOOL func_33(var uParam0, int iParam1) // Hash - 0xDDB0D9A1 ^0xDDB0D9A1
{
	return IS_BIT_SET(*uParam0, iParam1);
}

void func_34(var uParam0, char* sParam1) // Hash - 0xDBE07EBC ^0xBFCC729C
{
	if (uParam0->f_1.f_1 == 1)
	{
		if (func_4())
...
void func_35(var uParam0, char* sParam1) // Hash - 0x8975B317 ^0xEFD8197F
{
...
void func_38(var uParam0) // Hash - 0x9CDF7BA9 ^0x1CFCDB6E
{
...
int func_39(var uParam0) // Hash - 0x474CDCA0 ^0xE3AE8FD8
{
	int randomIntInRange;
...
int func_40(int iParam0) // Hash - 0xD64DC1C0 ^0xD64DC1C0
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_41(int iParam0) // Hash - 0xD55999B8 ^0x13BF8162
{
	switch (iParam0)
	{
		case 2:
...
void func_42(var uParam0) // Hash - 0x8FDF8FEB ^0xB6E3D0FD
{
	if (uParam0->f_6 != -1)
	{
		func_43(&(uParam0->f_6));
...
int func_44(int iParam0) // Hash - 0x7F0E29AD ^0x84091235
{
	int i;
...
BOOL func_46(int iParam0) // Hash - 0x32DCC68B ^0x32DCC68B
{
	if (iParam0 != 4)
		return false;
...
BOOL func_47(Player plParam0) // Hash - 0x1B551CF7 ^0xAB2412A1
{
	return func_48(plParam0) == joaat("WEAPON_MINIGUN");
}

int func_48(Player plParam0) // Hash - 0x9A12FE93 ^0x9A12FE93
{
	return Global_1894573[plParam0 /*608*/].f_585;
}

BOOL func_49(var uParam0) // Hash - 0xC4DC15CC ^0x78623F1
{
	*uParam0(!func_33(&(uParam0->f_7), 5), &uParam0->f_16[uParam0->f_9 /*14*/], uParam0->f_9);
	return StackVal || StackVal;
}

BOOL func_50(var uParam0) // Hash - 0x2ACFA271 ^0xBC9FDE1B
{
	var sizeAndPeds;
	int i;
...
BOOL func_51(var uParam0) // Hash - 0x5A66F202 ^0x4225076A
{
	int i;
	Player playerIndex;
	...
	for (i = 0; i < NETWORK::NETWORK_GET_MAX_NUM_PARTICIPANTS(); i = i + 1)
	{
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(i)))
		{
			...
			if (playerIndex != PLAYER::PLAYER_ID() && func_54(playerIndex, true, true))
...
int func_52(Player plParam0) // Hash - 0x89E9F0BB ^0x89E9F0BB
{
	if (plParam0 != func_53())
...
Player func_53() // Hash - 0x478900E4 ^0x478900E4
{
	return -1;
}

BOOL func_54(Player plParam0, BOOL bParam1, BOOL bParam2) // Hash - 0x3FF6E4CA ^0xE6B59972
{
	Player player;
...
BOOL func_55(var uParam0) // Hash - 0x5DB3FF9E ^0xC7881261
{
	return uParam0->f_7 & 31 > 0;
}

BOOL func_56(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Hash - 0x71A37C6C ^0xEC6C38BF
{
...
BOOL func_57(Ped pedParam0, var uParam1) // Hash - 0x6712051B ^0x6E11D0BF
{
	return ENTITY::IS_ENTITY_IN_ANGLED_AREA(pedParam0, uParam1->f_6.f_1, uParam1->f_6.f_4, uParam1->f_6, false, true, 0);
}

BOOL func_58(var uParam0) // Hash - 0xC9211965 ^0x65C304D3
{
	int i;
...
void func_59(var uParam0, int iParam1) // Hash - 0x4F8BE4B5 ^0x533746C9
{
	uParam0->f_13 = iParam1;
	return;
}

void func_60(int* piParam0, int iParam1) // Hash - 0xAEE04633 ^0xFF7FBF85
{
	MISC::CLEAR_BIT(piParam0, iParam1);
	return;
}

void func_61(var uParam0) // Hash - 0x7C92BF3B ^0x568F172A
{
	if (uParam0->f_13 == 6)
	{
	}
...
float func_62() // Hash - 0x22FB54B8 ^0x22FB54B8
{
	return 0.13f;
}

void func_63(var uParam0) // Hash - 0xFBA1CE25 ^0xBA375A2E
{
...
void func_64(int* piParam0, int iParam1, BOOL bParam2) // Hash - 0xCE3B1F15 ^0x328D875C
{
	int offset;
...
BOOL func_65() // Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_75693;
}

BOOL func_66() // Hash - 0x96B129E4 ^0x1555B3BB
{
...
BOOL func_69() // Hash - 0x52E21E9B ^0xD0F85E96
{
...
Hash func_70() // Hash - 0x90B5165C ^0xB8DD5DC8
{
	switch (func_72())
	{
		case 0:
...
Hash func_71() // Hash - 0x61402777 ^0xB9FAC976
{
...
int func_72() // Hash - 0x21D64237 ^0x21D64237
{
	return Global_32163;
}
...
BOOL func_74(int iParam0) // Hash - 0xA28ADBB4 ^0x6EB81E64
{
...
BOOL func_75() // Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_2694524;
}

BOOL func_76() // Hash - 0x974E48B4 ^0x974E48B4
{
	return Global_2683862.f_693;
}

BOOL func_77(Player plParam0) // Hash - 0x131B8A8 ^0x131B8A8
{
	if (plParam0 != func_53() && func_54(plParam0, true, true))
...
BOOL func_78(Player plParam0) // Hash - 0x7C71011F ^0x7C71011F
{
	if (plParam0 != func_53() && func_54(plParam0, true, true))
...
BOOL func_80(Player plParam0) // Hash - 0x20B57C9A ^0x138F48AE
{
	if (plParam0 != func_53())
		if (func_54(plParam0, true, true))
...
void func_82() // Hash - 0xD8395A21 ^0xD8395A21
{
	Global_1950092 = 0;
	func_84(&uLocal_111);
	func_83();
...
void func_83() // Hash - 0xCE5FB49E ^0x214A59D5
{
	SCRIPT::TERMINATE_THIS_THREAD();
	return;
}

void func_84(var uParam0) // Hash - 0x9537D004 ^0x18439461
{
	int localSceneFromNetworkId;
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(plParam0) && PLAYER::IS_PLAYER_PLAYING(plParam0) || bParam3 == true)
		{
			...
			if (!flag18)
			{
				...
				else if (flag14 || !func_94(PLAYER::PLAYER_ID(), 0) && !func_93())
...
BOOL func_94(Player plParam0, int iParam1) // Hash - 0x5A3B86CC ^0x2CFA58CE
{
	BOOL flag;
...
int func_95(int iParam0, BOOL bParam1) // Hash - 0x1DCD393E ^0x1DCD393E
{
	int num;
	int num2;
...
int func_96() // Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1574918;
}

BOOL func_97() // Hash - 0xEBB0E6F7 ^0x19BAFBE9
{
...
void func_98() // Hash - 0x67A21019 ^0x8AD1793C
{
...
void func_99() // Hash - 0xD105B52E ^0xD105B52E
{
...
void func_100(int iParam0, var uParam1, int iParam2, int iParam3) // Hash - 0x86CEDF1 ^0xBC3E84C1
{
	var unk;
	float num;
...
Vector3 func_101() // Hash - 0x28CC1A1D ^0x28CC1A1D
{
	return 0.5f, -0.5f, 2f;
}

Vector3 func_102(float fParam0, var uParam1, var uParam2, float fParam3) // Hash - 0x8959C4D1 ^0x8922A2E2
{
	float num;
	float num2;
	float num3;
...
float func_103(int iParam0, float fParam1) // Hash - 0x1E604EEF ^0x1E604EEF
{
	switch (iParam0)
	{
		case 1:
...
Vector3 func_104() // Hash - 0x8664ACB1 ^0x8664ACB1
{
	return -0.5f, -0.5f, 0f;
}

void func_105(int iParam0, var uParam1, var uParam2) // Hash - 0xB54FFF9 ^0xB54FFF9
{
	if (func_4())
	{
		switch (iParam0)
...
void func_106() // Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

int func_107(int iParam0, int iParam1, BOOL bParam2) // Hash - 0x75751681 ^0x9140C9A0
{
	int i;
...
BOOL func_108(BOOL bParam0) // Hash - 0x1CCCE169 ^0x1CCCE169
{
	bParam0;
