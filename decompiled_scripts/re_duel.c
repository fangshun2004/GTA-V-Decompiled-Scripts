...
{
	MISC::SET_BIT(&(Local_49[iParam0 /*5*/].f_2), bParam1);
}
...
{
	MISC::CLEAR_BIT(&iLocal_156, bParam0);
}
...
{
	MISC::SET_BIT(&iLocal_156, bParam0);
}
...
{
	MISC::CLEAR_BIT(&(Local_49[iParam0 /*5*/].f_2), bParam1);
}
