...
void __EntryFunction__()
{
	...
	iLocal_239 = 1;
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_238) && func_104(iLocal_238))
	{
	...
	while (iVar0 == 1)
	{
		...
		fVar43 = func_98(PLAYER::PLAYER_PED_ID(), iLocal_238);
		...
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		{
			if ((((PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_238) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_238)) && fVar43 < 25f) && func_90(PLAYER::PLAYER_PED_ID()) != joaat("weapon_unarmed")) && func_87(iLocal_238, PLAYER::PLAYER_PED_ID(), 1126825984, 0))
			{
				if (!func_91())
				{
					func_93();
		...
		if (func_86(iLocal_238, PLAYER::PLAYER_PED_ID(), 1) < 25f)
		{
			if (!HUD::DOES_BLIP_EXIST(iLocal_246))
			{
				func_82(&iLocal_246, &iLocal_238, 0);
			}
		}
		...
		switch (iLocal_248)
		{
			...
			case 3:
				...
				if (func_86(iLocal_238, PLAYER::PLAYER_PED_ID(), 1) < fVar40)
				{
					if (func_60() == 1)
					{
						iLocal_248 = 8;
			...
			case 8:
				...
				else if (iLocal_438 == 1)
				{
					...
					{
						func_54(Global_114849[iLocal_249], iLocal_295, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_238, &Local_370, &Local_354));
					}
				}
				break;
			...
			case 9:
				...
				if (!bVar37 && (!bVar36 || bLocal_435))
				{
					if (bLocal_503)
					{
						Global_114849[iLocal_249] = uLocal_502;
					}
					else
					{
			...
			case 13:
				...
				func_52(&sVar1);
				func_51(&uLocal_35, 0, PLAYER::PLAYER_PED_ID(), &sVar1, 0, 1);
				func_51(&uLocal_35, 3, iLocal_238, &Local_234, 0, 1);
				func_50(&cVar5);
		...
		if (((((((((((((iLocal_248 == 0 || iLocal_248 == 1) || iLocal_248 == 3) || iLocal_248 == 8) || iLocal_248 == 9) || iLocal_248 == 7) && func_86(iLocal_238, PLAYER::PLAYER_PED_ID(), 1) < 5f) && bLocal_434 == 1) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) && iVar30 == 0) && bLocal_437 == 1) && !Global_4) && func_7()) && bVar81)
		{
			if (iLocal_296 == -1)
			{
	...
	while (true)
	{
		...
		if ((ENTITY::IS_ENTITY_OCCLUDED(iLocal_238) && func_86(iLocal_238, PLAYER::PLAYER_PED_ID(), 1) > 50f) && !BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
		{
			func_115(1);
		}
		SYSTEM::WAIT(0);
...
{
	func_10();
	if (func_104(iLocal_238) && func_104(PLAYER::PLAYER_PED_ID()))
	{
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_238, false);
...
void func_18()
{
	...
	{
		if (func_22(Global_114904.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_21(PLAYER::PLAYER_PED_ID());
			if (func_20(iVar0) && (!func_19(14) || Global_113852))
			{
				if (Global_114904.f_2370.f_539.f_4321 != iVar0 && func_20(Global_114904.f_2370.f_539.f_4321))
				{
...
void func_56()
{
	...
	func_59(Global_114849[iLocal_249] + 1, &sVar0, &Var8);
...
{
	return func_113(Global_114904.f_20124, uParam0);
}
