...
void main() // Position - 0x0 Hash - 0x5D84F89F ^0x5D84F89F
{
	...
	iLocal_455 = 49;
	iLocal_456 = 64;
	uLocal_242 = { uScriptParam_508.f_1[0 /*3*/] };
	func_119();
	...
	while (num == 1)
	{
		...
		{
			if (!func_90() && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(-892862129) == 0)
			{
				func_109();
		...
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		{
			if (PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), pedLocal_240) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), pedLocal_240) && num6 < 25f && func_89(PLAYER::PLAYER_PED_ID()) != -1569615261 && func_86(pedLocal_240, PLAYER::PLAYER_PED_ID(), 1126825984, 0))
			{
				if (!func_90())
				{
					func_92();
		...
		flag6 = SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(1974937116) > 0;
		!flag6;
...
void func_2(var uParam0) // Position - 0x1204 Hash - 0xFE5630E8 ^0xFE5630E8
{
	int num;
...
void func_6(var uParam0, int iParam1, char* sParam2, int iParam3, const char* sParam4, int iParam5, int iParam6) // Position - 0x13A5 Hash - 0xC67F23A2 ^0xEFF6309F
{
	int i;
...
int func_17() // Position - 0x1672 Hash - 0x3C5423D7 ^0x3C5423D7
{
	func_18();
...
BOOL func_20(int iParam0) // Position - 0x1796 Hash - 0x8907F004 ^0x8907F004
{
	return iParam0 < 3;
}

int func_21(Ped pedParam0) // Position - 0x17A2 Hash - 0xAC4E9801 ^0xB379A75F
{
	int i;
	Hash entityModel;
...
Hash func_22(int iParam0) // Position - 0x17DF Hash - 0xADCB9755 ^0xADCB9755
{
	if (func_20(iParam0))
...
Hash func_23(int iParam0) // Position - 0x1804 Hash - 0xE4CEEC2C ^0xE4CEEC2C
{
...
BOOL func_34(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x1B81 Hash - 0x384540C1 ^0x384540C1
{
...
Player func_40() // Position - 0x1F5F Hash - 0x478900E4 ^0x478900E4
{
	return -1;
}
...
void func_45() // Position - 0x20ED Hash - 0x98476CE1 ^0x250FEB7C
{
	if (func_19(14))
	{
...
void func_48(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x221D Hash - 0xC6B752B2 ^0xC6B752B2
{
...
void func_50(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x22AE Hash - 0x6C235EE0 ^0x9E57F206
{
...
void func_53(int iParam0, int iParam1, float fParam2) // Position - 0x2389 Hash - 0x5912C248 ^0x4B30201
{
	if (iParam0 == 3)
	{
		...
		{
			obLocal_448 = OBJECT::CREATE_OBJECT(-1038739674, ENTITY::GET_ENTITY_COORDS(pedLocal_240, true), true, true, false);
...
BOOL func_62() // Position - 0x25D5 Hash - 0x152DA0B2 ^0x220E93E9
{
...
BOOL func_103(Ped pedParam0) // Position - 0x31F2 Hash - 0x3D210083 ^0xF7E7C389
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
		if (!ENTITY::IS_ENTITY_DEAD(pedParam0, false))
			return true;
