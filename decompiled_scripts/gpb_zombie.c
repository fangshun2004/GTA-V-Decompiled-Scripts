...
void main() // Hash - 0x5D84F89F ^0x5D84F89F
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(pedLocal_240) && func_103(pedLocal_240))
	{
	...
	while (num == 1)
	{
		...
		switch (iLocal_250)
		{
			...
			case 13:
				...
				func_51(&unk);
				func_50(&uLocal_37, 0, PLAYER::PLAYER_PED_ID(), &unk, 0, 1);
				func_50(&uLocal_37, 3, pedLocal_240, &uLocal_236, 0, 1);
				func_49(&unk5);
			
				if (func_34(&uLocal_37, &uLocal_304, &unk5, 3, 0, 0, 0))
					iLocal_250 = 14;
			...
			case 10:
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED(&uLocal_404))
				{
					if (bLocal_437)
						num4 = 1;
					else if (func_34(&uLocal_37, &uLocal_304, &unk9, 3, 0, 0, 0))
						num4 = 1;
...
void func_2(var uParam0) // Hash - 0xFE5630E8 ^0xFE5630E8
{
	int num;
...
int func_3(int iParam0) // Hash - 0x7F0E29AD ^0x84091235
{
	int i;
...
BOOL func_4(int iParam0, BOOL bParam1) // Hash - 0xE8E8EFB4 ^0x98461D05
{
	int num;
...
BOOL func_5(int iParam0) // Hash - 0xE8921B44 ^0x4F063755
{
	if (iParam0 == 1)
...
void func_6(var uParam0, int iParam1, char* sParam2, int iParam3, const char* sParam4, int iParam5, int iParam6) // Hash - 0xC67F23A2 ^0xEFF6309F
{
	int i;
...
BOOL func_7() // Hash - 0x7FC26EC8 ^0x7FC26EC8
{
	return !func_8();
}

BOOL func_8() // Hash - 0x357D3B51 ^0x357D3B51
{
...
void func_9() // Hash - 0xD9D84A4B ^0xFCBF3CCF
{
	func_10();

	if (func_103(pedLocal_240) && func_103(PLAYER::PLAYER_PED_ID()))
	{
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(pedLocal_240, false);
...
void func_10() // Hash - 0x63765CAF ^0xEB8E13BF
{
	if (bLocal_449)
	{
		if (func_8())
...
void func_11() // Hash - 0xD5E5FC77 ^0xD6C09E94
{
	func_10();
...
void func_12() // Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_13(var uParam0, int iParam1) // Hash - 0xD18CB130 ^0xA0F4C6FD
{
...
void func_14() // Hash - 0xC536DD5 ^0xC536DD5
{
	Global_20591 = 0;
	func_15();
	return;
...
void func_15() // Hash - 0xE32CF1EF ^0xB9A7BEB2
{
...
int func_16() // Hash - 0xD5EF1690 ^0xD5EF1690
{
	int num;
...
int func_17() // Hash - 0x3C5423D7 ^0x3C5423D7
{
	func_18();
	return Global_113648.f_2365.f_539.f_4321;
}

void func_18() // Hash - 0xD1F2D853 ^0xF9F5FD4D
{
	int num;
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_22(Global_113648.f_2365.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_20(num) && !func_19(14) || Global_112599)
			{
...
BOOL func_19(int iParam0) // Hash - 0x937D8816 ^0x937D8816
{
...
void func_24(char* sParam0) // Hash - 0x9923C7DF ^0x6647A95
{
	var unk;
...
void func_25(char* sParam0) // Hash - 0x2C5C83C1 ^0x30D0C3C4
{
	int num;
...
void func_26(char* sParam0) // Hash - 0x3372085F ^0x6F5B90E3
{
	int num;
...
void func_27(int iParam0, char* sParam1) // Hash - 0xC4958D46 ^0x1F7ADE34
{
	switch (iParam0)
	{
		case 0:
...
void func_28(char* sParam0) // Hash - 0x3018B517 ^0xC0233A2E
{
	var unk;
...
void func_29(char* sParam0) // Hash - 0x79E2B8C7 ^0x4B4BA468
{
	var unk;
	...
	*sParam0 = { unk };
	...
	TEXT_LABEL_APPEND_INT(sParam0, uLocal_299[func_17()], 16);
	return;
}

void func_30(char* sParam0) // Hash - 0x3BD51041 ^0x2F4923A2
{
...
void func_31() // Hash - 0x8F1EFECE ^0xB07F52D9
{
	iLocal_254 = MISC::GET_RANDOM_INT_IN_RANGE(0, iLocal_253);
	return;
}

void func_32(char* sParam0) // Hash - 0xE431A142 ^0x7D608AC5
{
	int num;
...
void func_33() // Hash - 0xB39DC0B0 ^0xB39DC0B0
{
	if (!func_63())
		func_102(1, true);
...
BOOL func_34(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Hash - 0x384540C1 ^0x384540C1
{
...
int func_35(char* sParam0, int iParam1, BOOL bParam2) // Hash - 0x77297D51 ^0x40DC584A
{
	Global_21726 = 0;
...
void func_36() // Hash - 0xF42BEB19 ^0xA29557DA
{
	if (!func_37())
		return;
...
BOOL func_37() // Hash - 0x7B74B45F ^0xCE052A5D
{
...
BOOL func_38(Player plParam0) // Hash - 0x6E46BC72 ^0x6E46BC72
{
	return func_39(plParam0, 20);
}

BOOL func_39(Player plParam0, int iParam1) // Hash - 0x7CD5054C ^0x870BEA81
{
	return IS_BIT_SET(Global_1894573[plParam0 /*608*/].f_10.f_4, iParam1);
}

Player func_40() // Hash - 0x478900E4 ^0x478900E4
{
	return -1;
}

void func_41() // Hash - 0xE1F0C158 ^0xB5D2F635
{
	int i;
...
void func_42() // Hash - 0xCD8A4D28 ^0xCD8A4D28
{
...
BOOL func_43() // Hash - 0xD140D54A ^0xE638D98F
{
...
BOOL func_44() // Hash - 0x9A999369 ^0x4033F7BF
{
	int num;
	int weaponHash;
...
void func_45() // Hash - 0x98476CE1 ^0x250FEB7C
{
	if (func_19(14))
	{
...
void func_46() // Hash - 0x719867DD ^0xB196B20A
{
	int i;
...
BOOL func_47(int iParam0, int iParam1) // Hash - 0xA14C4D3F ^0xA6034F77
{
	switch (iParam0)
	{
		case 5:
...
void func_48(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Hash - 0xC6B752B2 ^0xC6B752B2
{
...
void func_49(var uParam0) // Hash - 0x823AD68D ^0x823AD68D
{
	int num;
...
void func_50(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Hash - 0x6C235EE0 ^0x9E57F206
{
...
void func_51(char* sParam0) // Hash - 0xB19D680C ^0x8A88A7C3
{
	int num;
...
void func_52(int iParam0) // Hash - 0xB22D5C46 ^0xB22D5C46
{
	return;
}

void func_53(int iParam0, int iParam1, float fParam2) // Hash - 0x5912C248 ^0x4B30201
{
	if (iParam0 == 3)
	{
...
void func_54() // Hash - 0x9E10B2D8 ^0xFD86B393
{
	STREAMING::REMOVE_ANIM_DICT(&uLocal_388);
	return;
}

void func_55() // Hash - 0xA2D696C2 ^0x6CFE4BE
{
	var unk;
	var animationName;
...
void func_56(int iParam0) // Hash - 0xB22D5C46 ^0xB22D5C46
{
	return;
}

void func_57(const char* sParam0) // Hash - 0xF54A2398 ^0xC5887C42
{
	MISC::ARE_STRINGS_EQUAL(sParam0, sParam0);
	return;
}

void func_58(int iParam0, char* sParam1, char* sParam2) // Hash - 0xA1B3AA65 ^0xC96F6878
{
...
int func_59() // Hash - 0x41DAEEE1 ^0x41DAEEE1
{
	var unk;
	int num;
	...
	if (bLocal_437)
		...
		num = func_34(&uLocal_37, &uLocal_304, &unk, 3, 0, 0, 0);

	uLocal_500 = { unk };
	return num;
}

BOOL func_60() // Hash - 0xD56328D2 ^0xD56328D2
{
	return Global_100733.f_387 > 0;
}

BOOL func_61() // Hash - 0x3584B5B8 ^0x3906E6CB
{
...
BOOL func_62() // Hash - 0x152DA0B2 ^0x220E93E9
{
...
BOOL func_63() // Hash - 0xF0354A0B ^0xA4E2A87D
{
...
void func_64() // Hash - 0xF29E5C2B ^0x5C175570
{
	var animDict;
...
void func_65(char* sParam0) // Hash - 0xD55EAE22 ^0x21DEE7D0
{
	var unk;
...
void func_66(char* sParam0) // Hash - 0xB591EA76 ^0xB591EA76
{
	func_27(iLocal_297, sParam0);
	return;
}

void func_67(char* sParam0) // Hash - 0x217F514E ^0x99A1DD2E
{
...
void func_68(Hash hParam0, BOOL bParam1) // Hash - 0xA91A0121 ^0xA91A0121
{
	int num;
...
void func_69(int iParam0, BOOL bParam1) // Hash - 0x588AF130 ^0xCF9D0CCB
{
	int offset;
		...
		if (func_78(iParam0))
		{
			if (!func_76(iParam0))
			{
				...
				if (!bParam1)
				{
					...
					if (!func_73(70))
						func_70(_("Unique characters become available in Rockstar Editor's 'Director Mode' as you meet them around Los Santos."), 2, 0, 20000, 10000, 7, 0, 210, 0);
				}
			}
		}
	}
...
void func_70(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Hash - 0xFA14711 ^0xFA14711
{
	func_71(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
	return;
}

void func_71(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Hash - 0x2DEFD20B ^0x2F7188BE
{
	int i;
...
void func_72() // Hash - 0xCF8881D1 ^0x40507183
{
	int i;
...
BOOL func_73(int iParam0) // Hash - 0x3F44A899 ^0x7041C53
{
	int num;
	int i;
...
void func_74(char* sParam0) // Hash - 0x2E18739A ^0x19C6F65C
{
...
char* func_75(int iParam0) // Hash - 0xE6862179 ^0x3C80BEA6
{
	switch (iParam0)
	{
		case 0:
		...
		case 10:
			return _("Pamela Drake");
	
		case 11:
			return _("Impotent Rage");
...
BOOL func_76(int iParam0) // Hash - 0xFC3F2DA7 ^0x69CE7F6B
{
	if (func_78(iParam0))
...
BOOL func_77(int iParam0) // Hash - 0x8A92B8AA ^0xFC025D06
{
	int num;
...
BOOL func_78(int iParam0) // Hash - 0xC941AB77 ^0xC941AB77
{
...
int func_79(Hash hParam0) // Hash - 0xEE599357 ^0xEE599357
{
	switch (hParam0)
	{
...
void func_80(Blip* pblParam0) // Hash - 0x2C2591EC ^0x5D798EF3
{
	if (iLocal_447 == 1)
...
void func_81(var uParam0, var uParam1, BOOL bParam2) // Hash - 0x669F0ED7 ^0x75D79A15
{
	if (iLocal_447 == 1)
	{
...
Blip func_82(Entity eParam0, BOOL bParam1, int iParam2) // Hash - 0xA714218A ^0xAD0F82BD
{
	Blip blip;
...
Blip func_83(Entity eParam0, BOOL bParam1, BOOL bParam2) // Hash - 0x2E5A72B ^0x64F26CC0
{
	Blip blip;
...
var func_84(BOOL bParam0, var uParam1, var uParam2) // Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
float func_85(Ped pedParam0, Ped pedParam1, BOOL bParam2) // Hash - 0x7B2C17A2 ^0xDF922C6D
{
	Vector3 entityCoords;
...
BOOL func_86(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Hash - 0x6EF1707D ^0x8C069CF9
{
	var unk;
...
float func_87(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Hash - 0x596BEA29 ^0x5FBCDBE5
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_88(float fParam0, var uParam1, var uParam2) // Hash - 0xFB6A39D2 ^0x80C9C759
{
	float num;
	float num2;
...
int func_89(Ped pedParam0) // Hash - 0xA860C4B2 ^0x4F46EE3F
{
	int weaponHash;
...
BOOL func_90() // Hash - 0x25DC971D ^0x25DC971D
{
...
void func_91() // Hash - 0x367752C5 ^0xC1A6862
{
	if (iLocal_245 != -1)
	{
...
void func_93() // Hash - 0xF6D04E68 ^0x80AE5309
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22736 = 0;
...
BOOL func_94() // Hash - 0xBA2FE0DB ^0xBA2FE0DB
{
	return func_8();
}

void func_95() // Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_96() // Hash - 0x842B90EB ^0x842B90EB
{
...
float func_97(Ped pedParam0, Ped pedParam1) // Hash - 0xB4D52F0E ^0xB4D52F0E
{
	return func_85(pedParam0, pedParam1, true);
}

void func_98(int iParam0) // Hash - 0xAEE12E46 ^0xAEE12E46
{
	int num;
...
int func_99(int iParam0) // Hash - 0xC7A76CB1 ^0xC7A76CB1
{
	int i;
	int num;
...
int func_100(int iParam0, BOOL bParam1) // Hash - 0x90D8E204 ^0x90D8E204
{
	if (!func_78(iParam0))
	{
		!bParam1;
...
void func_101(int iParam0, int iParam1) // Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

void func_102(int iParam0, BOOL bParam1) // Hash - 0x929713B9 ^0x575FC5C6
{
	if (iParam0 == 1)
		TASK::TASK_PLAY_ANIM(pedLocal_240, &uLocal_324, &uLocal_218, 2f, -2f, -1, 0, 0, false, false, false);
	else
...
BOOL func_103(Ped pedParam0) // Hash - 0x3D210083 ^0xF7E7C389
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
		if (!ENTITY::IS_ENTITY_DEAD(pedParam0, false))
			return true;
...
void func_104() // Hash - 0xD8C6DE12 ^0xD8C6DE12
{
	func_105();
	return;
}

void func_105() // Hash - 0x4FC79AAC ^0xE93FBDFA
{
...
void func_106() // Hash - 0x5D537092 ^0x4803EB37
{
	...
	bLocal_436 = !Global_3;
	iLocal_252 = 8;
	sLocal_303 = _("Press ~INPUT_CONTEXT~ to talk to the Zombie.");
...
BOOL func_108() // Hash - 0xC20DBA70 ^0xAC4006FB
{
	if (Global_97603 != -1)
...
BOOL func_109() // Hash - 0x1CB029D8 ^0x1CB029D8
{
	if (Global_43257 == 15)
		return false;
...
BOOL func_110() // Hash - 0xFD255207 ^0xFD255207
{
	return true;
}

BOOL func_111(int iParam0) // Hash - 0xC86BC762 ^0xC86BC762
{
	return func_112(Global_113648.f_20119, iParam0);
}

BOOL func_112(int iParam0, int iParam1) // Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

int func_113(const char* sParam0) // Hash - 0xD5121E5F ^0x63B46402
{
...
void func_114(int iParam0) // Hash - 0x8B2883F3 ^0x111D5E85
{
	var string1;
...
void func_115(Blip* pblParam0) // Hash - 0x4C359FE5 ^0xBAF5111C
{
	if (HUD::DOES_BLIP_EXIST(*pblParam0))
	{
...
struct<6> func_116() // Hash - 0xB37EF8EF ^0xB37EF8EF
{
	var unk;
...
void func_117() // Hash - 0xD8C6DE12 ^0xD8C6DE12
{
	func_118();
	return;
}

void func_118() // Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_119() // Hash - 0x66F88FF ^0x478E9B29
{
	if (iLocal_245 == -1)
