...
void func_19(bool bParam0)
{
	...
	while (iVar0 <= 26)
	{
		func_24(&(Local_107[iVar0 /*178*/]), iVar0);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 29)
	{
		func_23(&(Local_4915[iVar0 /*24*/]), iVar0);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 23)
	{
		func_22(&(Local_5637[iVar0 /*24*/]), iVar0);
		iVar0++;
	}
