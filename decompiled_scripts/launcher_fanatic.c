...
void __EntryFunction__()
{
	...
	if (!func_284(&iVar64, &Var0, Var61, 1f))
	{
		func_283();
	...
	while (true)
	{
		...
		func_219(Var0.f_0);
		func_212(&iLocal_92, &(Var0.f_9), Var61);
		if (iLocal_93 == 0)
		{
			if (Var0.f_0 == 22)
			{
		...
		if (Var0.f_0 == 21)
		{
			func_208(&Var0, Var61, "FAN1AU", "FAN1_AMB", 3, "MARYANN", 1500);
		}
		else if (Var0.f_0 == 22)
		{
			func_203(&Var0, Var61, "FAN2AU", "FAN2_AMB", 3, "MARYANN", 5000, 1101004800);
		}
		else if (Var0.f_0 == 23)
		{
			if (iLocal_94 == 0)
			{
				if (func_208(&Var0, Var61, "FAN3AUD", "FAN3_AMB", 3, "MARYANN", 50))
				{
					iLocal_94 = 1;
				}
			}
...
int func_171(int iParam0)
{
	...
	iVar0 = func_173(&(Global_113991[iParam0 /*10*/].f_9), 1, 4, 0, 0);
	if (!iVar0 == 1)
	{
		return 0;
	}
	...
	switch (iParam0->f_16)
	{
		case 0:
			if (*iParam0 == 12)
			{
				...
				else if (func_211(iParam0->f_28[0]))
				{
					if (func_187(iParam0))
					{
						if (func_191(2))
		...
		case 5:
			if (*iParam0 == 6)
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
				{
					if (func_211(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)))
					{
...
void func_200(int iParam0)
{
	...
	if ((MISC::GET_GAME_TIMER() - iLocal_95) >= 900)
	{
		if (func_211(iParam0->f_28[0]))
		{
			if (!func_157())
			{
				func_201(iParam0->f_28[0], "PUSHUP_BREATH", "MARYANN", 6, 0);
				iLocal_95 = MISC::GET_GAME_TIMER();
			}
		}
	}
...
int func_203(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_211(PLAYER::PLAYER_PED_ID()) && func_211(iParam0->f_28[0])) && !func_157()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_207(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
int func_208(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)
{
	var uVar0;
	...
	if (func_191(2))
	{
		if (!func_157())
		{
			if (((func_211(PLAYER::PLAYER_PED_ID()) && func_211(iParam0->f_28[0])) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_207(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f)
			{
				uVar0 = 16;
				func_206(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
				func_204(&uVar0, cParam4, sParam5, 7, 0, 0);
		...
		else if (func_209(sParam5))
		{
			...
			{
				if (func_207(PLAYER::PLAYER_PED_ID(), Param1, 1) >= 20f)
				{
					func_155();
				}
			}
...
void func_212(int iParam0, char* sParam1, struct<3> Param2)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
{
	if ((func_256() && Global_102429.f_11 == 6) && iParam0 == func_179(&(Global_102429.f_3), 0))
	{
		return 1;
	}
	return 0;
...
void func_266(var uParam0, char* sParam1, char* sParam2, int iParam3)
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
void func_271(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)
{
	func_272(iParam0);
