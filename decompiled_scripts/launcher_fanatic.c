...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		func_219(Var0.f_0);
		func_212(&iLocal_111, &(Var0.f_9), Var61);
		if (iLocal_112 == 0)
		{
			if (Var0.f_0 == 22)
			{
...
int func_171(int iParam0)
{
	...
	iVar0 = func_173(&(Global_114050[iParam0 /*10*/].f_9), 1, 4, 0, 0);
	if (!iVar0 == 1)
	{
		return 0;
	}
...
bool func_234(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_235(&(Local_54[iVar4 /*4*/]), Var1, iParam1, &(Local_54[iVar4 /*4*/].f_3), iParam0, iParam5);
...
{
	if ((func_256() && Global_102486.f_11 == 6) && iParam0 == func_179(&(Global_102486.f_3), 0))
	{
		return 1;
	}
	return 0;
