...
void func_17(char* sParam0) // Hash - 0x9BA5CAFA ^0x9BA5CAFA
{
	TEXT_LABEL_ASSIGN_STRING(sParam0, "", 64);
	return;
}

void func_18(char* sParam0) // Hash - 0x3372085F ^0x8925731E
{
	int num;
...
void func_19(int iParam0, char* sParam1) // Hash - 0xC4958D46 ^0x418626B7
{
	switch (iParam0)
	{
		case 0:
...
void func_20(char* sParam0) // Hash - 0x3018B517 ^0x7A85BB55
{
	var unk;
...
void func_29(char* sParam0) // Hash - 0x3BD51041 ^0xDD7B2B9E
{
...
void func_31(char* sParam0) // Hash - 0xE431A142 ^0x4DB453CD
{
	int num;
...
void func_50(char* sParam0) // Hash - 0xB19D680C ^0xBE3C8E62
{
	int num;
...
void func_57(int iParam0, char* sParam1, char* sParam2) // Hash - 0xA1B3AA65 ^0x61BF5C00
{
...
void func_64(char* sParam0) // Hash - 0xD55EAE22 ^0x3565B2D0
{
	var unk;
...
void func_66(char* sParam0) // Hash - 0x217F514E ^0xD1385ABF
{
...
void func_73(char* sParam0) // Hash - 0x2E18739A ^0xD10C56DD
{
...
char* func_74(int iParam0) // Hash - 0xE6862179 ^0x251791A2
{
	switch (iParam0)
	{
		case 0:
...
void func_94() // Hash - 0xF3561679 ^0x84ABF17
{
	func_49(&uLocal_37, 3, pedLocal_240, &uLocal_236, 0, 1);
...
void func_105() // Hash - 0x2326C92C ^0x4AA1FB68
{
...
int func_112(const char* sParam0) // Hash - 0xD5121E5F ^0xC6E59C79
{
