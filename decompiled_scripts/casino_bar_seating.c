...
BOOL func_80(Player plParam0) // Hash - 0xB5AF000F ^0x9424D0A9
{
	if (plParam0 != func_53())
...
void func_82() // Hash - 0x43275282 ^0x43275282
{
	func_84(&uLocal_111);
	func_83();
	return;
...
void func_105(int iParam0, var uParam1, var uParam2) // Hash - 0x81D21288 ^0x81D21288
{
	if (func_4())
	{
		switch (iParam0)
