...
void func_9() // Hash - 0xE4A614CB ^0x14C0A70E
{
...
int func_15() // Hash - 0x98B7EFDD ^0x98B7EFDD
{
	return 0;
}

void func_16(char* sParam0) // Hash - 0x9923C7DF ^0x6647A95
{
	var unk;
...
void func_17(char* sParam0) // Hash - 0x2B34E328 ^0xBC379712
{
	switch (iLocal_254)
	{
		case 0:
...
void func_18(char* sParam0) // Hash - 0x3372085F ^0x8272DEC8
{
	int num;
...
void func_19(int iParam0, char* sParam1) // Hash - 0xC4958D46 ^0x28EEA2F3
{
	switch (iParam0)
	{
		case 0:
...
void func_20(char* sParam0) // Hash - 0x3018B517 ^0xDBF83189
{
	var unk;
...
void func_21(char* sParam0) // Hash - 0x79E2B8C7 ^0x4B4BA468
{
	var unk;
	...
	*sParam0 = { unk };
	...
	TEXT_LABEL_APPEND_INT(sParam0, uLocal_299[func_22()], 16);
	return;
}
...
void func_29(char* sParam0) // Hash - 0x3BD51041 ^0xA65348B4
{
...
void func_31(char* sParam0) // Hash - 0xE431A142 ^0x97CC28F1
{
	int num;
...
void func_50(char* sParam0) // Hash - 0xB19D680C ^0x9E5EB5F6
{
	int num;
...
void func_57(int iParam0, char* sParam1, char* sParam2) // Hash - 0xA1B3AA65 ^0xBE7E2D8D
{
...
void func_64(char* sParam0) // Hash - 0xD55EAE22 ^0x4E6CC41A
{
	var unk;
...
void func_66(char* sParam0) // Hash - 0x217F514E ^0x5EC9CA22
{
...
void func_73(char* sParam0) // Hash - 0x2E18739A ^0xB1697A9A
{
...
char* func_74(int iParam0) // Hash - 0xE6862179 ^0x904CD8BF
{
	switch (iParam0)
	{
		case 0:
...
void func_104() // Hash - 0xA3C194E0 ^0x76E43C6
{
	if (!ENTITY::IS_ENTITY_DEAD(pedLocal_240, false))
...
void func_105() // Hash - 0x37CB6BB2 ^0x2159366A
{
	...
	iLocal_252 = 15;
	iLocal_253 = 6;
	sLocal_303 = _("Press ~INPUT_CONTEXT~ to talk to Impotent Rage.");
...
int func_112(const char* sParam0) // Hash - 0xD5121E5F ^0x1271C3AE
{
