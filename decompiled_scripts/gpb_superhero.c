...
int func_22() // Position - 0x1911 Hash - 0x3C5423D7 ^0x3C5423D7
{
	func_23();
...
BOOL func_25(int iParam0) // Position - 0x1A35 Hash - 0x8907F004 ^0x8907F004
{
	return iParam0 < 3;
}

int func_26(Ped pedParam0) // Position - 0x1A41 Hash - 0xAC4E9801 ^0xB379A75F
{
	int i;
	Hash entityModel;
...
Hash func_27(int iParam0) // Position - 0x1A7E Hash - 0xADCB9755 ^0xADCB9755
{
	if (func_25(iParam0))
...
Hash func_28(int iParam0) // Position - 0x1AA3 Hash - 0xE4CEEC2C ^0xE4CEEC2C
{
...
BOOL func_33(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x1B50 Hash - 0x384540C1 ^0x384540C1
{
...
Player func_39() // Position - 0x1F2E Hash - 0x478900E4 ^0x478900E4
{
	return -1;
}
...
void func_44() // Position - 0x20BC Hash - 0x98476CE1 ^0x250FEB7C
{
	if (func_24(14))
	{
...
void func_47(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x21EC Hash - 0xC6B752B2 ^0xC6B752B2
{
...
void func_49(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x227D Hash - 0x6C235EE0 ^0x9E57F206
{
...
BOOL func_61() // Position - 0x258E Hash - 0x152DA0B2 ^0x220E93E9
{
...
BOOL func_102(Ped pedParam0) // Position - 0x3198 Hash - 0x3D210083 ^0xF7E7C389
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
		if (!ENTITY::IS_ENTITY_DEAD(pedParam0, false))
			return true;
