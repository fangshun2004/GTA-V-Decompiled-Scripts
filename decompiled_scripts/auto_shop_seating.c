...
BOOL func_75(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Hash - 0x71A37C6C ^0xEC6C38BF
{
...
BOOL func_85() // Hash - 0x96B129E4 ^0x1555B3BB
{
...
BOOL func_97(Player plParam0) // Hash - 0xA4C8B8D7 ^0xE5015FA1
{
	if (plParam0 != func_72())
...
int func_98(int iParam0) // Hash - 0xEE599357 ^0xEE599357
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_99() // Hash - 0x6774E22C ^0x90A4DD76
{
...
void func_100() // Hash - 0xD105B52E ^0xD105B52E
{
...
void func_101(int iParam0, var uParam1, int iParam2, int iParam3) // Hash - 0x86CEDF1 ^0xBC3E84C1
{
	var unk;
	float num;
...
Vector3 func_102() // Hash - 0x28CC1A1D ^0x28CC1A1D
{
	return 0.5f, -0.5f, 2f;
}

Vector3 func_103() // Hash - 0x8664ACB1 ^0x8664ACB1
{
	return -0.5f, -0.5f, 0f;
}

Vector3 func_104() // Hash - 0x4D2B2292 ^0x4D2B2292
{
	return 1f, -0.5f, 2f;
}
...
Vector3 func_107() // Hash - 0xB118B565 ^0xB118B565
{
	return -1f, -0.5f, 0f;
}
