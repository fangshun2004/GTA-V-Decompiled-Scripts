...
void func_9() // Hash - 0x76827BF3 ^0xB4B5946D
{
...
int func_15() // Hash - 0xAB884E0A ^0xAB884E0A
{
	int num;
...
void func_24(char* sParam0) // Hash - 0x2C5C83C1 ^0xC74751F
{
	int num;
...
void func_25(char* sParam0) // Hash - 0x3372085F ^0xE5B13BEF
{
	int num;
...
void func_26(int iParam0, char* sParam1) // Hash - 0xC4958D46 ^0x3A46861B
{
	switch (iParam0)
	{
		case 0:
...
void func_27(char* sParam0) // Hash - 0x3018B517 ^0xE1F13EA3
{
	var unk;
...
void func_29(char* sParam0) // Hash - 0x3BD51041 ^0x5BE20DEE
{
...
void func_31(char* sParam0) // Hash - 0xE431A142 ^0x6F28BB3B
{
	int num;
...
void func_50(char* sParam0) // Hash - 0xB19D680C ^0x96B4B562
{
	int num;
...
void func_57(int iParam0, char* sParam1, char* sParam2) // Hash - 0xA1B3AA65 ^0x18DBFE89
{
...
void func_64(char* sParam0) // Hash - 0xD55EAE22 ^0xFA18F5EE
{
	var unk;
...
void func_66(char* sParam0) // Hash - 0x217F514E ^0x9D57AAA6
{
...
void func_73(char* sParam0) // Hash - 0x2E18739A ^0x7C60066
{
...
char* func_74(int iParam0) // Hash - 0xE6862179 ^0x788E8CE2
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_93() // Hash - 0xFD255207 ^0xFD255207
{
	return true;
}
...
void func_104() // Hash - 0xCE5FEB21 ^0x69E6EA4A
{
...
void func_105() // Hash - 0x2AAA2977 ^0xCAB5FF78
{
	...
	bLocal_436 = !Global_3;
	iLocal_252 = 7;
	sLocal_303 = _("Press ~INPUT_CONTEXT~ to talk to Jane.");
...
BOOL func_107() // Hash - 0xC20DBA70 ^0xAC4006FB
{
	if (Global_97603 != -1)
...
BOOL func_108() // Hash - 0x1CB029D8 ^0x1CB029D8
{
	if (Global_43257 == 15)
		return false;
...
BOOL func_109() // Hash - 0x12F43F2C ^0x12F43F2C
{
	if (func_110(62))
		return true;
...
BOOL func_110(int iParam0) // Hash - 0x35F9F9C ^0x35F9F9C
{
...
int func_113(const char* sParam0) // Hash - 0xD5121E5F ^0xAE71861D
{
...
void func_118() // Hash - 0xF81B7039 ^0x63524292
{
	if (iLocal_449 == 1)
