...
void func_9()
{
	...
	{
		PED::SET_PED_MOVEMENT_CLIPSET(iLocal_257, sLocal_465, 0.25f);
	}
}
...
void func_106()
{
	iLocal_53 = joaat("u_f_y_comjane");
	StringCopy(&Local_251, "PBJA", 8);
	StringCopy(&Local_253, "JANE", 16);
	StringCopy(&Local_219, "Special_Ped@jane", 64);
	StringCopy(&Local_235, "Base", 64);
	bLocal_453 = !Global_4;
	iLocal_269 = 7;
	sLocal_320 = "PBJA_INTERACT";
	StringCopy(&Local_329, "PBJA_CONV_GM", 16);
	StringCopy(&Local_333, "PBJA_CONV_GT", 16);
	StringCopy(&Local_337, "PBJA_CONV_GF", 16);
	StringCopy(&cLocal_341, "special_ped@jane@base", 64);
	StringCopy(&cLocal_357, "special_ped@jane@intro", 64);
