				...
				switch (Global_97125)
				{
					case 0:
						if (!Global_97124)
						{
							...
							AUDIO::SET_CUSTOM_RADIO_TRACK_LIST(_("Los Santos Rock Radio"), "END_CREDITS_KILL_TREVOR", true);
						}
						break;
					...
					case 1:
						if (!Global_97124)
						{
							...
							AUDIO::SET_MOBILE_PHONE_RADIO_STATE(true);
							AUDIO::SET_RADIO_TO_STATION_NAME(_("Los Santos Rock Radio"));
							AUDIO::SET_CUSTOM_RADIO_TRACK_LIST(_("Los Santos Rock Radio"), "END_CREDITS_KILL_MICHAEL", true);
						}
						break;
					...
					case 2:
						if (!Global_97124)
						{
							...
							AUDIO::SET_MOBILE_PHONE_RADIO_STATE(true);
							AUDIO::SET_RADIO_TO_STATION_NAME(_("Los Santos Rock Radio"));
							AUDIO::SET_CUSTOM_RADIO_TRACK_LIST(_("Los Santos Rock Radio"), "END_CREDITS_SAVE_MICHAEL_TREVOR", true);
						}
						break;
				}
...
void func_40(BOOL bParam0, BOOL bParam1) // Position - 0x42A9 Hash - 0x56032C5B ^0x18DFBA48
{
	...
	if (bParam0)
	{
		if (func_43(false) && Global_78805.f_1 == 1 && func_42(Global_78805))
		{
		}
		else
		{
	...
	if (Global_113648.f_9087 || func_43(false))
	{
		num = func_41();
