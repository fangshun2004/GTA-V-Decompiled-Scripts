...
BOOL func_2(Any* panParam0) // Hash - 0x7257D4F0 ^0x7257D4F0
{
	const char* str;
	var unk32;
...
struct<2> func_9(int iParam0) // Hash - 0x323E6781 ^0x25F8F6EA
{
	var unk;
	var unk3;
...
void func_19() // Hash - 0xF5CA4074 ^0x64A2C168
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("MISSION_STAT_WATCHER")) > 0)
	{
		if (func_20())
...
void func_23(char* sParam0, int iParam1, Ped pedParam2) // Hash - 0xB566D143 ^0x30F5E0BA
{
...
BOOL func_44(int iParam0, int iParam1, char* sParam2, var uParam3) // Hash - 0x8E372EAA ^0xD20092AD
{
...
void func_109(int iParam0) // Hash - 0x35AC36F2 ^0x545FA7BC
{
	int num;
	var textLabel;
...
void func_112(char* sParam0, Any anParam1, int iParam2) // Hash - 0x817AB180 ^0x8C88CFCE
{
...
struct<2> func_114(int iParam0) // Hash - 0x975AC8C9 ^0xB7139F62
{
	var unk;
...
void func_115(int iParam0, var uParam1) // Hash - 0x2D8E3F8 ^0xBD654505
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_148(const char* sParam0) // Hash - 0x16488C7A ^0xE799AF98
{
...
void func_177(int iParam0, var uParam1) // Hash - 0x16CCAA18 ^0xAD5F4730
{
	if (iParam0 == 1)
	{
		if (!func_135(uParam1))
...
void func_189(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Hash - 0xA38693DA ^0xBAAA90B1
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_190(int iParam0, BOOL bParam1) // Hash - 0x3ABFF97A ^0x3ABFF97A
{
	if (iParam0 == -1)
		return;
...
int func_191(int iParam0) // Hash - 0x3F6843D0 ^0x973F28A6
{
	if (Global_78554 == iParam0)
		if (Global_78555 == -1)
...
void func_192(var uParam0, int iParam1) // Hash - 0xA189769D ^0xD7591C4B
{
	BOOL flag;
	int i;
...
BOOL func_194() // Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_97990;
}

void func_195(var uParam0) // Hash - 0x8EEB5116 ^0x2325FF68
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_196(uParam0);
...
void func_196(var uParam0) // Hash - 0x1C509C5B ^0x1C509C5B
{
	BOOL flag;
	int num;
	int i;
...
void func_197(int iParam0) // Hash - 0xD347101A ^0xCC220E7F
{
	if (iParam0 == -1)
		iParam0 = func_171();
...
BOOL func_198(Any* panParam0, BOOL bParam1) // Hash - 0x7D86F6E4 ^0xF836EB14
{
	var unk;
...
void func_199(Ped pedParam0, var uParam1, int iParam2) // Hash - 0xD4C7D099 ^0x162C1E9
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_200(int iParam0) // Hash - 0xD681AEF7 ^0xD681AEF7
{
...
BOOL func_201(var uParam0) // Hash - 0x42F869D4 ^0xFFADB180
{
...
BOOL func_202(var uParam0) // Hash - 0x6329B93C ^0xCBBB8D92
{
...
void func_203(var uParam0) // Hash - 0x2E98ABB1 ^0xFF31A41F
{
	int i;
	int taskSequenceId;
...
void func_204(Object* pobParam0) // Hash - 0x4EAFEE58 ^0x34D7ECA6
{
...
void func_205(var uParam0) // Hash - 0x5209F824 ^0xCFA0F1CA
{
	int i;
...
BOOL func_206(var uParam0, BOOL bParam1, BOOL bParam2) // Hash - 0x53567DCF ^0x584F6887
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_207(Ped pedParam0, Vehicle veParam1) // Hash - 0xFB12ABF0 ^0x730FD205
{
...
BOOL func_208(var uParam0, BOOL bParam1, int iParam2) // Hash - 0xE9BDE167 ^0x20C575FA
{
	int i;
	int num;
...
BOOL func_209(int iParam0) // Hash - 0x9E3DCA43 ^0x9E3DCA43
{
...
BOOL func_210(Ped pedParam0, int iParam1) // Hash - 0x5EA05E45 ^0x7984EB04
{
	float xSize;
...
BOOL func_211(Ped pedParam0, int iParam1) // Hash - 0xF1789D04 ^0x3F9D1900
{
	return func_212(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_212(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Hash - 0x275BB58B ^0x275BB58B
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_213(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Hash - 0xBBBECF07 ^0xBBBECF07
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_214(Ped pedParam0, int iParam1) // Hash - 0xA6273130 ^0xF7D9CDEA
{
...
int func_215() // Hash - 0x1398F041 ^0xCD84FF69
{
	int i;
...
BOOL func_216(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Hash - 0x6EF1707D ^0x8C069CF9
{
	var unk;
...
float func_217(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Hash - 0x596BEA29 ^0x5FBCDBE5
{
...
void func_219(var uParam0) // Hash - 0xA4B72113 ^0x62A5EAE1
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_220(Ped pedParam0, Ped pedParam1) // Hash - 0xAA445031 ^0xEBA3F8CF
{
	int i;
...
BOOL func_221(Ped pedParam0) // Hash - 0xEC80536A ^0x2D4CF2B0
{
...
BOOL func_222(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Hash - 0x5B46DA49 ^0x44F718
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_223(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Hash - 0x1310B579 ^0x2AAFC0CC
{
	float entityCoords;
	float num;
...
BOOL func_224(Ped pedParam0, float fParam1) // Hash - 0xFA3D7088 ^0x33A74060
{
	var outProjectile;
	var outCoords;
...
BOOL func_225(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Hash - 0x3F40E5FA ^0xC3BEFE6A
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_226(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Hash - 0x18BAE105 ^0x60D3B20E
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_227(int iParam0) // Hash - 0x5B443B41 ^0x5B443B41
{
...
void func_228(Ped pedParam0) // Hash - 0xAD821AF8 ^0xC7A832B7
{
	int taskSequenceId;
...
BOOL func_229(int iParam0) // Hash - 0x6F2BC7EE ^0x6F2BC7EE
{
	if (iParam0 == -1)
		iParam0 = func_171();
...
BOOL func_230(int iParam0) // Hash - 0xDE7BA54D ^0xDE7BA54D
{
...
BOOL func_231() // Hash - 0x29CB2928 ^0xE369A18D
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_232() // Hash - 0x98CCC132 ^0x97B0D6ED
{
	if (Global_97603 != -1)
...
BOOL func_233(int iParam0) // Hash - 0xC2630182 ^0xFBD23031
{
...
BOOL func_234() // Hash - 0x25806CBF ^0x25806CBF
{
...
BOOL func_235(int iParam0) // Hash - 0x1156B580 ^0x34C7FA05
{
	if (func_113(false))
...
BOOL func_236(var uParam0) // Hash - 0x14648AE3 ^0xDD8AEC21
{
	if (!func_237(uParam0))
		return false;
...
BOOL func_237(var uParam0) // Hash - 0xE93917CE ^0x5C413B09
{
	int num;
	int i;
	BOOL flag;
...
BOOL func_238(Ped* ppedParam0, int iParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Hash - 0x5E27D69A ^0xE8A3C3CE
{
...
BOOL func_239(Ped* ppedParam0, int iParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Hash - 0xC57592AD ^0x9AA0BE7
{
	Hash model;
...
int func_240(var uParam0, int iParam1) // Hash - 0x5AC42C11 ^0x5AC42C11
{
	int num;
...
void func_241(Object* pobParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Hash - 0x61F651EE ^0x2FE58679
{
	func_204(pobParam0);
...
BOOL func_242(var uParam0) // Hash - 0xC42B20E0 ^0x728F1DAE
{
	int i;
...
void func_243(int iParam0, BOOL bParam1, BOOL bParam2) // Hash - 0xDC336ADA ^0xDC336ADA
{
	Vector3 vector;
	Vector3 vector2;
...
Hash func_244(int iParam0) // Hash - 0xBF0B24A5 ^0xBF0B24A5
{
	if (!func_36(iParam0))
		return func_47(iParam0);
	else
...
BOOL func_245(int iParam0) // Hash - 0x59D2F680 ^0x59D2F680
{
	var unk;
	int num;
...
BOOL func_246(int iParam0) // Hash - 0xC6B32843 ^0xA45CCA60
{
	const char* string2;
...
BOOL func_247(int iParam0) // Hash - 0x791D84F4 ^0x791D84F4
{
	var unk;
...
BOOL func_248(int iParam0) // Hash - 0xDEAD9A68 ^0xDEAD9A68
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_249(int iParam0, char* sParam1) // Hash - 0xC64245F ^0xACEF95F6
{
...
BOOL func_250(int iParam0) // Hash - 0x5ADD7F05 ^0x5ADD7F05
{
...
BOOL func_251(int iParam0) // Hash - 0xBB053D24 ^0xBB053D24
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_252(int iParam0) // Hash - 0x5D95A044 ^0x5D95A044
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_253(int iParam0) // Hash - 0x9FFC81CD ^0x47A2AB8B
{
	if (func_230(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
void func_254() // Hash - 0x5631C87C ^0x90A23071
{
...
BOOL func_255(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Hash - 0x5B983661 ^0x5B983661
{
	int i;
...
BOOL func_256(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Hash - 0xC6B7068B ^0xB9A971A4
{
	int num;
	char* str;
...
BOOL func_257(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Hash - 0x1FB736D4 ^0x234AEAB7
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_258(var uParam0, BOOL bParam1) // Hash - 0x4DA83231 ^0xCEBF45A7
{
	if (bParam1)
	{
...
int func_259(var uParam0) // Hash - 0x86633390 ^0x82B4D893
{
	if (func_202(uParam0))
	{
...
void func_260(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Hash - 0x5BE1D1E3 ^0x5BE1D1E3
{
...
void func_261(var uParam0, BOOL bParam1) // Hash - 0xEDC3BD2D ^0xE0B6F056
{
	func_262(&(uParam0->f_41), bParam1);
	return;
}

void func_262(var uParam0, BOOL bParam1) // Hash - 0x9E80EA71 ^0x9E80EA71
{
	int i;
...
void func_263(Object* pobParam0, BOOL bParam1) // Hash - 0xD7EE3E27 ^0xC5769B29
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_264(var uParam0, BOOL bParam1) // Hash - 0xEDC3BD2D ^0xE2474F74
{
	func_265(&(uParam0->f_35), bParam1);
	return;
}

void func_265(var uParam0, BOOL bParam1) // Hash - 0xA98F6284 ^0xA98F6284
{
	int i;
...
void func_266(Vehicle* pveParam0) // Hash - 0xC50F9886 ^0x638B6124
{
...
void func_267(Vehicle* pveParam0) // Hash - 0x8D18F713 ^0xF71A18A8
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_268(var uParam0, int iParam1) // Hash - 0xEDC3BD2D ^0xA9A19095
{
	func_269(&(uParam0->f_28), iParam1);
	return;
}

void func_269(var uParam0, int iParam1) // Hash - 0xB72ACFD2 ^0xB72ACFD2
{
	int i;
...
void func_270(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Hash - 0x34362197 ^0xC592197
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_271(Ped* ppedParam0) // Hash - 0xCA79453F ^0x7BA88177
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
void func_272(var uParam0) // Hash - 0x73752192 ^0x129315BF
{
...
BOOL func_273(Ped pedParam0, eScriptTaskHash esthParam1) // Hash - 0x5CB13EA9 ^0x50B73240
{
...
void func_274(int iParam0) // Hash - 0x995C9E2 ^0x995C9E2
{
	if (*iParam0 == -1)
		return;
...
void func_275(char* sParam0) // Hash - 0x54B64147 ^0x56EEAFB9
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_276(var uParam0) // Hash - 0x4CD8BCE8 ^0x8DEDC5F7
{
	*uParam0 = -1;
...
void func_277() // Hash - 0x554DA35 ^0xCF745799
{
