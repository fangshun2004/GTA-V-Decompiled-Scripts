...
void func_1() // Hash - 0x2BC5D66C ^0x813E67DD
{
	Hash model;
	Hash pickupHash;
	int address;
...
struct<5> func_2(Hash hParam0, Vector3 vParam1, var uParam2, var uParam3, int iParam4, int iParam5, Hash hParam6, BOOL bParam7, BOOL bParam8) // Hash - 0xDA03BE01 ^0xDA03BE01
{
	var unk;
...
struct<5> func_3(Hash hParam0, Vector3 vParam1, var uParam2, var uParam3, int iParam4, int iParam5, Hash hParam6, BOOL bParam7) // Hash - 0xC0A4E8E1 ^0xC0A4E8E1
{
	var unk;
	int num;
	Hash hash;
...
int func_4(var uParam0) // Hash - 0xE374EDA2 ^0xE374EDA2
{
	int i;
...
BOOL func_5(var uParam0, var uParam1) // Hash - 0x152AB8AC ^0xE21D1BAA
{
...
BOOL func_6(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, BOOL bParam6) // Hash - 0x2D46096D ^0xEA41378F
{
	if (bParam6)
...
BOOL func_7(var uParam0) // Hash - 0xDB6E44FA ^0x3962D52C
{
...
BOOL func_8(float fParam0, var uParam1, var uParam2) // Hash - 0x16E871AD ^0x10C54C39
{
...
int func_9(int iParam0) // Hash - 0x7CC95B2E ^0x464C4CB7
{
	int num;
	int i;
...
int func_10() // Hash - 0x5320BFD5 ^0x5320BFD5
{
	int num;
	int i;
...
int func_11(int iParam0) // Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
...
int func_12() // Hash - 0x974E48B4 ^0x974E48B4
{
	return Global_262145.f_30937;
}

int func_13(int iParam0, int iParam1) // Hash - 0x8FF32F3 ^0x5AB70E11
{
	float value;
...
BOOL func_14() // Hash - 0x52E21E9B ^0xD0F85E96
{
...
Hash func_15() // Hash - 0x90B5165C ^0xB8DD5DC8
{
	switch (func_17())
	{
		case 0:
...
Hash func_16() // Hash - 0x61402777 ^0xB9FAC976
{
...
BOOL func_19(int iParam0) // Hash - 0xA28ADBB4 ^0x6EB81E64
{
...
BOOL func_21() // Hash - 0x974E48B4 ^0x974E48B4
{
	return Global_2683862.f_693;
}

int func_22(int iParam0, int iParam1, BOOL bParam2) // Hash - 0x75751681 ^0x9140C9A0
{
	int i;
...
BOOL func_23(BOOL bParam0) // Hash - 0x1CCCE169 ^0x1CCCE169
{
	bParam0;
	return Global_1575035;
}

void func_24() // Hash - 0xCE5FB49E ^0x214A59D5
{
	SCRIPT::TERMINATE_THIS_THREAD();
	return;
}

void func_25() // Hash - 0xCE5FB49E ^0x214A59D5
{
	SCRIPT::TERMINATE_THIS_THREAD();
	return;
}
