			...
			if (BRAIN::IS_OBJECT_WITHIN_BRAIN_ACTIVATION_RANGE(iScriptParam_0))
			{
				switch (iLocal_35)
				{
					case 0:
						...
						{
							Local_36 = { ENTITY::GET_ENTITY_COORDS(iScriptParam_0, true) };
							iLocal_35 = 1;
						}
						break;
...
void func_1()
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		func_2(iVar1, OBJECT::GET_SAFE_PICKUP_COORDS(Local_36, 1.2f, 1.5f), iVar2, iVar3, iVar0, 0, 0);
	}
	else
	{
		OBJECT::CREATE_PICKUP(iVar1, OBJECT::GET_SAFE_PICKUP_COORDS(Local_36, 1.2f, 1.5f), iVar2, iVar3, false, iVar0);
	}
}
...
int func_4(var uParam0)
{
	...
	while (iVar0 < 10)
	{
		if (func_5(uParam0, &(Global_2652581.f_2452[iVar0 /*16*/])))
		{
			return iVar0;
		}
		iVar0++;
...
int func_9(int iParam0)
{
	...
	while (iVar1 < 10)
	{
		if (!func_7(&(Global_1912667[iParam0 /*318*/].f_102.f_21[iVar1 /*14*/])))
		{
			iVar0 = iVar1;
		}
		else
...
int func_10(int iParam0, struct<3> Param1)
{
	int iVar0;
	int iVar1;
	...
	while (iVar1 < 10)
	{
		if (!func_7(&(Global_2652581.f_2452[iVar1 /*16*/])) && !OBJECT::DOES_PICKUP_OF_TYPE_EXIST_IN_AREA(iParam0, Param1, 2f))
		{
			iVar0 = iVar1;
		}
		else
