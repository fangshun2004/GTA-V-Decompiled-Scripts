...
int func_16() // Position - 0x1616 Hash - 0x3C5423D7 ^0x3C5423D7
{
	func_17();
...
BOOL func_19(int iParam0) // Position - 0x173A Hash - 0x8907F004 ^0x8907F004
{
	return iParam0 < 3;
}

int func_20(Ped pedParam0) // Position - 0x1746 Hash - 0xAC4E9801 ^0xB379A75F
{
	int i;
	Hash entityModel;
...
Hash func_21(int iParam0) // Position - 0x1783 Hash - 0xADCB9755 ^0xADCB9755
{
	if (func_19(iParam0))
...
Hash func_22(int iParam0) // Position - 0x17A8 Hash - 0xE4CEEC2C ^0xE4CEEC2C
{
...
BOOL func_33(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x1B17 Hash - 0x384540C1 ^0x384540C1
{
...
Player func_39() // Position - 0x1EF5 Hash - 0x478900E4 ^0x478900E4
{
	return -1;
}
...
void func_44() // Position - 0x2083 Hash - 0x98476CE1 ^0x250FEB7C
{
	if (func_18(14))
	{
...
void func_47(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x21B3 Hash - 0xC6B752B2 ^0xC6B752B2
{
...
void func_49(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x2244 Hash - 0x6C235EE0 ^0x9E57F206
{
...
BOOL func_61() // Position - 0x24BC Hash - 0x152DA0B2 ^0x220E93E9
{
...
BOOL func_102(Ped pedParam0) // Position - 0x30C6 Hash - 0x3D210083 ^0xF7E7C389
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
		if (!ENTITY::IS_ENTITY_DEAD(pedParam0, false))
			return true;
