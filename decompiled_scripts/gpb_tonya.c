...
int func_15() // Hash - 0x9B9F4C39 ^0x9B9F4C39
{
	int num;
...
void func_24(char* sParam0) // Hash - 0x9CF292E1 ^0x7EE136AB
{
	int num;
...
void func_25(char* sParam0) // Hash - 0x3372085F ^0xDE4B623B
{
	int num;
...
void func_26(int iParam0, char* sParam1) // Hash - 0xC4958D46 ^0x61C1FBEE
{
	switch (iParam0)
	{
		case 0:
...
void func_27(char* sParam0) // Hash - 0x3018B517 ^0xC74C98E2
{
	var unk;
...
void func_29(char* sParam0) // Hash - 0x3BD51041 ^0x9D3BBA9
{
...
void func_31(char* sParam0) // Hash - 0xE431A142 ^0xD045698D
{
	int num;
...
void func_50(char* sParam0) // Hash - 0xB19D680C ^0xB659EB5C
{
	int num;
...
void func_57(int iParam0, char* sParam1, char* sParam2) // Hash - 0xA1B3AA65 ^0x38C9E06
{
...
void func_64(char* sParam0) // Hash - 0xD55EAE22 ^0xBE3FF932
{
	var unk;
...
void func_66(char* sParam0) // Hash - 0x217F514E ^0x5295C602
{
...
void func_73(char* sParam0) // Hash - 0x2E18739A ^0xB85C2597
{
...
char* func_74(int iParam0) // Hash - 0xE6862179 ^0x83FBC236
{
	switch (iParam0)
	{
		case 0:
...
void func_105() // Hash - 0x9FD67808 ^0xD232BEAD
{
	...
	if (func_106())
		...
		sLocal_303 = _("Press ~INPUT_CONTEXT~ to talk to Tonya.");
...
BOOL func_106() // Hash - 0x51FF05F ^0x51FF05F
{
...
BOOL func_110() // Hash - 0x1E5FE519 ^0x1E5FE519
{
...
BOOL func_111() // Hash - 0x387F9FE2 ^0x387F9FE2
{
...
BOOL func_112(int iParam0) // Hash - 0xC86BC762 ^0xC86BC762
{
	return func_113(Global_113648.f_20119, iParam0);
}

BOOL func_113(int iParam0, int iParam1) // Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

int func_114(const char* sParam0) // Hash - 0xD5121E5F ^0x81F17A8D
{
...
void func_115(int iParam0) // Hash - 0x8B2883F3 ^0x111D5E85
{
	var string1;
...
void func_116(Blip* pblParam0) // Hash - 0x4C359FE5 ^0xBAF5111C
{
	if (HUD::DOES_BLIP_EXIST(*pblParam0))
	{
...
struct<6> func_117() // Hash - 0xB37EF8EF ^0xB37EF8EF
{
	var unk;
...
void func_118() // Hash - 0xD8C6DE12 ^0xD8C6DE12
{
	func_119();
	return;
}

void func_119() // Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_120() // Hash - 0x66F88FF ^0x478E9B29
{
	if (iLocal_245 == -1)
