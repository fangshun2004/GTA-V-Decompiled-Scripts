...
int func_15() // Hash - 0xDBAF5436 ^0xDBAF5436
{
	int num;
...
void func_24(char* sParam0) // Hash - 0x3B4A7888 ^0x388BC954
{
	int num;
...
void func_25(char* sParam0) // Hash - 0x3372085F ^0xFC33940B
{
	int num;
...
void func_26(int iParam0, char* sParam1) // Hash - 0xC4958D46 ^0x99BEDA7D
{
	switch (iParam0)
	{
		case 0:
...
void func_27(char* sParam0) // Hash - 0x3018B517 ^0xA7A64DAC
{
	var unk;
...
void func_29(char* sParam0) // Hash - 0x3BD51041 ^0x76395E
{
...
void func_31(char* sParam0) // Hash - 0xE431A142 ^0x4098801A
{
	int num;
...
void func_50(char* sParam0) // Hash - 0xB19D680C ^0xB2638998
{
	int num;
...
void func_57(int iParam0, char* sParam1, char* sParam2) // Hash - 0xA1B3AA65 ^0x9D44ECB1
{
...
void func_64(char* sParam0) // Hash - 0xD55EAE22 ^0x532B33D7
{
	var unk;
...
void func_66(char* sParam0) // Hash - 0x217F514E ^0x592BE62D
{
...
void func_73(char* sParam0) // Hash - 0x2E18739A ^0x10959DAD
{
...
char* func_74(int iParam0) // Hash - 0xE6862179 ^0xC94C3B07
{
	switch (iParam0)
	{
		case 0:
...
void func_105() // Hash - 0xD1DEAC26 ^0xF24495B0
{
...
int func_112(const char* sParam0) // Hash - 0xD5121E5F ^0x5A579C63
{
