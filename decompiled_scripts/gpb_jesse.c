...
void func_106()
{
	iLocal_53 = joaat("u_m_m_jesus_01");
	StringCopy(&Local_251, "PBJS", 8);
	StringCopy(&Local_253, "JESSE", 16);
	StringCopy(&Local_219, "Special_Ped@jessie", 64);
	StringCopy(&Local_235, "Base", 64);
	bLocal_453 = true;
	iLocal_269 = 15;
	sLocal_320 = "PBJS_INTERACT";
	StringCopy(&Local_329, "PBJS_CONV_GM", 16);
	StringCopy(&Local_333, "PBJS_CONV_GT", 16);
	StringCopy(&Local_337, "PBJS_CONV_GF", 16);
	StringCopy(&cLocal_341, "special_ped@jessie@base", 64);
	StringCopy(&cLocal_357, "special_ped@jessie@intro", 64);
	iLocal_268 = 7;
	iLocal_272[0] = 8;
	iLocal_272[1] = 6;
	iLocal_272[2] = 6;
