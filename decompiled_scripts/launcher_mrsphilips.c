...
BOOL func_2(Any* panParam0) // Hash - 0x1E3440FD ^0x1E3440FD
{
	const char* str;
	var unk32;
...
struct<2> func_9(int iParam0) // Hash - 0xAB086551 ^0xC658C94
{
	var unk;
	var unk3;
...
void func_19() // Hash - 0x1086CDE1 ^0x927D46DA
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("MISSION_STAT_WATCHER")) > 0)
	{
		if (func_20())
...
void func_23(char* sParam0, int iParam1, Ped pedParam2) // Hash - 0x85659ABD ^0x85659ABD
{
...
BOOL func_44(int iParam0, int iParam1, char* sParam2, var uParam3) // Hash - 0x38D4474 ^0x8B29CF4C
{
...
void func_109(int iParam0) // Hash - 0x35AC36F2 ^0x227F209C
{
	int num;
	var textLabel;
...
void func_112(char* sParam0, Any anParam1, int iParam2) // Hash - 0x931C080E ^0xCB252A3F
{
...
struct<2> func_114(int iParam0) // Hash - 0xB85D2CDA ^0xD12F85BD
{
	var unk;
...
void func_115(int iParam0, var uParam1) // Hash - 0x5A04DB9 ^0x771B093D
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_148(const char* sParam0) // Hash - 0x16488C7A ^0x8225328D
{
...
void func_177(int iParam0, var uParam1) // Hash - 0x16CCAA18 ^0xA95B6FB4
{
	if (iParam0 == 1)
	{
		if (!func_135(uParam1))
...
BOOL func_198(Any* panParam0, BOOL bParam1) // Hash - 0x7D86F6E4 ^0xE32D76E4
{
	var unk;
...
void func_228(Vehicle veParam0) // Hash - 0xAD821AF8 ^0x6BD5D07E
{
	int taskSequenceId;
...
void func_236(var uParam0) // Hash - 0x75A23B20 ^0x31BE76CA
{
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	{
...
void func_237(var uParam0) // Hash - 0x987DEC47 ^0x9F9EC476
{
	uParam0->f_16 = 5;
...
BOOL func_238(int iParam0) // Hash - 0x59D2F680 ^0x59D2F680
{
	var unk;
	int num;
...
BOOL func_239(int iParam0) // Hash - 0xC6B32843 ^0x838A5D57
{
	const char* string2;
...
BOOL func_240(int iParam0) // Hash - 0x791D84F4 ^0x791D84F4
{
	var unk;
...
BOOL func_241(int iParam0) // Hash - 0xDEAD9A68 ^0xDEAD9A68
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_242(int iParam0, char* sParam1) // Hash - 0xBDAC14DE ^0xE1753E57
{
...
BOOL func_243(int iParam0) // Hash - 0x5ADD7F05 ^0x5ADD7F05
{
...
BOOL func_244(int iParam0) // Hash - 0xBB053D24 ^0xBB053D24
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_245(int iParam0) // Hash - 0x5D95A044 ^0x5D95A044
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_246(int iParam0) // Hash - 0x9FFC81CD ^0x47A2AB8B
{
	if (func_230(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
void func_247() // Hash - 0x5631C87C ^0x250788D3
{
...
BOOL func_248(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Hash - 0x5B983661 ^0x5B983661
{
	int i;
...
BOOL func_249(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Hash - 0xC6B7068B ^0xB9A971A4
{
	int num;
	char* str;
...
BOOL func_250(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Hash - 0x1FB736D4 ^0x234AEAB7
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_251(var uParam0, BOOL bParam1) // Hash - 0x4A418723 ^0xF6FC35A5
{
	if (bParam1)
	{
...
void func_252(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Hash - 0x5BE1D1E3 ^0x5BE1D1E3
{
...
void func_253(var uParam0, BOOL bParam1) // Hash - 0xEDC3BD2D ^0xE0B6F056
{
	func_254(&(uParam0->f_41), bParam1);
	return;
}

void func_254(var uParam0, BOOL bParam1) // Hash - 0x9E80EA71 ^0x9E80EA71
{
	int i;
...
void func_255(Object* pobParam0, BOOL bParam1) // Hash - 0xD7EE3E27 ^0xC5769B29
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_256(var uParam0, BOOL bParam1) // Hash - 0xEDC3BD2D ^0xE2474F74
{
	func_257(&(uParam0->f_35), bParam1);
	return;
}

void func_257(var uParam0, BOOL bParam1) // Hash - 0xA98F6284 ^0xA98F6284
{
	int i;
...
void func_258(Vehicle* pveParam0) // Hash - 0xC50F9886 ^0x638B6124
{
...
void func_260(var uParam0, int iParam1) // Hash - 0xEDC3BD2D ^0xA9A19095
{
	func_261(&(uParam0->f_28), iParam1);
	return;
}

void func_261(var uParam0, int iParam1) // Hash - 0xB72ACFD2 ^0xB72ACFD2
{
	int i;
...
void func_262(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Hash - 0x34362197 ^0xC592197
{
...
void func_263(Ped* ppedParam0) // Hash - 0xCA79453F ^0x7BA88177
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_264(int iParam0) // Hash - 0x995C9E2 ^0x995C9E2
{
	if (*iParam0 == -1)
		return;
...
void func_265(char* sParam0) // Hash - 0x54B64147 ^0x56EEAFB9
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_266(var uParam0) // Hash - 0x800133EE ^0x65417563
{
	*uParam0 = -1;
...
void func_267() // Hash - 0x554DA35 ^0xC57E8517
{
