...
void __EntryFunction__()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_113991[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_320(&(Global_113991[Var0.f_0 /*10*/].f_9));
			}
		}
		func_303(&Var0, 1);
	}
	...
	if (Var0.f_0 == 27)
	{
		func_269(&uLocal_95, 5, Var0.f_28[0], "JOSH", 0, 1);
	}
	else if (Var0.f_0 == 30)
	{
		func_269(&uLocal_95, 4, Var0.f_28[0], "JOSH", 0, 1);
		func_269(&uLocal_95, 3, Var0.f_28[1], "JOSHCOP", 0, 1);
	...
	while (true)
	{
		...
		func_229(Var0.f_0);
		func_222(&iLocal_93, &(Var0.f_9), Var61);
		if (Var0.f_0 == 27)
		{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_204()) || Global_33778) || func_203()) || func_202(8, -1)) || func_200()) || func_102()) || func_201()) || func_199()) || Global_114904.f_7695.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_204()) || Global_113951) || Global_33778) || func_203()) || func_202(8, -1)) || func_200()) || func_102()) || func_201()) || func_199()) || Global_114904.f_7695.f_919[bVar0] == 5) || Global_45416 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_204()) || Global_113951) || Global_33778) || func_203()) || func_202(8, -1)) || func_102()) || func_201()) || func_199()) || Global_114904.f_7695.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_204() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_202(8, -1)) || func_199()) || func_198()) || Global_114904.f_7695.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_205()
{
	switch (iLocal_94)
	{
		...
		case 1:
			...
			{
				if (func_206(&uLocal_95, "JOSH4AU", "JOSH4_AMB", 8, 0, 0, 0))
				{
					iLocal_94 = 2;
				}
			}
...
int func_232(var uParam0, bool bParam1)
{
	...
	if ((func_268(*uParam0) || func_266(*uParam0)) || Global_80526 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
bool func_245(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_246(&(Local_35[iVar4 /*4*/]), Var1, iParam1, &(Local_35[iVar4 /*4*/].f_3), iParam0, iParam5);
...
void func_272(int* iParam0, bool bParam1)
{
	...
	func_273(iParam0, iLocal_91, Var0, fVar3);
...
{
	func_273(iParam0, iLocal_91, 558.09f, -1765.39f, 28.86f, 335.3252f);
	VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(*iParam0, 4);
