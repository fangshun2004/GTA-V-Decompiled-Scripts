...
BOOL func_2(Any* panParam0) // Hash - 0xDE97F4EA ^0x7A4495EE
{
	const char* str;
	var unk32;
...
struct<2> func_9(int iParam0) // Hash - 0x323E6781 ^0x3EFA50FA
{
	var unk;
	var unk3;
...
void func_19() // Hash - 0x429A4038 ^0xA2AD9E47
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("MISSION_STAT_WATCHER")) > 0)
	{
		if (func_20())
...
void func_23(char* sParam0, int iParam1, Ped pedParam2) // Hash - 0xB566D143 ^0x48952136
{
...
BOOL func_44(int iParam0, int iParam1, char* sParam2, var uParam3) // Hash - 0x8E372EAA ^0xBCB2AFA1
{
...
void func_109(int iParam0) // Hash - 0x35AC36F2 ^0x6C9835BF
{
	int num;
	var textLabel;
...
void func_112(char* sParam0, Any anParam1, int iParam2) // Hash - 0x817AB180 ^0x478B8D8
{
...
struct<2> func_114(int iParam0) // Hash - 0x975AC8C9 ^0x8A2D6B18
{
	var unk;
...
void func_115(int iParam0, var uParam1) // Hash - 0x2D8E3F8 ^0x95D8A6AF
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_147(const char* sParam0) // Hash - 0x16488C7A ^0xDB2E3534
{
...
BOOL func_177(var uParam0) // Hash - 0x39E07673 ^0x49D8E625
{
	if (*uParam0 == 30)
	{
...
float func_178(Ped pedParam0, Entity eParam1, BOOL bParam2) // Hash - 0x7B2C17A2 ^0xDF922C6D
{
...
BOOL func_179(var uParam0) // Hash - 0x5A7F6A5B ^0x95439C8E
{
	if (*uParam0 == 29)
	{
...
int func_181(var uParam0) // Hash - 0x7CCB64A0 ^0x9A37790B
{
	if (*uParam0 == 28)
	{
...
int func_182(var uParam0, int iParam1) // Hash - 0x4C332810 ^0xCFFAAA23
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_183() // Hash - 0x1DF115D ^0x1DF115D
{
	func_27(&(Global_104212.f_2890), &Global_104212, 0, 1, 1, 0);
	return;
}

BOOL func_184(var uParam0) // Hash - 0xBE0C612E ^0xC181C5F3
{
	float num;
...
void func_185(int iParam0, var uParam1) // Hash - 0x16CCAA18 ^0xFFE473BF
{
	if (iParam0 == 1)
	{
		if (!func_134(uParam1))
...
BOOL func_186(BOOL bParam0) // Hash - 0x328D4447 ^0x90410402
{
...
BOOL func_187(Vehicle veParam0) // Hash - 0x7E47BB06 ^0x692E6B64
{
...
BOOL func_188(int iParam0) // Hash - 0x97844555 ^0xADCD6DAA
{
	int num;
...
BOOL func_189() // Hash - 0x4228A1C2 ^0x952FE30F
{
	return Global_100720.f_1;
}

BOOL func_190() // Hash - 0xC20DBA70 ^0xAC4006FB
{
	if (Global_97603 != -1)
...
BOOL func_191() // Hash - 0x3CA1BB47 ^0xB78A1ACB
{
...
BOOL func_192() // Hash - 0xE663B8F6 ^0xE663B8F6
{
	if (Global_78819)
		return true;
...
BOOL func_193() // Hash - 0xD56328D2 ^0xD56328D2
{
	return Global_100733.f_388 > 0;
}

BOOL func_194(int iParam0, int iParam1) // Hash - 0xA14C4D3F ^0xA6034F77
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_196() // Hash - 0x7FE517FE ^0x128A3BC8
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_197() // Hash - 0x7B21E756 ^0x39C784C5
{
	switch (iLocal_96)
	{
		case 0:
...
BOOL func_198(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Hash - 0x384540C1 ^0x384540C1
{
...
BOOL func_199(char* sParam0, int iParam1, BOOL bParam2) // Hash - 0x77297D51 ^0x40DC584A
{
	Global_21726 = 0;
...
void func_200() // Hash - 0xF42BEB19 ^0xA29557DA
{
	if (!func_201())
		return;
...
BOOL func_201() // Hash - 0x7B74B45F ^0xCE052A5D
{
...
BOOL func_202(Player plParam0) // Hash - 0x6E46BC72 ^0x6E46BC72
{
	return func_203(plParam0, 20);
}

BOOL func_203(Player plParam0, int iParam1) // Hash - 0x7CD5054C ^0x870BEA81
{
	return IS_BIT_SET(Global_1894573[plParam0 /*608*/].f_10.f_4, iParam1);
}

void func_204() // Hash - 0xDB58E314 ^0x370EF11D
{
	int i;
...
void func_205() // Hash - 0xCD8A4D28 ^0xCD8A4D28
{
...
BOOL func_206() // Hash - 0x9A999369 ^0x4033F7BF
{
	int num;
	int weaponHash;
...
void func_207() // Hash - 0x98476CE1 ^0x250FEB7C
{
	if (func_57(14))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
...
void func_208() // Hash - 0xBE88A374 ^0x2DED65BA
{
	int i;
...
void func_209(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Hash - 0xC6B752B2 ^0xC6B752B2
{
...
int func_211(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Hash - 0xA74186BF ^0x512FC932
{
	var unk;
...
void func_212(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Hash - 0xF7ECDFD9 ^0x6B079C3E
{
...
void func_213(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Hash - 0xA38693DA ^0xBAAA90B1
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_214(int iParam0, BOOL bParam1) // Hash - 0x3ABFF97A ^0x3ABFF97A
{
	if (iParam0 == -1)
		return;
...
int func_215(int iParam0) // Hash - 0x3F6843D0 ^0x973F28A6
{
	if (Global_78554 == iParam0)
		if (Global_78555 == -1)
...
void func_216(var uParam0, int iParam1) // Hash - 0xA189769D ^0xD7591C4B
{
	BOOL flag;
	int i;
...
void func_218(var uParam0) // Hash - 0x8EEB5116 ^0x2325FF68
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_219(uParam0);
...
void func_219(var uParam0) // Hash - 0x1C509C5B ^0x1C509C5B
{
	BOOL flag;
	int num;
	int i;
...
void func_220(int iParam0) // Hash - 0xD347101A ^0xCC220E7F
{
	if (iParam0 == -1)
		iParam0 = func_170();
...
void func_221(var uParam0) // Hash - 0x5209F824 ^0xCFA0F1CA
{
	int i;
...
float func_222(Ped pedParam0, float fParam1, float fParam2, float fParam3, BOOL bParam4) // Hash - 0xC22B942A ^0xE0DB8793
{
	Vector3 entityCoords;
...
BOOL func_223(Any* panParam0, BOOL bParam1) // Hash - 0x7D86F6E4 ^0x2638AAD1
{
	var unk;
...
void func_224(Ped pedParam0, var uParam1, int iParam2) // Hash - 0xD4C7D099 ^0x162C1E9
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_225(int iParam0) // Hash - 0xD681AEF7 ^0xD681AEF7
{
...
BOOL func_226(var uParam0) // Hash - 0x42F869D4 ^0xFFADB180
{
...
BOOL func_227(var uParam0) // Hash - 0x6329B93C ^0xCBBB8D92
{
...
void func_228(var uParam0) // Hash - 0x2E98ABB1 ^0xFF31A41F
{
	int i;
	int taskSequenceId;
...
void func_229(Object* pobParam0) // Hash - 0x4EAFEE58 ^0x34D7ECA6
{
...
BOOL func_230(var uParam0, BOOL bParam1, BOOL bParam2) // Hash - 0x53567DCF ^0x584F6887
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_231(Ped pedParam0, Vehicle veParam1) // Hash - 0xFB12ABF0 ^0x730FD205
{
...
BOOL func_232(var uParam0, BOOL bParam1, int iParam2) // Hash - 0xE9BDE167 ^0x20C575FA
{
	int i;
	int num;
...
BOOL func_233(int iParam0) // Hash - 0x9E3DCA43 ^0x9E3DCA43
{
...
BOOL func_234(Ped pedParam0, int iParam1) // Hash - 0x5EA05E45 ^0x7984EB04
{
	float xSize;
...
BOOL func_235(Ped pedParam0, int iParam1) // Hash - 0xF1789D04 ^0x3F9D1900
{
	return func_236(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_236(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Hash - 0x275BB58B ^0x275BB58B
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_237(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Hash - 0xBBBECF07 ^0xBBBECF07
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_238(Ped pedParam0, int iParam1) // Hash - 0xA6273130 ^0xF7D9CDEA
{
...
int func_239() // Hash - 0x1398F041 ^0xCD84FF69
{
	int i;
...
BOOL func_240(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Hash - 0x6EF1707D ^0x8C069CF9
{
	var unk;
...
float func_241(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Hash - 0x596BEA29 ^0x5FBCDBE5
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_242(float fParam0, var uParam1, var uParam2) // Hash - 0xFB6A39D2 ^0x80C9C759
{
	float num;
	float num2;
...
void func_243(var uParam0) // Hash - 0xA4B72113 ^0x62A5EAE1
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_244(Ped pedParam0, Ped pedParam1) // Hash - 0xAA445031 ^0xEBA3F8CF
{
	int i;
...
BOOL func_245(Ped pedParam0) // Hash - 0xEC80536A ^0x2D4CF2B0
{
...
BOOL func_246(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Hash - 0x5B46DA49 ^0x44F718
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_247(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Hash - 0x1310B579 ^0x2AAFC0CC
{
	float entityCoords;
	float num;
...
BOOL func_248(Ped pedParam0, float fParam1) // Hash - 0xFA3D7088 ^0x33A74060
{
	var outProjectile;
	var outCoords;
...
BOOL func_249(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Hash - 0x3F40E5FA ^0xC3BEFE6A
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_250(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Hash - 0x18BAE105 ^0x60D3B20E
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_251(int iParam0) // Hash - 0x5B443B41 ^0x5B443B41
{
...
void func_252(Vehicle veParam0) // Hash - 0xAD821AF8 ^0x36262824
{
	int taskSequenceId;
...
BOOL func_253(int iParam0) // Hash - 0x6F2BC7EE ^0x6F2BC7EE
{
	if (iParam0 == -1)
		iParam0 = func_170();
...
BOOL func_254(int iParam0) // Hash - 0xDE7BA54D ^0xDE7BA54D
{
...
BOOL func_255() // Hash - 0x29CB2928 ^0xE369A18D
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_256() // Hash - 0x98CCC132 ^0x97B0D6ED
{
	if (Global_97603 != -1)
...
BOOL func_257(int iParam0) // Hash - 0xC2630182 ^0xFBD23031
{
...
BOOL func_258() // Hash - 0x25806CBF ^0x25806CBF
{
...
BOOL func_259(int iParam0) // Hash - 0x1156B580 ^0x34C7FA05
{
	if (func_113(false))
...
void func_260(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Hash - 0x6C235EE0 ^0x9E57F206
{
...
BOOL func_261(var uParam0) // Hash - 0x24D26100 ^0x24D26100
{
	switch (*uParam0)
	{
		case 27:
...
BOOL func_262(var uParam0) // Hash - 0x90D8FC86 ^0x2F0D3BFF
{
	int num;
	int i;
...
void func_263(Vehicle* pveParam0, BOOL bParam1) // Hash - 0x73DACAF1 ^0x73DACAF1
{
	var unk;
	float num;
...
void func_264(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Hash - 0x60B41505 ^0x2C4B5209
{
	func_265(pveParam0);
...
void func_265(Vehicle* pveParam0) // Hash - 0x8D18F713 ^0xF71A18A8
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_266(Ped* ppedParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5, ePedType eptParam6) // Hash - 0x616C5024 ^0x190F8C82
{
	func_267(ppedParam0);
...
BOOL func_268(Ped* ppedParam0, int iParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Hash - 0x5E27D69A ^0xE8A3C3CE
{
...
BOOL func_269(Ped* ppedParam0, int iParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Hash - 0xC57592AD ^0x9AA0BE7
{
	Hash model;
...
int func_270(var uParam0, int iParam1) // Hash - 0x5AC42C11 ^0x5AC42C11
{
	int num;
...
BOOL func_271(BOOL bParam0, BOOL bParam1) // Hash - 0x327E81C1 ^0x533CF916
{
	int num;
...
BOOL func_272(BOOL bParam0, BOOL bParam1) // Hash - 0xB5DD8227 ^0xCC6F280
{
	int num;
...
BOOL func_273(var uParam0) // Hash - 0xB319BDFA ^0xA1F4DAFB
{
	if (func_227(uParam0))
	{
...
BOOL func_274(var uParam0) // Hash - 0xC42B20E0 ^0x728F1DAE
{
	int i;
...
void func_275(var uParam0, char* sParam1, char* sParam2, int iParam3) // Hash - 0x6EEDFC2 ^0xD51569DC
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
BOOL func_276(var uParam0) // Hash - 0x708E0529 ^0x5A121484
{
	int num;
	int i;
	BOOL flag;
...
void func_277(Vehicle* pveParam0) // Hash - 0xB059F4DA ^0x153B99A9
{
...
BOOL func_278(var uParam0) // Hash - 0x708E0529 ^0x5A121484
{
	int num;
	int i;
	BOOL flag;
...
BOOL func_279(var uParam0) // Hash - 0x2BA3A0FA ^0xC7365863
{
	int num;
	int i;
	BOOL flag;
...
BOOL func_280(BOOL bParam0, BOOL bParam1) // Hash - 0xD0FD5EC9 ^0x4AC1AE5E
{
	int num;
...
BOOL func_281(int iParam0) // Hash - 0x59D2F680 ^0x59D2F680
{
	var unk;
	int num;
...
BOOL func_282(int iParam0) // Hash - 0xC6B32843 ^0x2F94E7AA
{
	const char* string2;
...
BOOL func_283(int iParam0) // Hash - 0x791D84F4 ^0x791D84F4
{
	var unk;
...
BOOL func_284(int iParam0) // Hash - 0xDEAD9A68 ^0xDEAD9A68
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_285(int iParam0, char* sParam1) // Hash - 0xC64245F ^0xE24AD367
{
...
BOOL func_286(int iParam0) // Hash - 0x5ADD7F05 ^0x5ADD7F05
{
...
BOOL func_287(int iParam0) // Hash - 0xBB053D24 ^0xBB053D24
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_288(int iParam0) // Hash - 0x5D95A044 ^0x5D95A044
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_289(int iParam0) // Hash - 0x9FFC81CD ^0x47A2AB8B
{
	if (func_254(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
void func_290() // Hash - 0x5631C87C ^0x912F6DE7
{
...
BOOL func_291(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Hash - 0x5B983661 ^0x5B983661
{
	int i;
...
BOOL func_292(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Hash - 0xC6B7068B ^0xB9A971A4
{
	int num;
	char* str;
...
BOOL func_293(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Hash - 0x1FB736D4 ^0x234AEAB7
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_294(var uParam0, BOOL bParam1) // Hash - 0x7BC84B2D ^0x40573925
{
	char* str;
...
void func_295(char* sParam0) // Hash - 0xA52CF679 ^0xC94F8C8B
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
		if (func_298(sParam0))
			func_296();
...
void func_296() // Hash - 0xC536DD5 ^0xC536DD5
{
	Global_20591 = 0;
	func_297();
	return;
...
void func_297() // Hash - 0xF6D04E68 ^0x80AE5309
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22736 = 0;
...
BOOL func_298(char* sParam0) // Hash - 0x5CF3EDA6 ^0x878C8302
{
	var string1;
...
struct<6> func_299() // Hash - 0xB37EF8EF ^0xB37EF8EF
{
	var unk;
...
int func_300(var uParam0) // Hash - 0x86633390 ^0xF0F00C46
{
	if (func_227(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_301(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Hash - 0x5BE1D1E3 ^0x5BE1D1E3
{
...
void func_302(var uParam0, BOOL bParam1) // Hash - 0xEDC3BD2D ^0xE0B6F056
{
	func_303(&(uParam0->f_41), bParam1);
	return;
}

void func_303(var uParam0, BOOL bParam1) // Hash - 0x9E80EA71 ^0x9E80EA71
{
	int i;
...
void func_304(Object* pobParam0, BOOL bParam1) // Hash - 0xD7EE3E27 ^0xC5769B29
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_305(var uParam0, BOOL bParam1) // Hash - 0xEDC3BD2D ^0xE2474F74
{
	func_306(&(uParam0->f_35), bParam1);
	return;
}

void func_306(var uParam0, BOOL bParam1) // Hash - 0xA98F6284 ^0xA98F6284
{
	int i;
...
void func_307(Vehicle* pveParam0) // Hash - 0xC50F9886 ^0x638B6124
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_308(var uParam0, int iParam1) // Hash - 0xEDC3BD2D ^0xA9A19095
{
	func_309(&(uParam0->f_28), iParam1);
	return;
}

void func_309(var uParam0, int iParam1) // Hash - 0xB72ACFD2 ^0xB72ACFD2
{
	int i;
...
void func_310(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Hash - 0x34362197 ^0xC592197
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_311(int iParam0) // Hash - 0x995C9E2 ^0x995C9E2
{
	if (*iParam0 == -1)
		return;
...
void func_312(char* sParam0) // Hash - 0x54B64147 ^0x56EEAFB9
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_313(var uParam0) // Hash - 0x4CD8BCE8 ^0x4EB20D63
{
	*uParam0 = -1;
...
void func_314() // Hash - 0x554DA35 ^0xCA3363C8
{
...
Hash func_315(int iParam0) // Hash - 0xBF0B24A5 ^0xBF0B24A5
{
	if (!func_36(iParam0))
		return func_47(iParam0);
	else
