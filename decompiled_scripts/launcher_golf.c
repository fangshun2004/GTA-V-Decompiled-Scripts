...
void __EntryFunction__()
{
	...
	iLocal_112 = 0;
	func_94(&Global_113609, 0);
	func_91();
	if (func_90(uLocal_111, 1))
	{
		iLocal_117 = 10;
	}
	else
	...
	if (!func_90(uLocal_111, 8))
	{
		if (!func_88(iLocal_117))
		{
			if (func_87(0, iLocal_116))
			{
				func_96(0);
			}
			else
	...
	if (func_90(uLocal_111, 8388608))
	{
		func_96(1);
	}
	if (func_90(uLocal_111, 524288) && (func_86() && !func_85()))
	{
		func_96(1);
	}
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_90(uLocal_111, 4194304))
	{
		if (iLocal_122 != 263)
		{
			func_84(iLocal_122, 1, 0);
			iLocal_122 = 263;
		}
		func_83(10);
	}
	while (true)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_102) && !ENTITY::IS_ENTITY_DEAD(iLocal_102, false))
		{
			...
			{
				case 0:
					if (func_88(iLocal_117) || (func_90(uLocal_111, 16) && !func_90(uLocal_111, 524288)))
					{
						iLocal_115 = -1;
						func_82();
						func_83(1);
				...
				case 3:
					...
					if (!func_88(iLocal_117))
					{
						...
						{
							bVar1 = true;
							if (MISC::ARE_STRINGS_EQUAL(&(Global_102486.f_3), &cLocal_86))
							{
								cLocal_86 = { Local_70 };
								bVar1 = false;
							}
					...
					if (!func_90(uLocal_111, 4))
					{
						func_80();
						func_79(&uLocal_111, 4);
					}
					if (fLocal_127 > (fLocal_119 * fLocal_119) && !Global_102520)
					{
						if (iLocal_122 != 263)
						{
							if (func_78(6) && !func_77(iLocal_122))
							{
							}
							else
							{
					...
					{
						cLocal_86 = { Local_70 };
						bVar2 = !func_90(uLocal_111, 64);
						func_94(&uLocal_111, 128);
						if (!func_76(3) && !Global_102520)
						{
							if (func_90(uLocal_111, 2097152))
							{
								if ((!func_90(uLocal_111, 1) || !ENTITY::DOES_ENTITY_EXIST(func_75())) && !Global_102520)
								{
									func_83(10);
									break;
								}
						...
						if ((!func_66(6) || Global_114010) || func_65())
						{
							bVar2 = false;
						}
						if (func_90(uLocal_111, 1))
						...
						if (bVar2)
						{
							...
							{
								if (!ENTITY::IS_ENTITY_AT_COORD(PED::GET_VEHICLE_PED_IS_IN(iLocal_102, false), ScriptParam_0.f_1[0 /*3*/], fLocal_134, fLocal_134, 20f, false, false, iLocal_120))
								{
									bVar2 = false;
								}
							}
							else if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_102, ScriptParam_0.f_1[0 /*3*/], fLocal_134, fLocal_134, 2f, false, true, iLocal_120))
							{
								bVar2 = false;
							}
							if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_102, ScriptParam_0.f_1[0 /*3*/], fLocal_134, fLocal_134, 2f, false, true, 0))
							{
								func_62(&uLocal_111, 128);
								bVar2 = false;
							}
							...
							{
								if (iVar3 < iLocal_135 && iVar3 >= iLocal_136)
								{
									func_62(&uLocal_111, 128);
									bVar2 = false;
									if (fLocal_110 < ((fLocal_134 * fLocal_134) + 4f))
									{
										if (!func_90(uLocal_111, 134217728))
										{
											func_55("MG_NA_TIME", iLocal_135, iLocal_136);
											func_62(&uLocal_111, 134217728);
										}
									}
									else
									{
										func_94(&uLocal_111, 134217728);
									}
								}
							}
							else if (iVar3 < iLocal_135 || iVar3 >= iLocal_136)
							{
								func_62(&uLocal_111, 128);
								bVar2 = false;
								if (fLocal_110 < ((fLocal_134 * fLocal_134) + 4f))
							...
							if (bVar2 && func_48(func_49()) < iLocal_137)
							{
								func_62(&uLocal_111, 128);
								bVar2 = false;
								if (!func_90(uLocal_111, 33554432))
								{
									func_47("MG_YOU_IS_BROKE", iLocal_137, -1);
									func_62(&uLocal_111, 33554432);
								}
							}
							else
							{
								func_94(&uLocal_111, 33554432);
							}
							...
							if (bVar2)
							{
								...
								if (func_46(iLocal_103))
								{
									if (iLocal_113 == -1)
									{
										if (iLocal_137 > 0)
										{
											func_45(&iLocal_113, 4, "", 1, 0, 0, 0);
											func_44(sLocal_118, iLocal_137);
											func_62(&uLocal_111, 2048);
										}
										else
										{
									...
									else if (!func_90(uLocal_111, 2048) || !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED())
									{
										func_43(&iLocal_113);
										func_94(&uLocal_111, 2048);
									}
									if (func_41(iLocal_113, 1))
									{
										sLocal_118 = sLocal_118;
										func_43(&iLocal_113);
										func_94(&uLocal_111, 2048);
										if (func_90(uLocal_111, 2048))
										{
										...
										SCRIPT::REQUEST_SCRIPT(&cLocal_86);
				...
				case 5:
					PAD::SET_INPUT_EXCLUSIVE(0, 51);
					if (SCRIPT::HAS_SCRIPT_LOADED(&cLocal_86))
					{
						if (iLocal_113 != -1)
						{
							func_43(&iLocal_113);
						...
						if (iVar4 != 1)
						{
							iVar4 = func_36(&iLocal_115, 6, iLocal_117, 0, 0);
						}
						if (iVar4 == 1)
						{
							...
							iLocal_69 = SYSTEM::START_NEW_SCRIPT(&cLocal_86, iLocal_114);
							SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED(&cLocal_86);
							Local_70 = { cLocal_86 };
							StringCopy(&cLocal_86, "", 64);
							func_94(&uLocal_111, 4);
							func_25();
							func_62(&uLocal_111, 2);
							func_83(6);
							func_21(&iLocal_124);
							if (iLocal_116 != -1)
							{
				...
				case 6:
					if (func_90(Global_113609, 262144))
					{
						func_94(&Global_113609, 262144);
						func_15();
					}
					if (func_90(uLocal_111, 2097152))
					{
						if (!func_76(3) && !SCRIPT::IS_THREAD_ACTIVE(iLocal_69))
						{
							func_83(10);
						}
					}
					if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_69))
					{
						...
						func_10(&iLocal_124);
						func_94(&uLocal_111, 256);
						func_7();
						if (bVar0)
						{
							func_94(&uLocal_111, 2);
						}
						else if (func_90(uLocal_111, 2))
						{
							if (func_90(Global_113609, 0))
							{
								func_6(&iLocal_115);
								iLocal_115 = -1;
								func_94(&uLocal_111, 2);
						...
						func_4();
						func_94(&Global_113609, 0);
						if (func_90(uLocal_111, 16777216))
						{
							func_96(1);
						}
						if (iLocal_116 != -1)
					...
					if ((iLocal_121 % 150) == 0)
					{
						if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
						{
							if (iLocal_123 == 2)
							{
								if (iLocal_123 == 2)
								{
									if (func_88(iLocal_117) && func_87(0, iLocal_116))
									{
										func_91();
										if (iLocal_122 != 263)
										{
...
void func_39()
{
	if (ENTITY::IS_ENTITY_AT_COORD(iLocal_102, Local_107, fLocal_134, fLocal_134, 2f, false, true, iLocal_120))
	{
...
void func_50()
{
	...
	{
		if (func_53(Global_114963.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_52(PLAYER::PLAYER_PED_ID());
			if (func_51(iVar0) && (!func_78(14) || Global_113909))
			{
				if (Global_114963.f_2370.f_539.f_4321 != iVar0 && func_51(Global_114963.f_2370.f_539.f_4321))
				{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_73()) || Global_33818) || func_72()) || func_58(8, -1)) || func_69()) || func_71()) || func_70()) || func_60()) || Global_114963.f_7697.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_73()) || Global_114010) || Global_33818) || func_72()) || func_58(8, -1)) || func_69()) || func_71()) || func_70()) || func_60()) || Global_114963.f_7697.f_919[iVar0] == 5) || Global_45468 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_73()) || Global_114010) || Global_33818) || func_72()) || func_58(8, -1)) || func_71()) || func_70()) || func_60()) || Global_114963.f_7697.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_73() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_58(8, -1)) || func_60()) || func_68()) || Global_114963.f_7697.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_73()) || Global_33818) || func_72()) || func_58(8, -1)) || func_70()) || func_69()) || func_60()) || Global_114963.f_7697.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_73()) || func_70()) || Global_114010) || Global_33818) || func_72()) || Global_46147) || func_58(8, -1)) || func_69()) || func_68()) || func_60()) || Global_114963.f_7697.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_73()) || Global_114010) || Global_33818) || func_72()) || func_58(8, -1)) || func_69()) || func_68()) || func_71()) || func_70()) || func_60())
						{
							return 0;
						}
						break;
...
{
	return func_89(iParam0, Global_44921);
}
...
void func_91()
{
	StringCopy(&Local_70, "golf", 64);
	iLocal_116 = 2;
	fLocal_134 = 7f;
	func_79(&uLocal_111, 1);
	if (func_78(6) || func_78(7))
	{
		iLocal_120 = 0;
	}
	...
	{
		iLocal_137 = func_93(ENTITY::DOES_ENTITY_EXIST(func_75()));
		sLocal_118 = "PAY_PLAY_GOLF";
	}
	iLocal_122 = 68;
...
void func_96(bool bParam0)
{
	...
	if (func_90(uLocal_111, 2048))
	{
		if (func_99(sLocal_118, iLocal_137))
		{
			func_94(&uLocal_111, 2048);
			HUD::CLEAR_HELP(false);
		}
	}
	if (func_90(uLocal_111, 2))
	{
		func_4();
		func_94(&uLocal_111, 2);
		func_6(&iLocal_115);
...
void func_97()
{
	...
	if (!MISC::IS_STRING_NULL(&cLocal_86))
	{
		if (HUD::GET_LENGTH_OF_LITERAL_STRING(&cLocal_86) != 0)
		{
			SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED(&cLocal_86);
		}
	}
