...
void main() // Position - 0x0 Hash - 0x5D84F89F ^0x5D84F89F
{
	...
	while (num == 1)
	{
		...
		{
			if (!func_89() && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(-892862129) == 0)
			{
				func_108();
		...
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		{
			if (PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), pedLocal_240) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), pedLocal_240) && num6 < 25f && func_88(PLAYER::PLAYER_PED_ID()) != -1569615261 && func_85(pedLocal_240, PLAYER::PLAYER_PED_ID(), 1126825984, 0))
			{
				if (!func_89())
				{
					func_91();
...
int func_16() // Position - 0x1630 Hash - 0x3C5423D7 ^0x3C5423D7
{
	func_17();
...
BOOL func_19(int iParam0) // Position - 0x1754 Hash - 0x8907F004 ^0x8907F004
{
	return iParam0 < 3;
}

int func_20(Ped pedParam0) // Position - 0x1760 Hash - 0xAC4E9801 ^0xB379A75F
{
	int i;
	Hash entityModel;
...
Hash func_21(int iParam0) // Position - 0x179D Hash - 0xADCB9755 ^0xADCB9755
{
	if (func_19(iParam0))
...
Hash func_22(int iParam0) // Position - 0x17C2 Hash - 0xE4CEEC2C ^0xE4CEEC2C
{
...
BOOL func_33(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x1B3F Hash - 0x384540C1 ^0x384540C1
{
...
Player func_39() // Position - 0x1F1D Hash - 0x478900E4 ^0x478900E4
{
	return -1;
}
...
void func_44() // Position - 0x20AB Hash - 0x98476CE1 ^0x250FEB7C
{
	if (func_18(14))
	{
...
void func_47(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x21DB Hash - 0xC6B752B2 ^0xC6B752B2
{
...
void func_49(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x226C Hash - 0x6C235EE0 ^0x9E57F206
{
...
BOOL func_61() // Position - 0x2506 Hash - 0x152DA0B2 ^0x220E93E9
{
...
BOOL func_102(Ped pedParam0) // Position - 0x3110 Hash - 0x3D210083 ^0xF7E7C389
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
		if (!ENTITY::IS_ENTITY_DEAD(pedParam0, false))
			return true;
...
void func_104() // Position - 0x313D Hash - 0xC0ED12C6 ^0x43D2784A
{
	...
	obLocal_448 = OBJECT::CREATE_OBJECT(-1202268978, ENTITY::GET_ENTITY_COORDS(pedLocal_240, true), true, true, false);
