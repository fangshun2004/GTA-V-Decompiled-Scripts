...
void func_9() // Hash - 0xCA36F757 ^0x66589377
{
...
int func_15() // Hash - 0x2CAA07 ^0x2CAA07
{
	int num;
...
void func_24(char* sParam0) // Hash - 0x2C5C83C1 ^0x5E5574B7
{
	int num;
...
void func_25(char* sParam0) // Hash - 0x3372085F ^0xF57CEDEC
{
	int num;
...
void func_26(int iParam0, char* sParam1) // Hash - 0xC4958D46 ^0x8D601007
{
	switch (iParam0)
	{
		case 0:
...
void func_27(char* sParam0) // Hash - 0x3018B517 ^0x5180585A
{
	var unk;
...
void func_29(char* sParam0) // Hash - 0x3BD51041 ^0x8F9992F1
{
...
void func_31(char* sParam0) // Hash - 0xE431A142 ^0xF8C030B3
{
	int num;
...
void func_50(char* sParam0) // Hash - 0xB19D680C ^0xEE1E641
{
	int num;
...
void func_57(int iParam0, char* sParam1, char* sParam2) // Hash - 0xA1B3AA65 ^0xE15E3D18
{
...
void func_64(char* sParam0) // Hash - 0xD55EAE22 ^0x54D1196A
{
	var unk;
...
void func_66(char* sParam0) // Hash - 0x217F514E ^0x50263B16
{
...
void func_73(char* sParam0) // Hash - 0x2E18739A ^0x9CAA685E
{
...
char* func_74(int iParam0) // Hash - 0xE6862179 ^0x92F329A1
{
	switch (iParam0)
	{
		case 0:
...
void func_104() // Hash - 0xC0ED12C6 ^0x43D2784A
{
...
void func_105() // Hash - 0x5D537092 ^0xE7C5D490
{
	...
	bLocal_436 = !Global_3;
	iLocal_252 = 8;
	sLocal_303 = _("Press ~INPUT_CONTEXT~ to talk to Griff.");
...
BOOL func_110(int iParam0) // Hash - 0xC86BC762 ^0xC86BC762
{
...
int func_112(const char* sParam0) // Hash - 0xD5121E5F ^0x5420718F
{
...
void func_113(int iParam0) // Hash - 0x8B2883F3 ^0x111D5E85
{
	var string1;
...
void func_114(Blip* pblParam0) // Hash - 0x4C359FE5 ^0xBAF5111C
{
	if (HUD::DOES_BLIP_EXIST(*pblParam0))
	{
...
struct<6> func_115() // Hash - 0xB37EF8EF ^0xB37EF8EF
{
	var unk;
...
void func_116() // Hash - 0xD8C6DE12 ^0xD8C6DE12
{
	func_117();
	return;
}

void func_117() // Hash - 0xA826E0F3 ^0xF53D1F97
{
	if (ENTITY::DOES_ENTITY_EXIST(obLocal_448))
...
void func_118() // Hash - 0x66F88FF ^0x478E9B29
{
	if (iLocal_245 == -1)
