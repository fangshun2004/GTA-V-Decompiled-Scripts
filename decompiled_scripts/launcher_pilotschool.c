...
void __EntryFunction__()
{
	...
	iLocal_112 = 0;
	func_90(&Global_113609, 0);
	func_89();
	if (func_88(uLocal_111, 1))
	{
		iLocal_117 = 10;
	}
	else
	...
	if (func_88(uLocal_111, 8388608))
	{
		func_92(1);
	}
	if (func_88(uLocal_111, 524288) && (func_84() && !func_83()))
	{
		func_92(1);
	}
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_88(uLocal_111, 4194304))
	{
		if (iLocal_122 != 263)
		{
			func_82(iLocal_122, 1, 0);
			iLocal_122 = 263;
		}
		func_81(10);
	}
	while (true)
	{
		if (!func_88(uLocal_111, 268435456))
		{
			fVar1 = 0f;
			if (MISC::GET_GROUND_Z_FOR_3D_COORD(ScriptParam_0.f_1[0 /*3*/], &fVar1, false, false))
			{
				if (fVar1 != 0f)
				{
					...
					func_80(&uLocal_111, 268435456);
				}
			}
		}
		iLocal_102 = PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID());
		if (func_88(uLocal_111, 1048576))
		{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_102) && !ENTITY::IS_ENTITY_DEAD(iLocal_102, false))
		{
			...
			{
				case 0:
					if (func_86(iLocal_117) || (func_88(uLocal_111, 16) && !func_88(uLocal_111, 524288)))
					{
						iLocal_115 = -1;
						func_79();
						func_81(1);
				...
				case 3:
					...
					if (!func_88(uLocal_111, 4))
					{
						func_77();
						func_80(&uLocal_111, 4);
					}
					...
					{
						Local_86 = { Local_70 };
						bVar3 = !func_88(uLocal_111, 64);
						func_90(&uLocal_111, 128);
						if (!func_74(3) && !Global_102520)
						{
							if (func_88(uLocal_111, 2097152))
							{
								if ((!func_88(uLocal_111, 1) || !ENTITY::DOES_ENTITY_EXIST(func_73())) && !Global_102520)
								{
									func_81(10);
									break;
								}
						...
						if ((!func_58(6) || Global_114010) || func_57())
						{
							bVar3 = false;
						}
						if (func_88(uLocal_111, 1))
						...
						if (bVar3)
						{
							...
							if (bVar3)
							{
								...
								if (func_47(uLocal_103))
								{
									if (iLocal_113 == -1)
									{
										func_46(&iLocal_113, 4, sLocal_118, 0, 0, 0, 0);
										func_54(&uLocal_111, 2048);
									}
									else if (!func_88(uLocal_111, 2048) || !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED())
									{
										func_45(&iLocal_113);
										func_90(&uLocal_111, 2048);
									}
									if (func_43(iLocal_113, 1))
									{
				...
				case 5:
					...
					if (SCRIPT::HAS_SCRIPT_LOADED(&Local_86))
					{
						...
						if (iVar4 != 1)
						{
							iVar4 = func_39(&iLocal_115, 6, iLocal_117, 0, 0);
						}
						if (iVar4 == 1)
						{
							...
							iLocal_69 = func_28();
							func_90(&uLocal_111, 4);
							func_27();
							func_54(&uLocal_111, 2);
							func_81(6);
							func_23(&iLocal_124);
							if (iLocal_116 != -1)
							{
				...
				case 6:
					if (!func_88(uLocal_111, 256))
					{
						...
						{
							func_54(&uLocal_111, 256);
						}
					}
					if (func_88(Global_113609, 262144))
					{
						func_90(&Global_113609, 262144);
						func_17();
					}
					if (func_88(uLocal_111, 2097152))
					{
					...
					if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_69))
					{
						...
						func_12(&iLocal_124);
						func_90(&uLocal_111, 256);
						func_9();
						if (bVar0)
						{
							func_90(&uLocal_111, 2);
						}
						else if (func_88(uLocal_111, 2))
						{
							if (func_88(Global_113609, 0))
							{
								func_8(&iLocal_115);
								iLocal_115 = -1;
								func_90(&uLocal_111, 2);
						...
						func_4();
						func_90(&Global_113609, 0);
						if (func_88(uLocal_111, 16777216))
						{
							func_92(1);
						}
						if (iLocal_116 != -1)
					...
					if ((iLocal_121 % 150) == 0)
					{
						if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
						{
							if (iLocal_123 == 2)
							{
								if (iLocal_123 == 2)
								{
									if (func_86(iLocal_117) && func_85(0, iLocal_116))
									{
										func_89();
										if (iLocal_122 != 263)
										{
...
int func_28()
{
	...
	iVar0 = SYSTEM::START_NEW_SCRIPT_WITH_ARGS(&Local_70, &uLocal_135, 4, iLocal_114);
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_65()) || Global_114010) || Global_33818) || func_64()) || func_50(8, -1)) || func_63()) || func_62()) || func_61()) || func_52()) || Global_114963.f_7697.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_65()) || Global_33818) || func_64()) || func_50(8, -1)) || func_61()) || func_63()) || func_62()) || func_52()) || Global_114963.f_7697.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_65()) || Global_114010) || Global_33818) || func_64()) || func_50(8, -1)) || func_61()) || func_63()) || func_62()) || func_52()) || Global_114963.f_7697.f_919[iVar0] == 5) || Global_45468 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_65()) || Global_114010) || Global_33818) || func_64()) || func_50(8, -1)) || func_63()) || func_62()) || func_52()) || Global_114963.f_7697.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_65() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_50(8, -1)) || func_52()) || func_60()) || Global_114963.f_7697.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_65()) || Global_33818) || func_64()) || func_50(8, -1)) || func_62()) || func_61()) || func_52()) || Global_114963.f_7697.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_65()) || func_62()) || Global_114010) || Global_33818) || func_64()) || Global_46147) || func_50(8, -1)) || func_61()) || func_60()) || func_52()) || Global_114963.f_7697.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_65()) || Global_114010) || Global_33818) || func_64()) || func_50(8, -1)) || func_61()) || func_60()) || func_63()) || func_62()) || func_52())
						{
							return 0;
						}
						break;
...
void func_68()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_70(Global_114963.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_66(iVar0) && (!func_76(14) || Global_113909))
			{
				if (Global_114963.f_2370.f_539.f_4321 != iVar0 && func_66(Global_114963.f_2370.f_539.f_4321))
				{
...
{
	iLocal_116 = 5;
	sLocal_118 = "PLAY_PSCHOOL";
	StringCopy(&Local_70, "Pilot_School", 64);
	iLocal_114 = 64500;
}
