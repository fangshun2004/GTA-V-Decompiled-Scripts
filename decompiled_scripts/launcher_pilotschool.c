...
void main() // Hash - 0x5D84F89F ^0x5D84F89F
{
	...
	while (true)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(pedLocal_85) && !ENTITY::IS_ENTITY_DEAD(pedLocal_85, false))
		{
			...
			{
				case 0:
					if (func_86(iLocal_100) || func_88(iLocal_94, 16) && !func_88(iLocal_94, 524288))
					{
						iLocal_98 = -1;
						func_79();
						func_81(1);
...
void func_4() // Hash - 0x54615105 ^0x54615105
{
	func_5(&uLocal_122);
	return;
}
...
void func_29(Ped pedParam0) // Hash - 0x91438920 ^0xDA692F14
{
	int num;
	int num2;
	int num3;
...
void func_30(int iParam0) // Hash - 0xBB510F32 ^0xE77AE77B
{
...
int func_31(Ped pedParam0) // Hash - 0x14AF2EDD ^0xC5BC7CD2
{
	int i;
...
void func_32(int iParam0, int iParam1, int iParam2) // Hash - 0xF54D70EF ^0xF54D70EF
{
	func_33(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_33(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Hash - 0x9F3D8BA2 ^0x9F3D8BA2
{
	int num;
...
int func_34() // Hash - 0x11506CC4 ^0x2E9F5641
{
	int i;
...
BOOL func_35(int iParam0, int iParam1, int iParam2) // Hash - 0x3A30B8C2 ^0x3A30B8C2
{
...
int func_36(int iParam0, int iParam1, int iParam2) // Hash - 0x61F8C119 ^0x1C9B84EC
{
	int i;
...
int func_37(Ped pedParam0) // Hash - 0xDCBB968F ^0xDCBB968F
{
	int i;
...
void func_38() // Hash - 0x53295875 ^0x53295875
{
...
int func_39(var uParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Hash - 0x8F9349A ^0xC5C097C1
{
	int i;
...
void func_40(var uParam0, int iParam1) // Hash - 0x6AC97785 ^0x6AC97785
{
	int i;
...
BOOL func_41(int iParam0) // Hash - 0x3BAB94E9 ^0x3BAB94E9
{
	if (Global_43257 == 15)
		return false;
...
void func_42() // Hash - 0xB4E0F37 ^0x6DE553F7
{
	if (func_75(76))
...
BOOL func_43(int iParam0, BOOL bParam1) // Hash - 0xE8E8EFB4 ^0x98461D05
{
	int num;
...
void func_45(var uParam0) // Hash - 0xFE5630E8 ^0xFE5630E8
{
	int num;
...
void func_46(var uParam0, int iParam1, char* sParam2, int iParam3, const char* sParam4, int iParam5, int iParam6) // Hash - 0xC67F23A2 ^0xEFF6309F
{
	int i;
...
BOOL func_47(var uParam0) // Hash - 0x2DF5A077 ^0x2DF5A077
{
	return true;
}
...
BOOL func_49(int iParam0) // Hash - 0xE8921B44 ^0x4F063755
{
	if (iParam0 == 1)
...
BOOL func_51() // Hash - 0x44A439DC ^0x3D5209CD
{
	return MISC::GET_GAME_TIMER() <= Global_23270.f_6321 + 100;
}

BOOL func_52() // Hash - 0x3CA1BB47 ^0xB78A1ACB
{
...
BOOL func_53(BOOL bParam0) // Hash - 0x1F743529 ^0xDFDFCA73
{
	if (bParam0)
...
BOOL func_57() // Hash - 0xC7110B3 ^0x51D25EBB
{
	int weaponHash;
	BOOL flag;
...
BOOL func_58(int iParam0) // Hash - 0x97844555 ^0xADCD6DAA
{
	int num;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_65() || Global_112695 || Global_32166 || func_64() || func_50(8, -1) || func_63() || func_62() || func_61() || func_52() || Global_113648.f_7690.f_919[num] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_65() || Global_32166 || func_64() || func_50(8, -1) || func_61() || func_63() || func_62() || func_52() || Global_113648.f_7690.f_919[num] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_65() || Global_112695 || Global_32166 || func_64() || func_50(8, -1) || func_61() || func_63() || func_62() || func_52() || Global_113648.f_7690.f_919[num] == 5 || Global_43804 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_65() || Global_112695 || Global_32166 || func_64() || func_50(8, -1) || func_63() || func_62() || func_52() || Global_113648.f_7690.f_919[num] == 5)
							return false;
						break;
				
					case 4:
						if (func_65() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_50(8, -1) || func_52() || func_60() || Global_113648.f_7690.f_919[num] == 5)
							return false;
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_65() || Global_32166 || func_64() || func_50(8, -1) || func_62() || func_61() || func_52() || Global_113648.f_7690.f_919[num] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_65() || func_62() || Global_112695 || Global_32166 || func_64() || Global_44446 || func_50(8, -1) || func_61() || func_60() || func_52() || Global_113648.f_7690.f_919[num] == 5)
							return false;
						break;
...
BOOL func_59() // Hash - 0x4228A1C2 ^0x952FE30F
{
	return Global_100720.f_1;
}

BOOL func_60() // Hash - 0xC20DBA70 ^0xAC4006FB
{
	if (Global_97603 != -1)
...
BOOL func_61() // Hash - 0xE663B8F6 ^0xE663B8F6
{
	if (Global_78819)
		return true;
...
BOOL func_62() // Hash - 0xD56328D2 ^0xD56328D2
{
...
BOOL func_65() // Hash - 0x7FE517FE ^0x128A3BC8
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
BOOL func_66(int iParam0) // Hash - 0x8907F004 ^0x8907F004
{
	return iParam0 < 3;
}
...
void func_68() // Hash - 0xD1F2D853 ^0xF9F5FD4D
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_70(Global_113648.f_2365.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_66(num) && !func_76(14) || Global_112599)
			{
				if (Global_113648.f_2365.f_539.f_4321 != num && func_66(Global_113648.f_2365.f_539.f_4321))
...
BOOL func_72() // Hash - 0x3CA1BB47 ^0x4BFFF917
{
...
Entity func_73() // Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_96513;
}

BOOL func_74(int iParam0) // Hash - 0x6ACD7BFA ^0x6ACD7BFA
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_75(int iParam0) // Hash - 0x7524A8DB ^0x409ED99B
{
	int num;
...
void func_77() // Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_78() // Hash - 0xFD255207 ^0xFD255207
{
	return true;
}

void func_79() // Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_80(var uParam0, int iParam1) // Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_81(int iParam0) // Hash - 0x28DF00E8 ^0x28DF00E8
{
	iLocal_95 = iParam0;
	return;
}

void func_82(int iParam0, BOOL bParam1, BOOL bParam2) // Hash - 0x3DFD90D4 ^0xB85FE721
{
	int num;
	BOOL flag;
...
BOOL func_83() // Hash - 0x29CB2928 ^0xE369A18D
{
...
BOOL func_85(int iParam0, int iParam1) // Hash - 0xDEE74A4E ^0xDEE74A4E
{
	BOOL flag;
...
BOOL func_86(int iParam0) // Hash - 0xECB6C71B ^0xECB6C71B
{
	return func_87(iParam0, Global_43257);
}

BOOL func_87(int iParam0, int iParam1) // Hash - 0x1FD727E0 ^0x1FD727E0
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_88(int iParam0, int iParam1) // Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_89() // Hash - 0xC7E459BA ^0x279E2978
{
	iLocal_99 = 5;
	sLocal_101 = _("Press ~INPUT_CONTEXT~ to enter Flight School.");
	TEXT_LABEL_ASSIGN_STRING(&uLocal_53, "Pilot_School", 64);
	essLocal_97 = 54000;
	return;
}

void func_90(int iParam0, int iParam1) // Hash - 0xF55E891F ^0xF55E891F
{
	func_91(iParam0, iParam1);
	return;
}

void func_91(var uParam0, int iParam1) // Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_92(BOOL bParam0) // Hash - 0x12400ACB ^0x3A862E90
{
	if (bParam0)
		if (iLocal_105 != 263)
...
void func_93() // Hash - 0xC88B3A8B ^0xCE5EF390
{
	func_90(&iLocal_94, 4);
	func_94();
...
void func_94() // Hash - 0x6CC2F021 ^0x6CC2F021
{
	if (bLocal_123)
		func_95(76);
...
void func_95(int iParam0) // Hash - 0x1281F51C ^0xDCF2FE21
{
	if (iParam0 != 263)
