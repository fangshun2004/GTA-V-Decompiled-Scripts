...
void main() // Position - 0x0 Hash - 0x5D84F89F ^0x5D84F89F
{
	...
	iLocal_105 = 263;
	fLocal_117 = 4f;
	uLocal_90 = { uScriptParam_128.f_1[0 /*3*/] };
	uLocal_90 = { uLocal_90 };
	uLocal_86 = uLocal_86;
	uLocal_69 = { uLocal_69 };
	flag = false;
	...
	while (true)
	{
		if (!func_88(iLocal_94, 268435456))
		{
			...
			if (MISC::GET_GROUND_Z_FOR_3D_COORD(uScriptParam_128.f_1[0 /*3*/], &groundZ, false, false))
			{
				if (groundZ != 0f)
				{
					uScriptParam_128.f_1[0 /*3*/].f_2 = groundZ;
		...
		if (ENTITY::DOES_ENTITY_EXIST(pedLocal_85) && !ENTITY::IS_ENTITY_DEAD(pedLocal_85, false))
		{
			...
			fLocal_93 = SYSTEM::VDIST2(uLocal_87, uScriptParam_128.f_1[0 /*3*/]);
			fLocal_93 = fLocal_93;
			uLocal_111 = { uLocal_87 };
			uLocal_114 = { uScriptParam_128.f_1[0 /*3*/] };
			uLocal_111.f_2 = 0f;
			uLocal_114.f_2 = 0f;
			...
			switch (iLocal_95)
			{
				case 0:
					...
					else
					{
						...
						uLocal_87.f_2 - uScriptParam_128.f_1[0 /*3*/].f_2 > 500f;
					}
					break;
				...
				case 3:
					...
					else
					{
						...
						if (flag3)
						{
							if (!ENTITY::IS_ENTITY_AT_COORD(pedLocal_85, uScriptParam_128.f_1[0 /*3*/], fLocal_117, fLocal_117, 2f, false, true, iLocal_103))
								flag3 = false;
...
BOOL func_1(char* sParam0) // Position - 0xA75 Hash - 0xCD6A3595 ^0xB0E86AA0
{
...
BOOL func_6(Vehicle veParam0) // Position - 0xADD Hash - 0x2E9AC124 ^0x1451AD2A
{
...
void func_7(char* sParam0, int iParam1, Any anParam2, BOOL bParam3, BOOL bParam4) // Position - 0xB20 Hash - 0xE9AC9AEE ^0xA4AB7C48
{
...
BOOL func_10() // Position - 0xBE3 Hash - 0x4C81F065 ^0x26D68D51
{
	return MISC::IS_ORBIS_VERSION() || unk_0xEE17703CF2C2875A();
}

BOOL func_11() // Position - 0xBF9 Hash - 0x4C81F065 ^0x60494CEC
{
...
void func_19(char* sParam0, int iParam1, int iParam2) // Position - 0xCE4 Hash - 0x8572F920 ^0xA7259CBD
{
	...
	unk_0x363D7D2154F0040D(sParam0, iParam1, iParam2, func_20(false));
	return;
}

BOOL func_20(BOOL bParam0) // Position - 0xD25 Hash - 0x15889021 ^0xE7262364
{
...
void func_45(var uParam0) // Position - 0x1574 Hash - 0xFE5630E8 ^0xFE5630E8
{
	int num;
...
void func_46(var uParam0, int iParam1, char* sParam2, int iParam3, const char* sParam4, int iParam5, int iParam6) // Position - 0x15CB Hash - 0xC67F23A2 ^0xEFF6309F
{
	int i;
...
BOOL func_66(int iParam0) // Position - 0x20E8 Hash - 0x8907F004 ^0x8907F004
{
	return iParam0 < 3;
}

int func_67() // Position - 0x20F4 Hash - 0x3C5423D7 ^0x3C5423D7
{
	func_68();
...
int func_69(Ped pedParam0) // Position - 0x220A Hash - 0xAC4E9801 ^0xB379A75F
{
	int i;
	Hash entityModel;
...
Hash func_70(int iParam0) // Position - 0x2247 Hash - 0xADCB9755 ^0xADCB9755
{
	if (func_66(iParam0))
...
Hash func_71(int iParam0) // Position - 0x226C Hash - 0xE4CEEC2C ^0xE4CEEC2C
{
...
Entity func_73() // Position - 0x2295 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_96513;
}
...
BOOL func_86(int iParam0) // Position - 0x251D Hash - 0xECB6C71B ^0xECB6C71B
{
...
void func_89() // Position - 0x271E Hash - 0xC7E459BA ^0x279E2978
{
	iLocal_99 = 5;
