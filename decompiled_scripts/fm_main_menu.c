#region Local Var
	...
	var uLocal_152 = 0;
	var uLocal_153 = 0;
	struct<6> Local_154 = { 0, 0, 0, 0, 0, -1 } ;
	var uLocal_160 = 0;
	var uLocal_161 = 0;
	var uLocal_162 = 3;
	var uLocal_163 = 17;
...
void __EntryFunction__()
{
	...
	uLocal_275 = Global_4718592.f_2;
	Global_1574605 = 0;
	Local_154.f_5 = Global_4718592;
	Global_1574533 = 0;
	Global_1574606 = 0;
	iLocal_274 = Global_4718592;
	if (Global_4718592 == 0)
	{
		Global_4718592.f_2 = uLocal_275;
	}
	Global_1926868 = 0;
	while (true)
	{
		if (iLocal_274 != Global_4718592)
		{
			func_20(&Local_154);
			iLocal_274 = Global_4718592;
			MISC::CLEAR_BIT(&(Local_154.f_4), 0);
		}
		if (func_19() == 3)
		{
			func_21();
		...
		switch (iLocal_272)
		{
			...
			case 1:
				if (Local_154.f_5 != Global_4718592)
				{
					Local_154.f_5 = Global_4718592;
					func_20(&Local_154);
				}
...
int func_3(int* iParam0)
{
	if (!BitTest(*iParam0, 2))
	{
		...
		if (SCRIPT::HAS_SCRIPT_LOADED("FM_Race_Creator"))
		{
			if (!func_4())
			{
				SYSTEM::START_NEW_SCRIPT("FM_Race_Creator", 64500);
...
int func_6(int* iParam0)
{
	if (!BitTest(*iParam0, 2))
	{
		...
		if (SCRIPT::HAS_SCRIPT_LOADED("FM_Deathmatch_Creator"))
		{
			if (!func_4())
			{
				SYSTEM::START_NEW_SCRIPT("FM_Deathmatch_Creator", 64500);
...
int func_7(int* iParam0)
{
	if (!BitTest(*iParam0, 2))
	{
		...
		if (SCRIPT::HAS_SCRIPT_LOADED("FM_Capture_Creator"))
		{
			if (!func_4())
			{
				SYSTEM::START_NEW_SCRIPT("FM_Capture_Creator", 64500);
...
int func_8(int* iParam0)
{
	if (!BitTest(*iParam0, 2))
	{
		...
		if (SCRIPT::HAS_SCRIPT_LOADED("Public_Mission_Creator"))
		{
			if (!func_4())
			{
				SYSTEM::START_NEW_SCRIPT("Public_Mission_Creator", 64500);
...
int func_9(int* iParam0)
{
	if (!BitTest(*iParam0, 2))
	{
		...
		if (SCRIPT::HAS_SCRIPT_LOADED("Freemode_Creator"))
		{
			if (!func_4())
			{
				SYSTEM::START_NEW_SCRIPT("Freemode_Creator", 64500);
...
int func_10(int* iParam0)
{
	if (!BitTest(*iParam0, 2))
	{
		...
		if (SCRIPT::HAS_SCRIPT_LOADED("Basic_Creator"))
		{
			if (!func_4())
			{
				SYSTEM::START_NEW_SCRIPT("Basic_Creator", 64500);
...
int func_11(int* iParam0)
{
	if (!BitTest(*iParam0, 2))
	{
		...
		if (SCRIPT::HAS_SCRIPT_LOADED("FM_Survival_Creator"))
		{
			if (!func_4())
			{
				SYSTEM::START_NEW_SCRIPT("FM_Survival_Creator", 64500);
...
int func_13(int* iParam0)
{
	if (!BitTest(*iParam0, 2))
	{
		...
		if (SCRIPT::HAS_SCRIPT_LOADED("FM_LTS_Creator"))
		{
			if (!func_4())
			{
				SYSTEM::START_NEW_SCRIPT("FM_LTS_Creator", 64500);
...
int func_14(bool bParam0)
{
	...
	if ((((((Global_4718592 == 0 || Global_4718592 == 4) || Global_4718592 == 6) || Global_4718592 == 3) || Global_4718592 == 31) || (Global_4718592.f_2 == 6 && Global_4718592 == 0)) || (Global_4718592.f_2 == 5 && Global_4718592 == 0))
	{
		return 1;
	}
	return 0;
...
bool func_16()
{
	return (Global_24430.f_5 || Global_24430.f_6);
}
...
void func_17(var uParam0)
{
	if (Global_4718592 == 0)
	{
		Global_4718592.f_3768 = uParam0->f_8[0 /*18*/][5];
		Global_4718592.f_3769 = uParam0->f_8[0 /*18*/][5];
		Global_4718592.f_3773 = uParam0->f_8[0 /*18*/][7] + 1;
	}
	else if (Global_4718592 == 1)
	{
	}
	...
	{
		Global_4718592.f_3768 = uParam0->f_8[2 /*18*/][4];
		Global_4718592.f_121957 = uParam0->f_8[2 /*18*/][7];
	}
}
...
int func_19()
{
	if (BitTest(Global_1677555.f_102, 1))
	{
		return 1;
	}
	if (BitTest(Global_1677555.f_102, 2))
	{
		MISC::CLEAR_BIT(&(Global_1677555.f_102), 2);
		return 2;
	}
	if (BitTest(Global_1677555.f_102, 3))
	{
		MISC::CLEAR_BIT(&(Global_1677555.f_102), 3);
		return 3;
	}
	return 0;
}
