...
void __EntryFunction__()
{
	...
	while (iLocal_70)
	{
		SYSTEM::WAIT(0);
		iLocal_70 = 0;
		if (func_45(1, Local_99, 1.5f))
		{
			func_36(&uLocal_130, &iLocal_131, &uLocal_134, &uLocal_135, Local_99, "v_franklinshouse");
			if (func_35(126))
			{
				func_1(2, &uLocal_65, Local_99, 30f, 22.5f, 7.5f, &uLocal_83);
			}
			iLocal_70 = 1;
		}
	}
...
int func_1(int iParam0, var uParam1, struct<3> Param2, struct<3> Param5, var uParam8)
{
	...
	while (iVar0 < 3)
	{
		...
		if (!func_31(iVar1))
		{
			if (ENTITY::DOES_ENTITY_EXIST(Global_99939[iVar0]))
			{
...
void func_23()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_26(Global_114963.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_29(iVar0) && (!func_24(14) || Global_113909))
			{
...
int func_28(int iParam0)
{
	if (func_29(iParam0))
	{
		if ((Global_114963.f_9094 || Global_4) || func_5(0))
		{
...
int func_46(int iParam0)
{
	...
	if (!BitTest(Global_114963.f_9094.f_2[27 /*3*/], 1))
	{
		return 0;
	}
	return 1;
...
void func_51()
{
	...
	func_52(&uLocal_141, 0, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
}
...
void func_54()
{
	...
	while (iVar0 < 1)
	{
		...
		if (iVar1 < 15)
		{
			if (Global_97467[iVar1] != 141)
			{
				func_58(iVar1);
				Global_97467[iVar1] = 141;
			}
			func_55(iVar1);
		}
		iVar0++;
...
void func_65(int iParam0)
{
	...
	while (iVar15 < Global_114963.f_7697.f_198)
	{
		...
		{
			func_66(Global_114963.f_7697.f_137[iVar15 /*15*/].f_6);
			iVar16 = iVar15;
...
int func_66(int iParam0)
{
	...
	{
		if (func_72(iParam0, Global_21649) == 1)
		{
			func_71(iParam0, Global_21649, 0);
			if (func_70(iParam0, Global_21649) == 0)
			{
				iVar0 = Global_21649;
