...
void main() // Position - 0x0 Hash - 0x25236ADA ^0x25236ADA
{
	...
	iLocal_146 = -1;
	sLocal_151 = "REYE_AU";
	func_173(uScriptParam_317.f_1[0 /*3*/]);

	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(27))
		func_172();

	if (func_145(uScriptParam_317.f_1[0 /*3*/], 30, 0, false, false))
		func_143(30);
	else
...
BOOL func_2(Ped pedParam0) // Position - 0x2A0 Hash - 0x3D210083 ^0xF7E7C389
{
...
void func_4() // Position - 0x5C0 Hash - 0xC43B8F66 ^0x5FCFC8A0
{
...
BOOL func_7(BOOL bParam0) // Position - 0x65C Hash - 0x15889021 ^0xE7262364
{
...
void func_14(int iParam0, int iParam1, int iParam2) // Position - 0xD95 Hash - 0xCF91FBA1 ^0xC4FE4CB6
{
	if (iParam2 == -1)
		iParam2 = func_15();
...
BOOL func_25(int iParam0) // Position - 0x1600 Hash - 0x8907F004 ^0x8907F004
{
	return iParam0 < 3;
}

int func_26(Ped pedParam0) // Position - 0x160C Hash - 0xAC4E9801 ^0xB379A75F
{
	int i;
	Hash entityModel;
...
Hash func_27(int iParam0) // Position - 0x1649 Hash - 0xADCB9755 ^0xADCB9755
{
	if (func_25(iParam0))
...
Hash func_28(int iParam0) // Position - 0x166E Hash - 0xE4CEEC2C ^0xE4CEEC2C
{
...
BOOL func_39(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x1CDA Hash - 0x384540C1 ^0x384540C1
{
...
Player func_45() // Position - 0x20B8 Hash - 0x478900E4 ^0x478900E4
{
	return -1;
}
...
void func_50() // Position - 0x2247 Hash - 0x98476CE1 ^0x250FEB7C
{
	if (func_24(14))
	{
...
void func_54(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x23CF Hash - 0xC6B752B2 ^0xC6B752B2
{
...
int func_55() // Position - 0x2425 Hash - 0x3C5423D7 ^0x3C5423D7
{
	func_23();
	return Global_113648.f_2365.f_539.f_4321;
}

void func_56(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x243E Hash - 0x6C235EE0 ^0x9E57F206
{
...
BOOL func_57() // Position - 0x24D9 Hash - 0x152DA0B2 ^0x220E93E9
{
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (func_60())
			{
				...
				{
					OBJECT::ADD_DOOR_TO_SYSTEM(-1831288286, -2051651622, -31.72f, -1101.85f, 26.57f, true, true, false);
				}
...
void func_68(int iParam0) // Position - 0x2C4F Hash - 0x3B4E6AAB ^0xDE553B62
{
	switch (iParam0)
	{
		case 0:
...
void func_69(char* sParam0, int iParam1) // Position - 0x2D2A Hash - 0xCBB0D91 ^0x21070E5C
{
...
BOOL func_74(int iParam0) // Position - 0x2F40 Hash - 0xECB6C71B ^0xECB6C71B
{
		...
		case 1:
			if (!func_2(pedLocal_91) || !func_2(pedLocal_92))
			{
				...
				if (func_2(pedLocal_91))
				{
					...
					WEAPON::GIVE_WEAPON_TO_PED(pedLocal_91, 453432689, 999, false, false);
					ENTITY::SET_ENTITY_CAN_BE_DAMAGED_BY_RELATIONSHIP_GROUP(pedLocal_91, false, hLocal_148);
					PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, hLocal_148, 1862763509);
				...
				if (func_2(pedLocal_92))
				{
					...
					WEAPON::GIVE_WEAPON_TO_PED(pedLocal_92, 453432689, 999, false, false);
			...
			{
				func_80();
				veLocal_123 = VEHICLE::CREATE_VEHICLE(142944341, -46.2722f, -1097.4662f, 25.42f, 112.53633f, true, true, false);
				...
				veLocal_124 = VEHICLE::CREATE_VEHICLE(-1008861746, -41.07354f, -1099.5669f, 25.42f, 138.42923f, true, true, false);
				...
				veLocal_125 = VEHICLE::CREATE_VEHICLE(850565707, -36.744564f, -1101.5826f, 25.42f, 155.15735f, true, true, false);
...
int func_81(Ped* ppedParam0, int iParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x3618 Hash - 0xC57592AD ^0x9AA0BE7
{
	Hash model;
...
int func_82(var uParam0, int iParam1) // Position - 0x36A6 Hash - 0x5AC42C11 ^0x5AC42C11
{
	int num;
...
Hash func_83(int iParam0) // Position - 0x36EC Hash - 0xBF0B24A5 ^0xBF0B24A5
{
	if (!func_25(iParam0))
		return func_28(iParam0);
	else
...
void func_130() // Position - 0x673C Hash - 0xF96AD62F ^0xF96AD62F
{
	...
	uLocal_47[0 /*20*/] = -39239064;
	uLocal_47[0 /*20*/].f_17 = 453432689;
	...
	uLocal_47[1 /*20*/] = -984709238;
	uLocal_47[1 /*20*/].f_17 = 453432689;
	...
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, hLocal_150, 1862763509);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, 1862763509, hLocal_150);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, hLocal_148, 1862763509);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, hLocal_148);
...
void func_131(int iParam0, int iParam1) // Position - 0x69D4 Hash - 0x4FE65956 ^0x4FE65956
{
	int num;
...
void func_132(int iParam0) // Position - 0x6AC1 Hash - 0xF9254656 ^0xECCFDFAF
{
...
void func_133(int iParam0) // Position - 0x6B0C Hash - 0xE7EE45FB ^0x26036F0B
{
	Vector3 vector;
	BOOL unk;
	BOOL unk2;
...
BOOL func_134() // Position - 0x6FD1 Hash - 0x70B4A54B ^0xF137E5FF
{
...
int func_135(int iParam0) // Position - 0x7050 Hash - 0x46546439 ^0x46546439
{
	int num;
...
BOOL func_136(int iParam0) // Position - 0x7278 Hash - 0x5A075A23 ^0x27F6B86F
{
	Hash entityModel;
...
Vehicle func_137(Vehicle veParam0) // Position - 0x72E4 Hash - 0xC9D82232 ^0xC9D82232
{
	return veParam0;
}

void func_138(int iParam0, var uParam1) // Position - 0x72EE Hash - 0x45AE8BFD ^0xA0700457
{
	int num;
	int num2;
...
BOOL func_139(int iParam0) // Position - 0x7C86 Hash - 0xDEE87AD1 ^0x5F1ACD39
{
	var unk;
	int unk2;
...
struct<7> func_140(int iParam0) // Position - 0x7CBA Hash - 0xA6A81C3E ^0x591CC9FB
{
	var unk;
...
BOOL func_147(int iParam0) // Position - 0xAD57 Hash - 0x687D9246 ^0x687D9246
{
	int num;
...
BOOL func_167(int iParam0, int iParam1, int iParam2) // Position - 0xBA59 Hash - 0xBEEFD79C ^0xBEEFD79C
{
	BOOL num;
	int num2;
...
int func_168(int iParam0) // Position - 0xBB3D Hash - 0x45FC9D61 ^0x45FC9D61
{
	if (!func_25(iParam0))
		return 7;
...
BOOL func_171() // Position - 0xBBFD Hash - 0x44DD83CC ^0x6D2C8335
{
	int profileSetting;
