...
BOOL func_72() // Hash - 0x5F11735 ^0xF8348068
{
...
BOOL func_82() // Hash - 0xE08A0E1B ^0xC4DD90A4
{
...
void func_84() // Hash - 0x13CE8C1C ^0x13CE8C1C
{
...
void func_89(int iParam0, var uParam1, var uParam2) // Hash - 0xB54FFF9 ^0xB54FFF9
{
	if (func_12())
	{
		switch (iParam0)
