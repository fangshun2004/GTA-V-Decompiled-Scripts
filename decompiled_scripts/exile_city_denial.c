...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		bLocal_46 = func_24(Var2, &bLocal_49);
		...
		if (bLocal_47 != bLocal_46)
		{
			...
			if (bLocal_46 && !bVar6)
			{
				...
				while (bVar8)
				{
					switch (func_18(&iLocal_45, 6, 12, 0, 0))
					{
						case 0:
							bVar8 = false;
							bVar7 = false;
				...
				if (bVar7)
				{
					...
					{
						if (!BitTest(Global_114963.f_7697.f_923, 0))
						{
							func_10(1628462442, 7, 1, 31, 3, 10000, 20000, -1, -1, 150, -1, 1024);
						}
						else if (!BitTest(Global_114963.f_7697.f_923, 1))
						{
							func_10(1791324372, 7, 1, 31, 3, 10000, 20000, -1, -1, 150, -1, 1024);
						}
						else if (!BitTest(Global_114963.f_7697.f_923, 2))
						{
					...
					{
						if (!BitTest(Global_114963.f_7697.f_923, 3))
						{
							func_10(1806999335, 7, 4, 31, 3, 10000, 20000, -1, -1, 151, -1, 1024);
						}
						else if (!BitTest(Global_114963.f_7697.f_923, 4))
						{
						...
						if ((!func_9(0) && !func_9(4)) && !func_9(3))
						{
							if (MISC::GET_NUMBER_RESOURCES_ALLOCATED_TO_WANTED_LEVEL(11) < 256)
							{
								if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
								{
									if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
									{
										MISC::CREATE_INCIDENT_WITH_ENTITY(11, PLAYER::PLAYER_PED_ID(), iVar0, 0f, &iLocal_50, 0, 0);
									}
								}
							}
		...
		if (bLocal_46 && SYSTEM::TIMERB() > 60000)
		{
			SYSTEM::SETTIMERB(0);
			...
			if (iVar0 < 8)
			{
				if (MISC::IS_INCIDENT_VALID(iLocal_50))
				{
					MISC::SET_INCIDENT_REQUESTED_UNITS(iLocal_50, 11, iVar0);
				}
...
void func_5(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		MISC::SET_BIT(&(Global_114963.f_7236.f_17[iParam0]), false);
	}
	else
	{
		MISC::CLEAR_BIT(&(Global_114963.f_7236.f_17[iParam0]), false);
	}
	MISC::DISABLE_POLICE_RESTART(Global_97600[iParam0 /*9*/].f_8, !bParam1);
	func_6(Global_97600[iParam0 /*9*/].f_7, 0, 0);
}
...
void func_7(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		MISC::SET_BIT(&(Global_114963.f_7236.f_11[iParam0]), false);
	}
	else
	{
		MISC::CLEAR_BIT(&(Global_114963.f_7236.f_11[iParam0]), false);
	}
	MISC::DISABLE_HOSPITAL_RESTART(Global_97664[iParam0 /*9*/].f_8, !bParam1);
	func_6(Global_97664[iParam0 /*9*/].f_7, 0, 0);
}
...
void func_23()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_16(Global_114963.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_12(iVar0) && (!func_9(14) || Global_113909))
			{
...
void func_29(int iParam0)
{
	...
	while (iVar15 < Global_114963.f_7697.f_198)
	{
		...
		{
			func_30(Global_114963.f_7697.f_137[iVar15 /*15*/].f_6);
			iVar16 = iVar15;
...
int func_30(int iParam0)
{
	...
	{
		if (func_36(iParam0, Global_21649) == 1)
		{
			func_35(iParam0, Global_21649, 0);
			if (func_34(iParam0, Global_21649) == 0)
			{
				iVar0 = Global_21649;
