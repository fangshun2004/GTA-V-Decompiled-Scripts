		...
		if (!IS_BIT_SET(iLocal_216, 0))
		{
			if (ENTITY::DOES_ENTITY_EXIST(pedLocal_46))
			{
				if (!PED::IS_PED_INJURED(pedLocal_46))
				{
					...
					func_28(&uLocal_51, 3, pedLocal_46, "LESTER", 0, 1);
...
void func_1() // Hash - 0xB119F0AB ^0xB9901E0A
{
	if (func_2())
	{
...
void func_3(int iParam0, BOOL bParam1) // Hash - 0xA20CF5DD ^0xFF4288EE
{
	int offset;
...
void func_11() // Hash - 0x1B550DC5 ^0xB191D7C2
{
	int i;
...
void func_17() // Hash - 0xBCA64AAA ^0xB38361D2
{
	int i;
...
void func_23() // Hash - 0xD1F2D853 ^0xF9F5FD4D
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_26(Global_113648.f_2365.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_24(num) && !func_16(14) || Global_112599)
			{
...
void func_28(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Hash - 0x6C235EE0 ^0x9E57F206
{
...
void func_30() // Hash - 0x54973B01 ^0x156844AE
{
...
void func_31() // Hash - 0xDDCEF922 ^0x6DBD2285
{
	func_32();
...
void func_32() // Hash - 0x78F268EE ^0xBFF7CC08
{
	if (HUD::IS_NAMED_RENDERTARGET_REGISTERED("tvscreen"))
