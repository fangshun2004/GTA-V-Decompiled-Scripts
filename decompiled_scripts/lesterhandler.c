	...
	while (!BitTest(uLocal_214, 1))
	{
		if (!BitTest(uLocal_214, 0))
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_44))
			{
				if (!PED::IS_PED_INJURED(iLocal_44))
				{
					...
					func_29(&uLocal_49, 3, iLocal_44, "LESTER", 0, 1);
		...
		else if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
		{
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_44, false))
			{
				...
				if (Global_80545 == 86)
				{
					if (!Global_114899 == 1 && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 718.0749f, -976.0472f, 22.91482f, 718.0593f, -979.455f, 27.1191f, 5.75f, false, true, 0))
					{
						func_3(7, 1);
						Global_114895 = 0;
						Global_114899 = 1;
...
void func_24()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_27(Global_114904.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_25(iVar0) && (!func_17(14) || Global_113852))
			{
