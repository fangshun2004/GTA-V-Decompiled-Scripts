...
void __EntryFunction__()
{
	...
	while (!BitTest(uLocal_233, 1))
	{
		if (!BitTest(uLocal_233, 0))
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_63))
			{
				if (!PED::IS_PED_INJURED(iLocal_63))
				{
					...
					PED::ADD_RELATIONSHIP_GROUP("Lester Group", &iLocal_67);
					PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_67, joaat("player"));
					PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, joaat("player"), iLocal_67);
					PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_63, iLocal_67);
					PED::SET_PED_DIES_WHEN_INJURED(iLocal_63, false);
					PED::SET_PED_CAN_BE_TARGETTED(iLocal_63, false);
					PED::SET_PED_SUFFERS_CRITICAL_HITS(iLocal_63, false);
					PED::SET_PED_CAN_EVASIVE_DIVE(iLocal_63, false);
					ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(iLocal_63, false, 0f);
					PED::SET_PED_CAN_RAGDOLL(iLocal_63, false);
					PED::SET_PED_ID_RANGE(iLocal_63, 250f);
					PED::SET_PED_TARGET_LOSS_RESPONSE(iLocal_63, 1);
					ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(iLocal_63, false, 0f);
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_63, true);
					PED::SET_PED_CONFIG_FLAG(iLocal_63, 132, true);
					PED::SET_PED_CONFIG_FLAG(iLocal_63, 32, false);
					PED::SET_PED_CONFIG_FLAG(iLocal_63, 208, true);
					PED::SET_PED_CONFIG_FLAG(iLocal_63, 118, false);
					PED::SET_PED_CONFIG_FLAG(iLocal_63, 174, true);
					PED::SET_PED_CONFIG_FLAG(iLocal_63, 169, true);
					ENTITY::SET_ENTITY_PROOFS(iLocal_63, true, true, true, true, true, false, false, false);
					...
					TASK::TASK_PERFORM_SEQUENCE(iLocal_63, iLocal_66);
					PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_63, false, false);
					ENTITY::FREEZE_ENTITY_POSITION(iLocal_63, true);
					func_29(&uLocal_68, 3, iLocal_63, "LESTER", 0, 1);
					iLocal_64 = OBJECT::CREATE_OBJECT(joaat("prop_cs_walking_stick"), 706.9874f, -967.0945f, 30.4f, false, false, false);
					ENTITY::SET_ENTITY_COORDS(iLocal_64, 706.9874f, -967.0945f, 30.4f, true, false, false, true);
					ENTITY::SET_ENTITY_ROTATION(iLocal_64, 90f, 0f, 160f, 2, true);
					ENTITY::SET_ENTITY_INVINCIBLE(iLocal_64, true, 0);
					ENTITY::SET_ENTITY_PROOFS(iLocal_64, true, true, true, true, true, false, false, false);
					...
					iLocal_65 = OBJECT::CREATE_OBJECT(joaat("prop_laptop_lester2"), 707.3041f, -967.6456f, 30.376f, true, true, false);
					ENTITY::SET_ENTITY_HEADING(iLocal_65, 183.14f);
					ENTITY::FREEZE_ENTITY_POSITION(iLocal_65, true);
					ENTITY::SET_ENTITY_INVINCIBLE(iLocal_65, true, 0);
					ENTITY::SET_ENTITY_PROOFS(iLocal_65, true, true, true, true, true, false, false, false);
		...
		else if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
		{
			...
			{
				fVar6 = SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iLocal_63, true));
				if (func_23() == 0)
				{
					if (fVar6 < 4f)
					{
						if (MISC::GET_GAME_TIMER() > iLocal_234)
						{
							if (!func_22())
							{
								if (func_4(&uLocal_68, "JHFAUD", "JHF_LEAVE", 3, 0, 0, 0))
								{
				...
				if (Global_80602 == 86)
				{
					if (!Global_114958 == 1 && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 718.0749f, -976.0472f, 22.91482f, 718.0593f, -979.455f, 27.1191f, 5.75f, false, true, 0))
					{
						func_3(7, 1);
						Global_114954 = 0;
						Global_114958 = 1;
...
void func_24()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_27(Global_114963.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_25(iVar0) && (!func_17(14) || Global_113909))
			{
...
void func_31()
{
	...
	PED::REMOVE_RELATIONSHIP_GROUP(iLocal_67);
	func_32();
