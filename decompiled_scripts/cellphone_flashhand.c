...
void __EntryFunction__()
{
	...
	if (Global_20248 == 0)
	{
		...
		if (Global_78319)
		{
			if (func_121())
			{
				Global_20247 = unk_0x67D02A194A2FC2BD("cellphone_badger");
			}
			else
			{
				Global_20247 = unk_0x67D02A194A2FC2BD("cellphone_ifruit");
			}
			iLocal_88 = 1;
			if (iLocal_88 == 1)
			{
		...
		{
			Global_20254 = 1;
			Global_20247 = unk_0x67D02A194A2FC2BD("cellphone_prologue");
		}
		else
		{
			Global_20247 = unk_0x67D02A194A2FC2BD(&(Global_113386.f_14051[Global_20266 /*20*/]));
		}
		SYSTEM::SETTIMERA(0);
