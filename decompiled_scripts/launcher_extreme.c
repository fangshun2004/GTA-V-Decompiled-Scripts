...
BOOL func_2(Any* panParam0) // Hash - 0xDE97F4EA ^0xC393299B
{
	const char* str;
	var unk32;
...
struct<2> func_9(int iParam0) // Hash - 0x323E6781 ^0xED7E0235
{
	var unk;
	var unk3;
...
void func_19() // Hash - 0x429A4038 ^0xCDCC1C76
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("MISSION_STAT_WATCHER")) > 0)
	{
		if (func_20())
...
void func_23(char* sParam0, int iParam1, Ped pedParam2) // Hash - 0xB566D143 ^0x40617A8A
{
...
BOOL func_44(int iParam0, int iParam1, char* sParam2, var uParam3) // Hash - 0x8E372EAA ^0x563CEDF1
{
...
BOOL func_81(int iParam0) // Hash - 0x78AB9EAC ^0x78AB9EAC
{
	if (iParam0 != func_90())
...
BOOL func_89(int iParam0) // Hash - 0x9D5E1610 ^0x9D5E1610
{
	if (iParam0 != func_90())
...
int func_90() // Hash - 0x478900E4 ^0x478900E4
{
	return -1;
}
...
var func_97() // Hash - 0x9E44C35 ^0xB9993D58
{
	var unk;
...
void func_109(int iParam0) // Hash - 0x35AC36F2 ^0xBEFD43DD
{
	int num;
	var textLabel;
...
void func_112(char* sParam0, Any anParam1, int iParam2) // Hash - 0x817AB180 ^0x26AC61AF
{
...
struct<2> func_114(int iParam0) // Hash - 0x975AC8C9 ^0xD5F3BD82
{
	var unk;
...
void func_115(int iParam0, var uParam1) // Hash - 0x2D8E3F8 ^0xAD184233
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_147(const char* sParam0) // Hash - 0x16488C7A ^0x8125DDA3
{
...
void func_148() // Hash - 0xC536DD5 ^0xC536DD5
{
	Global_20591 = 0;
	func_149();
	return;
...
void func_149() // Hash - 0xE32CF1EF ^0xB9A7BEB2
{
...
void func_150() // Hash - 0xE60F63BE ^0xE60F63BE
{
	func_155(0);
	func_154();
	func_151();
...
void func_151() // Hash - 0xC95798F1 ^0x61ADB9D7
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
...
BOOL func_152(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Hash - 0x60473011 ^0x5B80F12B
{
...
void func_153(Vehicle veParam0) // Hash - 0x94E8CB0B ^0x47923A23
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_154() // Hash - 0x2A0AC5B7 ^0xAF27577A
{
...
void func_155(int iParam0) // Hash - 0x7E11E9C ^0x544BF257
{
	if (func_160())
		return;
...
void func_156(int iParam0) // Hash - 0x4066FEF5 ^0x9787FBDA
{
	if (func_160())
		return;
...
BOOL func_159(int iParam0) // Hash - 0xE8921B44 ^0x4F063755
{
	if (iParam0 == 1)
...
BOOL func_160() // Hash - 0xC41437CB ^0xC41437CB
{
	return IS_BIT_SET(Global_1962996, 19);
}

BOOL func_161(int iParam0) // Hash - 0x2BFED607 ^0x2BFED607
{
...
BOOL func_162(int iParam0) // Hash - 0x5C21BF6B ^0xB5545E1F
{
	int num;
...
void func_163(int iParam0) // Hash - 0xF49E441F ^0xE21552CB
{
...
int func_164(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Hash - 0x8F9349A ^0xC5C097C1
{
	int i;
...
void func_165(int iParam0, int iParam1) // Hash - 0x6AC97785 ^0x6AC97785
{
	int i;
...
BOOL func_166(int iParam0) // Hash - 0xECB6C71B ^0xECB6C71B
{
	return func_167(iParam0, Global_43257);
}

BOOL func_167(int iParam0, int iParam1) // Hash - 0x1FD727E0 ^0x1FD727E0
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_168(int iParam0) // Hash - 0x3BAB94E9 ^0x3BAB94E9
{
	if (Global_43257 == 15)
		return false;
...
int func_169() // Hash - 0x613FC6AD ^0xDC7835B3
{
	return func_170(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_170(const char* sParam0, int iParam1) // Hash - 0x76A2E0AF ^0x8A5231BB
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL func_171() // Hash - 0x77F66043 ^0x77F66043
{
	if (Global_100681 == 10 || Global_100681 == 9)
		return true;
...
void func_172(int iParam0, var uParam1) // Hash - 0x4DABA5AB ^0x5B086A56
{
	switch (iParam0)
	{
		case 0:
...
Blip func_173(float fParam0, float fParam1, float fParam2, BOOL bParam3) // Hash - 0xF4E99477 ^0x29669E98
{
	Blip blip;
...
var func_174(BOOL bParam0, var uParam1, var uParam2) // Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
BOOL func_175(int iParam0) // Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
		case 0:
...
int func_176(var uParam0) // Hash - 0xAA038C57 ^0xDFE87324
{
	if (*uParam0 == 18)
	{
...
BOOL func_177(Ped pedParam0, eScriptTaskHash esthParam1) // Hash - 0x5CB13EA9 ^0x50B73240
{
...
int func_178(var uParam0, int iParam1) // Hash - 0x4C332810 ^0xCFFAAA23
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_179() // Hash - 0x1DF115D ^0x1DF115D
{
	func_27(&(Global_104212.f_2890), &Global_104212, 0, 1, 1, 0);
	return;
}

BOOL func_180(var uParam0) // Hash - 0xBE0C612E ^0xC181C5F3
{
	float num;
...
void func_181(int iParam0, var uParam1) // Hash - 0x16CCAA18 ^0x1E38878E
{
	if (iParam0 == 1)
	{
		if (!func_134(uParam1))
...
BOOL func_182(BOOL bParam0) // Hash - 0x328D4447 ^0x90410402
{
...
BOOL func_183(Vehicle veParam0) // Hash - 0x7E47BB06 ^0x692E6B64
{
...
BOOL func_184(int iParam0) // Hash - 0x97844555 ^0xADCD6DAA
{
	int num;
...
BOOL func_185() // Hash - 0x4228A1C2 ^0x952FE30F
{
	return Global_100720.f_1;
}

BOOL func_186() // Hash - 0xC20DBA70 ^0xAC4006FB
{
	if (Global_97603 != -1)
...
BOOL func_187() // Hash - 0x3CA1BB47 ^0xB78A1ACB
{
...
BOOL func_188() // Hash - 0xE663B8F6 ^0xE663B8F6
{
	if (Global_78819)
		return true;
...
BOOL func_189() // Hash - 0xD56328D2 ^0xD56328D2
{
	return Global_100733.f_388 > 0;
}

BOOL func_190(int iParam0, int iParam1) // Hash - 0xA14C4D3F ^0xA6034F77
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_191() // Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1575060;
}

BOOL func_192() // Hash - 0x7FE517FE ^0x128A3BC8
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_193(char* sParam0, int iParam1) // Hash - 0xCBB0D91 ^0x21070E5C
{
...
BOOL func_194(Ped pedParam0) // Hash - 0x3D210083 ^0xF7E7C389
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_195() // Hash - 0x152DA0B2 ^0x220E93E9
{
...
int func_196(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Hash - 0xA74186BF ^0x512FC932
{
	var unk;
...
void func_197(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Hash - 0xF7ECDFD9 ^0x6B079C3E
{
...
void func_198(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Hash - 0xC6B752B2 ^0xC6B752B2
{
...
void func_199(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Hash - 0x6C235EE0 ^0x9E57F206
{
...
float func_200(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Hash - 0xC22B942A ^0xE0DB8793
{
...
void func_201(var uParam0) // Hash - 0x6F563419 ^0xCBB27FF5
{
...
void func_202(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Hash - 0xA38693DA ^0xBAAA90B1
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_203(int iParam0, BOOL bParam1) // Hash - 0x3ABFF97A ^0x3ABFF97A
{
	if (iParam0 == -1)
		return;
...
int func_204(int iParam0) // Hash - 0x3F6843D0 ^0x973F28A6
{
	if (Global_78554 == iParam0)
		if (Global_78555 == -1)
...
void func_205(var uParam0, int iParam1) // Hash - 0xA189769D ^0xD7591C4B
{
	BOOL flag;
	int i;
...
BOOL func_206() // Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_97990;
}

void func_207(var uParam0) // Hash - 0x8EEB5116 ^0x2325FF68
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_208(uParam0);
...
void func_208(var uParam0) // Hash - 0x1C509C5B ^0x1C509C5B
{
	BOOL flag;
	int num;
	int i;
...
void func_209(int iParam0) // Hash - 0xD347101A ^0xCC220E7F
{
	if (iParam0 == -1)
		iParam0 = func_169();
...
BOOL func_210(Any* panParam0, BOOL bParam1) // Hash - 0x7D86F6E4 ^0x1ECA2AA9
{
	var unk;
...
void func_211(Ped pedParam0, var uParam1, int iParam2) // Hash - 0xD4C7D099 ^0x162C1E9
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_212(int iParam0) // Hash - 0xD681AEF7 ^0xD681AEF7
{
...
BOOL func_213(var uParam0) // Hash - 0x42F869D4 ^0xFFADB180
{
...
BOOL func_214(var uParam0) // Hash - 0x6329B93C ^0xCBBB8D92
{
...
void func_215(var uParam0) // Hash - 0x2E98ABB1 ^0xFF31A41F
{
	int i;
	int taskSequenceId;
...
void func_216(Object* pobParam0) // Hash - 0x4EAFEE58 ^0x34D7ECA6
{
...
void func_217(var uParam0) // Hash - 0x5209F824 ^0xCFA0F1CA
{
	int i;
...
BOOL func_218(var uParam0, BOOL bParam1, BOOL bParam2) // Hash - 0x53567DCF ^0x584F6887
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_219(Ped pedParam0, Vehicle veParam1) // Hash - 0xFB12ABF0 ^0x730FD205
{
...
BOOL func_220(var uParam0, BOOL bParam1, int iParam2) // Hash - 0xE9BDE167 ^0x20C575FA
{
	int i;
	int num;
...
BOOL func_221(int iParam0) // Hash - 0x9E3DCA43 ^0x9E3DCA43
{
...
BOOL func_222(Ped pedParam0, int iParam1) // Hash - 0x5EA05E45 ^0x7984EB04
{
	float xSize;
...
BOOL func_223(Ped pedParam0, int iParam1) // Hash - 0xF1789D04 ^0x3F9D1900
{
	return func_224(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_224(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Hash - 0x275BB58B ^0x275BB58B
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_225(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Hash - 0xBBBECF07 ^0xBBBECF07
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_226(Ped pedParam0, int iParam1) // Hash - 0xA6273130 ^0xF7D9CDEA
{
...
int func_227() // Hash - 0x1398F041 ^0xCD84FF69
{
	int i;
...
BOOL func_228(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Hash - 0x6EF1707D ^0x8C069CF9
{
	var unk;
...
float func_229(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Hash - 0x596BEA29 ^0x5FBCDBE5
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_230(float fParam0, var uParam1, var uParam2) // Hash - 0xFB6A39D2 ^0x80C9C759
{
	float num;
	float num2;
...
void func_231(var uParam0) // Hash - 0xA4B72113 ^0x62A5EAE1
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_232(Ped pedParam0, Ped pedParam1) // Hash - 0xAA445031 ^0xEBA3F8CF
{
	int i;
...
BOOL func_233(Ped pedParam0) // Hash - 0xEC80536A ^0x2D4CF2B0
{
...
BOOL func_234(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Hash - 0x5B46DA49 ^0x44F718
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_235(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Hash - 0x1310B579 ^0x2AAFC0CC
{
	float entityCoords;
	float num;
...
BOOL func_236(Ped pedParam0, float fParam1) // Hash - 0xFA3D7088 ^0x33A74060
{
	var outProjectile;
	var outCoords;
...
BOOL func_237(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Hash - 0x3F40E5FA ^0xC3BEFE6A
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_238(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Hash - 0x18BAE105 ^0x60D3B20E
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_239(int iParam0) // Hash - 0x5B443B41 ^0x5B443B41
{
...
void func_240(Vehicle veParam0) // Hash - 0xAD821AF8 ^0xA8D033D0
{
	int taskSequenceId;
...
BOOL func_241(int iParam0) // Hash - 0x6F2BC7EE ^0x6F2BC7EE
{
	if (iParam0 == -1)
		iParam0 = func_169();
...
BOOL func_242(int iParam0) // Hash - 0xDE7BA54D ^0xDE7BA54D
{
...
BOOL func_243() // Hash - 0x29CB2928 ^0xE369A18D
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_244() // Hash - 0x98CCC132 ^0x97B0D6ED
{
	if (Global_97603 != -1)
...
BOOL func_245(int iParam0) // Hash - 0xC2630182 ^0xFBD23031
{
...
BOOL func_246() // Hash - 0x25806CBF ^0x25806CBF
{
...
BOOL func_247(int iParam0) // Hash - 0x1156B580 ^0x34C7FA05
{
	if (func_113(false))
...
BOOL func_248(var uParam0) // Hash - 0x24D26100 ^0x24D26100
{
	switch (*uParam0)
	{
		case 17:
...
BOOL func_249(var uParam0) // Hash - 0xC6212070 ^0x583221A3
{
	int num;
	int i;
...
void func_250(Ped* ppedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Hash - 0xCC0E504 ^0x39682CA7
{
...
void func_251(Ped* ppedParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, ePedType eptParam6) // Hash - 0x616C5024 ^0x190F8C82
{
	func_252(ppedParam0);
...
void func_252(Ped* ppedParam0) // Hash - 0xCA79453F ^0x7BA88177
{
...
BOOL func_253(var uParam0) // Hash - 0xB319BDFA ^0xA1F4DAFB
{
	if (func_214(uParam0))
	{
...
BOOL func_254(var uParam0) // Hash - 0xC42B20E0 ^0x728F1DAE
{
	int i;
...
void func_255(var uParam0, char* sParam1, char* sParam2, char* sParam3) // Hash - 0x6EEDFC2 ^0xD51569DC
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
BOOL func_256(var uParam0) // Hash - 0xCEE3AD20 ^0xD867CA8A
{
	int num;
	int i;
	BOOL flag;
...
BOOL func_257(Ped* ppedParam0, int iParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Hash - 0x5E27D69A ^0xE8A3C3CE
{
...
BOOL func_258(Ped* ppedParam0, int iParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Hash - 0xC57592AD ^0x9AA0BE7
{
	Hash model;
...
int func_259(var uParam0, int iParam1) // Hash - 0x5AC42C11 ^0x5AC42C11
{
	int num;
...
BOOL func_260(var uParam0) // Hash - 0x25D8AC68 ^0x2D3584A5
{
	int num;
	int i;
	BOOL flag;
...
void func_261(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Hash - 0x60B41505 ^0x2C4B5209
{
	func_262(pveParam0);
...
void func_262(Vehicle* pveParam0) // Hash - 0x8D18F713 ^0xF71A18A8
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_263(var uParam0) // Hash - 0x604DB9A5 ^0xCCC78054
{
	int num;
	int i;
...
BOOL func_264(int iParam0) // Hash - 0x59D2F680 ^0x59D2F680
{
	var unk;
	int num;
...
BOOL func_265(int iParam0) // Hash - 0xC6B32843 ^0x832471EF
{
	const char* string2;
...
BOOL func_266(int iParam0) // Hash - 0x791D84F4 ^0x791D84F4
{
	var unk;
...
BOOL func_267(int iParam0) // Hash - 0xF688DFB ^0xF688DFB
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_268(int iParam0, char* sParam1) // Hash - 0xC64245F ^0xA2D8EDA1
{
...
BOOL func_269(int iParam0) // Hash - 0x5ADD7F05 ^0x5ADD7F05
{
...
BOOL func_270(int iParam0) // Hash - 0xBB053D24 ^0xBB053D24
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_271(int iParam0) // Hash - 0x5D95A044 ^0x5D95A044
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_272(int iParam0) // Hash - 0x9FFC81CD ^0x47A2AB8B
{
	if (func_242(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
void func_273() // Hash - 0x5631C87C ^0x9394552B
{
...
BOOL func_274(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Hash - 0x5B983661 ^0x5B983661
{
	int i;
...
BOOL func_275(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Hash - 0xC6B7068B ^0xB9A971A4
{
	int num;
	char* str;
...
BOOL func_276(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Hash - 0x1FB736D4 ^0x234AEAB7
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_277(var uParam0, BOOL bParam1) // Hash - 0x510E39A7 ^0xD126193F
{
	if (*uParam0 == 18)
	{
		if (func_194(uParam0->f_35[0]))
...
int func_278(var uParam0) // Hash - 0x86633390 ^0x6319A575
{
	if (func_214(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_279(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Hash - 0x5BE1D1E3 ^0x5BE1D1E3
{
...
void func_280(var uParam0, BOOL bParam1) // Hash - 0xEDC3BD2D ^0xE0B6F056
{
	func_281(&(uParam0->f_41), bParam1);
	return;
}

void func_281(var uParam0, BOOL bParam1) // Hash - 0x9E80EA71 ^0x9E80EA71
{
	int i;
...
void func_282(Object* pobParam0, BOOL bParam1) // Hash - 0xD7EE3E27 ^0xC5769B29
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_283(var uParam0, BOOL bParam1) // Hash - 0xEDC3BD2D ^0xE2474F74
{
	func_284(&(uParam0->f_35), bParam1);
	return;
}

void func_284(var uParam0, BOOL bParam1) // Hash - 0xA98F6284 ^0xA98F6284
{
	int i;
...
void func_285(Vehicle* pveParam0) // Hash - 0xC50F9886 ^0x638B6124
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_286(var uParam0, int iParam1) // Hash - 0xEDC3BD2D ^0xA9A19095
{
	func_287(&(uParam0->f_28), iParam1);
	return;
}

void func_287(var uParam0, int iParam1) // Hash - 0xB72ACFD2 ^0xB72ACFD2
{
	int i;
...
void func_288(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Hash - 0x34362197 ^0xC592197
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_289(int iParam0) // Hash - 0x995C9E2 ^0x995C9E2
{
	if (*iParam0 == -1)
		return;
...
void func_290(char* sParam0) // Hash - 0x54B64147 ^0x56EEAFB9
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_291(var uParam0) // Hash - 0x4CD8BCE8 ^0x20D39BA8
{
	*uParam0 = -1;
...
void func_292() // Hash - 0x554DA35 ^0x3CA57428
{
...
Hash func_293(int iParam0) // Hash - 0xBF0B24A5 ^0xBF0B24A5
{
	if (!func_36(iParam0))
		return func_47(iParam0);
	else
