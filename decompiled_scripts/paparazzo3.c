...
void __EntryFunction__()
{
	...
	fLocal_49 = 180f;
	iLocal_52 = 3;
	uLocal_97 = func_521(50);
	iLocal_98 = joaat("pcj");
	iLocal_100 = -2;
	iLocal_169 = joaat("prop_cs_dumpster_lidl");
	iLocal_170 = joaat("prop_cs_dumpster_lidr");
	iLocal_171 = joaat("prop_cs_dumpster_01a");
	iLocal_172 = joaat("prop_dumpster_02a");
	...
	sLocal_179 = "Beverley";
	Local_350 = { -260.614f, 292.106f, 91.127f };
	Local_353 = { 7.2E-05f, -2.500116f, 89.63998f };
	Local_357 = { 0.07f, -0.13f, 0.07f };
	...
	while (true)
	{
		...
		func_328(Local_102.f_9, 0, 0, 0, 0, 0);
		if (iLocal_100 == 2)
		{
			func_324();
		}
...
{
	func_255();
	if (!func_236(Local_102.f_28[0], 1, 1116471296, 1126825984, 0, 0, 0, 0))
	{
		switch (iLocal_101)
		{
			case 0:
				if (func_234(Local_102.f_28[0]))
				{
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_102.f_28[0], true);
				}
				iLocal_101 = 1;
				break;
			...
			case 1:
				if (!bLocal_346)
				{
					bLocal_346 = func_218(&uLocal_180, "PAP3AU", "PAP3_RCM_LO", 8, 0, 0, 0);
				}
				else if (!func_217())
				{
		...
		if (bParam2)
		{
			if (!Global_80337)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_10178[iParam1 /*4*/] = { func_210(iParam0) };
					...
					{
						Global_10129[1 /*6*/] = { func_210(iParam0) };
...
bool func_239(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_240(&(Local_54[iVar4 /*4*/]), Var1, iParam1, &(Local_54[iVar4 /*4*/].f_3), iParam0, iParam5);
...
void func_255()
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()) && func_235(Local_102.f_28[0]))
	{
		PED::SET_IK_TARGET(Local_102.f_28[0], 1, PLAYER::PLAYER_PED_ID(), 31086, 0f, 0f, 0f, 0, -1, -1);
		PED::SET_IK_TARGET(PLAYER::PLAYER_PED_ID(), 1, Local_102.f_28[0], 31086, 0f, 0f, 0f, 0, -1, -1);
	}
}
...
void func_256()
{
	switch (iLocal_101)
	{
		case 0:
			...
			{
				if (func_235(Local_102.f_28[0]))
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_102.f_28[0], sLocal_179, 0, 0, 0);
				}
				if (func_235(PLAYER::PLAYER_PED_ID()))
				{
				...
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_166[0], sLocal_173, 0, iLocal_169, 0);
				}
				else
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_166[0], sLocal_173, 2, iLocal_169, 0);
				}
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_166[1]))
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_166[1], sLocal_174, 0, iLocal_170, 0);
				}
				else
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_166[1], sLocal_174, 2, iLocal_170, 0);
				}
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_164))
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_164, sLocal_176, 0, iLocal_172, 0);
				}
				else
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_164, sLocal_176, 2, iLocal_172, 0);
				}
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_165))
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_165, sLocal_175, 0, iLocal_171, 0);
				}
				else
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_165, sLocal_175, 2, iLocal_171, 0);
				}
		...
		case 1:
			...
			{
				iLocal_349 = PED::CREATE_SYNCHRONIZED_SCENE(Local_350, Local_353, 2);
				TASK::TASK_SYNCHRONIZED_SCENE(Local_102.f_28[0], iLocal_349, sLocal_178, "leadout_pap_3_rcm_beverly", 1000f, -8f, 4, 32, 1000f, 0);
				PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_102.f_28[0], false, false);
			}
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_165))
			{
				if (ENTITY::DOES_ENTITY_EXIST(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_175, iLocal_171)))
				{
					iLocal_165 = ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_175, iLocal_171));
				}
			}
			else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_349) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_175, 0))
			{
				ENTITY::SET_ENTITY_COORDS(iLocal_165, Local_350, false, false, false, true);
				ENTITY::SET_ENTITY_ROTATION(iLocal_165, Local_353, 2, false);
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_165, iLocal_349, "leadout_pap_3_rcm_dumpster", sLocal_178, 1000f, -8f, 0, 1000f);
				ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(iLocal_165);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_166[0]))
			{
				if (ENTITY::DOES_ENTITY_EXIST(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_173, 0)))
				{
					iLocal_166[0] = ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_173, iLocal_169));
				}
			}
			else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_349) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_173, 0))
			{
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_166[0], iLocal_349, "leadout_pap_3_rcm_lid_l", sLocal_178, 1000f, -8f, 1, 1000f);
				ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(iLocal_166[0]);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_166[1]))
			{
				if (ENTITY::DOES_ENTITY_EXIST(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_174, 0)))
				{
					iLocal_166[1] = ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_174, iLocal_170));
				}
			}
			else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_349) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_174, 0))
			{
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_166[1], iLocal_349, "leadout_pap_3_rcm_lid_r", sLocal_178, 1000f, -8f, 1, 1000f);
				ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(iLocal_166[1]);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_164))
			{
				if (ENTITY::DOES_ENTITY_EXIST(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_176, 0)))
				{
					iLocal_164 = ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_176, iLocal_172));
				}
			}
			else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_349) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_176, 0))
			{
				ENTITY::SET_ENTITY_COORDS(iLocal_164, -261.1132f, 294.1956f, 90.68612f, false, false, false, true);
				ENTITY::SET_ENTITY_ROTATION(iLocal_164, -0.604164f, -2.332095f, 89.8831f, 2, false);
				ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(iLocal_164);
			}
...
void func_300()
{
	if (func_268())
	{
		CAM::SET_GAMEPLAY_ENTITY_HINT(Local_102.f_28[0], 0f, 0f, 0f, true, -1, 1500, 2000, 0);
	}
}
...
void func_301()
{
	...
	switch (iLocal_101)
	{
		case 0:
			...
			if (func_234(Local_102.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_165))
			{
				iLocal_347 = PED::CREATE_SYNCHRONIZED_SCENE(ENTITY::GET_ENTITY_COORDS(iLocal_165, true), ENTITY::GET_ENTITY_ROTATION(iLocal_165, 2), 2);
				TASK::TASK_SYNCHRONIZED_SCENE(Local_102.f_28[0], iLocal_347, sLocal_178, "leadin_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1000f, 0);
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_165))
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_165, iLocal_347, "leadin_pap_3_rcm_dumpster", sLocal_178, 1000f, -8f, 0, 1000f);
				}
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_166[0]))
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_166[0], iLocal_347, "leadin_pap_3_rcm_lid_l", sLocal_178, 1000f, -8f, 0, 1000f);
				}
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_166[1]))
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_166[1], iLocal_347, "leadin_pap_3_rcm_lid_r", sLocal_178, 1000f, -8f, 0, 1000f);
				}
				func_258(1, 1, 1, 1);
				iLocal_101 = 1;
			}
			...
			if (func_234(Local_102.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_165))
			{
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_347))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_347) > 0.99f)
					{
						...
						{
							iLocal_348 = PED::CREATE_SYNCHRONIZED_SCENE(ENTITY::GET_ENTITY_COORDS(iLocal_165, true), ENTITY::GET_ENTITY_ROTATION(iLocal_165, 2), 2);
							TASK::TASK_SYNCHRONIZED_SCENE(Local_102.f_28[0], iLocal_348, sLocal_178, "idle_01_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1000f, 0);
							PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_102.f_28[0], false, false);
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_165))
							{
								ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_165, iLocal_348, "idle_01_pap_3_rcm_dumpster", sLocal_178, 1000f, -8f, 0, 1000f);
								ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(iLocal_165);
							}
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_166[0]))
							{
								ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_166[0], iLocal_348, "idle_01_pap_3_rcm_lid_l", sLocal_178, 1000f, -8f, 0, 1000f);
								ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(iLocal_166[0]);
							}
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_166[1]))
							{
								ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_166[1], iLocal_348, "idle_01_pap_3_rcm_lid_r", sLocal_178, 1000f, -8f, 0, 1000f);
								ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(iLocal_166[1]);
							}
						}
					}
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_347) > 0.3f)
					{
						if (!bLocal_345)
						{
							bLocal_345 = func_218(&uLocal_180, "PAP3AU", "PAP3_RCM_LI", 8, 0, 0, 0);
						}
					}
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_347) > 0.3f)
					{
...
void func_302()
{
	if (ENTITY::DOES_ENTITY_EXIST(Local_102.f_41[3]) && !iLocal_362)
	{
		GRAPHICS::START_PARTICLE_FX_NON_LOOPED_AT_COORD("scr_rcpap1_camera", PED::GET_PED_BONE_COORDS(Local_102.f_28[0], 28422, Local_357), ENTITY::GET_ENTITY_ROTATION(Local_102.f_41[3], 2), 1f, false, false, false);
		...
		{
			AUDIO::PLAY_SOUND_FROM_COORD(iLocal_356, "CAMERA", PED::GET_PED_BONE_COORDS(Local_102.f_28[0], 28422, Local_357), sLocal_361, false, 0, false);
			iLocal_362 = 1;
		}
	}
}
...
void func_312()
{
	...
	if (func_234(PLAYER::PLAYER_PED_ID()))
	{
		iLocal_163 = PED::GET_PED_RELATIONSHIP_GROUP_HASH(PLAYER::PLAYER_PED_ID());
	}
	if (func_234(Local_102.f_28[0]))
	{
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_102.f_28[0], iLocal_163);
		PED::SET_PED_CONFIG_FLAG(Local_102.f_28[0], 132, true);
		PED::SET_PED_KEEP_TASK(Local_102.f_28[0], true);
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_102.f_28[0], true);
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_164))
	{
		iLocal_164 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-261.19f, 292.22f, 90.79f, 10f, iLocal_172, true, false, true);
		ENTITY::SET_CAN_CLIMB_ON_ENTITY(iLocal_164, false);
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_165))
	{
		func_321(&iLocal_165, &(Local_102.f_41[0]));
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_166[0]))
	{
		func_321(&(iLocal_166[0]), &(Local_102.f_41[1]));
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_166[1]))
	{
		func_321(&(iLocal_166[1]), &(Local_102.f_41[2]));
	}
	func_320(&uLocal_180, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	func_320(&uLocal_180, 3, Local_102.f_28[0], "BEVERLY", 0, 1);
...
void func_316()
{
	if (func_235(Local_102.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_165))
	{
		iLocal_349 = PED::CREATE_SYNCHRONIZED_SCENE(Local_350, Local_353, 2);
		TASK::TASK_SYNCHRONIZED_SCENE(Local_102.f_28[0], iLocal_349, sLocal_178, "leadout_pap_3_rcm_beverly", 1000f, -8f, 4, 32, 1000f, 0);
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_165))
...
int func_322()
{
	...
	else if (ENTITY::DOES_ENTITY_EXIST(Local_102.f_28[0]))
	{
		if (ENTITY::IS_ENTITY_DEAD(Local_102.f_28[0], false))
		{
			func_323("P3BEVDEAD");
			return 1;
		}
		else if (PED::GET_PED_MAX_HEALTH(Local_102.f_28[0]) > ENTITY::GET_ENTITY_HEALTH(Local_102.f_28[0]))
		{
			func_323("P3BEVHURT");
			return 1;
		}
...
void func_324()
{
	...
	{
		case 0:
			if (MISC::ARE_STRINGS_EQUAL(sLocal_363, "DEFAULT"))
			{
				func_499(1);
			}
			else
			{
				func_326(sLocal_363, 1);
			}
			iLocal_101 = 1;
			break;
	...
	if (Global_80592 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_330(Global_80593, Global_80595, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
		...
		if (Global_114963.f_2370.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var5.f_0)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_114963.f_2370.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_114963.f_2370.f_539.f_2407[0 /*295*/][iParam1 /*98*/], Param2, fParam5, false, false, false);
				...
				func_427(iParam0, &(Global_114963.f_2370.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_114963.f_2370.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_114963.f_2370.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var5.f_0)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_114963.f_2370.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_114963.f_2370.f_539.f_2407[1 /*295*/][iParam1 /*98*/], Param2, fParam5, false, false, false);
				...
				func_427(iParam0, &(Global_114963.f_2370.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_114963.f_2370.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("bodhi2"))
...
void func_347(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_154(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, false))
	{
		...
		{
			func_351(iParam1, &(Global_114963.f_2370.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_114963.f_2370.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_114963.f_20127[iParam0 /*43*/].f_31 = func_350(*iParam1);
				...
				func_348(Global_114963.f_2370.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_114963.f_2370.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_114963.f_20127[iParam0 /*43*/].f_1));
				...
				func_348(Global_114963.f_2370.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_114963.f_20127[iParam0 /*43*/].f_2));
			}
		}
	}
}
...
int func_352(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	if (func_399(1))
	{
		if (func_398(iParam0, 1) && VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("speedo")))
		{
			return 1;
		}
	}
	if ((!func_396(iVar0, bParam1, uParam2) && !func_395(PLAYER::PLAYER_ID())) && !func_367(iParam0))
	{
		return 0;
	}
...
int func_354(int iParam0)
{
	if (iParam0 != func_225())
	{
		if (func_356(iParam0, 1, 1))
		{
			...
			{
				return func_355(Global_2658293[iParam0 /*468*/].f_325.f_8) == 30;
			}
		}
	}
	return 0;
...
int func_358(int iParam0)
{
	if (iParam0 != func_225())
	{
		if (func_356(iParam0, 1, 1))
		{
			if (Global_2658293[iParam0 /*468*/].f_325.f_8 != -1)
			{
				return func_355(Global_2658293[iParam0 /*468*/].f_325.f_8) == 11;
			}
		}
	}
	return 0;
...
int func_361(int iParam0)
{
	if (iParam0 != func_225())
	{
		if (func_356(iParam0, 1, 1))
		{
			if (Global_2658293[iParam0 /*468*/].f_325.f_8 != -1)
			{
				return func_355(Global_2658293[iParam0 /*468*/].f_325.f_8) == 26;
			}
		}
	}
	return 0;
...
int func_362(int iParam0)
{
	if (iParam0 != func_225())
	{
		if (func_356(iParam0, 1, 1))
		{
			if (Global_2658293[iParam0 /*468*/].f_325.f_8 != -1)
			{
				return func_355(Global_2658293[iParam0 /*468*/].f_325.f_8) == 13;
			}
		}
	}
	return 0;
...
int func_363(int iParam0)
{
	if (iParam0 != func_225())
	{
		if (func_356(iParam0, 1, 1))
		{
			if (Global_2658293[iParam0 /*468*/].f_325.f_8 != -1)
			{
				return func_355(Global_2658293[iParam0 /*468*/].f_325.f_8) == 7;
			}
		}
	}
	return 0;
...
int func_371(int iParam0)
{
	...
	if (func_395(iParam0) && Global_2658293[iParam0 /*468*/].f_325.f_11 == iParam0)
	{
		return 1;
	}
	return 0;
...
int func_385(int iParam0)
{
	if (PLAYER::PLAYER_ID() != func_225())
	{
		...
		if (((func_389(PLAYER::PLAYER_ID(), 1, 0) && Global_1845298[PLAYER::PLAYER_ID() /*881*/].f_260.f_39 > 0) || BitTest(Global_1845298[PLAYER::PLAYER_ID() /*881*/].f_260.f_37, 14)) || BitTest(Global_1845298[PLAYER::PLAYER_ID() /*881*/].f_260.f_37, 11))
		{
			return 0;
		}
		if (DECORATOR::DECOR_IS_REGISTERED_AS_TYPE("Player_Vehicle", 3))
		{
			if (DECORATOR::DECOR_EXIST_ON(iParam0, "Player_Vehicle"))
			{
				if (DECORATOR::DECOR_GET_INT(iParam0, "Player_Vehicle") == NETWORK::NETWORK_HASH_FROM_PLAYER_HANDLE(PLAYER::PLAYER_ID()))
				{
					if (func_387() != -1 && func_387() < 607)
					{
						if (!func_386(iParam0) || ENTITY::GET_ENTITY_MODEL(iParam0) != Global_1583771[func_387() /*143*/].f_66)
						{
							return 1;
						}
...
int func_393(int iParam0)
{
	if (iParam0 != func_225())
	{
		if (func_356(iParam0, 1, 1))
		{
			if (Global_2658293[iParam0 /*468*/].f_325.f_8 != -1 && Global_2658293[iParam0 /*468*/].f_325.f_11 != func_225())
			{
				return func_355(Global_2658293[iParam0 /*468*/].f_325.f_8) == 5;
			}
		}
	}
	return 0;
...
int func_394(int iParam0)
{
	if (iParam0 != func_225())
	{
		if (func_356(iParam0, 1, 1))
		{
			if (Global_2658293[iParam0 /*468*/].f_325.f_8 != -1 && Global_2658293[iParam0 /*468*/].f_325.f_11 != func_225())
			{
				return func_355(Global_2658293[iParam0 /*468*/].f_325.f_8) == 8;
			}
		}
	}
	return 0;
...
int func_395(int iParam0)
{
	if (iParam0 != func_225())
	{
		if (func_356(iParam0, 1, 1))
		{
			if (Global_2658293[iParam0 /*468*/].f_325.f_8 != -1)
			{
				return func_355(Global_2658293[iParam0 /*468*/].f_325.f_8) == 9;
			}
		}
	}
	return 0;
...
int func_396(int iParam0, bool bParam1, var uParam2)
{
	bool bVar0;
...
{
	if (func_404(iParam0) == 373)
	{
		return func_401(iParam0, 373);
	}
	return -1;
}
...
void func_405(int iParam0, int iParam1)
{
	...
	func_406(iParam0, &(Global_114963.f_32759.f_5510));
}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_277(iParam0, 0, 0)) || func_277(iParam0, 1, 0)) || func_277(iParam0, 2, 0)) || func_423(iParam0) != 145) || func_422(iParam0)) || func_421(iParam0)) || func_353(iParam0)) || func_420(iParam0)) || !func_410(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_421(iParam0))
		{
		}
...
int func_427(int iParam0, var uParam1, var uParam2)
{
	...
	while (iVar0 < *uParam1)
	{
		...
		else if (VEHICLE::GET_VEHICLE_MOD(*iParam0, iVar1) != ((*uParam1)[iVar0] - 1))
		{
			...
			if ((*uParam1)[iVar0] > 0)
			{
				...
				else if (func_433(*iParam0, iVar1, ((*uParam1)[iVar0] - 1)))
				{
				}
				else
				{
	...
	if (func_432(ENTITY::GET_ENTITY_MODEL(*iParam0)) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_430(*iParam0, ((*uParam1)[38] - 1)))
	{
...
int func_430(int iParam0, int iParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		iVar0 = func_431(iParam0, 38) + 1;
		iVar1 = func_431(iParam0, 24) + 1;
...
int func_431(int iParam0, int iParam1)
{
	...
	while (iVar0 >= 0 && func_433(iParam0, iParam1, iVar0))
	{
		iVar0 = (iVar0 - 1);
	}
	return iVar0;
...
{
	if (func_383(iParam0, 1) && !func_384(iParam0))
	{
		return 1;
	}
	switch (iParam0)
...
{
	if (!func_434() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(iParam0, iParam1, iParam2))
	{
		return 1;
	}
	return 0;
...
void func_437(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_99792[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_99792[iVar0]) == func_438(iParam0, iParam1))
				{
...
void func_439(struct<3> Param0, float fParam3, bool bParam4)
{
	int iVar0;
	...
	while (iVar0 < 68)
	{
		if (func_444(&(Global_79127.f_555[0 /*21*/]), iVar0))
		{
...
int func_442(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_443(&(Global_114963.f_32759.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_411(Global_114963.f_32759.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0, -1);
}
...
int func_444(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_445(Global_114963.f_32759.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_445(Global_114963.f_2370.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_445(Global_114963.f_2370.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
bool func_445(struct<3> Param0, struct<3> Param3, bool bParam6)
{
	if (bParam6)
	{
...
{
	return func_447(&(Global_108504.f_2890), Param0, fParam3, 0);
}
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				...
				{
					if ((!bParam4 || func_445(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), true) < 10f)
					{
...
void func_452(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		{
			iVar0 = 1;
			if (BitTest(uParam1->f_77, func_407(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (BitTest(uParam1->f_77, func_407(iVar1 + 1)))
			{
			}
			else
			{
				MISC::SET_BIT(&(uParam1->f_77), func_407(iVar1 + 1));
			}
		}
		else if (uParam1->f_66 == joaat("formula") || uParam1->f_66 == joaat("formula2"))
		{
			...
			while (iVar2 <= 9)
			{
				if (BitTest(uParam1->f_77, func_407(iVar2)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_407(iVar2));
				}
				iVar2++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel1"))
		{
			...
			while (iVar3 <= 6)
			{
				if (BitTest(uParam1->f_77, func_407(iVar3)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_407(iVar3));
				}
				iVar3++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel2"))
		{
			...
			while (iVar4 <= 11)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					if (BitTest(uParam1->f_77, func_407(iVar4)))
					{
					}
					else
					{
						MISC::SET_BIT(&(uParam1->f_77), func_407(iVar4));
					}
				}
				iVar4++;
			}
		...
		else if (uParam1->f_66 == joaat("surfer3"))
		{
			...
			while (iVar5 <= 2)
			{
				if (BitTest(uParam1->f_77, func_407(iVar5)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_407(iVar5));
				}
				iVar5++;
			}
		}
		...
		{
			if (BitTest(uParam1->f_77, func_407(4)))
			{
			}
			else
			{
		...
		else if (uParam1->f_66 == joaat("hotknife"))
		{
			...
			while (iVar6 <= 2)
			{
				if (BitTest(uParam1->f_77, func_407(iVar6)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_407(iVar6));
				}
				iVar6++;
			}
		}
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar7 <= 11)
			{
				if (BitTest(uParam1->f_77, func_407(iVar7 + 1)))
				{
		...
		if ((((func_454() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66)) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(iParam0)) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("avenger"))) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, func_365(1)))
		{
...
int func_477(var uParam0)
{
	...
	switch (iLocal_96)
	{
		...
		case 1:
			if (!func_482(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar30))
			{
				return 0;
			}
			iLocal_96 = 2;
		...
		case 2:
			...
			{
				if (func_479(&(uParam0->f_28[0]), 50, -261f, 292.22f, 90.89f, 10.53f, "PAPARAZZO LAUNCHER RC", 1))
				{
			...
			if (func_234(uParam0->f_28[0]))
			{
				...
				{
					func_478(&(uParam0->f_41[3]), iVar0[1], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
		...
		case 3:
			if (func_235(uParam0->f_41[0]))
			{
				...
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[0], iLocal_99, "idle_closed_pap_3_rcm_dumpster", sVar30, 8f, -8f, 0, 1000f);
				PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_99, true);
				if (func_235(uParam0->f_28[0]))
				{
					TASK::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], iLocal_99, sVar30, "idle_closed_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1000f, 0);
				}
				if (func_235(uParam0->f_41[1]))
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[1], iLocal_99, "idle_closed_pap_3_rcm_lid_l", sVar30, 8f, -8f, 0, 1000f);
				}
				if (func_235(uParam0->f_41[2]))
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[2], iLocal_99, "idle_closed_pap_3_rcm_lid_r", sVar30, 8f, -8f, 0, 1000f);
				}
			}
			iVar31 = 0;
			while (iVar31 <= (iVar0 - 1))
...
void func_484()
{
	...
	func_497(&(iLocal_166[0]), 0);
	func_497(&(iLocal_166[1]), 0);
	func_497(&iLocal_164, 0);
	func_497(&iLocal_165, 0);
	...
	HUD::CLEAR_PRINTS();
	func_495(&(Local_102.f_28[0]), 1, 0, 1);
	func_485(&Local_102, 1, 0, 0);
...
int func_503()
{
	...
	iVar0 = func_504(&(Global_102486.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
