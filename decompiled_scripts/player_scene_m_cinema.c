...
int func_7(int iParam0, Entity eParam1) // Position - 0x431 Hash - 0xD1960A5B ^0x3A103378
{
...
Entity func_8(var uParam0) // Position - 0x515 Hash - 0xC9D82232 ^0xC9D82232
{
	return uParam0;
}
...
BOOL func_12(int iParam0) // Position - 0x671 Hash - 0x8907F004 ^0x8907F004
{
	return iParam0 < 3;
}

int func_13(Ped pedParam0) // Position - 0x67D Hash - 0xAC4E9801 ^0xB379A75F
{
	int i;
	Hash entityModel;
...
Hash func_14(int iParam0) // Position - 0x6BA Hash - 0xADCB9755 ^0xADCB9755
{
	if (func_12(iParam0))
...
Hash func_15(int iParam0) // Position - 0x6DF Hash - 0xE4CEEC2C ^0xE4CEEC2C
{
...
void func_17() // Position - 0x6FC Hash - 0xCB830ADA ^0x200C2612
{
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
	...
	switch (uParam0.f_2)
	{
		...
		case 80:
			*uParam109 = { uParam0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_24(uParam109, 17, -2017877118, -2017877118, { 2.6407f, 8.164f, -14.1564f } + { -1f, 0.03f, -2.16f }, -66f + -56f);
...
BOOL func_31() // Position - 0x86C2 Hash - 0x6E373505 ^0x528400E3
{
...
char* func_33(int iParam0) // Position - 0x904F Hash - 0x5ECC773B ^0x5ECC773B
{
	switch (iParam0)
	{
		case 2014101067:
