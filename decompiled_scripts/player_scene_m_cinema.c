...
BOOL func_2() // Hash - 0x5A2CF61D ^0xF90A8FB9
{
	int i;
...
int func_3(Ped pedParam0, int iParam1) // Hash - 0x2D409515 ^0x21644596
{
	char* scenarioName;
	int i;
...
BOOL func_4(Ped pedParam0) // Hash - 0xEDF93FD9 ^0x5967271D
{
	int i;
...
BOOL func_5() // Hash - 0x9BF6DAA2 ^0xB6FD0BD5
{
...
BOOL func_6() // Hash - 0x61F0437E ^0x61F0437E
{
	int i;
...
int func_7(int iParam0, Entity eParam1) // Hash - 0xD1960A5B ^0x3A103378
{
...
Entity func_8(var uParam0) // Hash - 0xC9D82232 ^0xC9D82232
{
	return uParam0;
}

BOOL func_9(int iParam0, int iParam1) // Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

int func_10() // Hash - 0x35BC7314 ^0x35BC7314
{
	func_11();
...
void func_11() // Hash - 0xD1F2D853 ^0xF9F5FD4D
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_14(Global_113648.f_2365.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_12(num) && !func_16(14) || Global_112599)
			{
...
void func_17() // Hash - 0xCB830ADA ^0x4F0A1B48
{
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
...
void func_18() // Hash - 0x70035002 ^0x70035002
{
...
void func_20() // Hash - 0x850DE8C4 ^0x850DE8C4
{
	func_19(0);
	return;
}

void func_21() // Hash - 0x1893571B ^0x24CB31BD
{
	int i;
	int num;
	BOOL flag;
...
void func_22() // Hash - 0x6D1D2B42 ^0x78904FEA
{
	var unk;
	int num;
	var unk117;
...
void func_24(var uParam0, int iParam1, int iParam2, int iParam3, float fParam4, float fParam5, float fParam6, float fParam7) // Hash - 0xB67DDD9F ^0xE0258F09
{
...
void func_25(var uParam0) // Hash - 0x9000D55C ^0x3177311F
{
	func_24(uParam0, 145, joaat("SCRIPT_TASK_ANY"), joaat("SCRIPT_TASK_ANY"), 0f, 0f, 0f, 0f);
	return;
}

int func_26(int iParam0, var uParam1, var uParam2, char* sParam3) // Hash - 0x2F312A49 ^0x832B6972
{
	int num;
...
BOOL func_27(var uParam0) // Hash - 0xF5357FFC ^0xF5357FFC
{
	int num;
	Vector3 entityCoords;
	float num2;
...
BOOL func_28(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Hash - 0x2D46096D ^0xEA41378F
{
	if (bParam6)
...
BOOL func_29(int iParam0, var uParam1, char* sParam2) // Hash - 0xC35B5ACB ^0x48DC0D97
{
	var unk;
	int num;
	var unk4;
...
BOOL func_30(int iParam0, int iParam1, var uParam2, var uParam3) // Hash - 0x416CB035 ^0x416CB035
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_32(int iParam0, var uParam1, var uParam2) // Hash - 0x6BF2FA05 ^0x6BF2FA05
{
	switch (iParam0)
	{
		case 11:
...
char* func_33(int iParam0) // Hash - 0x5ECC773B ^0x5ECC773B
{
	switch (iParam0)
	{
...
void func_34() // Hash - 0x1C542A56 ^0x5104A4D4
{
	int i;
