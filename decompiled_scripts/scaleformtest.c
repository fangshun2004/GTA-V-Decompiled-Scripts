...
void func_1(int iParam0, int iParam1) // Hash - 0xA804AEFE ^0x87942C5D
{
	switch (iParam0)
	{
		case 0:
...
void func_3(const char* sParam0) // Hash - 0x690E6520 ^0x509C71F3
{
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_PLAYER_NAME_STRING(sParam0);
	return;
}

void func_4() // Hash - 0xDE877BFB ^0xA4C20B34
{
	if (Global_20362 == 0)
	{
...
void func_5() // Hash - 0x1818D874 ^0x9190E20D
{
	func_6(false);
...
void func_6(BOOL bParam0) // Hash - 0x5FE88D2A ^0xA22C291D
{
	if (bParam0)
	{
		func_13();
...
BOOL func_10() // Hash - 0x8DF3D75D ^0x8DF3D75D
{
	return IS_BIT_SET(Global_1962996, 5);
}

BOOL func_11() // Hash - 0xC41437CB ^0xC41437CB
{
	return IS_BIT_SET(Global_1962996, 19);
}

BOOL func_12(int iParam0) // Hash - 0xE8921B44 ^0x4F063755
{
	if (iParam0 == 1)
...
void func_13() // Hash - 0xF8FE2348 ^0xA77911B2
{
