...
void __EntryFunction__()
{
	...
	fLocal_49 = 180f;
	iLocal_52 = 3;
	uLocal_97 = func_376(60);
	uLocal_98 = func_376(14);
	sLocal_163 = "red_epsilon_truck";
	iLocal_165 = joaat("cs_tom");
	iLocal_166 = joaat("bison");
	sLocal_168 = "DEFAULT";
	sLocal_169 = "GET_UP@DIRECTIONAL@TRANSITION@PRONE_TO_SEATED@STANDARD";
	Local_335 = { 1971.714f, 2870.046f, 48.9397f };
	Local_338 = { 1975.87f, 2865.398f, 49.1545f };
	fLocal_341 = 15f;
	...
	if (func_329())
	{
		Global_80583 = 1;
		iLocal_96 = 0;
		while (!func_324(&Local_100))
		{
			SYSTEM::WAIT(0);
		}
		Global_80583 = 0;
	}
	if (ENTITY::DOES_ENTITY_EXIST(Local_100.f_35[0]))
	{
		VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_100.f_35[0], 1);
	}
	func_323("EP_1_RCM_Concat", 1);
	while (true)
	{
		SYSTEM::WAIT(0);
		func_307(Local_100.f_9, 0, 0, 0, 0, 0);
		switch (iLocal_161)
		{
			case 0:
				func_299();
...
void func_1()
{
	...
	switch (iLocal_162)
	{
		case 0:
			...
			if (MISC::ARE_STRINGS_EQUAL(sLocal_168, "DEFAULT"))
			{
				func_356(1);
			}
			else
...
int func_7(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	...
	else
	{
		...
		iVar20 = 0;
		func_13(&iVar20);
		iVar21 = func_12(Var10, Global_114963.f_7697.f_765[iVar20 /*10*/]);
		if (iVar21 == 2)
		{
			func_10(Global_114963.f_7697.f_765[iVar20 /*10*/]);
		...
		else if (iVar21 == 1)
		{
			...
			{
				if (!func_8(Global_114963.f_7697.f_765[iVar20 /*10*/]))
				{
					Global_114963.f_7697.f_765[iVar20 /*10*/] = { Var10 };
					func_9(&Var10);
					return 1;
...
void func_13(int iParam0)
{
	...
	*iParam0 = 0;
	...
	{
		if (func_12(Global_114963.f_7697.f_765[iVar0 /*10*/], Global_114963.f_7697.f_765[*iParam0 /*10*/]) == 0)
		{
			*iParam0 = iVar0;
		}
		iVar0++;
...
void func_17(int iParam0, bool bParam1)
{
	...
	{
		func_187(&(Global_114050[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
...
void func_20()
{
	...
	{
		func_6(13, SYSTEM::FLOOR(Global_114963.f_10203.f_3853));
	}
...
int func_44(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		Global_80120[1 /*14*/] = { func_97(iVar0, iParam1, uVar31[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_89(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_89(iParam1), Global_80120[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_89(iParam1), Global_80120[1 /*14*/].f_3, Global_80120[1 /*14*/].f_4, 0);
		}
	}
...
int func_45(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_162(iParam0, Global_114963.f_2370.f_539[iVar0 /*65*/].f_64, Global_114963.f_2370.f_539[iVar0 /*65*/].f_63))
		{
...
int func_47(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
				...
				if (BitTest(Global_80120[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							...
							func_63(iParam0, Global_80120[1 /*14*/].f_12, Global_80120[1 /*14*/].f_3, Global_80120[1 /*14*/].f_4);
							func_79(14);
							if (Global_80118 == 1)
							{
								iVar2 = 0;
			...
			{
				Global_80120[1 /*14*/] = { func_97(iVar10, iVar0, func_53(iParam0, iVar0, -1), -1) };
...
int func_88(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_162(iParam0, Global_114963.f_2370.f_539[iVar0 /*65*/].f_61, Global_114963.f_2370.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_96(&Var1, -99, -99, Global_114963.f_2370.f_539.f_196[0], Global_114963.f_2370.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_96(&Var1, -99, -99, Global_114963.f_2370.f_539.f_196[1], Global_114963.f_2370.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_96(&Var1, -99, -99, Global_114963.f_2370.f_539.f_196[2], Global_114963.f_2370.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_84(func_103(iParam1, uParam0->f_2), Global_80117);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), true);
			}
			uVar0 = func_84(func_102(iParam1, uParam0->f_2), Global_80117);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_84(iVar1, Global_80117);
				if (!BitTest(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_169()
{
	...
	{
		if (func_164(Global_114963.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_163(PLAYER::PLAYER_PED_ID());
			if (func_166(iVar0) && (!func_105(14) || Global_113909))
			{
				if (Global_114963.f_2370.f_539.f_4321 != iVar0 && func_166(Global_114963.f_2370.f_539.f_4321))
				{
...
void func_174(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_175(&sVar32, Var0.f_3, Global_102523, bParam1, bParam2);
	}
}
...
void func_219()
{
	...
	switch (iLocal_162)
	{
		case 0:
			...
			func_247(PLAYER::PLAYER_PED_ID(), Local_335, 201.2074f, 0, 1);
			if (!STREAMING::IS_NEW_LOAD_SCENE_ACTIVE())
			{
				STREAMING::NEW_LOAD_SCENE_START_SPHERE(Local_335, 100f, 1);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_167))
			{
				iLocal_167 = VEHICLE::CREATE_VEHICLE(iLocal_166, 1970.362f, 2859.594f, 49.2307f, 151.6095f, true, true, false);
			}
			if (func_218(iLocal_164))
			{
				PED::SET_PED_CAN_BE_TARGETTED(iLocal_164, false);
				PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_164, joaat("player"));
				PED::SET_PED_KEEP_TASK(iLocal_164, true);
				if (func_218(iLocal_167))
				{
					VEHICLE::SET_VEHICLE_COLOURS(iLocal_167, 0, 0);
					VEHICLE::SET_VEHICLE_EXTRA_COLOURS(iLocal_167, 0, 0);
					VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_167, 5f);
					VEHICLE::SET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iLocal_167, 0);
					TASK::TASK_WARP_PED_INTO_VEHICLE(iLocal_164, iLocal_167, -1);
					VEHICLE::SET_VEHICLE_DOORS_LOCKED(iLocal_167, 3);
					VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_167, true, true, false);
				}
			}
			if (func_218(PLAYER::PLAYER_PED_ID()))
			{
				TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_169, "back_armsdown", 1000f, -8f, -1, 1, 0f, false, false, false);
				PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(PLAYER::PLAYER_PED_ID(), true, false);
			}
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_164))
			{
				func_246(&uLocal_170, 4, iLocal_164, "CRIS", 0, 1);
			}
			bLocal_343 = false;
			iLocal_162 = 1;
			break;
		...
		case 1:
			if (STREAMING::IS_NEW_LOAD_SCENE_ACTIVE())
			{
				if (STREAMING::IS_NEW_LOAD_SCENE_LOADED())
				{
					...
					iLocal_347 = CAM::CREATE_CAMERA_WITH_PARAMS(26379945, 1966.059f, 2861.493f, 50.10657f, 5.965983f, 0f, -30.2506f, 50f, false, 2);
					CAM::SET_CAM_ACTIVE(iLocal_347, true);
					iLocal_348 = CAM::CREATE_CAMERA_WITH_PARAMS(26379945, 1970.629f, 2872.505f, 49.44081f, 5.712656f, 0f, -160.9523f, 50f, false, 2);
					CAM::RENDER_SCRIPT_CAMS(true, false, 3000, true, false, 0);
				}
			}
			else if (func_218(iLocal_164))
			{
				if (func_218(iLocal_167))
				{
					if (func_245(iLocal_164, iLocal_167, -1))
					{
						if (iLocal_346)
						{
							if (!bLocal_343)
							{
								bLocal_343 = func_227(&uLocal_170, "EPS1AU", "EPS1_CAR", 8, 0, 0, 0);
							}
							else if (!func_226())
							{
								TASK::TASK_VEHICLE_DRIVE_WANDER(iLocal_164, iLocal_167, fLocal_341, 786599);
								func_222(PLAYER::PLAYER_PED_ID(), 30000, 0, -1082130432);
								CAM::STOP_RENDERING_SCRIPT_CAMS_USING_CATCH_UP(false, 0f, 3, 0);
								CAM::SET_CAM_ACTIVE(iLocal_348, false);
								func_249(0);
								iLocal_162 = 2;
							}
							else if (SYSTEM::TIMERA() > 10000)
							{
								if (!CAM::IS_CAM_ACTIVE(iLocal_348))
								{
									CAM::SET_CAM_ACTIVE(iLocal_348, true);
									CAM::SET_CAM_ACTIVE(iLocal_347, false);
									CAM::SET_CAM_PARAMS(iLocal_348, 1970.766f, 2872.221f, 49.47233f, 5.712656f, 0f, -160.9523f, 50f, 5000, 3, 3, 2);
								}
							}
						}
						else if (func_218(PLAYER::PLAYER_PED_ID()))
						{
							if (TASK::GET_SCRIPT_TASK_STATUS(PLAYER::PLAYER_PED_ID(), joaat("script_task_play_anim")) == 1)
							{
								...
								SYSTEM::SETTIMERA(0);
								func_221(2000, 0);
								CAM::SET_CAM_PARAMS(iLocal_347, 1966.352f, 2861.772f, 50.31656f, 4.433831f, 0f, -30.38087f, 50f, 10000, 0, 0, 2);
							}
						}
					}
					else
...
void func_248()
{
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_164))
	{
		iLocal_164 = PED::CREATE_PED(26, iLocal_165, Local_338, 0f, true, true);
	}
	if (func_218(iLocal_164))
	{
...
void func_257()
{
	...
	switch (iLocal_162)
	{
		case 0:
			...
			{
				if (func_218(Local_100.f_35[0]))
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_100.f_35[0], sLocal_163, 0, joaat("bison"), 0);
				}
				func_286();
...
void func_298()
{
	...
	switch (iLocal_162)
	{
		...
		case 1:
			if (!bLocal_345)
			{
				bLocal_345 = func_227(&uLocal_170, "EPS1AU", "EPS1_TRUCK", 8, 0, 0, 0);
			}
			else if (!func_226())
			{
...
void func_299()
{
	...
	while (((!STREAMING::HAS_ANIM_DICT_LOADED(sLocal_169) || !HUD::HAS_ADDITIONAL_TEXT_LOADED(0)) || !STREAMING::HAS_MODEL_LOADED(iLocal_166)) || !STREAMING::HAS_MODEL_LOADED(iLocal_165))
	{
		SYSTEM::WAIT(0);
	}
	PLAYER::SET_WANTED_LEVEL_MULTIPLIER(0.1f);
	OBJECT::SUPPRESS_PICKUP_REWARD_TYPE(128, false);
	func_246(&uLocal_170, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
	if (func_218(PLAYER::PLAYER_PED_ID()))
	{
...
void func_300(int iParam0, bool bParam1)
{
	...
	if (func_166(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_301(iParam0, &(Global_114963.f_2370.f_539.f_298[iVar0 /*477*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
	...
	if (Global_80592 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_309(Global_80593, Global_80595, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
void func_341(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_166(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		func_342(iParam0, &(Global_114963.f_2370.f_539.f_298[iVar0 /*477*/]), bParam1);
		iVar1 = 0;
		while (iVar1 <= (8 - 1))
		{
			...
			if (bParam2)
			{
				if (iVar1 == Global_114963.f_2370.f_539.f_1763 || (Global_114963.f_2370.f_539.f_1763 == -1 && iVar1 == 4))
				{
					if (Global_114963.f_2370.f_539.f_1730[iVar1 /*4*/][iVar0] != 0 && Global_114963.f_2370.f_539.f_1730[iVar1 /*4*/][iVar0] != joaat("weapon_molotov"))
					{
						if (WEAPON::HAS_PED_GOT_WEAPON(iParam0, Global_114963.f_2370.f_539.f_1730[iVar1 /*4*/][iVar0], false))
						{
							WEAPON::SET_CURRENT_PED_WEAPON(iParam0, Global_114963.f_2370.f_539.f_1730[iVar1 /*4*/][iVar0], true);
						}
					}
				}
			}
...
int func_360()
{
	...
	iVar0 = func_361(&(Global_102486.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
