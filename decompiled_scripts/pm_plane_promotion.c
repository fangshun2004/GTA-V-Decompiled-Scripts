...
void func_1() // Hash - 0x1AF75F25 ^0x6F9C4B53
{
	Vector3 vector;
	var unk3;
	float num;
...
void func_9() // Hash - 0x66027F1A ^0x6A120190
{
	int i;
...
void func_21() // Hash - 0x39A1D88 ^0xA4057B55
{
	int i;
...
BOOL func_25(int iParam0) // Hash - 0x35F9F9C ^0x35F9F9C
{
...
BOOL func_26() // Hash - 0xD0D4EACB ^0xE3E0578A
{
	if (func_144())
		return false;
...
void func_27() // Hash - 0x7B712FE2 ^0x7B712FE2
{
	func_151(1);
	func_150();
	return;
...
BOOL func_28(Vehicle veParam0, int iParam1, int iParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Hash - 0x60473011 ^0x5B80F12B
{
...
void func_29(Vehicle veParam0) // Hash - 0x94E8CB0B ^0x47923A23
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
Blip func_32(Vehicle veParam0, BOOL bParam1, BOOL bParam2) // Hash - 0x177BFEFF ^0x177BFEFF
{
	return func_33(veParam0, !bParam1, bParam2);
}

Blip func_33(Vehicle veParam0, BOOL bParam1, BOOL bParam2) // Hash - 0x2E5A72B ^0x64F26CC0
{
	Blip blip;
...
var func_34(BOOL bParam0, var uParam1, var uParam2) // Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
BOOL func_35(Blip* pblParam0) // Hash - 0x6909601B ^0x43769063
{
...
BOOL func_37(Ped pedParam0) // Hash - 0x71630E54 ^0xA6BB5465
{
	float entitySpeed;
...
BOOL func_38(Ped pedParam0, BOOL bParam1) // Hash - 0x66565C22 ^0x7D7F41BD
{
	if (!PED::IS_PED_INJURED(pedParam0))
	{
...
BOOL func_39(Ped pedParam0, Ped pedParam1) // Hash - 0xB2684CBC ^0x4356A1AE
{
	Vehicle vehiclePedIsIn;
...
BOOL func_41(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Hash - 0x1FB736D4 ^0x234AEAB7
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_42(Blip blParam0, Blip* pblParam1) // Hash - 0xB76BB510 ^0x44EEA9C5
{
...
Blip func_43(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Hash - 0xF4E99477 ^0x29669E98
{
	Blip blip;
...
void func_44(Ped pedParam0, char* sParam1, int iParam2) // Hash - 0x48D349EA ^0xA208047E
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(pedParam0, sParam1, func_45(iParam2), 1);
	return;
}

char* func_45(int iParam0) // Hash - 0x2796E13E ^0xEB093145
{
	char* str;
...
void func_46(Blip* pblParam0, char* sParam1, BOOL bParam2) // Hash - 0xA5F96F8 ^0xA128836
{
	if (!bParam2)
...
BOOL func_47(Blip* pblParam0) // Hash - 0x76C26D7D ^0xC80C7EEA
{
...
BOOL func_48(Blip* pblParam0, int iParam1) // Hash - 0x4C09C8B0 ^0x26FD74C8
{
...
BOOL func_49() // Hash - 0xB8E6BAC9 ^0xB8E6BAC9
{
	if (Global_22736 == 1)
		return true;
...
BOOL func_50(Blip* pblParam0) // Hash - 0xAF65C0BD ^0x2A755CFA
{
	int num;
	int gameTimer;
...
BOOL func_51(Blip* pblParam0, int iParam1) // Hash - 0x8E2FACB ^0xA4BF42F5
{
	Vehicle vehiclePedIsIn;
...
BOOL func_52(Vehicle veParam0, Blip* pblParam1, int iParam2) // Hash - 0xD4375383 ^0x983550B3
{
	int num;
...
void func_53(char* sParam0) // Hash - 0x78302BA0 ^0xA1CD23FC
{
...
BOOL func_54(Blip* pblParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, char* sParam7, float fParam8, BOOL bParam9, Vehicle veParam10, BOOL bParam11, BOOL bParam12, var uParam13, var uParam14, var uParam15, int iParam16, BOOL bParam17) // Hash - 0x6DAD9811 ^0xC9215DBA
{
	int i;
	int num;
	int num2;
...
void func_55(int iParam0, Blip* pblParam1) // Hash - 0x1E3FA253 ^0x58FA4A13
{
	switch (iParam0)
	{
		case 0:
...
void func_56(Blip* pblParam0, const char* sParam1, const char* sParam2, BOOL bParam3) // Hash - 0x5A99F648 ^0x43F29C5B
{
	if (!bParam3)
		if (!MISC::IS_STRING_NULL(sParam1))
			if (!MISC::ARE_STRINGS_EQUAL(sParam1, ""))
...
void func_57(const char* sParam0, const char* sParam1, int iParam2, int iParam3) // Hash - 0xA3B0AE7D ^0x4927FD61
{
	iParam3 = iParam3;
...
BOOL func_58(int iParam0, Blip* pblParam1) // Hash - 0x600BF84A ^0x55A07351
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_59(Ped pedParam0, float fParam1) // Hash - 0x430D9426 ^0x1E20BEFF
{
	Vehicle vehiclePedIsIn;
...
BOOL func_60(Ped pedParam0, Vehicle veParam1) // Hash - 0x3428DDCA ^0x5AEC4411
{
...
BOOL func_61(Ped pedParam0, Vehicle veParam1) // Hash - 0x980D507B ^0x3BE5D72A
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
void func_62(int iParam0, Blip* pblParam1) // Hash - 0x15448333 ^0xB9FB55EE
{
	switch (iParam0)
	{
		case 0:
...
void func_63(int iParam0, Blip* pblParam1) // Hash - 0x15448333 ^0xBC910CAF
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_64(int iParam0, Blip* pblParam1) // Hash - 0x933A2257 ^0x69FB2D8F
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_65(Ped pedParam0) // Hash - 0x8AAA640C ^0xAE198AD7
{
	Vehicle vehiclePedIsUsing;
...
BOOL func_66(Vehicle veParam0, Blip* pblParam1) // Hash - 0x3E226C88 ^0xEA75D78A
{
	int num;
	int num2;
	int i;
...
BOOL func_67(Blip* pblParam0) // Hash - 0x3C89153B ^0x56EFDE35
{
	Vehicle vehiclePedIsIn;
...
BOOL func_68(Blip* pblParam0, Ped pedParam1, float fParam2, BOOL bParam3) // Hash - 0x1C5C3B1A ^0x5D8BFBBA
{
	Vehicle vehiclePedIsIn;
...
BOOL func_69(Vehicle veParam0) // Hash - 0x6799283D ^0x73763D18
{
	float entitySpeed;
...
BOOL func_70(Ped pedParam0, Vehicle veParam1) // Hash - 0xFB12ABF0 ^0x730FD205
{
	Vehicle vehiclePedIsUsing;
...
void func_71() // Hash - 0xD3ADA56D ^0x10639AB8
{
	Vehicle vehiclePedIsEntering;
	Ped pedInVehicleSeat;
...
void func_72(Blip* pblParam0) // Hash - 0xFF242068 ^0x3467AFB3
{
	int i;
...
void func_73(Blip* pblParam0) // Hash - 0xBD02C826 ^0xC8C2D545
{
	int i;
...
char* func_74() // Hash - 0x2ED91BC3 ^0x2ED91BC3
{
	char* unk;
...
Vector3 func_75() // Hash - 0xB451132E ^0xB451132E
{
	return 0f, 0f, 2f;
}

BOOL func_76(var uParam0) // Hash - 0x14A233D6 ^0xF7008CC3
{
	float num;
...
Blip func_77(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4) // Hash - 0x3A21D01B ^0x6111230A
{
	Blip blip;
...
float func_79(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Hash - 0xC22B942A ^0xE0DB8793
{
...
void func_80(float fParam0, float fParam1, float fParam2, float fParam3, int iParam4, int iParam5) // Hash - 0xFAD52877 ^0x5B3475CA
{
	var unk;
	float num;
...
void func_81(Vehicle veParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5, BOOL bParam6) // Hash - 0x29B4C4C8 ^0x31C8EC4C
{
	var unk;
...
void func_82(int iParam0, Vehicle veParam1, int iParam2) // Hash - 0x9860D273 ^0xD433FB9F
{
	Vehicle vehicle;
...
void func_83(Vehicle veParam0, int iParam1) // Hash - 0x403E4E98 ^0x34F9BF63
{
	Ped pedInVehicleSeat;
	int i;
	int j;
...
BOOL func_84(Vehicle veParam0) // Hash - 0xF8B40626 ^0x20AEF85E
{
...
BOOL func_85(Hash hParam0) // Hash - 0x66FE4A4A ^0x10D5195D
{
	if (hParam0 == 0)
		return false;
...
BOOL func_86(Hash hParam0, BOOL bParam1, int iParam2) // Hash - 0x9BD8A1CC ^0xA5081522
{
	int i;
	Hash outData;
...
BOOL func_87(Hash hParam0) // Hash - 0xC7E3100C ^0x6BF82986
{
	int num;
	var unk;
	var name;
...
BOOL func_88() // Hash - 0x2E0B1DC1 ^0xD2D0A3D9
{
...
BOOL func_89(Hash hParam0, int iParam1) // Hash - 0x2FF24ACC ^0x92A5C100
{
	BOOL num;
	int cloudTimeAsInt;
...
BOOL func_90() // Hash - 0x4C81F065 ^0x79C65D03
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL func_91() // Hash - 0x4C81F065 ^0xA2709774
{
	return MISC::IS_DURANGO_VERSION() || unk_0x0C545AB1CF97ABB3();
}

BOOL func_92() // Hash - 0x98B7EFDD ^0x98B7EFDD
{
	return false;
}
...
BOOL func_95() // Hash - 0x64659D79 ^0xC3C726F6
{
...
BOOL func_96() // Hash - 0x44DD83CC ^0x7B62A376
{
	int profileSetting;
...
BOOL func_97(Vehicle veParam0) // Hash - 0xC71C0264 ^0x8B6776
{
	Hash entityModel;
...
BOOL func_98(Vehicle veParam0) // Hash - 0xA5B9FC6B ^0x23EADD90
{
	int i;
...
BOOL func_99(Vehicle veParam0) // Hash - 0xB4CAAE6F ^0x153EF8BE
{
	int i;
...
BOOL func_100(Vehicle veParam0) // Hash - 0x7BB181DF ^0x17C4552A
{
	int i;
...
BOOL func_101(Vehicle veParam0, int iParam1, BOOL bParam2) // Hash - 0xBCC62924 ^0x77695844
{
	int i;
	var garageName;
	int num;
...
BOOL func_102(int iParam0, int iParam1, char* sParam2, var uParam3) // Hash - 0x31A11A33 ^0xB48096F1
{
...
var func_103() // Hash - 0x9E44C35 ^0xB9993D58
{
	var unk;
...
void func_104(var uParam0, int iParam1) // Hash - 0x15B9927E ^0x4A4674
{
	if (iParam1 <= 0)
		return;
...
void func_105(var uParam0, int iParam1) // Hash - 0x4C70B2C3 ^0x4C70B2C3
{
...
void func_106(var uParam0, int iParam1) // Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
int func_107(int iParam0, int iParam1) // Hash - 0xD3EBACB3 ^0xD3EBACB3
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_111(var uParam0, int iParam1) // Hash - 0x864304A8 ^0x1F5003E2
{
...
void func_112(var uParam0, int iParam1) // Hash - 0x76860AE7 ^0x32308FFF
{
...
void func_113(var uParam0, int iParam1) // Hash - 0xDB8A72C0 ^0x4F6D426D
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_114(var uParam0, int iParam1) // Hash - 0x8FF875B9 ^0x85A5EFB7
{
	BOOL num;
	int num2;
...
int func_115(int iParam0, int iParam1) // Hash - 0x3C1119CD ^0x1010ECAE
{
	int num;
...
void func_116(int iParam0, var uParam1, int iParam2) // Hash - 0xF92B8944 ^0xD11BCD5C
{
	int num;
...
void func_117(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5, int iParam6) // Hash - 0xE596DE1C ^0xAEF9731A
{
	if (func_114(&Global_77348.f_555[0 /*21*/], iParam0))
	{
...
void func_118(int iParam0, BOOL bParam1) // Hash - 0xF45B4890 ^0xF45B4890
{
	if (iParam0 == -1)
		return;
...
void func_119(int iParam0, int iParam1, BOOL bParam2) // Hash - 0xDEF0CB8B ^0x421AAE37
{
	if (iParam0 == -1)
		return;
...
BOOL func_120(int iParam0, int iParam1) // Hash - 0x9EA0654 ^0x9EA0654
{
	if (iParam0 == -1)
		return false;
...
void func_121(var uParam0, var uParam1) // Hash - 0x8EF4EDA5 ^0xC1247BD8
{
...
void func_122(int iParam0) // Hash - 0x64A608A0 ^0xF3C031DC
{
	if (iParam0 == -1)
		return;
...
int func_123(Vehicle veParam0) // Hash - 0x593067C2 ^0x2918B7DD
{
	int i;
...
BOOL func_124(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Hash - 0x2D46096D ^0xEA41378F
{
	if (bParam6)
...
void func_125(Vehicle veParam0, var uParam1) // Hash - 0x5E84B52A ^0xEF20F807
{
	int i;
...
int func_127(var uParam0, var uParam1, var uParam2) // Hash - 0x4455160E ^0x8E5B3F28
{
	int i;
	int modType;
...
void func_129(var uParam0) // Hash - 0xB95AF921 ^0x4DC7C61C
{
	int i;
...
void func_130(int iParam0) // Hash - 0x6203AFCC ^0x6203AFCC
{
...
BOOL func_131(var uParam0, var uParam1, var uParam2, int iParam3, var uParam4, var uParam5) // Hash - 0x2129E9A2 ^0x2129E9A2
{
	int num;
...
int func_132(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4) // Hash - 0xF069BA05 ^0x35D3817B
{
	int i;
...
BOOL func_133(int iParam0) // Hash - 0x757E9BA6 ^0x757E9BA6
{
	return IS_BIT_SET(Global_113648.f_7231[iParam0], 0);
}

Vehicle func_134(int iParam0) // Hash - 0x220835E3 ^0xF13BEB49
{
	if (iParam0 == -1)
		return 0;
...
void func_135(Blip* pblParam0, BOOL bParam1, BOOL bParam2) // Hash - 0x634140C0 ^0xD1086239
{
	int i;
...
void func_136(int iParam0, Blip* pblParam1) // Hash - 0x1E3FA253 ^0xEDD411CE
{
	switch (iParam0)
	{
		case 0:
...
void func_137(Blip* pblParam0) // Hash - 0x2F9D6A60 ^0x6561436A
{
	if (HUD::DOES_BLIP_EXIST(pblParam0->f_5))
		HUD::REMOVE_BLIP(&(pblParam0->f_5));
...
float func_138(float fParam0, float fParam1, float fParam2) // Hash - 0xF4DC03E3 ^0xF4DC03E3
{
	if (fParam0 > fParam2)
		return fParam2;
...
BOOL func_139(char* sParam0) // Hash - 0xCD6A3595 ^0xB0E86AA0
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

float func_140(Ped pedParam0, Vehicle veParam1, BOOL bParam2) // Hash - 0x7B2C17A2 ^0xDF922C6D
{
	Vector3 entityCoords;
...
Blip func_141(Vehicle veParam0, BOOL bParam1, BOOL bParam2) // Hash - 0x177BFEFF ^0x177BFEFF
{
	return func_33(veParam0, !bParam1, bParam2);
}

void func_142(char* sParam0, int iParam1, int iParam2) // Hash - 0x8A76EF8E ^0x32DD2C0C
{
	iParam2 = iParam2;
	HUD::BEGIN_TEXT_COMMAND_PRINT(sParam0);
...
void func_143() // Hash - 0x2CEE6999 ^0x2CEE6999
{
	func_151(2);
	func_150();
	return;
...
BOOL func_144() // Hash - 0x152DA0B2 ^0x220E93E9
{
...
void func_145() // Hash - 0xD86DCF6E ^0xE1BA72E6
{
	int i;
	float groundZ;
...
int func_146() // Hash - 0x4228A1C2 ^0x350FFF83
{
	return Global_112358.f_20;
}

BOOL func_147(float fParam0, var uParam1, var uParam2) // Hash - 0x16E871AD ^0x10C54C39
{
...
void func_148(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Hash - 0x6C235EE0 ^0x9E57F206
{
...
void func_149(int iParam0, int iParam1) // Hash - 0x7CE9D5F9 ^0xF92D761B
{
...
void func_150() // Hash - 0x2DB2F054 ^0x253336C1
{
	if (ENTITY::DOES_ENTITY_EXIST(veLocal_241))
...
void func_151(int iParam0) // Hash - 0x29A8F290 ^0x87716063
{
