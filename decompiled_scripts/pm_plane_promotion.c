	...
	switch (iLocal_47)
	{
		case 0:
			...
			if (STREAMING::HAS_MODEL_LOADED(-2122757008))
			{
				...
				if (!ENTITY::DOES_ENTITY_EXIST(veLocal_241))
				{
					veLocal_241 = VEHICLE::CREATE_VEHICLE(-2122757008, vector, 121.2244f, true, true, false);
	...
	switch (iLocal_48)
	{
		case 0:
			...
			else if (func_26() && MISC::GET_GAME_TIMER() - iLocal_49 > 5000 && bLocal_329)
			{
				...
				if (func_2(&uLocal_76, &uLocal_39, &unk3, 8, 0, 0, 0))
				{
		...
		case 1:
			...
			{
				if (func_2(&uLocal_76, &uLocal_39, "DONE", 8, 0, 0, 0))
				{
					TEXT_LABEL_ASSIGN_STRING(&unk3, "", 16);
					iLocal_48 = iLocal_48 + 1;
				}
...
BOOL func_2(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x568 Hash - 0x384540C1 ^0x384540C1
{
...
Player func_8() // Position - 0x946 Hash - 0x478900E4 ^0x478900E4
{
	return -1;
}
...
void func_13() // Position - 0xAD5 Hash - 0x98476CE1 ^0x250FEB7C
{
	if (func_20(14))
	{
...
int func_14() // Position - 0xB77 Hash - 0x3C5423D7 ^0x3C5423D7
{
	func_15();
...
BOOL func_16(int iParam0) // Position - 0xC8D Hash - 0x8907F004 ^0x8907F004
{
	return iParam0 < 3;
}

int func_17(Ped pedParam0) // Position - 0xC99 Hash - 0xAC4E9801 ^0xB379A75F
{
	int i;
	Hash entityModel;
...
Hash func_18(int iParam0) // Position - 0xCD6 Hash - 0xADCB9755 ^0xADCB9755
{
	if (func_16(iParam0))
...
Hash func_19(int iParam0) // Position - 0xCFB Hash - 0xE4CEEC2C ^0xE4CEEC2C
{
...
void func_24(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDFE Hash - 0xC6B752B2 ^0xC6B752B2
{
...
BOOL func_28(Vehicle veParam0, int iParam1, int iParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xEB7 Hash - 0x60473011 ^0x5B80F12B
{
...
void func_29(Vehicle veParam0) // Position - 0x104F Hash - 0x94E8CB0B ^0x47923A23
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
	...
	if (func_54(pblParam0, pblParam0->f_17[0], pblParam0->f_17[1], pblParam0->f_17[2], sParam20, sParam21, sParam22, sParam23, pblParam0->f_8, bParam25, veParam18, false, false, sParam32, sParam33, sParam34, iParam14, bParam26))
	{
		...
		if (CAM::IS_SCREEN_FADED_IN())
		{
			...
			if (flag)
			{
				func_53(sParam24);
				func_53(sParam27);
				func_53(_("A vehicle with more seats is needed."));
				...
				if (bParam26 && PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
				{
					...
					if (!func_48(pblParam0, 1) && !func_47(pblParam0) && !IS_BIT_SET(pblParam0->f_13, 0))
					{
						if (bParam30)
						{
							func_46(pblParam0, _("Lose the Cops."), false);
						...
						if (!func_48(pblParam0, 2))
						{
							if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
							{
								if (!IS_BIT_SET(pblParam0->f_13, 13))
								{
									...
									func_46(pblParam0, _("A vehicle with more seats is needed."), false);
...
Blip func_32(Vehicle veParam0, BOOL bParam1, BOOL bParam2) // Position - 0x19D5 Hash - 0x177BFEFF ^0x177BFEFF
{
	return func_33(veParam0, !bParam1, bParam2);
}

Blip func_33(Vehicle veParam0, BOOL bParam1, BOOL bParam2) // Position - 0x19E8 Hash - 0x2E5A72B ^0x64F26CC0
{
	Blip blip;
...
var func_34(BOOL bParam0, var uParam1, var uParam2) // Position - 0x1A8C Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
BOOL func_35(Blip* pblParam0) // Position - 0x1AA3 Hash - 0x6909601B ^0x43769063
{
...
BOOL func_36(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1AF8 Hash - 0xF0D380FF ^0x29DD7336
{
	Vehicle vehiclePedIsIn;
...
BOOL func_37(Ped pedParam0) // Position - 0x1BDD Hash - 0x71630E54 ^0xA6BB5465
{
	float entitySpeed;
...
BOOL func_38(Ped pedParam0, BOOL bParam1) // Position - 0x1C14 Hash - 0x66565C22 ^0x7D7F41BD
{
	if (!PED::IS_PED_INJURED(pedParam0))
	{
...
BOOL func_39(Ped pedParam0, Ped pedParam1) // Position - 0x1C7F Hash - 0xB2684CBC ^0x4356A1AE
{
	Vehicle vehiclePedIsIn;
...
int func_40() // Position - 0x1CC7 Hash - 0xDED80B4D ^0xD3C18941
{
	return PLAYER::GET_PLAYER_GROUP(PLAYER::GET_PLAYER_INDEX());
}

BOOL func_41(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x1CD7 Hash - 0x1FB736D4 ^0x234AEAB7
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_42(Blip blParam0, Blip* pblParam1) // Position - 0x1D52 Hash - 0xB76BB510 ^0x44EEA9C5
{
...
Blip func_43(var uParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x1D8D Hash - 0xF4E99477 ^0xFAB7E8FB
{
...
void func_44(Ped pedParam0, char* sParam1, int iParam2) // Position - 0x1DB9 Hash - 0x48D349EA ^0xA208047E
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(pedParam0, sParam1, func_45(iParam2), 1);
	return;
}

char* func_45(int iParam0) // Position - 0x1DD0 Hash - 0x2796E13E ^0xEB093145
{
	char* str;
...
void func_46(Blip* pblParam0, char* sParam1, BOOL bParam2) // Position - 0x1FC4 Hash - 0xA5F96F8 ^0xA128836
{
	if (!bParam2)
...
BOOL func_47(Blip* pblParam0) // Position - 0x1FFB Hash - 0x76C26D7D ^0xC80C7EEA
{
...
BOOL func_48(Blip* pblParam0, int iParam1) // Position - 0x201F Hash - 0x4C09C8B0 ^0x26FD74C8
{
...
BOOL func_49() // Position - 0x2077 Hash - 0xB8E6BAC9 ^0xB8E6BAC9
{
	if (Global_22736 == 1)
		return true;
...
BOOL func_50(Blip* pblParam0) // Position - 0x208E Hash - 0xAF65C0BD ^0x2A755CFA
{
	int num;
	int gameTimer;
...
BOOL func_51(Blip* pblParam0, int iParam1) // Position - 0x20B1 Hash - 0x8E2FACB ^0xA4BF42F5
{
	Vehicle vehiclePedIsIn;
...
BOOL func_52(Vehicle veParam0, Blip* pblParam1, int iParam2) // Position - 0x20E2 Hash - 0xD4375383 ^0x983550B3
{
	int num;
...
void func_53(char* sParam0) // Position - 0x2176 Hash - 0x78302BA0 ^0xA1CD23FC
{
...
BOOL func_54(Blip* pblParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, char* sParam7, float fParam8, BOOL bParam9, Vehicle veParam10, BOOL bParam11, BOOL bParam12, var uParam13, var uParam14, var uParam15, int iParam16, BOOL bParam17) // Position - 0x218E Hash - 0x6DAD9811 ^0xC9215DBA
{
	int i;
	int num;
	int num2;
			...
			if (!PED::IS_PED_INJURED(pblParam0->f_17[0]) || !PED::IS_PED_INJURED(pblParam0->f_17[1]) || !PED::IS_PED_INJURED(pblParam0->f_17[2]))
			{
				if (!IS_BIT_SET(pblParam0->f_13, 31))
				{
					if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()) && !func_48(pblParam0, 2))
					{
						...
						{
							func_46(pblParam0, _("~s~Vehicle is not suitable."), false);
				...
				else if (!PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
				{
					...
					func_53(_("~s~Vehicle is not suitable."));
				}
			}
		}
...
void func_55(int iParam0, Blip* pblParam1) // Position - 0x31D1 Hash - 0x1E3FA253 ^0x58FA4A13
{
	switch (iParam0)
	{
		case 0:
...
void func_56(Blip* pblParam0, const char* sParam1, const char* sParam2, BOOL bParam3) // Position - 0x3219 Hash - 0x5A99F648 ^0x43F29C5B
{
	if (!bParam3)
		if (!MISC::IS_STRING_NULL(sParam1))
			if (!MISC::ARE_STRINGS_EQUAL(sParam1, ""))
...
void func_57(const char* sParam0, const char* sParam1, int iParam2, int iParam3) // Position - 0x3252 Hash - 0xA3B0AE7D ^0x4927FD61
{
	iParam3 = iParam3;
...
BOOL func_58(int iParam0, Blip* pblParam1) // Position - 0x3271 Hash - 0x600BF84A ^0x55A07351
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_59(Ped pedParam0, float fParam1) // Position - 0x32B1 Hash - 0x430D9426 ^0x1E20BEFF
{
	Vehicle vehiclePedIsIn;
...
BOOL func_60(Ped pedParam0, Vehicle veParam1) // Position - 0x32E8 Hash - 0x3428DDCA ^0x5AEC4411
{
...
BOOL func_61(Ped pedParam0, Vehicle veParam1) // Position - 0x334F Hash - 0x980D507B ^0x3BE5D72A
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
void func_62(int iParam0, Blip* pblParam1) // Position - 0x3384 Hash - 0x15448333 ^0xB9FB55EE
{
	switch (iParam0)
	{
		case 0:
...
void func_63(int iParam0, Blip* pblParam1) // Position - 0x33CC Hash - 0x15448333 ^0xBC910CAF
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_64(int iParam0, Blip* pblParam1) // Position - 0x3414 Hash - 0x933A2257 ^0x69FB2D8F
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_65(Ped pedParam0) // Position - 0x3454 Hash - 0x8AAA640C ^0xAE198AD7
{
...
BOOL func_66(Vehicle veParam0, Blip* pblParam1) // Position - 0x34E1 Hash - 0x3E226C88 ^0xEA75D78A
{
	int num;
	int num2;
	int i;
...
BOOL func_67(Blip* pblParam0) // Position - 0x3641 Hash - 0x3C89153B ^0x56EFDE35
{
	Vehicle vehiclePedIsIn;
...
BOOL func_68(Blip* pblParam0, Ped pedParam1, float fParam2, BOOL bParam3) // Position - 0x3670 Hash - 0x1C5C3B1A ^0x5D8BFBBA
{
	Vehicle vehiclePedIsIn;
...
BOOL func_69(Vehicle veParam0) // Position - 0x374E Hash - 0x6799283D ^0x73763D18
{
	float entitySpeed;
...
BOOL func_70(Ped pedParam0, Vehicle veParam1) // Position - 0x3786 Hash - 0xFB12ABF0 ^0x730FD205
{
	Vehicle vehiclePedIsUsing;
...
void func_71() // Position - 0x37B6 Hash - 0xD3ADA56D ^0x10639AB8
{
	Vehicle vehiclePedIsEntering;
	Ped pedInVehicleSeat;
...
void func_72(Blip* pblParam0) // Position - 0x3823 Hash - 0xFF242068 ^0x3467AFB3
{
	int i;
...
void func_73(Blip* pblParam0) // Position - 0x38C3 Hash - 0xBD02C826 ^0xC8C2D545
{
	int i;
...
char* func_74() // Position - 0x3959 Hash - 0x2ED91BC3 ^0x2ED91BC3
{
	char* unk;
...
Vector3 func_75() // Position - 0x3963 Hash - 0xB451132E ^0xB451132E
{
	return 0f, 0f, 2f;
}

BOOL func_76(var uParam0) // Position - 0x396E Hash - 0x14A233D6 ^0xF7008CC3
{
	float num;
...
Blip func_77(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4) // Position - 0x3AAC Hash - 0x3A21D01B ^0x6111230A
{
	Blip blip;
...
void func_78(char* sParam0, int iParam1) // Position - 0x3AE6 Hash - 0xCBB0D91 ^0x21070E5C
{
...
float func_79(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x3AFD Hash - 0xC22B942A ^0xE0DB8793
{
...
void func_80(float fParam0, float fParam1, float fParam2, float fParam3, int iParam4, int iParam5) // Position - 0x3B37 Hash - 0xFAD52877 ^0x5B3475CA
{
	var unk;
	float unk2;
...
void func_81(Vehicle veParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5, BOOL bParam6) // Position - 0x3BB2 Hash - 0x29B4C4C8 ^0x31C8EC4C
{
	var unk;
...
void func_82(int iParam0, Vehicle veParam1, int iParam2) // Position - 0x3CDB Hash - 0x9860D273 ^0xD433FB9F
{
	Vehicle vehicle;
...
void func_83(Vehicle veParam0, int iParam1) // Position - 0x3DF2 Hash - 0x403E4E98 ^0x34F9BF63
{
	Ped pedInVehicleSeat;
	int i;
	int j;
...
BOOL func_84(Vehicle veParam0) // Position - 0x3FF4 Hash - 0xF8B40626 ^0x20AEF85E
{
...
BOOL func_85(Hash hParam0) // Position - 0x40D2 Hash - 0x66FE4A4A ^0x10D5195D
{
	if (hParam0 == 0)
		return false;
...
BOOL func_86(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x4284 Hash - 0x9BD8A1CC ^0xA5081522
{
	int i;
	Hash outData;
...
BOOL func_87(Hash hParam0) // Position - 0x4406 Hash - 0xC7E3100C ^0x6BF82986
{
	int num;
	var unk;
	var unk2;
...
BOOL func_88() // Position - 0x44D2 Hash - 0x2E0B1DC1 ^0xD2D0A3D9
{
...
BOOL func_89(Hash hParam0, int iParam1) // Position - 0x44E9 Hash - 0x2FF24ACC ^0x92A5C100
{
	BOOL num;
	int cloudTimeAsInt;
...
BOOL func_90() // Position - 0x7B19 Hash - 0x4C81F065 ^0x26D68D51
{
	return MISC::IS_ORBIS_VERSION() || unk_0xEE17703CF2C2875A();
}

BOOL func_91() // Position - 0x7B2F Hash - 0x4C81F065 ^0x60494CEC
{
	return MISC::IS_DURANGO_VERSION() || unk_0x14F62099DEBAEA33();
}

BOOL func_92() // Position - 0x7B45 Hash - 0x98B7EFDD ^0x98B7EFDD
{
	return false;
}

BOOL func_93() // Position - 0x7B4E Hash - 0xFD255207 ^0xFD255207
{
	return true;
}

BOOL func_94() // Position - 0x7B57 Hash - 0xFD255207 ^0xFD255207
{
	return true;
}

BOOL func_95() // Position - 0x7B60 Hash - 0x64659D79 ^0xC3C726F6
{
...
BOOL func_96() // Position - 0x7B79 Hash - 0x44DD83CC ^0x6D2C8335
{
	int profileSetting;
...
BOOL func_97(Vehicle veParam0) // Position - 0x7C31 Hash - 0xC71C0264 ^0x8B6776
{
	Hash entityModel;
...
BOOL func_98(Vehicle veParam0) // Position - 0x7C78 Hash - 0xA5B9FC6B ^0x23EADD90
{
	int i;
...
BOOL func_99(Vehicle veParam0) // Position - 0x7CB3 Hash - 0xB4CAAE6F ^0x153EF8BE
{
	int i;
...
BOOL func_100(Vehicle veParam0) // Position - 0x7D2F Hash - 0x7BB181DF ^0x17C4552A
{
	int i;
...
BOOL func_101(Vehicle veParam0, int iParam1, BOOL bParam2) // Position - 0x7E17 Hash - 0xBCC62924 ^0x77695844
{
	int i;
	var garageName;
	int unk;
...
BOOL func_102(int iParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x7E85 Hash - 0x31A11A33 ^0xB48096F1
{
...
var func_103() // Position - 0x7F5D Hash - 0x9E44C35 ^0xB9993D58
{
	var unk;
...
void func_104(var uParam0, int iParam1) // Position - 0x7FA3 Hash - 0x15B9927E ^0x4A4674
{
	if (iParam1 <= 0)
		return;
...
void func_105(var uParam0, int iParam1) // Position - 0x802A Hash - 0x4C70B2C3 ^0x4C70B2C3
{
...
void func_106(var uParam0, int iParam1) // Position - 0x805D Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
int func_107(int iParam0, int iParam1) // Position - 0x80AE Hash - 0xD3EBACB3 ^0xD3EBACB3
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_108(int iParam0) // Position - 0x8150 Hash - 0xE1B0542C ^0x127A471E
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_109(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8172 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
int func_110(int iParam0) // Position - 0x8189 Hash - 0x2D4DB85F ^0x2D4DB85F
{
	return iParam0 & 15;
}

void func_111(var uParam0, int iParam1) // Position - 0x8196 Hash - 0x864304A8 ^0x1F5003E2
{
...
void func_112(var uParam0, int iParam1) // Position - 0x81D0 Hash - 0x76860AE7 ^0x32308FFF
{
...
void func_113(var uParam0, int iParam1) // Position - 0x820B Hash - 0xDB8A72C0 ^0x4F6D426D
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_114(var uParam0, int iParam1) // Position - 0x8247 Hash - 0x8FF875B9 ^0x85A5EFB7
{
	BOOL num;
	int num2;
...
int func_115(int iParam0, int iParam1) // Position - 0x9935 Hash - 0x3C1119CD ^0x1010ECAE
{
	int num;
...
void func_116(int iParam0, var uParam1, int iParam2) // Position - 0x9977 Hash - 0xF92B8944 ^0xD11BCD5C
{
	int num;
...
void func_117(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5, int iParam6) // Position - 0x9BD3 Hash - 0xE596DE1C ^0xAEF9731A
{
	if (func_114(&Global_77348.f_555[0 /*21*/], iParam0))
	{
...
void func_118(int iParam0, BOOL bParam1) // Position - 0x9CCC Hash - 0xF45B4890 ^0xF45B4890
{
	if (iParam0 == -1)
		return;
...
void func_119(int iParam0, int iParam1, BOOL bParam2) // Position - 0x9D29 Hash - 0xDEF0CB8B ^0x421AAE37
{
	if (iParam0 == -1)
		return;
...
BOOL func_120(int iParam0, int iParam1) // Position - 0x9D64 Hash - 0x9EA0654 ^0x9EA0654
{
	if (iParam0 == -1)
		return false;
...
void func_121(var uParam0, var uParam1) // Position - 0x9D84 Hash - 0x8EF4EDA5 ^0xC1247BD8
{
...
void func_122(int iParam0) // Position - 0x9E50 Hash - 0x64A608A0 ^0xF3C031DC
{
	if (iParam0 == -1)
		return;
...
int func_123(Vehicle veParam0) // Position - 0x9EC7 Hash - 0x593067C2 ^0x2918B7DD
{
	int i;
...
BOOL func_124(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x9F2A Hash - 0x2D46096D ^0xEA41378F
{
	if (bParam6)
...
void func_125(Vehicle veParam0, var uParam1) // Position - 0x9F71 Hash - 0x5E84B52A ^0xEF20F807
{
	int i;
...
int func_126(int iParam0) // Position - 0xA21C Hash - 0xEE599357 ^0xEE599357
{
	switch (iParam0)
	{
		case 1:
...
int func_127(var uParam0, var uParam1, var uParam2) // Position - 0xA2CC Hash - 0x4455160E ^0x8E5B3F28
{
	int i;
	int modType;
...
BOOL func_128(int iParam0) // Position - 0xA4BF Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case -1775728740:
...
void func_129(var uParam0) // Position - 0xA4DF Hash - 0xB95AF921 ^0x4DC7C61C
{
	int i;
...
void func_130(int iParam0) // Position - 0xA58F Hash - 0x6203AFCC ^0x6203AFCC
{
...
BOOL func_131(var uParam0, var uParam1, var uParam2, int iParam3, var uParam4, var uParam5) // Position - 0xA5B6 Hash - 0x2129E9A2 ^0x2129E9A2
{
	int num;
...
int func_132(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4) // Position - 0xA6CC Hash - 0xF069BA05 ^0x35D3817B
{
	int i;
...
BOOL func_133(int iParam0) // Position - 0xA75B Hash - 0x757E9BA6 ^0x757E9BA6
{
	return IS_BIT_SET(Global_113648.f_7231[iParam0], 0);
}

Vehicle func_134(int iParam0) // Position - 0xA770 Hash - 0x220835E3 ^0xF13BEB49
{
	if (iParam0 == -1)
		return 0;
...
void func_135(Blip* pblParam0, BOOL bParam1, BOOL bParam2) // Position - 0xA78C Hash - 0x634140C0 ^0xD1086239
{
	int i;
...
void func_136(int iParam0, Blip* pblParam1) // Position - 0xA937 Hash - 0x1E3FA253 ^0xEDD411CE
{
	switch (iParam0)
	{
		case 0:
...
void func_137(Blip* pblParam0) // Position - 0xA97F Hash - 0x2F9D6A60 ^0x6561436A
{
	if (HUD::DOES_BLIP_EXIST(pblParam0->f_5))
		HUD::REMOVE_BLIP(&(pblParam0->f_5));
...
float func_138(float fParam0, float fParam1, float fParam2) // Position - 0xA99A Hash - 0xF4DC03E3 ^0xF4DC03E3
{
	if (fParam0 > fParam2)
		return fParam2;
...
BOOL func_139(char* sParam0) // Position - 0xA9C1 Hash - 0xCD6A3595 ^0xB0E86AA0
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

float func_140(Ped pedParam0, Vehicle veParam1, BOOL bParam2) // Position - 0xA9D4 Hash - 0x7B2C17A2 ^0xDF922C6D
{
	Vector3 entityCoords;
	Vector3 unk;
...
Blip func_141(Vehicle veParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAA32 Hash - 0x177BFEFF ^0x177BFEFF
{
	return func_33(veParam0, !bParam1, bParam2);
}

void func_142(char* sParam0, int iParam1, int iParam2) // Position - 0xAA45 Hash - 0x8A76EF8E ^0x32DD2C0C
{
	iParam2 = iParam2;
	HUD::BEGIN_TEXT_COMMAND_PRINT(sParam0);
...
void func_143() // Position - 0xAA5E Hash - 0x2CEE6999 ^0x2CEE6999
{
	func_151(2);
	func_150();
	return;
...
BOOL func_144() // Position - 0xAA6F Hash - 0x152DA0B2 ^0x220E93E9
{
...
void func_145() // Position - 0xAA91 Hash - 0xD86DCF6E ^0xE1BA72E6
{
	int i;
	float groundZ;
...
int func_146() // Position - 0xACA9 Hash - 0x4228A1C2 ^0x350FFF83
{
	return Global_112358.f_20;
}

BOOL func_147(float fParam0, var uParam1, var uParam2) // Position - 0xACB7 Hash - 0x16E871AD ^0x10C54C39
{
...
void func_148(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xACE1 Hash - 0x6C235EE0 ^0x9E57F206
{
...
void func_149(int iParam0, int iParam1) // Position - 0xAD7C Hash - 0x7CE9D5F9 ^0xF92D761B
{
...
void func_150() // Position - 0xADA3 Hash - 0x2DB2F054 ^0x253336C1
{
	if (ENTITY::DOES_ENTITY_EXIST(veLocal_241))
...
void func_151(int iParam0) // Position - 0xAE2C Hash - 0x29A8F290 ^0x87716063
{
