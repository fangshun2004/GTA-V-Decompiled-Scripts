	...
	if (Global_80535 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_241(Global_80536, Global_80538, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
{
	if (((!func_253(0) || Global_80551) || Global_80539 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_80535)
...
{
	return func_255(iParam0, Global_44869);
}
...
int func_276()
{
	...
	iVar0 = func_277(&(Global_102429.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
