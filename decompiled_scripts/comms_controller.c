...
void __EntryFunction__()
{
	...
	while (true)
	{
				...
				if (iLocal_75 == 1)
				{
					if (func_146(0))
					{
						if (func_145())
						{
							...
							if (BitTest(Global_114963.f_7697[Global_45468 /*15*/].f_1, 3))
							{
								if (func_140())
								{
									iLocal_75 = 2;
		...
		iVar2 = 0;
		while (iVar2 < Global_114963.f_7697.f_910)
		{
			func_55(&iVar1, &(Global_114963.f_7697.f_867[iVar2 /*14*/]));
			iVar2++;
		}
		func_42();
...
void func_11(int iParam0)
{
	...
	while (iVar15 < Global_114963.f_7697.f_198)
	{
		...
		{
			func_12(Global_114963.f_7697.f_137[iVar15 /*15*/].f_6);
			iVar16 = iVar15;
...
int func_12(int iParam0)
{
	...
	{
		if (func_18(iParam0, Global_21649) == 1)
		{
			func_17(iParam0, Global_21649, 0);
			if (func_16(iParam0, Global_21649) == 0)
			{
				iVar0 = Global_21649;
...
void func_40()
{
	...
	Global_45472 = (Global_45472 + iVar1);
	iVar0 = 0;
	while (iVar0 < Global_114963.f_7697.f_136)
	{
		Global_114963.f_7697[iVar0 /*15*/].f_4 = (Global_114963.f_7697[iVar0 /*15*/].f_4 + iVar1);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < Global_114963.f_7697.f_764)
	{
		Global_114963.f_7697.f_651[iVar0 /*14*/].f_4 = (Global_114963.f_7697.f_651[iVar0 /*14*/].f_4 + iVar1);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < Global_114963.f_7697.f_866)
	{
		Global_114963.f_7697.f_765[iVar0 /*10*/].f_4 = (Global_114963.f_7697.f_765[iVar0 /*10*/].f_4 + iVar1);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < Global_114963.f_7697.f_650)
	{
		Global_114963.f_7697.f_199[iVar0 /*15*/].f_4 = (Global_114963.f_7697.f_199[iVar0 /*15*/].f_4 + iVar1);
		iVar0++;
	}
	iVar2 = func_41();
	iVar0 = 0;
	while (iVar0 < iVar2)
	{
		Global_45473[iVar0] = (Global_45473[iVar0] + iVar1);
		iVar0++;
	}
}
...
{
	func_59(uParam1);
	Global_114963.f_7697.f_915 = *uParam1;
	Global_45472 = *uParam0 + 20000;
	Global_45473[uParam1->f_6] = *uParam0 + 20000;
	func_57(*uParam1);
}
...
void func_57(int iParam0)
{
	...
	iVar1 = iVar0;
	while (iVar1 <= (Global_114963.f_7697.f_910 - 2))
	{
		Global_114963.f_7697.f_867[iVar1 /*14*/] = { Global_114963.f_7697.f_867[iVar1 + 1 /*14*/] };
		iVar1++;
	}
	Global_114963.f_7697.f_867[(Global_114963.f_7697.f_910 - 1) /*14*/] = { Var2 };
...
int func_58(int iParam0)
{
	...
	iVar0 = 0;
	while (iVar0 < Global_114963.f_7697.f_910)
	{
		if (Global_114963.f_7697.f_867[iVar0 /*14*/] == iParam0)
		{
			return iVar0;
		}
		iVar0++;
	...
	if (Global_118[iParam0 /*10*/].f_8 != 198)
	{
		...
		if (bParam2)
		{
			if (!Global_80337)
			{
				if (bParam1 != 4)
				{
					if (Global_21649 != bParam1)
					{
						Global_10178[bParam1 /*4*/] = { func_63(iParam0) };
						Global_10195[bParam1] = 1;
						Global_10200[bParam1] = iParam0;
					}
					...
					{
						Global_10129[1 /*6*/] = { func_63(iParam0) };
						Global_10129[1 /*6*/].f_5 = bParam1;
						func_62();
					}
				}
				else
...
void func_67()
{
	...
	{
		if (func_69(Global_114963.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_68(PLAYER::PLAYER_PED_ID());
			if (func_9(iVar0) && (!func_296(14) || Global_113909))
			{
...
int func_71(char* sParam0)
{
	...
	while (iVar0 < 35)
	{
		if (!MISC::IS_STRING_NULL(&(Global_114963.f_14150[iVar0 /*104*/])))
		{
			...
			{
				iVar1 = Global_114963.f_14150[iVar0 /*104*/].f_29;
				return iVar1;
			}
		}
		iVar0++;
...
void func_74(int iParam0)
{
	...
	if (BitTest(Global_114963.f_7697[Global_45468 /*15*/].f_1, 3))
	{
		iVar0 = Global_114963.f_7697[Global_45468 /*15*/].f_7;
		if (iVar0 != -1)
		{
			if (func_75(PLAYER::PLAYER_PED_ID(), iVar0, (Global_44922[iVar0 /*5*/].f_3 * 0.35f)))
			{
				func_150(&iParam0, 0);
				func_133(0);
				iLocal_75 = 0;
...
void func_76()
{
	...
	if (BitTest(Global_114963.f_7697[Global_45468 /*15*/].f_1, 1))
	{
		if (!func_54(26))
		{
			if (func_84())
			...
			if (func_82() != 0)
			{
				...
				else
				{
					if (Global_45469 != -1)
					{
						...
						while (iVar0 < 9)
						{
							if (Global_114963.f_18112.f_175[iVar0 /*19*/].f_8 == 0)
							{
								func_77(&(Global_114963.f_18112.f_175[iVar0 /*19*/].f_5), 300f);
							}
							iVar0++;
						}
					}
	...
	while (iVar0 < 8)
	{
		if (Global_99394[iVar0 /*17*/] && !Global_99394[iVar0 /*17*/].f_1)
		{
			if (Global_99394[iVar0 /*17*/].f_3 == 0)
			{
				...
				{
					func_80(Global_99394[iVar0 /*17*/].f_5, 1);
				}
			}
		}
		iVar0++;
...
void func_85()
{
	...
	if (iLocal_65)
	{
		iVar0 = Global_114963.f_7697[Global_45468 /*15*/].f_9;
		if (iVar0 != -1)
		{
			if (func_88(Global_114963.f_7697[Global_45468 /*15*/].f_9))
			{
				iVar1 = Global_114963.f_7697[Global_45468 /*15*/].f_10;
			}
			else
			{
				iVar1 = Global_114963.f_7697[Global_45468 /*15*/].f_11;
			}
			if (iVar1 != -1)
			{
				func_87(iVar1, &Var2);
...
int func_90()
{
	...
	if (iVar0 >= 0 && iVar0 < 3)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_98295[iVar0]))
		{
			return 0;
		}
	}
...
int func_96()
{
	...
	else
	{
		...
		if (func_99(&(Global_114963.f_18112.f_175[iVar4 /*19*/].f_5)) && func_97(&(Global_114963.f_18112.f_175[iVar4 /*19*/].f_5)) < (5f * 60f))
		{
			return 0;
		}
	}
...
int func_104()
{
	...
	while (iVar0 < Global_114963.f_7697.f_136)
	{
		if (Global_114963.f_7697[iVar0 /*15*/] == 2033185762)
		{
			return 0;
		}
		iVar0++;
...
var func_105()
{
	return BitTest(Global_114963.f_18583[26 /*6*/], 3);
}
...
Vector3 func_108(int iParam0, int iParam1)
{
	...
	return Global_34195[iVar0 /*23*/][iParam1 /*3*/];
}
...
int func_119()
{
	...
	{
		iVar1 = 0;
		while (iVar1 < Global_98490[iVar0 /*19*/])
		{
			bVar2 = false;
			switch (iVar0)
			{
			...
			if (bVar2 && Global_114963.f_1.f_12[iVar0 /*6*/][iVar1] == 12)
			{
				return 1;
			}
			iVar1++;
...
int func_123(int iParam0)
{
	...
	if (iVar0 != 7)
	{
		...
		while (iVar1 < 9)
		{
			if (Global_114963.f_18112.f_175[iVar1 /*19*/] == iVar0 || Global_114963.f_18112.f_175[iVar1 /*19*/].f_1 == iVar0)
			{
				iVar2 = Global_98317[iVar1 /*2*/];
				if (iVar2 == 3 || iVar2 == 4)
				{
					return 1;
				}
...
void func_128(int iParam0)
{
	...
	if (Global_45468 != -1)
	{
		if (BitTest(Global_114963.f_7697[Global_45468 /*15*/].f_1, 1) && !Global_114963.f_7697.f_913)
		{
			func_150(iParam0, 0);
		}
		else
		{
			...
			if (BitTest(Global_114963.f_7697[Global_45468 /*15*/].f_1, 15))
			{
				...
				func_13(Global_114963.f_7697[Global_45468 /*15*/].f_6, iVar0);
...
void func_130(int iParam0, int iParam1)
{
	...
	if (iParam0 != iParam1)
	{
		...
		if (iVar0 != 7 && iVar1 != 7)
		{
			...
			if (iVar2 != 10)
			{
				func_131(&(Global_114963.f_18112.f_175[iVar2 /*19*/].f_5));
				Global_114963.f_18112.f_175[iVar2 /*19*/].f_8 = 0;
			}
		}
	}
}
...
int func_140()
{
	switch (func_141(&Global_45469, 5, 0, 0, 0))
	{
		case 1:
			return 1;
			break;
...
void func_150(int iParam0, int iParam1)
{
	...
	if (BitTest(Global_114963.f_7697[Global_45468 /*15*/].f_1, 1))
	{
		if (!Global_114963.f_7697.f_913)
		{
			...
			if (Global_114963.f_7697[Global_45468 /*15*/].f_6 == 17)
			{
				func_60(125, 0);
			}
			else if (Global_114963.f_7697[Global_45468 /*15*/].f_6 == 14)
			{
				func_60(126, 0);
			}
			else if (Global_114963.f_7697[Global_45468 /*15*/].f_6 == 15)
			{
				func_60(127, 0);
			}
		}
	...
	if (Global_45469 != -1)
	{
		...
		while (iVar1 < 9)
		{
			if (Global_114963.f_18112.f_175[iVar1 /*19*/].f_8 == 0)
			{
				func_77(&(Global_114963.f_18112.f_175[iVar1 /*19*/].f_5), 300f);
			}
			iVar1++;
		}
	}
	if (BitTest(Global_114963.f_7697[Global_45468 /*15*/].f_1, 10) || iParam1)
	{
		func_153(*iParam0, &(Global_114963.f_7697[Global_45468 /*15*/]), 0);
		if (BitTest(Global_114963.f_7697[Global_45468 /*15*/].f_1, 3))
		{
		...
		if (BitTest(Global_114963.f_7697[Global_45468 /*15*/].f_1, 8))
		{
			func_154(&(Global_114963.f_7697[Global_45468 /*15*/]));
		}
	}
	else if (BitTest(Global_114963.f_7697[Global_45468 /*15*/].f_1, 11))
	{
...
void func_154(var uParam0)
{
	if (!func_157(*uParam0))
	{
		...
		{
			Global_114963.f_7697.f_137[Global_114963.f_7697.f_198 /*15*/] = { *uParam0 };
			Global_114963.f_7697.f_198++;
...
int func_155(int iParam0)
{
	...
	if (Global_118[iParam0 /*10*/].f_8 != 198)
	{
		func_17(iParam0, Global_21649, 1);
		if (func_64(iParam0, Global_21649) == 0)
		{
			iVar0 = Global_21649;
...
int func_161()
{
	...
	if (bVar9)
	{
		...
		func_178(&uLocal_76, 3, 0, &Var5, 0, 0);
		if (func_163(&uLocal_76, "CBRADAU", &Var0, 1, 1, 0, 0))
		{
	...
	else
	{
		...
		func_178(&uLocal_76, 4, 0, &Var12, 0, 0);
		if (func_163(&uLocal_76, "CBRADAU", &Var0, 1, 1, 0, 0))
		{
			AUDIO::PLAY_SOUND_FRONTEND(-1, "Start_Squelch", "CB_RADIO_SFX", true);
			AUDIO::PLAY_SOUND_FRONTEND(iLocal_74, "Background_Loop", "CB_RADIO_SFX", true);
...
void func_187(int iParam0)
{
	...
	iVar0 = 0;
	while (iVar0 < Global_114963.f_7697.f_866 && !iLocal_63)
	{
		func_221(&(Global_114963.f_7697.f_765[iVar0 /*10*/]));
		iVar1 = 0;
		if (Global_114963.f_7697.f_765[iVar0 /*10*/].f_3 >= 5)
		{
			iVar1 = 1;
		}
		if ((*iParam0 >= Global_45472 || BitTest(Global_114963.f_7697.f_765[iVar0 /*10*/].f_1, 21)) || iVar1)
		{
			if (*iParam0 >= Global_45473[Global_114963.f_7697.f_765[iVar0 /*10*/].f_6] || iVar1)
			{
				if (*iParam0 >= Global_114963.f_7697.f_765[iVar0 /*10*/].f_4)
				{
					if (func_189(&(Global_114963.f_7697.f_765[iVar0 /*10*/])))
					{
						iLocal_67 = -1;
						func_188(iParam0, &(Global_114963.f_7697.f_765[iVar0 /*10*/]));
						func_6(iVar0);
						iLocal_63 = 1;
					}
					else
					{
						func_153(*iParam0, &(Global_114963.f_7697.f_765[iVar0 /*10*/]), 0);
					}
				}
			}
		}
...
{
	func_59(uParam1);
	Global_114963.f_7697.f_918 = *uParam1;
	Global_45472 = *uParam0 + 20000;
	if (uParam1->f_6 != 144)
	{
		Global_45473[uParam1->f_6] = *uParam0 + 20000;
...
void func_193(int iParam0, bool bParam1)
{
	...
	func_194(Global_46166[iVar1 /*12*/].f_3, iParam0, 0, 0, bParam1);
	iVar3 = 0;
	while (iVar3 < iVar2)
	{
		...
		{
			func_194(Global_49491[iParam0 /*46*/].f_3[iVar3], iParam0, 0, 0, bParam1);
		}
		iVar3++;
	}
	if (Global_49491[iParam0 /*46*/].f_31 == Global_49491[iParam0 /*46*/].f_30)
...
void func_194(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (!bParam2)
	{
		...
		iVar2 = iVar20;
		Var3 = { func_199(Global_46166[iVar20 /*12*/].f_1) };
	...
	else
	{
		...
		{
			Var3 = { func_199(Global_46166[iVar26 /*12*/].f_1) };
		}
	}
	if (!bParam4)
	{
		...
		if (((((iParam1 == 17 || iParam1 == 19) || iParam1 == 14) || iParam1 == 0) || iParam1 == 1) || iParam1 == 2)
		{
			if (BitTest(uParam0, func_203()))
			{
				...
				if (iVar3 < 9)
				{
					...
					{
						if (func_99(&(Global_114963.f_18112.f_175[iVar3 /*19*/].f_5)))
						{
							if (func_97(&(Global_114963.f_18112.f_175[iVar3 /*19*/].f_5)) < 30f)
							{
								return 0;
							}
						}
				...
				if (func_246(48))
				{
					if ((((func_245() || func_244()) || func_243()) || func_242()) || func_241())
					{
						if ((((!ENTITY::DOES_ENTITY_EXIST(func_240(60)) && !ENTITY::DOES_ENTITY_EXIST(func_240(61))) && Global_80333 == -1) && !func_239()) && !func_238())
						{
							if (func_66() == 0)
							{
								func_178(&uLocal_76, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
								func_178(&uLocal_76, 3, 0, "DBLIMPOperator", 0, 1);
								cVar0[0] = "DAB_HELLO";
								cVar0[1] = "DAB_MICHAEL";
								cVar0[2] = "DAB_SEND";
								cVar0[3] = "DAB_THANK_M";
							...
							{
								func_178(&uLocal_76, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
								func_178(&uLocal_76, 3, 0, "DBLIMPOperator", 0, 1);
								cVar0[0] = "DAB_HELLO";
							...
							{
								func_178(&uLocal_76, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
								func_178(&uLocal_76, 3, 0, "DBLIMPOperator", 0, 1);
								cVar0[0] = "DAB_HELLO";
								cVar0[1] = "DAB_TREVOR";
								cVar0[2] = "DAB_SEND";
							...
							if (func_234(5, &uLocal_76, 48, "BLIMPAU", &cVar0, &cVar0, 11, 1, 0, 0, 0))
							{
								iLocal_68++;
							}
						}
...
int func_230(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_231(Global_114963.f_32759.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_231(Global_114963.f_2370.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_231(Global_114963.f_2370.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_247(var uParam0)
{
	...
	while (iVar0 < Global_114963.f_7697.f_650)
	{
		...
		if (func_9(bVar1))
		{
			if (BitTest(Global_114963.f_7697.f_199[iVar0 /*15*/].f_2, bVar1))
			{
				if (func_246(Global_114963.f_7697.f_199[iVar0 /*15*/].f_6))
				{
					if (*uParam0 >= Global_45473[Global_114963.f_7697.f_199[iVar0 /*15*/].f_6])
					{
						bVar2 = false;
						iVar3 = 0;
						while (iVar3 < Global_114963.f_7697.f_136 && !bVar2)
						{
							if (Global_114963.f_7697[iVar3 /*15*/] == Global_114963.f_7697.f_199[iVar0 /*15*/])
							{
								bVar2 = true;
							}
							iVar3++;
						...
						if (!bVar2)
						{
							iVar3 = Global_114963.f_7697.f_136;
							if (iVar3 < 9)
							{
								Global_114963.f_7697[iVar3 /*15*/] = { Global_114963.f_7697.f_199[iVar0 /*15*/] };
								Global_114963.f_7697.f_136++;
								bVar4 = false;
								while (bVar4 < 3)
								{
									if (BitTest(Global_114963.f_7697[iVar3 /*15*/].f_2, bVar4))
									{
										func_8(bVar4);
									}
									bVar4++;
						...
						if (func_248(&(Global_114963.f_7697[iVar3 /*15*/])))
						{
							Global_45468 = iVar3;
							iLocal_67 = -1;
							iLocal_75 = 1;
...
int func_248(var uParam0)
{
	...
	if (func_249(&Global_45303, uParam0->f_6, &Var0, &(Var0.f_4), 12, 1, 0, 0, 0))
	{
		return 1;
	}
	func_129();
...
void func_250(var uParam0)
{
	if (BitTest(uParam0->f_2, func_203()))
	{
		...
		{
			case 0:
				func_178(&Global_45303, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
				break;
			
			case 1:
				func_178(&Global_45303, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
				break;
			
			case 2:
				func_178(&Global_45303, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
				break;
		}
	}
	switch (uParam0->f_6)
	{
		case 0:
			func_178(&Global_45303, 0, 0, "MICHAEL", 0, 1);
			break;
		
		case 1:
			func_178(&Global_45303, 1, 0, "FRANKLIN", 0, 1);
			break;
		
		case 2:
			func_178(&Global_45303, 2, 0, "TREVOR", 0, 1);
			break;
		...
		case 10:
			func_178(&Global_45303, 0, 0, "MICHAEL", 0, 1);
			func_178(&Global_45303, 3, 0, "STEVE", 0, 1);
			break;
		...
		default:
			func_178(&Global_45303, uParam0->f_14, 0, func_251(uParam0->f_6), 0, 1);
			break;
	}
}
...
int func_252(int iParam0)
{
	...
	while (iVar0 < 7)
	{
		...
		{
			iVar2 = -1;
			iVar2 = Global_80608.f_109[Global_93213[iVar0 /*5*/] /*4*/];
			if (iVar2 != -1)
			{
				if (func_253(Global_93249[iVar2 /*34*/].f_12, iParam0))
				{
					return 1;
				}
			}
...
void func_256(var uParam0)
{
	...
	while (iVar0 < Global_114963.f_7697.f_198)
	{
		if (func_246(Global_114963.f_7697.f_137[iVar0 /*15*/].f_6))
		{
			if (*uParam0 >= Global_45473[Global_114963.f_7697.f_137[iVar0 /*15*/].f_6])
			{
				iVar1 = func_261(Global_114963.f_7697.f_137[iVar0 /*15*/]);
				if (iVar1 == -1)
				{
					iVar1 = Global_114963.f_7697.f_136;
					Global_114963.f_7697[iVar1 /*15*/] = { Global_114963.f_7697.f_137[iVar0 /*15*/] };
					Global_114963.f_7697.f_136++;
					bVar2 = false;
					while (bVar2 < 3)
					{
						if (BitTest(Global_114963.f_7697.f_137[iVar0 /*15*/].f_2, bVar2))
						{
							func_8(bVar2);
						}
						bVar2++;
				...
				if (func_257(&(Global_114963.f_7697[iVar1 /*15*/]), &iLocal_65))
				{
					Global_45468 = iVar0;
					iLocal_67 = -1;
					iLocal_75 = 1;
				...
				{
					func_153(*uParam0, &(Global_114963.f_7697[iVar1 /*15*/]), 0);
				}
			}
		}
		iVar0++;
	...
	if (func_9(func_66()))
	{
		if (BitTest(uParam0->f_2, func_203()))
		{
			...
			if (func_73(*uParam0) == 1)
			{
				...
				if (func_258(&Global_45303, uParam0->f_6, &Var0, &(Var0.f_4), 12, &(Var0.f_8), &cVar12, &cVar16, 1, 0, 0, 0))
				{
			...
			else
			{
				...
				if (func_249(&Global_45303, uParam0->f_6, &Var20, &cVar32, 12, 1, 0, 0, 0))
				{
					if (BitTest(uParam0->f_1, 13))
					{
						*uParam1 = 1;
...
bool func_258(var uParam0, var uParam1, char* sParam2, char* sParam3, int iParam4, char* sParam5, char* sParam6, char* sParam7, int iParam8, int iParam9, int iParam10, bool bParam11)
{
	...
	Global_23075 = 1;
	Global_23077 = 0;
	StringCopy(&Global_23105, sParam6, 24);
	StringCopy(&Global_23111, sParam7, 24);
...
void func_262(var uParam0)
{
	...
	while (iVar0 < Global_114963.f_7697.f_136)
	{
		if (BitTest(Global_114963.f_7697[iVar0 /*15*/].f_1, 7))
		{
			if (func_246(Global_114963.f_7697[iVar0 /*15*/].f_6))
			{
				if (*uParam0 >= Global_45473[Global_114963.f_7697[iVar0 /*15*/].f_6])
				{
					if (func_257(&(Global_114963.f_7697[iVar0 /*15*/]), &iLocal_65))
					{
						Global_45468 = iVar0;
						iLocal_67 = -1;
						iLocal_75 = 1;
					...
					{
						func_153(*uParam0, &(Global_114963.f_7697[iVar0 /*15*/]), 0);
					}
				}
			}
		}
...
void func_263(int iParam0)
{
	...
	iVar0 = 0;
	while (iVar0 < Global_114963.f_7697.f_764 && !iLocal_63)
	{
		func_287(&(Global_114963.f_7697.f_651[iVar0 /*14*/]));
		iVar1 = 0;
		if (Global_114963.f_7697.f_651[iVar0 /*14*/].f_3 >= 5)
		{
			iVar1 = 1;
		}
		if ((*iParam0 >= Global_45472 || BitTest(Global_114963.f_7697.f_651[iVar0 /*14*/].f_1, 21)) || iVar1)
		{
			if (*iParam0 >= Global_45473[Global_114963.f_7697.f_651[iVar0 /*14*/].f_6] || iVar1)
			{
				if (*iParam0 >= Global_114963.f_7697.f_651[iVar0 /*14*/].f_4)
				{
					if (func_266(&(Global_114963.f_7697.f_651[iVar0 /*14*/])))
					{
						func_264(&(Global_114963.f_7697.f_651[iVar0 /*14*/]));
						Global_114963.f_7697.f_916 = 0;
						func_7(iVar0);
						iLocal_63 = 1;
					}
					...
					{
						func_153(*iParam0, &(Global_114963.f_7697.f_651[iVar0 /*14*/]), 1);
					}
				}
			}
		}
...
void func_264(var uParam0)
{
	if (!func_265(*uParam0))
	{
		...
		{
			Global_114963.f_7697.f_867[Global_114963.f_7697.f_910 /*14*/] = { *uParam0 };
			Global_114963.f_7697.f_910++;
		}
	}
}
...
int func_266(var uParam0)
{
	...
	if (uParam0->f_10 != -1)
	{
		func_284(uParam0->f_10, &cVar7);
		StringConCat(&Var3, &cVar7, 16);
		if (uParam0->f_11 != -1)
		{
			func_284(uParam0->f_11, &cVar11);
			StringConCat(&Var3, &cVar11, 16);
		}
	}
	if (BitTest(uParam0->f_2, func_203()))
	{
		if (func_283(uParam0->f_6, &Var3, iVar1, iVar0, 0, iVar2, 0, 1, 0, uParam0->f_13))
		{
...
int func_267(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, int iParam9, var uParam10)
{
	...
	if (func_268(iParam0, sParam2, iParam3, iVar0, sVar1, sVar3, iVar2, iParam4, iParam5, iParam6, bParam8, iParam9, uParam10, iVar4, sVar5, sVar6, iParam1) == 1)
	{
		if (bParam8 == 1)
		{
			...
			Global_10129[3 /*6*/] = { func_63(iParam0) };
...
int func_268(int iParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	...
	if (!Global_21883 && !BitTest(Global_9504, 9))
	{
		if (Global_21649.f_1 == 6)
		{
			...
			func_272(1);
			func_276(Global_21630, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(Global_21629), -1082130432, -1082130432, -1082130432);
		}
	}
					...
					if (iVar0 == Global_9509[iVar1 /*15*/].f_4)
					{
						if (Global_10087[iVar0] == 0)
						{
							...
							if (Global_2697067)
							{
								if (iVar1 == 14)
								{
									func_273(Global_21630, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_9509[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(Global_24086), -1f, &(Global_9509[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
					...
					if (iVar0 == Global_9509[iVar1 /*15*/].f_4)
					{
						if (Global_10087[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_273(Global_21630, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_9509[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(Global_24092), -1f, &(Global_9509[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_80337)
								{
									...
									func_273(Global_21630, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_9509[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar4), -1f, &(Global_9509[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_21649)
									...
									func_273(Global_21630, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_9509[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar6), -1f, &(Global_9509[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_9509[iVar1 /*15*/].f_10 == 57 && iVar1 == 24)
							{
								...
								func_273(Global_21630, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_9509[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar9), -1f, &(Global_9509[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_273(Global_21630, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_9509[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(0), -1f, &(Global_9509[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_10087[iVar0] = 1;
						}
					}
...
void func_273(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11)
{
...
void func_280()
{
	...
	while (iVar2 < iVar1)
	{
		if (!func_281(Global_114963.f_14150[iVar2 /*104*/].f_18, Global_114963.f_14150[Global_24091 /*104*/].f_18))
		{
			Global_24091 = iVar2;
		}
		iVar2++;
...
int func_283(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, var uParam9)
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
void func_288(int iParam0)
{
	...
	iVar0 = 0;
	while (iVar0 < Global_114963.f_7697.f_136 && !iLocal_63)
	{
		func_294(&(Global_114963.f_7697[iVar0 /*15*/]));
		if (BitTest(Global_114963.f_7697[iVar0 /*15*/].f_1, 0))
		{
			iVar1 = 0;
			...
			if ((*iParam0 >= Global_45472 || BitTest(Global_114963.f_7697[iVar0 /*15*/].f_1, 21)) || iVar1)
			{
				if (Global_114963.f_7697[iVar0 /*15*/].f_3 == Global_114963.f_7697.f_919[func_66()] || !BitTest(Global_114963.f_7697[iVar0 /*15*/].f_2, func_203()))
				{
					if (*iParam0 >= Global_114963.f_7697[iVar0 /*15*/].f_4)
					{
						if (func_289(&(Global_114963.f_7697[iVar0 /*15*/]), &iLocal_65))
						{
							Global_45468 = iVar0;
							iLocal_67 = -1;
							iLocal_75 = 1;
						...
						{
							func_153(*iParam0, &(Global_114963.f_7697[iVar0 /*15*/]), 0);
						}
					}
				}
			}
...
int func_289(var uParam0, var uParam1)
{
	...
	if (BitTest(uParam0->f_2, func_203()))
	{
		...
		if (func_73(*uParam0) == 1)
		{
			...
			{
				if (func_293(&Global_45303, uParam0->f_6, &Var2, &(Var2.f_4), iVar0, &(Var2.f_8), &cVar14, &cVar18, 0, 0, 1))
				{
			...
			else if (func_292(&Global_45303, uParam0->f_6, &Var2, &(Var2.f_4), iVar0, &(Var2.f_8), &cVar14, &cVar18, 0, 0, 1))
			{
				if (uParam0->f_3 == 5 || BitTest(uParam0->f_1, 12))
				{
					func_144(1);
		...
		else
		{
			...
			{
				if (func_291(&Global_45303, uParam0->f_6, &Var22, &(Var22.f_4), iVar0, 0, 0, 1))
				{
					if (uParam0->f_3 == 5 || BitTest(uParam0->f_1, 12))
					{
						func_144(1);
			...
			{
				if (func_249(&Global_45303, uParam0->f_6, &Var22, &(Var22.f_4), iVar0, 1, 0, 0, 0))
				{
					if (uParam0->f_3 == 5 || BitTest(uParam0->f_1, 12))
					{
						func_144(1);
			...
			{
				if (func_290(&Global_45303, uParam0->f_6, &Var22, &(Var22.f_4), iVar0, 0, 0, 1))
				{
					func_144(1);
					if (BitTest(uParam0->f_1, 13))
					{
			...
			else if (func_291(&Global_45303, uParam0->f_6, &Var22, &(Var22.f_4), iVar0, 0, 0, 1))
			{
				if (BitTest(uParam0->f_1, 12))
				{
					func_144(1);
...
bool func_291(var uParam0, var uParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	func_177(uParam0, uParam1, sParam2, iParam5, iParam6, 0);
	Global_23071 = 0;
	Global_23030 = 1;
...
bool func_293(var uParam0, var uParam1, char* sParam2, char* sParam3, int iParam4, char* sParam5, char* sParam6, char* sParam7, int iParam8, int iParam9, bool bParam10)
{
	func_177(uParam0, uParam1, sParam2, iParam8, iParam9, 0);
	Global_23071 = 1;
	Global_23030 = 1;
...
void func_295(int iParam0)
{
	...
	while (iVar0 < Global_114963.f_7697.f_136 && !iLocal_63)
	{
		...
		if (!BitTest(Global_114963.f_7697[iVar0 /*15*/].f_1, 0))
		{
			...
			if ((*iParam0 >= Global_45472 || iVar1) || BitTest(Global_114963.f_7697[iVar0 /*15*/].f_1, 21))
			{
				if (Global_114963.f_7697[iVar0 /*15*/].f_3 == Global_114963.f_7697.f_919[func_66()] || !BitTest(Global_114963.f_7697[iVar0 /*15*/].f_2, func_203()))
				{
					if (*iParam0 >= Global_45473[Global_114963.f_7697[iVar0 /*15*/].f_6] || iVar1)
					{
						if (*iParam0 >= Global_114963.f_7697[iVar0 /*15*/].f_4)
						{
							if (func_289(&(Global_114963.f_7697[iVar0 /*15*/]), &iLocal_65))
