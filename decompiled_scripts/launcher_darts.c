...
void func_2() // Hash - 0x9FCDB84A ^0x2CE2D3C4
{
	if (bLocal_146)
	{
		if (hLocal_141 != 0)
...
void func_5(char* sParam0, int iParam1, Any anParam2, BOOL bParam3, BOOL bParam4) // Hash - 0xE9AC9AEE ^0xA4AB7C48
{
...
void func_7() // Hash - 0xE9E439A3 ^0x7AD2C7C7
{
	var textLabel;
...
void func_17(char* sParam0, int iParam1, int iParam2) // Hash - 0x8572F920 ^0xA7259CBD
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&Global_97751))
	{
...
char* func_19(int iParam0) // Hash - 0x4E453EBF ^0x4E453EBF
{
	switch (iParam0)
	{
		case 0:
...
void func_20(int iParam0) // Hash - 0x6F25AF03 ^0xBE6FE336
{
	int num;
	var textLabel;
...
int func_25() // Hash - 0xC302FBE5 ^0x6FECB631
{
	var entityRotation;
	int num;
...
void func_39() // Hash - 0x1640B27B ^0x5B9A2758
{
	var sizeAndPeds;
	int pedNearbyPeds;
	int i;
...
void func_40(int iParam0, int iParam1) // Hash - 0x4FE65956 ^0x4FE65956
{
	int num;
...
void func_41(int iParam0) // Hash - 0xF9254656 ^0xECCFDFAF
{
...
void func_42(int iParam0) // Hash - 0xE7EE45FB ^0x26036F0B
{
	Vector3 vector;
	BOOL flag;
	BOOL flag2;
...
BOOL func_43() // Hash - 0x70B4A54B ^0xF137E5FF
{
...
void func_45() // Hash - 0xD1F2D853 ^0xF9F5FD4D
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_48(Global_113648.f_2365.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_46(num) && !func_103(14) || Global_112599)
			{
...
int func_50(int iParam0) // Hash - 0x46546439 ^0x46546439
{
	int num;
...
BOOL func_51(int iParam0) // Hash - 0x5A075A23 ^0x27F6B86F
{
	Hash entityModel;
...
Vehicle func_52(Vehicle veParam0) // Hash - 0xC9D82232 ^0xC9D82232
{
	return veParam0;
}

void func_53(int iParam0, var uParam1) // Hash - 0x45AE8BFD ^0xA0700457
{
	int num;
	int num2;
...
BOOL func_54(int iParam0) // Hash - 0xDEE87AD1 ^0x5F1ACD39
{
	var unk;
	int doorState;
...
int func_55(int iParam0) // Hash - 0x626AEC54 ^0xDB28E416
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_56() // Hash - 0x9E44C35 ^0xB9993D58
{
	var unk;
...
void func_57(var uParam0, int iParam1) // Hash - 0x15B9927E ^0x4A4674
{
	if (iParam1 <= 0)
		return;
...
void func_58(var uParam0, int iParam1) // Hash - 0x4C70B2C3 ^0x4C70B2C3
{
...
void func_59(var uParam0, int iParam1) // Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
int func_60(int iParam0, int iParam1) // Hash - 0xD3EBACB3 ^0xD3EBACB3
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_61(int iParam0) // Hash - 0xE1B0542C ^0x127A471E
{
...
int func_63(int iParam0) // Hash - 0x2D4DB85F ^0x2D4DB85F
{
	return iParam0 & 15;
}

void func_64(var uParam0, int iParam1) // Hash - 0x864304A8 ^0x1F5003E2
{
...
void func_65(var uParam0, int iParam1) // Hash - 0x76860AE7 ^0x32308FFF
{
...
void func_66(var uParam0, int iParam1) // Hash - 0xDB8A72C0 ^0x4F6D426D
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
struct<7> func_67(int iParam0) // Hash - 0xA6A81C3E ^0x591CC9FB
{
	var unk;
...
BOOL func_68() // Hash - 0x6134FBB2 ^0x82030B41
{
...
void func_71(int iParam0) // Hash - 0x2EFE5DD5 ^0x2EFE5DD5
{
	if (iParam0 == 2)
	{
	}
...
int func_72() // Hash - 0x5A2831F6 ^0x81B9B24A
{
	Vector3 vector;
	float num;
	float num2;
...
Vector3 func_73(int iParam0) // Hash - 0xF6858EF6 ^0xF6858EF6
{
	switch (iParam0)
	{
		case 1:
...
int func_74() // Hash - 0xFD255207 ^0xFD255207
{
	return 1;
}

BOOL func_75(int iParam0, BOOL bParam1) // Hash - 0xE8E8EFB4 ^0x98461D05
{
	int num;
...
int func_76(int iParam0) // Hash - 0x7F0E29AD ^0x84091235
{
	int i;
...
void func_77(var uParam0) // Hash - 0xFE5630E8 ^0xFE5630E8
{
	int num;
...
void func_78(var uParam0, int iParam1, char* sParam2, int iParam3, const char* sParam4, int iParam5, int iParam6) // Hash - 0xC67F23A2 ^0xEFF6309F
{
	int i;
...
BOOL func_79(var uParam0) // Hash - 0x2DF5A077 ^0x2DF5A077
{
	return true;
}

BOOL func_80(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6, Object obParam7) // Hash - 0xBCFD702 ^0x575B6ADB
{
	int entityHit;
	var endCoords;
	var surfaceNormal;
...
BOOL func_84() // Hash - 0x44A439DC ^0x3D5209CD
{
	return MISC::GET_GAME_TIMER() <= Global_23270.f_6321 + 100;
}

BOOL func_85() // Hash - 0x3CA1BB47 ^0xB78A1ACB
{
...
BOOL func_86(BOOL bParam0) // Hash - 0x1F743529 ^0xDFDFCA73
{
	if (bParam0)
...
void func_87(var uParam0, int iParam1) // Hash - 0xF55E891F ^0xF55E891F
{
	func_88(uParam0, iParam1);
	return;
}

void func_88(var uParam0, int iParam1) // Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_89() // Hash - 0xE4089920 ^0xD14EFD54
{
	if (func_103(6) || func_103(7))
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
			return func_102(67);
...
BOOL func_90() // Hash - 0xC7110B3 ^0x51D25EBB
{
	int weaponHash;
	BOOL flag;
...
BOOL func_91(int iParam0) // Hash - 0x97844555 ^0xADCD6DAA
{
	int num;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_98() || Global_32166 || func_97() || func_83(8, -1) || func_94() || func_96() || func_95() || func_85() || Global_113648.f_7690.f_919[num] == 5)
							return false;
						break;
					...
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_98() || Global_112695 || Global_32166 || func_97() || func_83(8, -1) || func_96() || func_95() || func_85() || Global_113648.f_7690.f_919[num] == 5)
							return false;
						break;
				
					case 4:
						if (func_98() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_83(8, -1) || func_85() || func_93() || Global_113648.f_7690.f_919[num] == 5)
							return false;
						break;
...
BOOL func_92() // Hash - 0x4228A1C2 ^0x952FE30F
{
	return Global_100720.f_1;
}

BOOL func_93() // Hash - 0xC20DBA70 ^0xAC4006FB
{
	if (Global_97603 != -1)
...
BOOL func_94() // Hash - 0xE663B8F6 ^0xE663B8F6
{
	if (Global_78819)
		return true;
...
BOOL func_98() // Hash - 0x7FE517FE ^0x128A3BC8
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
BOOL func_99() // Hash - 0x3CA1BB47 ^0x4BFFF917
{
...
Entity func_100() // Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_96513;
}

BOOL func_101(int iParam0) // Hash - 0x6ACD7BFA ^0x6ACD7BFA
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_102(int iParam0) // Hash - 0x7524A8DB ^0x409ED99B
{
	int num;
...
BOOL func_103(int iParam0) // Hash - 0x937D8816 ^0x937D8816
{
	return Global_43257 == iParam0;
}

void func_104() // Hash - 0x9D18E3F3 ^0x1F212988
{
	Vector3 vector;
	Vector3 entityCoords;
	float num;
...
Vector3 func_106(BOOL bParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Hash - 0x6B64B100 ^0x6B64B100
{
	if (bParam0)
		return uParam1;
...
BOOL func_107() // Hash - 0xF90A87D ^0x1429979B
{
	if (bLocal_146)
...
void func_108() // Hash - 0x28FA5410 ^0x9A99D0C6
{
	int num;
...
void func_109(var uParam0, int iParam1) // Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_110(int iParam0) // Hash - 0x28DF00E8 ^0x28DF00E8
{
	iLocal_95 = iParam0;
	return;
}

void func_111(int iParam0, BOOL bParam1, BOOL bParam2) // Hash - 0x3DFD90D4 ^0xB85FE721
{
	int num;
	BOOL flag;
...
BOOL func_113() // Hash - 0x98CCC132 ^0x97B0D6ED
{
	if (Global_97603 != -1)
...
BOOL func_114(int iParam0, int iParam1) // Hash - 0xDEE74A4E ^0xDEE74A4E
{
	BOOL flag;
...
BOOL func_117(int iParam0, int iParam1) // Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_118() // Hash - 0x944B3B4B ^0x5C2BFB8F
{
	BOOL flag;

	TEXT_LABEL_ASSIGN_STRING(&uLocal_53, "Darts", 64);
	sLocal_101 = _("Press ~INPUT_CONTEXT~ to play darts.");
	iLocal_99 = 1;
	fLocal_117 = 2.5f;
...
void func_119(int iParam0, int iParam1) // Hash - 0xF55E891F ^0xF55E891F
{
	func_120(iParam0, iParam1);
	return;
}

void func_120(var uParam0, int iParam1) // Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_121(BOOL bParam0) // Hash - 0x12400ACB ^0x3A862E90
{
	if (bParam0)
		if (iLocal_105 != 263)
...
void func_122() // Hash - 0xC88B3A8B ^0xCE5EF390
{
...
void func_123() // Hash - 0xA1AB92E3 ^0xA1AB92E3
{
	if (bLocal_159)
		func_124(func_72());
...
void func_124(int iParam0) // Hash - 0x1281F51C ^0xDCF2FE21
{
	if (iParam0 != 263)
