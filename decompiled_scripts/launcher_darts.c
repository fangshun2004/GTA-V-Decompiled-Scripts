...
BOOL func_1(char* sParam0) // Position - 0xAD8 Hash - 0xCD6A3595 ^0xB0E86AA0
{
...
void func_5(char* sParam0, int iParam1, Any anParam2, BOOL bParam3, BOOL bParam4) // Position - 0xB29 Hash - 0xE9AC9AEE ^0xA4AB7C48
{
...
BOOL func_8() // Position - 0xBEC Hash - 0x4C81F065 ^0x26D68D51
{
	return MISC::IS_ORBIS_VERSION() || unk_0xEE17703CF2C2875A();
}

BOOL func_9() // Position - 0xC02 Hash - 0x4C81F065 ^0x60494CEC
{
...
BOOL func_18(BOOL bParam0) // Position - 0xD2E Hash - 0x15889021 ^0xE7262364
{
...
void func_40(int iParam0, int iParam1) // Position - 0x1A60 Hash - 0x4FE65956 ^0x4FE65956
{
	int num;
...
void func_41(int iParam0) // Position - 0x1B4D Hash - 0xF9254656 ^0xECCFDFAF
{
...
void func_42(int iParam0) // Position - 0x1B98 Hash - 0xE7EE45FB ^0x26036F0B
{
	Vector3 vector;
	BOOL unk;
	BOOL unk2;
...
int func_44() // Position - 0x20DC Hash - 0x3C5423D7 ^0x3C5423D7
{
	func_45();
...
BOOL func_46(int iParam0) // Position - 0x21F2 Hash - 0x8907F004 ^0x8907F004
{
	return iParam0 < 3;
}

int func_47(Ped pedParam0) // Position - 0x21FE Hash - 0xAC4E9801 ^0xB379A75F
{
	int i;
	Hash entityModel;
...
Hash func_48(int iParam0) // Position - 0x223B Hash - 0xADCB9755 ^0xADCB9755
{
	if (func_46(iParam0))
...
Hash func_49(int iParam0) // Position - 0x2260 Hash - 0xE4CEEC2C ^0xE4CEEC2C
{
...
BOOL func_51(int iParam0) // Position - 0x2497 Hash - 0x5A075A23 ^0x27F6B86F
{
	Hash entityModel;
...
void func_77(var uParam0) // Position - 0x5FE6 Hash - 0xFE5630E8 ^0xFE5630E8
{
	int num;
...
void func_78(var uParam0, int iParam1, char* sParam2, int iParam3, const char* sParam4, int iParam5, int iParam6) // Position - 0x603D Hash - 0xC67F23A2 ^0xEFF6309F
{
	int i;
...
Entity func_100() // Position - 0x6C41 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_96513;
}
...
{
	if (bLocal_146)
		return STREAMING::HAS_MODEL_LOADED(hLocal_141) && STREAMING::HAS_MODEL_LOADED(hLocal_142) && STREAMING::HAS_MODEL_LOADED(-472443277);
	...
	if (bLocal_146)
	{
		...
		switch (num)
		{
			case 66:
				...
				{
					case 0:
						hLocal_141 = 1264851357;
						break;
				
					case 1:
						hLocal_141 = -2039163396;
						break;
				
					case 2:
						hLocal_141 = 835315305;
						break;
				}
				...
				{
					case 0:
						hLocal_142 = 919005580;
						break;
				
					case 1:
						hLocal_142 = 534725268;
						break;
				}
			...
			case 67:
				...
				{
					case 0:
						hLocal_141 = -569505431;
						hLocal_142 = -855671414;
						break;
				
					case 1:
						hLocal_141 = -855671414;
						hLocal_142 = -569505431;
						break;
				}
...
BOOL func_115(int iParam0) // Position - 0x7204 Hash - 0xECB6C71B ^0xECB6C71B
{
