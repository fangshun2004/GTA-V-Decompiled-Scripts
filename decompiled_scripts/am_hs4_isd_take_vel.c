...
void func_304(var uParam0)
{
	...
	func_305(&uLocal_129, 4494.842f, -4522.146f, 4.9819f, -10.7044f, 0.1567f, 155.8207f, "HS4_ISD_TAKE_VEL", 0, 1, uParam0->f_4, 0);
}

void func_305(var uParam0, struct<3> Param1, struct<3> Param4, char* sParam7, int iParam8, int iParam9, var uParam10, int iParam11)
{
