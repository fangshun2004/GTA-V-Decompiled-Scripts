...
void func_73(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	func_75();
	if (!bParam4)
	{
...
void func_77(int iParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		if ((NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iParam0)) || !NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			...
			func_139(iParam0, uParam1, bParam2, bParam3);
			if (uParam1->f_102 != 0)
			{
				if (uParam1->f_102 == 2)
				{
...
bool func_79(int iParam0)
{
	...
	return (func_81(iParam0) && !func_80(iParam0));
}
...
void func_84(struct<3> Param0)
{
	...
	SCRIPT::_SEND_TU_SCRIPT_EVENT_NEW(1, &Var0, 6, func_85(1, 1), Var0.f_0);
}
...
int func_99(int iParam0, int iParam1)
{
	...
	func_101(*iParam0, &Global_1950086, &(Global_1950086.f_1), &(Global_1950086.f_4), &(Global_1950086.f_7), &(Global_1950086.f_10));
	...
	{
		if (func_100(iParam0, iParam1, Global_1950086, Global_1950086.f_1, Global_1950086.f_4, Global_1950086.f_7, Global_1950086.f_10, 0, Global_1950086.f_13))
		{
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
	...
	else
	{
		...
		if (((Global_1950086.f_23 == 0 && func_100(iParam0, iParam1, Global_1950086, Global_1950086.f_1, Global_1950086.f_4, Global_1950086.f_7, Global_1950086.f_10, 0, Global_1950086.f_13)) || Global_1950086.f_23 != 0) && ((Global_1950086.f_24 == 0 && func_100(iParam0, iParam1, Global_1950086, Global_1950086.f_14, Global_1950086.f_17, Global_1950086.f_20, Global_1950086.f_10, 1, Global_1950086.f_13)) || Global_1950086.f_24 != 0))
		{
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
				Global_1576399 = NETWORK::GET_NETWORK_TIME();
...
int func_101(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5)
{
	...
	*uParam1 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iParam0, "chassis_dummy");
	if (((!func_102(Global_1950112, 0f, 0f, 0f, 0) && !func_102(Global_1950115, 0f, 0f, 0f, 0)) && !func_102(Global_1950118, 0f, 0f, 0f, 0)) && !Global_1950121 == 0f)
	{
...
int func_106(int iParam0, var* uParam1)
{
	...
	{
		iVar2 = Global_2359296[func_113() /*5574*/].f_681.f_2;
...
int func_123(int iParam0)
{
	if (iParam0 != func_63())
	{
		if (func_124(iParam0) && Global_2658291[iParam0 /*468*/].f_325.f_11 == iParam0)
		{
			return 1;
		}
	}
...
int func_124(int iParam0)
{
	if (iParam0 != func_63())
	{
		if (func_7(iParam0, 1, 1))
		{
			...
			{
				return func_125(Global_2658291[iParam0 /*468*/].f_325.f_8) == 22;
			}
		}
	}
	return 0;
...
void func_139(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		if (((BitTest(uParam1->f_77, 15) || func_160(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_159())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if ((((func_142() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66)) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(iParam0)) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("avenger"))) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, func_141(1)))
		{
			if (!BitTest(uParam1->f_77, 23))
			{
				if (!BitTest(uParam1->f_77, 22) && func_140(iParam0, 5f))
				{
...
int func_148(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_153(ENTITY::GET_ENTITY_MODEL(*iParam0)) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_151(*iParam0, ((*uParam1)[38] - 1)))
	{
...
int func_170(var uParam0)
{
	...
	else
	{
		...
		func_171(uParam0->f_23, &(Global_1879623[iVar0 /*55*/]), 0, -1);
	}
...
int func_190(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar37 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 11, -1, false, -1, func_192(iParam2));
		if (iVar37 <= iVar36)
		{
			return -1;
		}
...
int func_200(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 11, -1, false, -1, func_192(iParam2));
...
int func_203(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_80063[1 /*14*/] = { func_219(iVar0, iParam1, iParam2, -1) };
	...
	if (iParam1 == 12)
	{
			...
			if (uVar8[iVar4] != -99)
			{
				if (!func_203(iParam0, iVar4, uVar8[iVar4]))
				{
					...
					if (iVar4 == 13)
					{
						...
						while (iVar5 <= 8)
						{
							if (!func_203(iParam0, 14, uVar25[iVar5]))
							{
								...
								while (iVar6 <= 19)
								{
									Global_80063[2 /*14*/] = { func_219(iVar0, 14, iVar6, -1) };
									if (Global_80063[2 /*14*/].f_12 == iVar5)
									{
										if (func_203(iParam0, 14, iVar6))
										{
											if (!func_207(iVar0, iParam2, 14, iVar6, &uVar8, &(Global_80063[2 /*14*/])))
											{
												Global_2883588 = uVar2;
												Global_2883589 = uVar3;
												return 0;
					...
					else
					{
						...
						Global_80063[2 /*14*/] = { func_219(iVar0, iVar4, iVar1, -1) };
						if (!func_207(iVar0, iParam2, iVar4, iVar1, &uVar8, &(Global_80063[2 /*14*/])))
						{
							Global_2883588 = uVar2;
							Global_2883589 = uVar3;
							return 0;
		...
		{
			if (func_89(1759, Global_80060) != uVar8[10])
			{
				Global_2883588 = uVar2;
				Global_2883589 = uVar3;
				return 0;
	...
	{
		if (Global_80063[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_192(iParam1)) && Global_80063[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_192(iParam1)))
		{
			return 1;
		}
		if (iParam1 == 4)
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_218(&Var1, -99, -99, Global_114904.f_2370.f_539.f_196[0], Global_114904.f_2370.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_218(&Var1, -99, -99, Global_114904.f_2370.f_539.f_196[1], Global_114904.f_2370.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_218(&Var1, -99, -99, Global_114904.f_2370.f_539.f_196[2], Global_114904.f_2370.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_221(int iParam0)
{
	...
	func_222(&(Global_80063[0 /*14*/]), iVar10, iParam0, &sVar2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_89(func_225(iParam1, uParam0->f_2), Global_80060);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), true);
			}
			uVar0 = func_89(func_224(iParam1, uParam0->f_2), Global_80060);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_89(iVar1, Global_80060);
				if (!BitTest(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_232(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				func_222(&(Global_80063[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_222(&(Global_80063[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_222(&(Global_80063[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("outfit_only"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_80261)
		{
			...
			func_222(&(Global_80063[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("outfit_only"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
void func_233(int iParam0, int iParam1)
{
	...
	func_222(&(Global_80063[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
var func_245(var uParam0, int iParam1)
{
	...
	uVar0 = func_89(func_246(uParam0), iParam1);
	return uVar0;
}
...
var func_272(bool bParam0)
{
	if (bParam0)
	{
		return (BitTest(Global_4718592.f_185514, 12) && func_273());
	}
			...
			switch (iVar0)
			{
				...
				case 5:
					if (!bParam1)
					{
						...
						else if (func_115(PLAYER::PLAYER_ID(), 1) && Global_1892653[PLAYER::PLAYER_ID() /*615*/].f_10.f_77.f_21 != 0)
						{
							return 1;
						}
					}
...
void func_300(var uParam0)
{
	...
	func_301(&uLocal_122, 4494.842f, -4522.146f, 4.9819f, -10.7044f, 0.1567f, 155.8207f, "HS4_ISD_TAKE_VEL", 0, 1, uParam0->f_4, 0);
}

void func_301(var uParam0, struct<3> Param1, struct<3> Param4, char* sParam7, int iParam8, int iParam9, var uParam10, int iParam11)
{
