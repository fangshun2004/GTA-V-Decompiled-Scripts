...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		func_236(Local_100.f_9, 0, 0, 0, 0, 0);
		switch (iLocal_98)
		{
			case 0:
				func_1();
...
void func_1()
{
	switch (iLocal_99)
	{
		...
		case 1:
			...
			func_226(&uLocal_162, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
			func_226(&uLocal_162, 3, 0, "BARRY", 0, 1);
			iLocal_161 = 0;
			iLocal_99 = 2;
			break;
		...
		case 2:
			if (!iLocal_161)
			{
				if (func_208(&uLocal_162, 49, "BARR4AU", "BAR4_RCM_LI", 11, 1, 0, 0, 0))
				{
	...
	if (Global_80592 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_238(Global_80593, Global_80595, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
		...
		if (Global_114963.f_2370.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var5.f_0)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_114963.f_2370.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_114963.f_2370.f_539.f_2407[0 /*295*/][iParam1 /*98*/], Param2, fParam5, false, false, false);
				...
				func_338(iParam0, &(Global_114963.f_2370.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_114963.f_2370.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_114963.f_2370.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var5.f_0)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_114963.f_2370.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_114963.f_2370.f_539.f_2407[1 /*295*/][iParam1 /*98*/], Param2, fParam5, false, false, false);
				...
				func_338(iParam0, &(Global_114963.f_2370.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_114963.f_2370.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("bodhi2"))
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Var5.f_0))
			{
				...
				*iParam0 = VEHICLE::CREATE_VEHICLE(Var5.f_0, Param2, fParam5, true, true, false);
				...
				func_338(iParam0, &(Var5.f_31), &(Var5.f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_96);
				if (iParam1 == 1)
				{
...
void func_255(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_154(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, false))
	{
		...
		{
			func_259(iParam1, &(Global_114963.f_2370.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_114963.f_2370.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_114963.f_20127[iParam0 /*43*/].f_31 = func_258(*iParam1);
				...
				func_256(Global_114963.f_2370.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_114963.f_2370.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_114963.f_20127[iParam0 /*43*/].f_1));
				...
				func_256(Global_114963.f_2370.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_114963.f_20127[iParam0 /*43*/].f_2));
			}
		}
	}
}
...
int func_260(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	if (func_307(1))
	{
		if (func_306(iParam0, 1) && VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("speedo")))
		{
			return 1;
		}
	}
	if ((!func_304(iVar0, bParam1, uParam2) && !func_303(PLAYER::PLAYER_ID())) && !func_275(iParam0))
	{
		return 0;
	}
...
int func_262(int iParam0)
{
	if (iParam0 != func_215())
	{
		if (func_264(iParam0, 1, 1))
		{
			...
			{
				return func_263(Global_2658293[iParam0 /*468*/].f_325.f_8) == 30;
			}
		}
	}
	return 0;
...
int func_266(int iParam0)
{
	if (iParam0 != func_215())
	{
		if (func_264(iParam0, 1, 1))
		{
			if (Global_2658293[iParam0 /*468*/].f_325.f_8 != -1)
			{
				return func_263(Global_2658293[iParam0 /*468*/].f_325.f_8) == 11;
			}
		}
	}
	return 0;
...
int func_269(int iParam0)
{
	if (iParam0 != func_215())
	{
		if (func_264(iParam0, 1, 1))
		{
			if (Global_2658293[iParam0 /*468*/].f_325.f_8 != -1)
			{
				return func_263(Global_2658293[iParam0 /*468*/].f_325.f_8) == 26;
			}
		}
	}
	return 0;
...
int func_270(int iParam0)
{
	if (iParam0 != func_215())
	{
		if (func_264(iParam0, 1, 1))
		{
			if (Global_2658293[iParam0 /*468*/].f_325.f_8 != -1)
			{
				return func_263(Global_2658293[iParam0 /*468*/].f_325.f_8) == 13;
			}
		}
	}
	return 0;
...
int func_271(int iParam0)
{
	if (iParam0 != func_215())
	{
		if (func_264(iParam0, 1, 1))
		{
			if (Global_2658293[iParam0 /*468*/].f_325.f_8 != -1)
			{
				return func_263(Global_2658293[iParam0 /*468*/].f_325.f_8) == 7;
			}
		}
	}
	return 0;
...
int func_279(int iParam0)
{
	...
	if (func_303(iParam0) && Global_2658293[iParam0 /*468*/].f_325.f_11 == iParam0)
	{
		return 1;
	}
	return 0;
...
int func_293(int iParam0)
{
	if (PLAYER::PLAYER_ID() != func_215())
	{
		...
		if (((func_297(PLAYER::PLAYER_ID(), 1, 0) && Global_1845298[PLAYER::PLAYER_ID() /*881*/].f_260.f_39 > 0) || BitTest(Global_1845298[PLAYER::PLAYER_ID() /*881*/].f_260.f_37, 14)) || BitTest(Global_1845298[PLAYER::PLAYER_ID() /*881*/].f_260.f_37, 11))
		{
			return 0;
		}
		if (DECORATOR::DECOR_IS_REGISTERED_AS_TYPE("Player_Vehicle", 3))
		{
			if (DECORATOR::DECOR_EXIST_ON(iParam0, "Player_Vehicle"))
			{
				if (DECORATOR::DECOR_GET_INT(iParam0, "Player_Vehicle") == NETWORK::NETWORK_HASH_FROM_PLAYER_HANDLE(PLAYER::PLAYER_ID()))
				{
					if (func_295() != -1 && func_295() < 607)
					{
						if (!func_294(iParam0) || ENTITY::GET_ENTITY_MODEL(iParam0) != Global_1583771[func_295() /*143*/].f_66)
						{
							return 1;
						}
...
int func_301(int iParam0)
{
	if (iParam0 != func_215())
	{
		if (func_264(iParam0, 1, 1))
		{
			if (Global_2658293[iParam0 /*468*/].f_325.f_8 != -1 && Global_2658293[iParam0 /*468*/].f_325.f_11 != func_215())
			{
				return func_263(Global_2658293[iParam0 /*468*/].f_325.f_8) == 5;
			}
		}
	}
	return 0;
...
int func_302(int iParam0)
{
	if (iParam0 != func_215())
	{
		if (func_264(iParam0, 1, 1))
		{
			if (Global_2658293[iParam0 /*468*/].f_325.f_8 != -1 && Global_2658293[iParam0 /*468*/].f_325.f_11 != func_215())
			{
				return func_263(Global_2658293[iParam0 /*468*/].f_325.f_8) == 8;
			}
		}
	}
	return 0;
...
int func_303(int iParam0)
{
	if (iParam0 != func_215())
	{
		if (func_264(iParam0, 1, 1))
		{
			if (Global_2658293[iParam0 /*468*/].f_325.f_8 != -1)
			{
				return func_263(Global_2658293[iParam0 /*468*/].f_325.f_8) == 9;
			}
		}
	}
	return 0;
...
{
	if (func_313(iParam0) == 373)
	{
		return func_309(iParam0, 373);
	}
	return -1;
}
...
void func_314(int iParam0, int iParam1)
{
	...
	func_315(iParam0, &(Global_114963.f_32759.f_5510));
}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_333(iParam0, 0, 0)) || func_333(iParam0, 1, 0)) || func_333(iParam0, 2, 0)) || func_332(iParam0) != 145) || func_331(iParam0)) || func_330(iParam0)) || func_261(iParam0)) || func_329(iParam0)) || !func_319(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_330(iParam0))
		{
		}
...
int func_338(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_343(ENTITY::GET_ENTITY_MODEL(*iParam0)) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_341(*iParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*iParam0, 24, func_341(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_340(iParam0);
	if (func_339(*iParam0))
	{
...
int func_341(int iParam0, int iParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		iVar0 = func_342(iParam0, 38) + 1;
		iVar1 = func_342(iParam0, 24) + 1;
...
{
	if (func_291(iParam0, 1) && !func_292(iParam0))
	{
		return 1;
	}
	switch (iParam0)
...
void func_348(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_99792[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_99792[iVar0]) == func_349(iParam0, iParam1))
				{
...
void func_350(struct<3> Param0, float fParam3, bool bParam4)
{
	...
	while (iVar0 < 68)
	{
		if (func_355(&(Global_79127.f_555[0 /*21*/]), iVar0))
		{
...
int func_353(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_354(&(Global_114963.f_32759.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_320(Global_114963.f_32759.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0, -1);
}
...
int func_355(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_356(Global_114963.f_32759.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_356(Global_114963.f_2370.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_356(Global_114963.f_2370.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
{
	return func_358(&(Global_108504.f_2890), Param0, fParam3, 0);
}
	...
	if (func_380(uParam0))
	{
		...
		if (func_379(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_360(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
...
int func_360(int iParam0, struct<3> Param1, bool bParam4)
{
	...
	{
		case joaat("cargobob"):
			if (func_362(iParam0, Global_79127.f_139[38], 0))
			{
				func_351(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_362(iParam0, Global_79127.f_139[43], 1))
			{
				func_351(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_362(iParam0, uVar1[iVar6], 1) && func_361(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
...
int func_361(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_363(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		{
			iVar0 = 1;
			if (BitTest(uParam1->f_77, func_316(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (BitTest(uParam1->f_77, func_316(iVar1 + 1)))
			{
			}
			else
			{
				MISC::SET_BIT(&(uParam1->f_77), func_316(iVar1 + 1));
			}
		}
		else if (uParam1->f_66 == joaat("formula") || uParam1->f_66 == joaat("formula2"))
		{
			...
			while (iVar2 <= 9)
			{
				if (BitTest(uParam1->f_77, func_316(iVar2)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_316(iVar2));
				}
				iVar2++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel1"))
		{
			...
			while (iVar3 <= 6)
			{
				if (BitTest(uParam1->f_77, func_316(iVar3)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_316(iVar3));
				}
				iVar3++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel2"))
		{
			...
			while (iVar4 <= 11)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					if (BitTest(uParam1->f_77, func_316(iVar4)))
					{
					}
					else
					{
						MISC::SET_BIT(&(uParam1->f_77), func_316(iVar4));
					}
				}
				iVar4++;
			}
		...
		else if (uParam1->f_66 == joaat("surfer3"))
		{
			...
			while (iVar5 <= 2)
			{
				if (BitTest(uParam1->f_77, func_316(iVar5)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_316(iVar5));
				}
				iVar5++;
			}
		}
		...
		{
			if (BitTest(uParam1->f_77, func_316(4)))
			{
			}
			else
			{
		...
		else if (uParam1->f_66 == joaat("hotknife"))
		{
			...
			while (iVar6 <= 2)
			{
				if (BitTest(uParam1->f_77, func_316(iVar6)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_316(iVar6));
				}
				iVar6++;
			}
		}
		...
		if (((BitTest(uParam1->f_77, 15) || func_372(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_371())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar7 <= 11)
			{
				if (BitTest(uParam1->f_77, func_316(iVar7 + 1)))
				{
		...
		if ((((func_365() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66)) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(iParam0)) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("avenger"))) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, func_273(1)))
		{
			if (!BitTest(uParam1->f_77, 23))
			{
				if (!BitTest(uParam1->f_77, 22) && func_364(iParam0, 5f))
				{
...
int func_380(var uParam0)
{
	...
	if (!func_320(uParam0->f_12.f_66, 0, -1))
	{
		return 0;
	}
	if (uParam0->f_12.f_66 == joaat("stunt") && func_361(*uParam0, 1694.62f, 3276.27f, 41.31f, 1056964608, 0))
	{
		return 0;
	}
	return 1;
...
void func_407(bool bParam0)
{
	...
	if (!func_428())
	{
		...
		{
			func_162(iVar0, 1, 0);
			func_408(SCRIPT::GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_114050[iVar0 /*10*/].f_9 == -1)
...
int func_409(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_415())
	{
		...
		{
			iVar33 = func_410(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
...
int func_411()
{
	...
	iVar0 = func_412(&(Global_102486.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
