...
BOOL func_33(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x1B25 Hash - 0x384540C1 ^0x384540C1
{
...
Player func_39() // Position - 0x1F03 Hash - 0x478900E4 ^0x478900E4
{
	return -1;
}
...
void func_44() // Position - 0x2091 Hash - 0x98476CE1 ^0x250FEB7C
{
	if (func_18(14))
	{
...
void func_47(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x21C1 Hash - 0xC6B752B2 ^0xC6B752B2
{
...
void func_49(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x2252 Hash - 0x6C235EE0 ^0x9E57F206
{
...
BOOL func_61() // Position - 0x24EC Hash - 0x152DA0B2 ^0x220E93E9
{
...
BOOL func_102(Ped pedParam0) // Position - 0x30F6 Hash - 0x3D210083 ^0xF7E7C389
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
		if (!ENTITY::IS_ENTITY_DEAD(pedParam0, false))
			return true;
...
void func_105() // Position - 0x312B Hash - 0x5D537092 ^0x6320BEC3
{
	...
	bLocal_436 = !Global_3;
	iLocal_252 = 8;
	sLocal_303 = _("Press ~INPUT_CONTEXT~ to talk to Mani.");
