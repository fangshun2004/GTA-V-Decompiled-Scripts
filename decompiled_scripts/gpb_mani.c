...
int func_15() // Hash - 0xDFB73352 ^0xDFB73352
{
	int num;
...
void func_24(char* sParam0) // Hash - 0x2C5C83C1 ^0xA57E250B
{
	int num;
...
void func_25(char* sParam0) // Hash - 0x3372085F ^0x97AA3B26
{
	int num;
...
void func_26(int iParam0, char* sParam1) // Hash - 0xC4958D46 ^0x1355CA2E
{
	switch (iParam0)
	{
		case 0:
...
void func_27(char* sParam0) // Hash - 0x3018B517 ^0xDF4FF591
{
	var unk;
...
void func_29(char* sParam0) // Hash - 0x3BD51041 ^0x2B2D0A7D
{
...
void func_31(char* sParam0) // Hash - 0xE431A142 ^0x1B5B4346
{
	int num;
...
void func_50(char* sParam0) // Hash - 0xB19D680C ^0xA876CF9
{
	int num;
...
void func_57(int iParam0, char* sParam1, char* sParam2) // Hash - 0xA1B3AA65 ^0xDB422270
{
...
void func_64(char* sParam0) // Hash - 0xD55EAE22 ^0x89891C41
{
	var unk;
...
void func_66(char* sParam0) // Hash - 0x217F514E ^0x90383318
{
...
void func_73(char* sParam0) // Hash - 0x2E18739A ^0x15FB8BB8
{
...
char* func_74(int iParam0) // Hash - 0xE6862179 ^0xF52CD79F
{
	switch (iParam0)
	{
		case 0:
...
void func_105() // Hash - 0x5D537092 ^0x6320BEC3
{
...
int func_112(const char* sParam0) // Hash - 0xD5121E5F ^0x1A410BA1
{
