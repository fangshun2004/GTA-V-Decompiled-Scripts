...
void func_2() // Hash - 0xEE079CCD ^0x36D78DA
{
	int num;
...
BOOL func_3(int iParam0) // Hash - 0x7FAC01B4 ^0x9388B6EC
{
...
BOOL func_4() // Hash - 0x57459B9C ^0x9A36D842
{
...
void func_5(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Hash - 0xD5DA5E14 ^0x5BD94F24
{
	Player playerIndex;
...
BOOL func_6(Ped pedParam0) // Hash - 0x7E48B415 ^0x126328AB
{
	if (func_7(pedParam0))
...
BOOL func_7(Ped pedParam0) // Hash - 0x3D210083 ^0xF7E7C389
{
...
void func_9(float fParam0, float fParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, int iParam11, BOOL bParam12) // Hash - 0x394D5546 ^0xF43EBD07
{
	Player playerIndex;
...
void func_10(int iParam0, BOOL bParam1) // Hash - 0xE7B2CDD3 ^0xC2D0D6D9
{
...
Vector3 func_11(Player plParam0) // Hash - 0x6712BF53 ^0x688D5BEC
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(plParam0), false);
}

int func_12(Ped pedParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Hash - 0x2F89DA4B ^0xC114075C
{
	int i;
	int j;
	int k;
...
BOOL func_13(Ped pedParam0, Hash hParam1, var uParam2) // Hash - 0x3FE7AB84 ^0x62AE0C44
{
	int num;
...
int func_14(Hash hParam0) // Hash - 0x389E0506 ^0x389E0506
{
	switch (hParam0)
	{
...
void func_15(Hash hParam0, int iParam1, int iParam2) // Hash - 0x193E1C5C ^0xBF5A02F8
{
	int num;
	int num2;
...
BOOL func_16(Hash hParam0, int iParam1, int iParam2) // Hash - 0x2BE7FB4 ^0x1D60B8BA
{
	if (hParam0 == joaat("PLAYER_ZERO"))
		if (iParam1 == 4)
...
BOOL func_17(Hash hParam0, int iParam1, int iParam2) // Hash - 0xCA8B24F3 ^0x4C678A52
{
	Global_78341[1 /*14*/] = { func_64(hParam0, iParam1, iParam2, -1) };
	return IS_BIT_SET(Global_78341[1 /*14*/].f_6, 2);
}

BOOL func_18(Hash hParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5) // Hash - 0x4EAC6644 ^0x84ED5CC8
{
	var unk;
	int i;
...
BOOL func_19(Hash hParam0, int iParam1, int iParam2) // Hash - 0x1194ADFB ^0x1194ADFB
{
	switch (hParam0)
	{
		case joaat("PLAYER_ZERO"):
...
BOOL func_20(Ped pedParam0, Hash hParam1, var uParam2, int iParam3) // Hash - 0x490228A8 ^0xCA034CC2
{
	int num;
...
int func_21(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Hash - 0x6AEB8E24 ^0x393FEB8F
{
	int i;
	int j;
...
ePedComponentType func_22(int iParam0) // Hash - 0xF91DA7A7 ^0xF91DA7A7
{
	switch (iParam0)
	{
		case 0:
...
int func_23(Hash hParam0, int iParam1, int iParam2, var uParam3) // Hash - 0x66694B65 ^0x9B4A4885
{
	int num;
...
int func_24(Ped pedParam0, Hash hParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Hash - 0x13FAC17C ^0xAC271D21
{
	int num;
	int num2;
	int num3;
...
BOOL func_25(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4) // Hash - 0x9B2DB9BF ^0x887A15B9
{
	int num;
...
int func_26(Hash hParam0, int iParam1, int iParam2, int iParam3) // Hash - 0x243669A7 ^0x243669A7
{
	int num;
...
int func_27(Hash hParam0, int iParam1, int iParam2, int iParam3) // Hash - 0x836A6BCB ^0x1BDA295A
{
	int i;
	int num;
...
BOOL func_28(Ped pedParam0, int iParam1, int iParam2, int iParam3) // Hash - 0x181F6657 ^0x181F6657
{
	int num;
...
BOOL func_29(Hash hParam0, int iParam1, var uParam2) // Hash - 0x9FD3CF97 ^0x79A65971
{
	*uParam2 = -99;
...
int func_30(Hash hParam0, int iParam1, int iParam2, var uParam3) // Hash - 0x6C977D30 ^0xDCB1D2AD
{
	int num;
...
int func_31(Hash hParam0, int iParam1, int iParam2) // Hash - 0x678DE6D2 ^0x678DE6D2
{
	switch (hParam0)
	{
		case joaat("PLAYER_ZERO"):
...
void func_32(Ped pedParam0, ePedComponentType epctParam1, int iParam2, int iParam3) // Hash - 0x64D2154E ^0x9C1670D6
{
	int num;
...
BOOL func_33(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Hash - 0xC42704DB ^0xC42704DB
{
	switch (hParam0)
	{
...
Hash func_34(Hash hParam0, int iParam1, int iParam2, int iParam3) // Hash - 0x3B4EF0B2 ^0x11322F71
{
	var outProp;
	int componentId;
	int num;
...
int func_35(Hash hParam0, int iParam1) // Hash - 0x765E2190 ^0x765E2190
{
	switch (hParam0)
	{
		case joaat("PLAYER_ZERO"):
...
int func_36(Hash hParam0) // Hash - 0xC0824942 ^0x8EB5258
{
	switch (hParam0)
	{
		case joaat("PLAYER_ZERO"):
...
int func_37(Ped pedParam0, int iParam1, int iParam2, ePedComponentType epctParam3) // Hash - 0x3F809B31 ^0x8E48393
{
	Hash entityModel;
...
int func_38(Ped pedParam0, ePedComponentType epctParam1) // Hash - 0x44F25C8 ^0x7C7D6C9E
{
	Hash entityModel;
...
int func_39(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Hash - 0x37A3B7AE ^0x8CDB7FD1
{
	var outfit;
	int i;
	int num;
...
int func_40(Hash hParam0) // Hash - 0x3694542E ^0xA74289BE
{
	switch (hParam0)
	{
		case joaat("PLAYER_ZERO"):
...
int func_41(ePedComponentType epctParam0) // Hash - 0xEE599357 ^0xEE599357
{
	switch (epctParam0)
	{
		case PV_COMP_HEAD:
...
struct<10> func_42(Hash hParam0, int iParam1) // Hash - 0x2A30F768 ^0x18171033
{
	int i;
	var unk;
...
void func_43(var uParam0, Hash hParam1, int iParam2, int iParam3) // Hash - 0xE5FA3D79 ^0xC01023AA
{
	int num;
	Hash itemHash;
	Hash outPropVariant;
...
void func_44(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Hash - 0xF7320378 ^0xF7320378
{
	uParam0->[0] = iParam1;
	uParam0->[1] = iParam2;
	uParam0->[2] = iParam3;
...
struct<17> func_45(Hash hParam0, int iParam1) // Hash - 0x10D20E1D ^0x38BDAFC5
{
	int i;
	var unk;
...
void func_46(var uParam0, Hash hParam1, int iParam2, int iParam3) // Hash - 0xD805D094 ^0x25EDFC78
{
	int num;
	Hash outfit;
...
int func_47(int iParam0) // Hash - 0xF91DA7A7 ^0xF91DA7A7
{
	switch (iParam0)
	{
		case 0:
...
void func_48(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Hash - 0xEC425A3E ^0xEC425A3E
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
	uParam0->[3] = iParam3;
...
BOOL func_49(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Hash - 0xCC83E9BC ^0xCC83E9BC
{
	switch (hParam0)
	{
		case joaat("PLAYER_ZERO"):
...
BOOL func_50(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Hash - 0x261C127A ^0x57548E07
{
	if (hParam0 == joaat("PLAYER_ZERO"))
	{
		if (iParam1 == 6)
...
BOOL func_51(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Hash - 0xAC33D304 ^0xAC33D304
{
	switch (hParam0)
	{
		case joaat("PLAYER_ZERO"):
...
int func_52(Ped pedParam0, ePedComponentType epctParam1) // Hash - 0xA9FF3076 ^0xC030B76B
{
	int pedPropIndex;
...
int func_53(Ped pedParam0, int iParam1) // Hash - 0x5DC76C2F ^0x122A4DD3
{
...
int func_54(Ped pedParam0, int iParam1, int iParam2, int iParam3) // Hash - 0x8F4AAD60 ^0xD2AF7F3D
{
	ePedComponentType componentId;
...
void func_55(int iParam0) // Hash - 0xE5A1F74D ^0x61D497DD
{
...
void func_56(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Hash - 0x3F2F251B ^0xAB09A1C4
{
	int num;
	int offset;
	int num2;
...
void func_57(int iParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Hash - 0x7D768555 ^0x693A841
{
	Hash statName;
...
int func_58(int iParam0) // Hash - 0x1A3F3220 ^0x1A3F3220
{
	int num;
	int num2;
...
int func_59() // Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1574918;
}

int func_60(int iParam0, int iParam1, int iParam2) // Hash - 0x4BC84F7B ^0x370D7D6F
{
	Hash statHash;
	int outValue;
...
BOOL func_61(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Hash - 0x1B8A3878 ^0x1D07D6A7
{
...
BOOL func_62(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Hash - 0xDF4F0B01 ^0xAAD287D4
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
BOOL func_63(int iParam0) // Hash - 0x972D67C7 ^0x6B327493
{
	if (!IS_BIT_SET(Global_78341[1 /*14*/].f_6, 0))
		return false;
...
struct<14> func_64(Hash hParam0, int iParam1, int iParam2, int iParam3) // Hash - 0x7D5AC326 ^0xB460D68E
{
	func_128();
...
void func_65(int iParam0, int iParam1) // Hash - 0x2A09B983 ^0x2A09B983
{
	switch (iParam0)
	{
		case 0:
...
void func_66(int iParam0) // Hash - 0x588E3553 ^0x51F4630D
{
	BOOL flag;
	int num;
	var unk;
...
void func_67(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Hash - 0xA2DFD38C ^0xCA7EA132
{
	int num;
	int num2;
...
BOOL func_68(int iParam0, int iParam1, var uParam2) // Hash - 0x805F0D09 ^0xD5FF8259
{
	*uParam2 = 979;
...
int func_69(int iParam0, int iParam1) // Hash - 0x4CEDF2DA ^0xD4A47B95
{
	switch (iParam1)
	{
		case 0:
...
int func_70(int iParam0, int iParam1) // Hash - 0x4CEDF2DA ^0x7536052F
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_71(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Hash - 0x8C42734C ^0x8C42734C
{
	int num;
	int num2;
	int num3;
...
int func_73(int iParam0) // Hash - 0xE4C61EBD ^0xE4C61EBD
{
	switch (iParam0)
	{
		case -1:
...
void func_74(int iParam0, int iParam1, int iParam2, Hash hParam3) // Hash - 0xE3509264 ^0xCA79B364
{
	int num;
	int num2;
	Hash outfit;
...
void func_75(int iParam0) // Hash - 0x33E192FB ^0x66E7EDBA
{
	BOOL flag;
	int num;
	var unk;
...
void func_76(int iParam0) // Hash - 0x7D56211F ^0x48982667
{
	BOOL flag;
	int num;
	var unk;
...
void func_77(int iParam0) // Hash - 0xB40ABE2B ^0x22EB383C
{
	BOOL flag;
	int num;
	var unk;
...
void func_78(int iParam0) // Hash - 0x3B26C80D ^0x3E613A90
{
	BOOL flag;
	int num;
	var unk;
...
void func_79(int iParam0) // Hash - 0xC290E725 ^0xB7B1A9FC
{
	BOOL flag;
	int num;
	var unk;
...
void func_80(int iParam0) // Hash - 0x642CA81B ^0xCE23FBE1
{
	BOOL flag;
	int num;
	var unk;
...
void func_81(int iParam0) // Hash - 0x549433F7 ^0xAA33F23C
{
	BOOL flag;
	int num;
	var unk;
...
void func_82(int iParam0) // Hash - 0xDDFE7744 ^0x2D80F80E
{
	BOOL flag;
	int num;
	var unk;
...
void func_83(int iParam0) // Hash - 0x7E0E5686 ^0xFD38652
{
	BOOL flag;
	int num;
	var unk;
...
void func_84(int iParam0) // Hash - 0xEF2456FB ^0x4F90E5F3
{
	BOOL flag;
	int num;
	var unk;
...
void func_85(int iParam0) // Hash - 0xD968CB7E ^0x9CEAA7F9
{
	BOOL flag;
	int num;
	var unk;
...
void func_86(int iParam0) // Hash - 0x2732DFB2 ^0x9C99461
{
	if (iParam0 < 136)
		func_88(iParam0);
	else
...
void func_87(int iParam0) // Hash - 0xB837F550 ^0xE3283054
{
	BOOL flag;
	int num;
	var unk;
...
void func_88(int iParam0) // Hash - 0x7B542CFB ^0xDE76FCFA
{
	BOOL flag;
	int num;
	var unk;
...
void func_89(int iParam0) // Hash - 0xC2F9B35A ^0xEE0F1732
{
	BOOL flag;
	int num;
	var unk;
...
void func_90(int iParam0) // Hash - 0x6C52547 ^0xA5156823
{
	BOOL flag;
	int num;
	var unk;
...
void func_91(int iParam0, int iParam1) // Hash - 0x2A09B983 ^0x2A09B983
{
	switch (iParam0)
	{
		case 0:
...
void func_92(int iParam0) // Hash - 0x3D2713EB ^0xEE84116F
{
	BOOL flag;
	int num;
	var unk;
...
void func_93(int iParam0) // Hash - 0x32ED2DFF ^0xE6530121
{
	BOOL flag;
	int num;
	var unk;
...
void func_94(int iParam0) // Hash - 0x4B9467AD ^0x21E0A5E3
{
	BOOL flag;
	int num;
	var unk;
...
void func_95(int iParam0) // Hash - 0xBCBC22B4 ^0xCF8B814D
{
	BOOL flag;
	int num;
	var unk;
...
void func_96(int iParam0) // Hash - 0x35EB4EC2 ^0x80EF7990
{
	BOOL flag;
	int num;
	var unk;
...
void func_97(int iParam0) // Hash - 0xCC657943 ^0x1E8C1FF
{
	BOOL flag;
	int num;
	var unk;
...
void func_98(int iParam0) // Hash - 0x22C484EE ^0xB9267103
{
	BOOL flag;
	int num;
	var unk;
...
void func_99(int iParam0) // Hash - 0xDBB748F8 ^0x1EF97F1F
{
	BOOL flag;
	int num;
	var unk;
...
void func_100(int iParam0) // Hash - 0x8CEE4CA3 ^0x2D46EBA6
{
	BOOL flag;
	int num;
	var unk;
...
void func_101(int iParam0) // Hash - 0x62A050C0 ^0xC04FA82A
{
	BOOL flag;
	int num;
	var unk;
...
void func_102(int iParam0) // Hash - 0xE2721790 ^0x85AE4D68
{
	BOOL flag;
	int num;
	var unk;
...
void func_103(int iParam0) // Hash - 0xBC068BE9 ^0xADA1A1BB
{
	BOOL flag;
	int num;
	var unk;
...
void func_104(int iParam0) // Hash - 0x905863CF ^0x4D59FCB8
{
	if (iParam0 < 107)
		func_107(iParam0);
	else if (iParam0 < 227)
...
void func_105(int iParam0) // Hash - 0x6B1EB2DB ^0x2A943CD8
{
	BOOL flag;
	int num;
	var unk;
...
void func_106(int iParam0) // Hash - 0x6B1EB2DB ^0xD248CD30
{
	BOOL flag;
	int num;
	var unk;
...
void func_107(int iParam0) // Hash - 0x6B1EB2DB ^0x527A497C
{
	BOOL flag;
	int num;
	var unk;
...
void func_108(int iParam0) // Hash - 0xD1DB443F ^0xE1082273
{
	BOOL flag;
	int num;
	var unk;
...
void func_109(int iParam0) // Hash - 0x508749F ^0x4F3D03A2
{
	BOOL flag;
	int num;
	var unk;
...
void func_111(int iParam0) // Hash - 0x4114D323 ^0x814D8044
{
	BOOL flag;
	int num;
	var unk;
...
void func_112(int iParam0) // Hash - 0xBEE4258A ^0xA6DD2BCF
{
	BOOL flag;
	int num;
	var unk;
...
void func_113(int iParam0) // Hash - 0x7AE9DF25 ^0x775A19CC
{
	BOOL flag;
	int num;
	var unk;
...
void func_114(int iParam0) // Hash - 0xAE0F501E ^0x32C41166
{
	BOOL flag;
	int num;
	var unk;
...
void func_115(int iParam0) // Hash - 0x77FE752F ^0xFFD64174
{
	BOOL flag;
	int num;
	var unk;
...
void func_116(int iParam0) // Hash - 0xBC3ED9F1 ^0x888F00F9
{
	BOOL flag;
	int num;
	var unk;
...
void func_117(int iParam0) // Hash - 0x6300D63 ^0xF15EABA8
{
	BOOL flag;
	int num;
	var unk;
...
void func_118(int iParam0) // Hash - 0x19D608F8 ^0x82DF58D2
{
	BOOL flag;
	int num;
	var unk;
...
void func_119(int iParam0) // Hash - 0xAFA604B5 ^0x359E258E
{
	BOOL flag;
	int num;
	var unk;
...
void func_120(int iParam0) // Hash - 0x35552BFE ^0x96BE4012
{
	BOOL flag;
	int num;
	var unk;
...
void func_121(int iParam0) // Hash - 0xE4934E8C ^0x69C1A49D
{
	BOOL flag;
	int num;
	var unk;
...
void func_122(int iParam0) // Hash - 0xC75B5564 ^0x54FC16
{
	BOOL flag;
	int num;
	var unk;
...
void func_123(int iParam0) // Hash - 0xA5A40372 ^0xCEFC4EDB
{
	if (iParam0 < 60)
		func_125(iParam0);
	else
...
void func_124(int iParam0) // Hash - 0x508D8CAF ^0x4C516EA6
{
	BOOL flag;
	int num;
	var unk;
...
void func_125(int iParam0) // Hash - 0x8425A109 ^0x474A1E2D
{
	BOOL flag;
	int num;
	var unk;
...
void func_126(int iParam0) // Hash - 0x646F46FD ^0x17F8903E
{
	BOOL flag;
	int num;
	var unk;
...
void func_127(int iParam0) // Hash - 0x2332BBFC ^0xF93E19D9
{
	BOOL flag;
	int num;
	var unk;
...
void func_128() // Hash - 0xE5F61993 ^0xEFD41040
{
...
BOOL func_129(Ped pedParam0, int iParam1, int iParam2) // Hash - 0x1B00EC8E ^0x386C7313
{
	Hash entityModel;
	int num;
	int i;
...
void func_136(BOOL bParam0) // Hash - 0xD10400C0 ^0xB6845444
{
	Player playerIndex;
...
void func_137(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Hash - 0x787E640E ^0x67C15509
{
	if (bParam0)
	{
...
BOOL func_138() // Hash - 0xAA7793E3 ^0x3F62CDC8
{
	return IS_BIT_SET(Global_1853910[PLAYER::PLAYER_ID() /*862*/].f_36.f_18, 14);
}

BOOL func_139(Player plParam0, int iParam1) // Hash - 0x5A3B86CC ^0x2CFA58CE
{
	BOOL flag;
...
int func_140(int iParam0, BOOL bParam1) // Hash - 0x1DCD393E ^0x1DCD393E
{
	int num;
	int num2;
...
BOOL func_141(Player plParam0) // Hash - 0x68897CDD ^0x62820466
{
...
BOOL func_142() // Hash - 0xA525B2F4 ^0xA525B2F4
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_143(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Hash - 0x3167F4C7 ^0xCE6B9B6A
{
	int num;
...
void func_145(int iParam0) // Hash - 0x1B2EEE72 ^0xEDBC1F9D
{
	if (iParam0 == 1)
...
void func_146() // Hash - 0xC536DD5 ^0xC536DD5
{
	Global_20591 = 0;
	func_147();
	return;
...
void func_147() // Hash - 0xF6D04E68 ^0x80AE5309
{
...
BOOL func_148(int iParam0, int iParam1, int iParam2) // Hash - 0x45E861F0 ^0xB70C2EC3
{
	int num;
...
BOOL func_149() // Hash - 0x7E48580B ^0x77F2F890
{
...
void func_150() // Hash - 0xC536DD5 ^0xC536DD5
{
	Global_20591 = 0;
	func_151();
	return;
...
void func_151() // Hash - 0xE32CF1EF ^0xB9A7BEB2
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22736 = 0;
...
BOOL func_152() // Hash - 0x152DA0B2 ^0x220E93E9
{
...
void func_153() // Hash - 0x2A0AC5B7 ^0xAF27577A
{
...
BOOL func_154(Ped pedParam0, eScriptTaskHash esthParam1) // Hash - 0x5CB13EA9 ^0x50B73240
{
	if (func_6(pedParam0))
...
BOOL func_155(Vehicle veParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Hash - 0x60473011 ^0x5B80F12B
{
...
void func_156(Vehicle veParam0) // Hash - 0x94E8CB0B ^0x47923A23
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
BOOL func_157() // Hash - 0x338E841B ^0x338E841B
{
	int num;
...
int func_158(var uParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Hash - 0x8F9349A ^0xC5C097C1
{
	int i;
...
void func_159(var uParam0, int iParam1) // Hash - 0x6AC97785 ^0x6AC97785
{
	int i;
...
BOOL func_160(int iParam0) // Hash - 0xECB6C71B ^0xECB6C71B
{
	return func_161(iParam0, Global_43257);
}

BOOL func_161(int iParam0, int iParam1) // Hash - 0x1FD727E0 ^0x1FD727E0
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_162(int iParam0) // Hash - 0x3BAB94E9 ^0x3BAB94E9
{
	if (Global_43257 == 15)
		return false;
...
BOOL func_163() // Hash - 0x4CBF8C43 ^0x6A520372
{
...
BOOL func_164() // Hash - 0x3CA1BB47 ^0xB78A1ACB
{
...
BOOL func_165() // Hash - 0x1CB029D8 ^0x1CB029D8
{
	if (Global_43257 == 15)
		return false;
...
BOOL func_166(int iParam0) // Hash - 0xB6246282 ^0x2350A449
{
...
BOOL func_167(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6) // Hash - 0xDDE15471 ^0xA130E15A
{
	float num;
...
BOOL func_168(var uParam0, float fParam1, var uParam2, var uParam3) // Hash - 0xEF71070A ^0x3D4398AD
{
	BOOL flag;
	int num;
	int num2;
...
void func_169(var uParam0) // Hash - 0x6A0A7C37 ^0x4AB04E31
{
	int i;
	float num;
...
void func_170(var uParam0, float fParam1, float fParam2, float fParam3) // Hash - 0x488A8B25 ^0x21309DD6
{
	uParam0->f_51 == 0;
	uParam0->f_46 >= 15;
...
void func_171(var uParam0) // Hash - 0x94803123 ^0x38D79261
{
	uParam0->f_51;
	uParam0->f_46 = 0;
...
void func_172() // Hash - 0xA6F2CDE9 ^0x50027DA8
{
	int offset;
...
BOOL func_173(int iParam0, var uParam1) // Hash - 0xC95D4ADC ^0xC95D4ADC
{
	switch (iParam0)
	{
		case 114:
...
void func_174(var uParam0) // Hash - 0x995C9E2 ^0x995C9E2
{
	if (*uParam0 == -1)
		return;
...
int func_175(int iParam0) // Hash - 0xFCBFD2CC ^0x1DBFD43E
{
	int num;
	int offset;
