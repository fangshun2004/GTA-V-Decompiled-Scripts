...
BOOL func_1(var uParam0, var uParam1) // Hash - 0x38FB7F9F ^0xDB15305E
{
	float value;
	var value2;
	int i;
...
void func_2(int iParam0, var uParam1) // Hash - 0x3381FBA6 ^0xB9B89555
{
	switch (iParam0)
	{
		case 0:
...
Hash func_4(int iParam0) // Hash - 0x18A4787C ^0xC10CB6F5
{
	var unk;
...
void func_5() // Hash - 0x414B00C ^0xA7B03D26
{
...
void func_6() // Hash - 0xCE5FB49E ^0x214A59D5
{
	SCRIPT::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_7() // Hash - 0x52E21E9B ^0xD0F85E96
{
	if (Global_1575035 == 0)
