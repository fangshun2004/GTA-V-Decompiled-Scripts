...
void main() // Hash - 0x5D84F89F ^0x5D84F89F
{
	...
	while (true)
	{
		...
		if (!func_220(&num, 1) || func_261(num))
			func_273(&num, true);
...
BOOL func_2(Any* panParam0) // Hash - 0xDE97F4EA ^0x3637A4A6
{
	const char* str;
	var unk32;
...
struct<2> func_9(int iParam0) // Hash - 0x323E6781 ^0xCDB94AA7
{
	var unk;
	var unk3;
...
void func_19() // Hash - 0x429A4038 ^0x3EA70FCA
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("MISSION_STAT_WATCHER")) > 0)
	{
		if (func_20())
...
void func_23(char* sParam0, int iParam1, Ped pedParam2) // Hash - 0xB566D143 ^0x33422B40
{
...
BOOL func_44(int iParam0, int iParam1, char* sParam2, var uParam3) // Hash - 0x8E372EAA ^0x1E6F67C
{
...
void func_109(int iParam0) // Hash - 0x35AC36F2 ^0x2E6885D9
{
	int num;
	var textLabel;
...
void func_112(char* sParam0, Any anParam1, int iParam2) // Hash - 0x817AB180 ^0x4F7CDA7D
{
...
struct<2> func_114(int iParam0) // Hash - 0x975AC8C9 ^0x51CFD048
{
	var unk;
...
void func_115(int iParam0, var uParam1) // Hash - 0x2D8E3F8 ^0xBB0B317A
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_148(const char* sParam0) // Hash - 0x16488C7A ^0xFD9756C5
{
...
void func_177(int iParam0, var uParam1) // Hash - 0x16CCAA18 ^0x6DD865F
{
	if (iParam0 == 1)
	{
		if (!func_135(uParam1))
...
void func_189(var uParam0) // Hash - 0xA8DAB52D ^0x79EB43CF
{
	float num;
...
float func_190(int* piParam0) // Hash - 0x4CA081DF ^0xE7D9DC6
{
...
BOOL func_192(int* piParam0) // Hash - 0x58F53CD ^0x58F53CD
{
	return IS_BIT_SET(*piParam0, 2);
}

void func_193(int* piParam0) // Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_194(piParam0, 0f);
	return;
}

void func_194(int* piParam0, float fParam1) // Hash - 0xED66BE55 ^0x9F6586C1
{
...
BOOL func_196(int* piParam0) // Hash - 0xA8A91C80 ^0xA8A91C80
{
	return IS_BIT_SET(*piParam0, 1);
}

int func_197(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6) // Hash - 0xB83D7D0 ^0xB83D7D0
{
...
int func_198(char* sParam0, int iParam1, BOOL bParam2) // Hash - 0x77297D51 ^0x40DC584A
{
	Global_21726 = 0;
...
void func_199() // Hash - 0xF42BEB19 ^0xA29557DA
{
	if (!func_200())
		return;
...
BOOL func_200() // Hash - 0x7B74B45F ^0xCE052A5D
{
...
BOOL func_201(Player plParam0) // Hash - 0x6E46BC72 ^0x6E46BC72
{
	return func_202(plParam0, 20);
}

BOOL func_202(Player plParam0, int iParam1) // Hash - 0x7CD5054C ^0x870BEA81
{
	return IS_BIT_SET(Global_1894573[plParam0 /*608*/].f_10.f_4, iParam1);
}

void func_203() // Hash - 0xDB58E314 ^0xCCB3938
{
	int i;
...
void func_204() // Hash - 0xCD8A4D28 ^0xCD8A4D28
{
...
BOOL func_205() // Hash - 0x9A999369 ^0x4033F7BF
{
	int num;
	int weaponHash;
...
void func_206() // Hash - 0x98476CE1 ^0x250FEB7C
{
	if (func_57(14))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
...
void func_207() // Hash - 0xBE88A374 ^0x48B9B8EC
{
	int i;
...
void func_208(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Hash - 0xC6B752B2 ^0xC6B752B2
{
...
int func_209(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Hash - 0x384540C1 ^0x384540C1
{
...
void func_210(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Hash - 0x6C235EE0 ^0x9E57F206
{
...
float func_215(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Hash - 0xC22B942A ^0xE0DB8793
{
...
void func_217(var uParam0) // Hash - 0x8EEB5116 ^0x2325FF68
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_218(uParam0);
...
void func_218(var uParam0) // Hash - 0x1C509C5B ^0x1C509C5B
{
	BOOL flag;
	int num;
	int i;
...
void func_219(int iParam0) // Hash - 0xD347101A ^0xCC220E7F
{
	if (iParam0 == -1)
		iParam0 = func_171();
...
BOOL func_220(Any* panParam0, BOOL bParam1) // Hash - 0x7D86F6E4 ^0x1CAFFB64
{
	var unk;
	...
	{
		if (!func_228(panParam0, true, true))
		{
			if (*panParam0 == 16)
				func_227(panParam0);
			else
	...
	{
		if (!func_228(panParam0, false, true))
		{
			func_225(panParam0);
			return false;
		}
	...
	{
		if (!func_228(panParam0, true, false))
		{
			func_225(panParam0);
			return false;
		}
	...
	{
		if (!func_228(panParam0, false, false))
		{
			func_225(panParam0);
			return false;
		}
...
void func_221(Ped pedParam0, var uParam1, int iParam2) // Hash - 0xD4C7D099 ^0x162C1E9
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_222(int iParam0) // Hash - 0xD681AEF7 ^0xD681AEF7
{
...
BOOL func_223(var uParam0) // Hash - 0x42F869D4 ^0xFFADB180
{
...
BOOL func_224(var uParam0) // Hash - 0x6329B93C ^0xCBBB8D92
{
...
void func_225(var uParam0) // Hash - 0x2E98ABB1 ^0xFF31A41F
{
	int i;
	int taskSequenceId;
...
void func_227(var uParam0) // Hash - 0x5209F824 ^0xCFA0F1CA
{
	int i;
...
BOOL func_228(var uParam0, BOOL bParam1, BOOL bParam2) // Hash - 0x53567DCF ^0x584F6887
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_229(Ped pedParam0, Vehicle veParam1) // Hash - 0xFB12ABF0 ^0x730FD205
{
...
BOOL func_230(var uParam0, BOOL bParam1, int iParam2) // Hash - 0xE9BDE167 ^0x20C575FA
{
	int i;
	int num;
...
BOOL func_231(int iParam0) // Hash - 0x9E3DCA43 ^0x9E3DCA43
{
...
BOOL func_232(Ped pedParam0, int iParam1) // Hash - 0x5EA05E45 ^0x7984EB04
{
	float xSize;
...
BOOL func_233(Ped pedParam0, int iParam1) // Hash - 0xF1789D04 ^0x3F9D1900
{
	return func_234(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_234(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Hash - 0x275BB58B ^0x275BB58B
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_235(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Hash - 0xBBBECF07 ^0xBBBECF07
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_236(Ped pedParam0, int iParam1) // Hash - 0xA6273130 ^0xF7D9CDEA
{
...
int func_237() // Hash - 0x1398F041 ^0xCD84FF69
{
	int i;
...
BOOL func_238(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Hash - 0x6EF1707D ^0x8C069CF9
{
	var unk;
...
float func_239(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Hash - 0x596BEA29 ^0x5FBCDBE5
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_240(float fParam0, var uParam1, var uParam2) // Hash - 0xFB6A39D2 ^0x80C9C759
{
	float num;
	float num2;
...
void func_241(var uParam0) // Hash - 0xA4B72113 ^0x62A5EAE1
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_242(Ped pedParam0, Ped pedParam1) // Hash - 0xAA445031 ^0xEBA3F8CF
{
	int i;
...
BOOL func_243(Ped pedParam0) // Hash - 0xEC80536A ^0x2D4CF2B0
{
...
BOOL func_244(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Hash - 0x5B46DA49 ^0x44F718
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_245(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Hash - 0x1310B579 ^0x2AAFC0CC
{
	float entityCoords;
	float num;
...
BOOL func_246(Ped pedParam0, float fParam1) // Hash - 0xFA3D7088 ^0x33A74060
{
	var outProjectile;
	var outCoords;
...
BOOL func_247(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Hash - 0x3F40E5FA ^0xC3BEFE6A
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_248(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Hash - 0x18BAE105 ^0x60D3B20E
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_249(int iParam0) // Hash - 0x5B443B41 ^0x5B443B41
{
...
void func_250(Vehicle veParam0) // Hash - 0xAD821AF8 ^0x883721EE
{
	int taskSequenceId;
...
BOOL func_251(int iParam0) // Hash - 0x6F2BC7EE ^0x6F2BC7EE
{
	if (iParam0 == -1)
		iParam0 = func_171();
...
BOOL func_252(int iParam0) // Hash - 0xDE7BA54D ^0xDE7BA54D
{
...
BOOL func_253() // Hash - 0x62DD5CB2 ^0xFA07DED3
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_254() // Hash - 0x98CCC132 ^0x97B0D6ED
{
	if (Global_97603 != -1)
...
BOOL func_255(int iParam0) // Hash - 0xC2630182 ^0xFBD23031
{
...
BOOL func_256() // Hash - 0x25806CBF ^0x25806CBF
{
...
BOOL func_257(int iParam0) // Hash - 0x1156B580 ^0x34C7FA05
{
	if (func_113(false))
...
BOOL func_258(var uParam0) // Hash - 0xD1E1B68A ^0xD1E1B68A
{
	if (!func_259(uParam0))
		return false;
...
BOOL func_259(var uParam0) // Hash - 0x12E9B767 ^0x292FB081
{
	BOOL flag;
	int taskSequenceId;
...
BOOL func_260(int iParam0) // Hash - 0x3D43FEFC ^0x3D43FEFC
{
	int i;
...
BOOL func_262(int iParam0) // Hash - 0xC6B32843 ^0xCF65EFDA
{
	const char* string2;
...
BOOL func_265(int iParam0, char* sParam1) // Hash - 0xC64245F ^0xCC6A1271
{
...
BOOL func_270(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Hash - 0x5B983661 ^0x5B983661
{
	int i;
...
BOOL func_271(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Hash - 0xC6B7068B ^0xB9A971A4
{
	int num;
	char* str;
...
BOOL func_272(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Hash - 0x1FB736D4 ^0x234AEAB7
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_273(var uParam0, BOOL bParam1) // Hash - 0x771D21E4 ^0x4A386BF2
{
	func_286();
...
void func_274(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Hash - 0x5BE1D1E3 ^0x5BE1D1E3
{
...
void func_275(var uParam0, BOOL bParam1) // Hash - 0xEDC3BD2D ^0xE0B6F056
{
	func_276(&(uParam0->f_41), bParam1);
	return;
}

void func_276(var uParam0, BOOL bParam1) // Hash - 0x9E80EA71 ^0x9E80EA71
{
	int i;
...
void func_277(Object* pobParam0, BOOL bParam1) // Hash - 0xD7EE3E27 ^0xC5769B29
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_278(var uParam0, BOOL bParam1) // Hash - 0xEDC3BD2D ^0xE2474F74
{
	func_279(&(uParam0->f_35), bParam1);
	return;
}

void func_279(var uParam0, BOOL bParam1) // Hash - 0xA98F6284 ^0xA98F6284
{
	int i;
...
void func_280(Vehicle* pveParam0) // Hash - 0xC50F9886 ^0x638B6124
{
...
void func_281(Vehicle* pveParam0) // Hash - 0x8D18F713 ^0xF71A18A8
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_282(var uParam0, int iParam1) // Hash - 0xEDC3BD2D ^0xA9A19095
{
	func_283(&(uParam0->f_28), iParam1);
	return;
}

void func_283(var uParam0, int iParam1) // Hash - 0xB72ACFD2 ^0xB72ACFD2
{
	int i;
...
void func_284(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Hash - 0x34362197 ^0xC592197
{
...
void func_285(Ped* ppedParam0) // Hash - 0xCA79453F ^0x7BA88177
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_287() // Hash - 0xF6D04E68 ^0x80AE5309
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22736 = 0;
...
void func_288(int iParam0) // Hash - 0x995C9E2 ^0x995C9E2
{
	if (*iParam0 == -1)
		return;
...
void func_289(char* sParam0) // Hash - 0x54B64147 ^0x56EEAFB9
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_290(var uParam0) // Hash - 0x4CD8BCE8 ^0x31325460
{
	*uParam0 = -1;
