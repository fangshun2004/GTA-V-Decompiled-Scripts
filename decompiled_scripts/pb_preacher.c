...
void func_1()
{
	if (SYSTEM::TIMERB() > 7000)
	{
		...
		{
			if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_69, 10f, 10f, 10f, false, true, 0) && iLocal_71 == 0)
			{
				SYSTEM::SETTIMERB(0);
				...
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_69, false))
				{
					TASK::TASK_PERFORM_SEQUENCE(iLocal_69, iLocal_72);
				}
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_72);
				iLocal_71 = 1;
			}
			if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_69, 3f, 3f, 3f, false, true, 0) && iLocal_70 == 0)
			{
				Local_65 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
				SYSTEM::SETTIMERB(0);
				TASK::OPEN_SEQUENCE_TASK(&iLocal_72);
...
void func_2()
{
	...
	iLocal_69 = PED::CREATE_PED(19, joaat("s_m_m_strpreach_01"), Local_62.f_0, Local_62.f_1, Local_65.f_2, 0f, true, true);
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_69, false))
	{
		TASK::OPEN_SEQUENCE_TASK(&iLocal_72);
		TASK::TASK_TURN_PED_TO_FACE_COORD(0, Local_65, 0);
