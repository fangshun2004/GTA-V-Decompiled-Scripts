...
void func_2() // Position - 0x1FE Hash - 0x7A00A7BA ^0x5234247F
{
	...
	pedLocal_52 = PED::CREATE_PED(PED_TYPE_DEALER, 469792763, fLocal_45, fLocal_45.f_1, uLocal_48.f_2, 0f, true, true);
...
BOOL func_14(int iParam0) // Position - 0xB2D Hash - 0x8907F004 ^0x8907F004
{
	return iParam0 < 3;
}

int func_15() // Position - 0xB39 Hash - 0x3C5423D7 ^0x3C5423D7
{
	func_16();
...
int func_17(Ped pedParam0) // Position - 0xC4F Hash - 0xAC4E9801 ^0xB379A75F
{
	int i;
	Hash entityModel;
...
Hash func_18(int iParam0) // Position - 0xC8C Hash - 0xADCB9755 ^0xADCB9755
{
	if (func_14(iParam0))
...
Hash func_19(int iParam0) // Position - 0xCB1 Hash - 0xE4CEEC2C ^0xE4CEEC2C
{
	return Global_2028[iParam0 /*29*/];
}

BOOL func_20(int iParam0) // Position - 0xCC0 Hash - 0xECB6C71B ^0xECB6C71B
{
