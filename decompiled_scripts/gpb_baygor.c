...
void main() // Position - 0x0 Hash - 0x5D84F89F ^0x5D84F89F
{
	...
	iLocal_454 = 49;
	iLocal_455 = 64;
	uLocal_242 = { uScriptParam_507.f_1[0 /*3*/] };
	func_121();
	...
	while (num == 1)
	{
		...
		{
			if (!func_92() && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(-892862129) == 0)
			{
				func_111();
		...
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		{
			if (PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), pedLocal_240) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), pedLocal_240) && num6 < 25f && func_91(PLAYER::PLAYER_PED_ID()) != -1569615261 && func_88(pedLocal_240, PLAYER::PLAYER_PED_ID(), 1126825984, 0))
			{
				if (!func_92())
				{
					func_94();
...
void func_13(char* sParam0, int iParam1) // Position - 0x15E5 Hash - 0xCBB0D91 ^0x21070E5C
{
...
int func_20() // Position - 0x1722 Hash - 0x3C5423D7 ^0x3C5423D7
{
	func_21();
...
BOOL func_23(int iParam0) // Position - 0x1846 Hash - 0x8907F004 ^0x8907F004
{
	return iParam0 < 3;
}

int func_24(Ped pedParam0) // Position - 0x1852 Hash - 0xAC4E9801 ^0xB379A75F
{
	int i;
	Hash entityModel;
...
Hash func_25(int iParam0) // Position - 0x188F Hash - 0xADCB9755 ^0xADCB9755
{
	if (func_23(iParam0))
...
Hash func_26(int iParam0) // Position - 0x18B4 Hash - 0xE4CEEC2C ^0xE4CEEC2C
{
...
BOOL func_37(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x1C46 Hash - 0x384540C1 ^0x384540C1
{
...
Player func_43() // Position - 0x2024 Hash - 0x478900E4 ^0x478900E4
{
	return -1;
}
...
void func_48() // Position - 0x21B2 Hash - 0x98476CE1 ^0x250FEB7C
{
	if (func_22(14))
	{
...
void func_51(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x22E2 Hash - 0xC6B752B2 ^0xC6B752B2
{
...
void func_53(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x2373 Hash - 0x6C235EE0 ^0x9E57F206
{
...
BOOL func_65() // Position - 0x260D Hash - 0x152DA0B2 ^0x220E93E9
{
...
BOOL func_105(Ped pedParam0) // Position - 0x31D7 Hash - 0x3D210083 ^0xF7E7C389
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
		if (!ENTITY::IS_ENTITY_DEAD(pedParam0, false))
			return true;
...
{
	obLocal_448 = OBJECT::CREATE_OBJECT(-2015467307, ENTITY::GET_ENTITY_COORDS(pedLocal_240, true), true, true, false);
