...
void __EntryFunction__()
{
	...
	fLocal_49 = 180f;
	iLocal_52 = 3;
	uLocal_97 = func_357(60);
	uLocal_98 = func_357(14);
	sLocal_102 = "Marnie";
	fLocal_332 = 40f;
	fLocal_333 = 0.35f;
	fLocal_334 = 0f;
	...
	while (true)
	{
		...
		SYSTEM::WAIT(0);
		func_288(Local_103.f_9, 0, 0, 0, 0, 0);
		switch (iLocal_100)
		{
			case 0:
				func_261();
...
void func_1()
{
	switch (iLocal_101)
	{
		...
		case 1:
			...
			{
				if (func_249(Local_103.f_28[0]))
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_103.f_28[0], sLocal_102, 0, 0, 0);
				}
...
int func_204(int iParam0, int iParam1, bool bParam2)
{
	...
	while (iVar1 < Global_55466[iVar0 /*203*/].f_3)
	{
		...
		if (iVar3 < 3)
		{
			func_205(Global_55466[iVar0 /*203*/].f_4[iVar1], Global_55466[iVar0 /*203*/].f_1, 1, bParam2, 0);
		}
		iVar1++;
	}
	return 1;
...
void func_205(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (!bParam2)
	{
		...
		iVar2 = iVar20;
		Var3 = { func_211(Global_46166[iVar20 /*12*/].f_1) };
	...
	else
	{
		...
		{
			Var3 = { func_211(Global_46166[iVar26 /*12*/].f_1) };
		}
	}
	if (!bParam4)
	{
...
void func_261()
{
	...
	switch (iLocal_101)
	{
		...
		case 1:
			if (func_279(PLAYER::PLAYER_PED_ID(), Local_103.f_28[0], 1) >= 4.5f)
			{
				if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
				{
					if (func_278())
					{
						CAM::SET_GAMEPLAY_ENTITY_HINT(Local_103.f_28[0], 0f, 0f, 0.5f, true, 30000, 2000, 2000, 0);
					}
					else
					{
						CAM::SET_GAMEPLAY_ENTITY_HINT(Local_103.f_28[0], -1f, 0f, 0f, false, 30000, 2000, 2000, 0);
					}
			...
			if (iLocal_331 == 0)
			{
				if (func_279(PLAYER::PLAYER_PED_ID(), Local_103.f_28[0], 1) <= 2.5f)
				{
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED("rcmepsilonism5"))
			{
				if (func_249(Local_103.f_28[0]))
				{
					if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_103.f_28[0], "rcm_epsilonism5", "ep_5_rcm_marnie_strokes_wall", 3))
					{
						if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(Local_103.f_28[0], "rcm_epsilonism5", "ep_5_rcm_marnie_strokes_wall") < 0.1f)
						{
							func_277(&uLocal_164, 4, Local_103.f_28[0], "MARNIE", 0, 1);
							func_277(&uLocal_164, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
							TASK::TASK_LOOK_AT_ENTITY(Local_103.f_28[0], PLAYER::PLAYER_PED_ID(), -1, 12, 2);
							TASK::TASK_PLAY_ANIM(Local_103.f_28[0], "rcmepsilonism5", "leadin_action", 8f, -8f, -1, 2, 0f, false, false, false);
							iLocal_101 = 2;
						}
					}
				}
		...
		case 2:
			if (func_249(Local_103.f_28[0]))
			{
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_103.f_28[0], "rcmepsilonism5", "leadin_action", 3))
				{
					if (iLocal_330 == 0)
					{
						if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(Local_103.f_28[0], "rcmepsilonism5", "leadin_action") >= 0.38f)
						{
							if (func_262(&uLocal_164, "EPS5AUD", "EP5_RCM_LI", 8, 0, 0, 0))
							{
								iLocal_330 = 1;
							}
						}
					}
					if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(Local_103.f_28[0], "rcmepsilonism5", "leadin_action") >= 0.95f)
					{
						iLocal_101 = 3;
					}
					if (iLocal_331 == 0)
	...
	if (Global_80592 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_290(Global_80593, Global_80595, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
		...
		if (bParam2)
		{
			if (!Global_80337)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_10178[iParam1 /*4*/] = { func_306(iParam0) };
					...
					{
						Global_10129[1 /*6*/] = { func_306(iParam0) };
...
void func_320()
{
	...
	if (func_249(Local_103.f_28[0]))
	{
		PED::SET_PED_CAN_BE_TARGETTED(Local_103.f_28[0], false);
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_103.f_28[0], joaat("player"));
	}
	func_321(&Local_103, 0, 0, 0);
...
int func_339()
{
	...
	iVar0 = func_340(&(Global_102486.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
