...
void func_1() // Hash - 0x21515259 ^0x144A031
{
	switch (iLocal_84)
	{
		case 0:
...
void func_2() // Hash - 0x7A1BEF27 ^0xB5682549
{
	int outValue;
...
void func_14() // Hash - 0x64388B73 ^0x64388B73
{
...
void func_28() // Hash - 0x8468D4B9 ^0x8468D4B9
{
...
BOOL func_47(Hash hParam0, int iParam1, var uParam2) // Hash - 0x9FD3CF97 ^0x79A65971
{
	*uParam2 = -99;
...
void func_84(int iParam0, int iParam1) // Hash - 0x35DF402F ^0x35DF402F
{
	switch (iParam0)
	{
		case 0:
...
void func_85(int iParam0) // Hash - 0x29CFF7DF ^0x220CF27F
{
	BOOL flag;
	int num;
	var unk;
...
void func_94(int iParam0) // Hash - 0x7C23DD1 ^0x2D6A671
{
	BOOL flag;
	int num;
	var unk;
...
void func_95(int iParam0) // Hash - 0x7D56211F ^0xD4A1BF64
{
	BOOL flag;
	int num;
	var unk;
...
void func_96(int iParam0) // Hash - 0x74C23E83 ^0x9C55255E
{
	BOOL flag;
	int num;
	var unk;
...
void func_97(int iParam0) // Hash - 0x8CA7E556 ^0x440AC92B
{
	BOOL flag;
	int num;
	var unk;
...
void func_98(int iParam0) // Hash - 0xC290E725 ^0xF36C3D90
{
	BOOL flag;
	int num;
	var unk;
...
void func_99(int iParam0) // Hash - 0x3F79E032 ^0x49EF0C2
{
	BOOL flag;
	int num;
	var unk;
...
void func_100(int iParam0) // Hash - 0x6310E1F8 ^0xE57367E2
{
	BOOL flag;
	int num;
	var unk;
...
void func_101(int iParam0) // Hash - 0xDDFE7744 ^0x71E981E6
{
	BOOL flag;
	int num;
	var unk;
...
void func_102(int iParam0) // Hash - 0x6FCAB90B ^0x3A4343F9
{
	BOOL flag;
	int num;
	var unk;
...
void func_103(int iParam0) // Hash - 0xEF2456FB ^0x3792C323
{
	BOOL flag;
	int num;
	var unk;
...
void func_104(int iParam0) // Hash - 0xFE20C6AF ^0x3A5DCB46
{
	BOOL flag;
	int num;
	var unk;
...
void func_106(int iParam0) // Hash - 0x7B542CFB ^0xA958C009
{
	BOOL flag;
	int num;
	var unk;
...
void func_107(int iParam0) // Hash - 0x7B542CFB ^0x4F5ADEC0
{
	BOOL flag;
	int num;
	var unk;
...
void func_108(int iParam0) // Hash - 0xC2F9B35A ^0xEB377C7F
{
	BOOL flag;
	int num;
	var unk;
...
void func_109(int iParam0) // Hash - 0x9031BDD2 ^0x75EA8856
{
	BOOL flag;
	int num;
	var unk;
...
void func_111(int iParam0) // Hash - 0xED47F78E ^0x66EE80F6
{
	BOOL flag;
	int num;
	var unk;
...
void func_112(int iParam0) // Hash - 0xEA001442 ^0x91B258B5
{
	BOOL flag;
	int num;
	var unk;
...
void func_113(int iParam0) // Hash - 0x9B4A43AE ^0xEC17F827
{
	BOOL flag;
	int num;
	var unk;
...
void func_114(int iParam0) // Hash - 0x1B785F17 ^0x6980365C
{
	BOOL flag;
	int num;
	var unk;
...
void func_115(int iParam0) // Hash - 0x2DC141BE ^0x4517F0E
{
	BOOL flag;
	int num;
	var unk;
...
void func_116(int iParam0) // Hash - 0xCB73BC76 ^0x418E129E
{
	BOOL flag;
	int num;
	var unk;
...
void func_117(int iParam0) // Hash - 0x276D0F8F ^0x5B194AEE
{
	BOOL flag;
	int num;
	var unk;
...
void func_118(int iParam0) // Hash - 0xBC918749 ^0x2B1D9817
{
	BOOL flag;
	int num;
	var unk;
...
void func_119(int iParam0) // Hash - 0xA9A084FB ^0xB7AC9383
{
	BOOL flag;
	int num;
	var unk;
...
void func_120(int iParam0) // Hash - 0x3F67047A ^0xA290EB65
{
	BOOL flag;
	int num;
	var unk;
...
void func_121(int iParam0) // Hash - 0xE2721790 ^0x9E267E84
{
	BOOL flag;
	int num;
	var unk;
...
void func_122(int iParam0) // Hash - 0xBC068BE9 ^0xB6E7352A
{
	BOOL flag;
	int num;
	var unk;
...
void func_124(int iParam0) // Hash - 0x6B1EB2DB ^0x902E068E
{
	BOOL flag;
	int num;
	var unk;
...
void func_125(int iParam0) // Hash - 0x6B1EB2DB ^0x5C33DFE0
{
	BOOL flag;
	int num;
	var unk;
...
void func_126(int iParam0) // Hash - 0x6B1EB2DB ^0xE0A8E5D3
{
	BOOL flag;
	int num;
	var unk;
...
void func_127(int iParam0) // Hash - 0xD1DB443F ^0xE1B32275
{
	BOOL flag;
	int num;
	var unk;
...
void func_128(int iParam0) // Hash - 0x5CD0A582 ^0xC70F74BD
{
	BOOL flag;
	int num;
	var unk;
...
void func_130(int iParam0) // Hash - 0x205D90A1 ^0x23C64617
{
	BOOL flag;
	int num;
	var unk;
...
void func_131(int iParam0) // Hash - 0xAEB08627 ^0xFC4453A0
{
	BOOL flag;
	int num;
	var unk;
...
void func_132(int iParam0) // Hash - 0x7AE9DF25 ^0xBD2C27AF
{
	BOOL flag;
	int num;
	var unk;
...
void func_133(int iParam0) // Hash - 0xE7109C4C ^0x2F0406BE
{
	BOOL flag;
	int num;
	var unk;
...
void func_134(int iParam0) // Hash - 0x8FDE2CF2 ^0x61601126
{
	BOOL flag;
	int num;
	var unk;
...
void func_135(int iParam0) // Hash - 0xBC3ED9F1 ^0x1B87462
{
	BOOL flag;
	int num;
	var unk;
...
void func_136(int iParam0) // Hash - 0x99ECB87E ^0x17A97F85
{
	BOOL flag;
	int num;
	var unk;
...
void func_137(int iParam0) // Hash - 0xA9F1B7B5 ^0x1435474
{
	BOOL flag;
	int num;
	var unk;
...
void func_138(int iParam0) // Hash - 0x2822745C ^0x9EF6F732
{
	BOOL flag;
	int num;
	var unk;
...
void func_139(int iParam0) // Hash - 0x37A3AF8F ^0x1C8FCD9B
{
	BOOL flag;
	int num;
	var unk;
...
void func_140(int iParam0) // Hash - 0xE4934E8C ^0xED6281FD
{
	BOOL flag;
	int num;
	var unk;
...
void func_141(int iParam0) // Hash - 0xC75B5564 ^0x788BEB8A
{
	BOOL flag;
	int num;
	var unk;
...
void func_143(int iParam0) // Hash - 0x95E71CFD ^0x7EF752D1
{
	BOOL flag;
	int num;
	var unk;
...
void func_144(int iParam0) // Hash - 0x8425A109 ^0x31E16924
{
	BOOL flag;
	int num;
	var unk;
...
void func_145(int iParam0) // Hash - 0x646F46FD ^0x25EBA540
{
	BOOL flag;
	int num;
	var unk;
...
void func_146(int iParam0) // Hash - 0xEEFCD249 ^0x36D30986
{
	BOOL flag;
	int num;
	var unk;
...
struct<2> func_156(int iParam0) // Hash - 0x861B9E2B ^0xB2384C3
{
	var unk;
	var unk3;
...
struct<2> func_157(int iParam0) // Hash - 0x4D5231E8 ^0xFECF32F6
{
	var unk;
...
void func_161(const char* sParam0, Any anParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Hash - 0x60AF66AB ^0xF6405622
{
...
void func_162(int iParam0, var uParam1) // Hash - 0x44D33F0D ^0x63FEA7A8
{
	switch (iParam0)
	{
		case 0:
...
void func_166() // Hash - 0xB5783D99 ^0xAB839B1
{
	if (Global_97993)
	{
		func_155();
...
char* func_167(int iParam0) // Hash - 0x179F0219 ^0x179F0219
{
	iParam0 = iParam0;
	return "";
}

void func_168() // Hash - 0x65F656DA ^0xD1513886
{
	var textLabel;
...
void func_174(int iParam0, BOOL bParam1) // Hash - 0x943B6D3D ^0x9869D19A
{
	var unk;
	int newsStory;
	BOOL flag;
...
void func_185(int iParam0, int iParam1) // Hash - 0xF488CE34 ^0x95C324D6
{
	switch (iParam0)
	{
		case 12:
...
int func_190(var uParam0, int iParam1) // Hash - 0xB888200C ^0x563B496D
{
	int i;
...
BOOL func_194(int iParam0) // Hash - 0x3F44A899 ^0x7041C53
{
	int num;
	int i;
...
void func_195(char* sParam0) // Hash - 0x4278F503 ^0x747E4957
{
...
char* func_196(int iParam0) // Hash - 0xE6862179 ^0x6861A6F6
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_197(int iParam0) // Hash - 0x156C351F ^0x156C351F
{
...
void func_198(int iParam0, int iParam1) // Hash - 0xEFDF2B54 ^0x1CE7BA3B
{
...
BOOL func_199(const char* sParam0) // Hash - 0xEC346BB4 ^0x735084E4
{
...
int func_200() // Hash - 0x613FC6AD ^0xDC7835B3
{
	return func_201(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_201(const char* sParam0, int iParam1) // Hash - 0x76A2E0AF ^0x8A5231BB
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL func_202(int iParam0, int iParam1) // Hash - 0x77E0C72A ^0x80DA2A54
{
...
int func_203(int iParam0, int iParam1, BOOL bParam2) // Hash - 0x28BA649B ^0xEC9C71B6
{
	int num;
	int i;
	int num2;
...
void func_204(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Hash - 0xCCE70A8D ^0x77ABAED7
{
	int num;
	int num2;
	int num3;
...
void func_205(int iParam0, int iParam1, int iParam2, const char* sParam3, const char* sParam4, const char* sParam5, const char* sParam6, const char* sParam7, const char* sParam8, const char* sParam9, const char* sParam10, const char* sParam11, const char* sParam12, const char* sParam13) // Hash - 0x959ECE1A ^0x68FFA9CB
{
	int num;
	BOOL flag;
	var txdName;
...
void func_206(int iParam0) // Hash - 0x73CDCFA8 ^0x73CDCFA8
{
...
char* func_207(int iParam0) // Hash - 0xA17D549C ^0xAD04ABEE
{
	switch (iParam0)
	{
		case 0:
...
const char* func_208(int iParam0, var uParam1) // Hash - 0x71D98912 ^0x53CBB5B1
{
	*uParam1 = 1;
...
int func_209() // Hash - 0x3C5423D7 ^0x3C5423D7
{
	func_155();
	return Global_113648.f_2365.f_539.f_4321;
}

struct<16> func_210(int iParam0) // Hash - 0x3B9894F8 ^0x6D02D2DD
{
	var unk;
	var unk17;
...
int func_211(int iParam0, BOOL bParam1) // Hash - 0x3EC54E77 ^0x658EE8EC
{
	int num;
	int i;
	BOOL flag;
...
int func_212(int iParam0) // Hash - 0x38AAB00E ^0x59EFC002
{
	int i;
	int num;
	int num2;
...
void func_213(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Hash - 0x4B794986 ^0x4B794986
{
	func_214(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
	return;
}

void func_214(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Hash - 0x8A7CAED6 ^0x5A76362
{
	int i;
...
void func_215() // Hash - 0xCF8881D1 ^0x40507183
{
	int i;
...
void func_216() // Hash - 0x9DC6AD9F ^0x7AE651B
{
...
void func_217(var uParam0, BOOL bParam1, BOOL bParam2) // Hash - 0x50B95D9E ^0x1806B4C4
{
	int i;
...
void func_218(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Hash - 0xD5DA5E14 ^0x5BD94F24
{
	Player playerIndex;
...
BOOL func_219(Ped pedParam0) // Hash - 0x7E48B415 ^0x126328AB
{
...
void func_220(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Hash - 0x787E640E ^0x67C15509
{
	if (bParam0)
	{
...
BOOL func_221() // Hash - 0xAA7793E3 ^0x3F62CDC8
{
	return IS_BIT_SET(Global_1853910[PLAYER::PLAYER_ID() /*862*/].f_36.f_18, 14);
}

BOOL func_222(Player plParam0, int iParam1) // Hash - 0x5A3B86CC ^0x2CFA58CE
{
	BOOL flag;
...
int func_223(int iParam0, BOOL bParam1) // Hash - 0x1DCD393E ^0x1DCD393E
{
	int num;
	int num2;
...
BOOL func_224(Player plParam0) // Hash - 0x68897CDD ^0x62820466
{
...
BOOL func_225() // Hash - 0xA525B2F4 ^0xA525B2F4
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_226(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Hash - 0x3167F4C7 ^0xCE6B9B6A
{
	int num;
...
BOOL func_227() // Hash - 0xD140D54A ^0xE638D98F
{
...
void func_228(int iParam0) // Hash - 0x1B2EEE72 ^0xEDBC1F9D
{
	if (iParam0 == 1)
...
void func_229() // Hash - 0xA0B53A29 ^0x6C0F8725
{
	if (func_247(uLocal_86.f_28[0]))
...
void func_230(Ped* ppedParam0) // Hash - 0xCA79453F ^0x7BA88177
{
...
BOOL func_231() // Hash - 0x8F7E9604 ^0xCBAAC82F
{
	if (func_247(PLAYER::PLAYER_PED_ID()))
	{
...
void func_232(float fParam0, float fParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, int iParam11, BOOL bParam12) // Hash - 0x394D5546 ^0xF43EBD07
{
	Player playerIndex;
...
Vector3 func_234(Player plParam0) // Hash - 0x6712BF53 ^0x688D5BEC
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(plParam0), false);
}

void func_235(BOOL bParam0) // Hash - 0xD10400C0 ^0xB6845444
{
	Player playerIndex;
...
void func_236(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, float fParam9, float fParam10, var uParam11, var uParam12, var uParam13, BOOL bParam14, BOOL bParam15, BOOL bParam16, BOOL bParam17, BOOL bParam18) // Hash - 0xC60077FB ^0xC60077FB
{
	func_237(fParam0, fParam3, fParam6, fParam7, fParam10, uParam11, bParam14, bParam15, bParam16, bParam17, bParam18);
	return;
}

void func_237(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5, float fParam6, Vector3 vParam7, var uParam8, var uParam9, float fParam10, float fParam11, var uParam12, var uParam13, BOOL bParam14, BOOL bParam15, BOOL bParam16, BOOL bParam17, BOOL bParam18) // Hash - 0xFD52326E ^0x1AB3EC4D
{
...
BOOL func_238(float fParam0, var uParam1, var uParam2) // Hash - 0x16E871AD ^0x10C54C39
{
...
BOOL func_239(Vehicle veParam0, int iParam1, BOOL bParam2) // Hash - 0xBCC62924 ^0x77695844
{
	int i;
	var garageName;
	int num;
...
BOOL func_240(int iParam0, int iParam1, char* sParam2, var uParam3) // Hash - 0x295E9118 ^0xA22D56B3
{
...
BOOL func_241(Vehicle veParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7) // Hash - 0x54559876 ^0xE4811CB1
{
	float num;
	var unk3;
	var unk6;
...
BOOL func_242(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, float fParam9, var uParam10, var uParam11) // Hash - 0x3823BB3 ^0xD0DFB98E
{
	float num;
	float num2;
	float num3;
...
void func_244(Vehicle veParam0) // Hash - 0xE71E0364 ^0xCB8720DC
{
...
void func_246() // Hash - 0x9F2F2451 ^0x9F2F2451
{
	int num;
...
BOOL func_247(Ped pedParam0) // Hash - 0x3D210083 ^0xF7E7C389
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_248(int iParam0, int iParam1, int iParam2) // Hash - 0x45E861F0 ^0xB70C2EC3
{
	int num;
...
BOOL func_249() // Hash - 0x7E48580B ^0x77F2F890
{
...
void func_250() // Hash - 0xC536DD5 ^0xC536DD5
{
	Global_20591 = 0;
	func_251();
	return;
...
void func_251() // Hash - 0xE32CF1EF ^0xB9A7BEB2
{
...
BOOL func_252() // Hash - 0x152DA0B2 ^0x220E93E9
{
...
void func_253() // Hash - 0x2A0AC5B7 ^0xAF27577A
{
...
BOOL func_254(Ped pedParam0, eScriptTaskHash esthParam1) // Hash - 0x5CB13EA9 ^0x50B73240
{
...
BOOL func_255(Vehicle veParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Hash - 0x60473011 ^0x5B80F12B
{
...
void func_256(Vehicle veParam0) // Hash - 0x94E8CB0B ^0x47923A23
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_257(char* sParam0, BOOL bParam1) // Hash - 0x67EBCD9D ^0x5C62CA92
{
	func_235(bParam1);
...
void func_258() // Hash - 0xB20E759E ^0x63E5C637
{
	func_276();
...
BOOL func_259(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Hash - 0x384540C1 ^0x384540C1
{
...
BOOL func_260(char* sParam0, int iParam1, BOOL bParam2) // Hash - 0x77297D51 ^0x40DC584A
{
	Global_21726 = 0;
...
void func_261() // Hash - 0xF42BEB19 ^0xA29557DA
{
	if (!func_262())
		return;
...
BOOL func_262() // Hash - 0x7B74B45F ^0xCE052A5D
{
...
BOOL func_263(Player plParam0) // Hash - 0x6E46BC72 ^0x6E46BC72
{
	return func_264(plParam0, 20);
}

BOOL func_264(Player plParam0, int iParam1) // Hash - 0x7CD5054C ^0x870BEA81
{
	return IS_BIT_SET(Global_1894573[plParam0 /*608*/].f_10.f_4, iParam1);
}

Player func_265() // Hash - 0x478900E4 ^0x478900E4
{
	return -1;
}

void func_266() // Hash - 0xAD4737C9 ^0x58483E67
{
	int i;
...
void func_267() // Hash - 0xCD8A4D28 ^0xCD8A4D28
{
...
BOOL func_268() // Hash - 0x9A999369 ^0x4033F7BF
{
	int num;
	int weaponHash;
...
void func_269() // Hash - 0x98476CE1 ^0x250FEB7C
{
	if (func_91(14))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
...
void func_270() // Hash - 0x2C570E2F ^0x6EFE88B0
{
	int i;
...
BOOL func_271(int iParam0, int iParam1) // Hash - 0xA14C4D3F ^0xA6034F77
{
	switch (iParam0)
	{
		case 5:
...
void func_272(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Hash - 0xC6B752B2 ^0xC6B752B2
{
...
void func_273(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Hash - 0x6C235EE0 ^0x9E57F206
{
...
BOOL func_274() // Hash - 0xF07E96DA ^0xE8D5CA6C
{
...
float func_275(Ped pedParam0, Entity eParam1, BOOL bParam2) // Hash - 0x7B2C17A2 ^0xDF922C6D
{
...
void func_276() // Hash - 0xE60F63BE ^0xE60F63BE
{
	func_278(0);
	func_253();
	func_277();
...
void func_277() // Hash - 0xC95798F1 ^0x61ADB9D7
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
...
void func_278(int iParam0) // Hash - 0x7E11E9C ^0x544BF257
{
	if (func_283())
		return;
...
void func_279(int iParam0) // Hash - 0x4066FEF5 ^0x9787FBDA
{
	if (func_283())
		return;
...
void func_280(BOOL bParam0, BOOL bParam1) // Hash - 0xF40FC178 ^0xA6F60F17
{
	if (bParam0)
	{
		if (func_282(0))
...
BOOL func_281() // Hash - 0x8DF3D75D ^0x8DF3D75D
{
	return IS_BIT_SET(Global_1962996, 5);
}

BOOL func_282(int iParam0) // Hash - 0xE8921B44 ^0x4F063755
{
	if (iParam0 == 1)
		if (Global_20383.f_1 > 3)
...
BOOL func_283() // Hash - 0xC41437CB ^0xC41437CB
{
	return IS_BIT_SET(Global_1962996, 19);
}

void func_284(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Hash - 0x91EBF9FE ^0x91EBF9FE
{
	float num;
	int value;
	int alpha;
...
float func_285(const char* sParam0) // Hash - 0x8E5AA519 ^0xD17CA0B4
{
	HUD::BEGIN_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(sParam0);
	return HUD::END_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(true);
}

struct<2> func_286(int iParam0, int iParam1, int iParam2) // Hash - 0xA932872C ^0xA932872C
{
	var unk;
	int num;
...
char* func_287(int iParam0) // Hash - 0xE6862179 ^0xB72681F1
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_288(int iParam0) // Hash - 0x4BD1BE9D ^0x1DFBB527
{
	var unk;
	var unk3;
...
struct<2> func_289(int iParam0) // Hash - 0x4BD1BE9D ^0xF78E7F3F
{
	var unk;
	var unk3;
...
struct<2> func_290(int iParam0) // Hash - 0x4BD1BE9D ^0xAF829E4F
{
	var unk;
	var unk3;
...
struct<2> func_291(int iParam0) // Hash - 0x4BD1BE9D ^0x37CEC7EE
{
	var unk;
	var unk3;
...
struct<2> func_292(int iParam0) // Hash - 0xF5844EDD ^0x429D0C24
{
	var unk;
	var unk3;
...
struct<2> func_293(int iParam0) // Hash - 0x4BD1BE9D ^0x67D4B6BC
{
	var unk;
	var unk3;
...
struct<2> func_294(int iParam0) // Hash - 0xD7A7FF9F ^0xAD495680
{
	var unk;
...
BOOL func_295(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Hash - 0xBDE8E122 ^0x400F0314
{
...
BOOL func_296(BOOL bParam0) // Hash - 0x1F743529 ^0xDFDFCA73
{
	if (bParam0)
...
BOOL func_297(int iParam0) // Hash - 0x3BAB94E9 ^0x3BAB94E9
{
	if (Global_43257 == 15)
		return false;
...
BOOL func_298(int iParam0) // Hash - 0xECB6C71B ^0xECB6C71B
{
	return func_299(iParam0, Global_43257);
}

BOOL func_299(int iParam0, int iParam1) // Hash - 0x1FD727E0 ^0x1FD727E0
{
	if (iParam1 == 15)
		return 1;
...
void func_300(int iParam0, int iParam1, BOOL bParam2) // Hash - 0x8A81DB2F ^0xDFC7B4EA
{
	int num;
...
void func_301() // Hash - 0x40B8273C ^0x7BE209F4
{
	var txdName;
	var subject;
...
struct<4> func_302(int iParam0) // Hash - 0x5D6A4A13 ^0x32291975
{
	return Global_2028[iParam0 /*29*/].f_3;
}

int func_303(int iParam0, int iParam1) // Hash - 0x97DCD8A1 ^0xF8178EDD
{
...
int func_304(int iParam0, int iParam1) // Hash - 0x97DCD8A1 ^0x5A8D70D2
{
	if (iParam1 < 0 || iParam1 > 4)
		return 0;
...
void func_305(int iParam0, int iParam1, int iParam2) // Hash - 0xAB9B6CC ^0x1B5EEB55
{
	if (iParam1 < 0 || iParam1 > 4)
		return;
...
void func_306(int iParam0, int iParam1, int iParam2) // Hash - 0xAB9B6CC ^0x80AE0F15
{
	if (iParam1 < 0 || iParam1 > 4)
		return;
...
BOOL func_307(var uParam0) // Hash - 0xCEE3AD20 ^0xD867CA8A
{
	int num;
	int i;
	BOOL flag;
...
BOOL func_308(Ped* ppedParam0, int iParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Hash - 0x5E27D69A ^0xE8A3C3CE
{
...
BOOL func_309(Ped* ppedParam0, int iParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Hash - 0xC57592AD ^0x9AA0BE7
{
	Hash model;
...
int func_310(var uParam0, int iParam1) // Hash - 0x5AC42C11 ^0x5AC42C11
{
	int num;
...
BOOL func_311(var uParam0) // Hash - 0xB319BDFA ^0xA1F4DAFB
{
	if (func_312(uParam0))
	{
...
BOOL func_312(var uParam0) // Hash - 0x6329B93C ^0xCBBB8D92
{
...
BOOL func_313(var uParam0) // Hash - 0xC42B20E0 ^0x728F1DAE
{
	int i;
...
void func_314(var uParam0, char* sParam1, char* sParam2, int iParam3) // Hash - 0x6EEDFC2 ^0xD51569DC
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
BOOL func_315() // Hash - 0x77F66043 ^0x77F66043
{
...
void func_316() // Hash - 0x607A454B ^0x8ED619E3
{
	func_246();
	func_330();
...
void func_317(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Hash - 0x5BE1D1E3 ^0x5BE1D1E3
{
...
void func_318(var uParam0, BOOL bParam1) // Hash - 0xEDC3BD2D ^0xE0B6F056
{
	func_319(&(uParam0->f_41), bParam1);
	return;
}

void func_319(var uParam0, BOOL bParam1) // Hash - 0x9E80EA71 ^0x9E80EA71
{
	int i;
...
void func_320(Object* pobParam0, BOOL bParam1) // Hash - 0xD7EE3E27 ^0xC5769B29
{
...
void func_321(Object* pobParam0) // Hash - 0x4EAFEE58 ^0x34D7ECA6
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_322(var uParam0, BOOL bParam1) // Hash - 0xEDC3BD2D ^0xE2474F74
{
	func_323(&(uParam0->f_35), bParam1);
	return;
}

void func_323(var uParam0, BOOL bParam1) // Hash - 0xA98F6284 ^0xA98F6284
{
	int i;
...
void func_324(Vehicle* pveParam0) // Hash - 0xC50F9886 ^0x638B6124
{
...
void func_325(Vehicle* pveParam0) // Hash - 0x8D18F713 ^0xF71A18A8
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_326(Vehicle veParam0) // Hash - 0x7E47BB06 ^0x692E6B64
{
...
void func_327(var uParam0, int iParam1) // Hash - 0xEDC3BD2D ^0xA9A19095
{
	func_328(&(uParam0->f_28), iParam1);
	return;
}

void func_328(var uParam0, int iParam1) // Hash - 0xB72ACFD2 ^0xB72ACFD2
{
	int i;
...
void func_329(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Hash - 0x34362197 ^0xC592197
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
BOOL func_330() // Hash - 0xBE5BC0C3 ^0x39FB8F89
{
	int num;
...
void func_331(BOOL bParam0) // Hash - 0x7B759B34 ^0x4EF237EA
{
	int num;
...
void func_332(const char* sParam0, int iParam1) // Hash - 0xF8D2A766 ^0x5740ACF1
{
	if (Global_100681 != 12)
...
BOOL func_333(const char* sParam0, int iParam1, int iParam2) // Hash - 0x71022A4D ^0x7DE21930
{
...
int func_334(char* sParam0) // Hash - 0x76B99CC6 ^0x7CBC6DD8
{
...
int func_335() // Hash - 0x2618AC69 ^0x91ED0F4F
{
	int num;
	int num2;
...
int func_336(char* sParam0, BOOL bParam1) // Hash - 0xB77E1B23 ^0xEB3CA535
{
	Hash hashKey;
	int num;
...
int func_337(Hash hParam0, BOOL bParam1) // Hash - 0x486E1959 ^0x3A81F66C
{
	int i;
...
BOOL func_338() // Hash - 0x4DEF90DC ^0x5BCA2C2E
{
...
BOOL func_339() // Hash - 0x5C8B3FB8 ^0x45F2ABEA
{
...
void func_340(BOOL bParam0) // Hash - 0x7936EEB2 ^0x2BE2E139
{
...
void func_341(int iParam0) // Hash - 0x3208FCBD ^0xBA877D65
{
	if (iParam0 == 1)
	{
		HUD::THEFEED_PAUSE();
...
void func_342(int iParam0) // Hash - 0xFA45F741 ^0xA5B13A23
{
	if (iParam0 == 1)
	{
...
void func_343() // Hash - 0x9A142650 ^0x4D0752C1
{
	Global_23131.f_5 = 1;
	return;
}

void func_344() // Hash - 0xC30A8265 ^0x139DE662
{
	Global_23131.f_5 = 0;
	return;
}

void func_345(BOOL bParam0) // Hash - 0x5FE88D2A ^0xA22C291D
{
	if (bParam0)
	{
		func_346();
...
void func_346() // Hash - 0xF8FE2348 ^0xA77911B2
{
...
void func_347() // Hash - 0xA68B3BE7 ^0xA68B3BE7
{
	Global_94857 = 0;
	Global_94858 = false;
	return;
...
BOOL func_348() // Hash - 0x25806CBF ^0x25806CBF
{
...
void func_349() // Hash - 0xA374022B ^0x41196847
{
	Global_100716 = 1;
...
void func_350(char* sParam0) // Hash - 0x54B64147 ^0x56EEAFB9
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_351(var uParam0) // Hash - 0x23409181 ^0x17F55207
{
...
void func_352(var uParam0) // Hash - 0x9B320D7B ^0x189EAC80
{
	int i;
...
Hash func_353(int iParam0) // Hash - 0xBF0B24A5 ^0xBF0B24A5
{
	if (!func_152(iParam0))
		return func_151(iParam0);
	else
