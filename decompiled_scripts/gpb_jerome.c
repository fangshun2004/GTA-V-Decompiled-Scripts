...
void func_57(int iParam0, char* sParam1, char* sParam2) // Hash - 0xA1B3AA65 ^0xACA98019
{
...
void func_66(char* sParam0) // Hash - 0x217F514E ^0xB3A90985
{
...
void func_73(char* sParam0) // Hash - 0x2E18739A ^0xB826C89C
{
...
char* func_74(int iParam0) // Hash - 0xE6862179 ^0x1F93241A
{
	switch (iParam0)
	{
		case 0:
...
void func_104() // Hash - 0xF1EF5589 ^0xCBD82737
{
	PED::SET_PED_PROP_INDEX(pedLocal_240, 1, 0, 0, false, 1);
	return;
}

void func_105() // Hash - 0x5D537092 ^0x28054812
{
...
int func_112(const char* sParam0) // Hash - 0xD5121E5F ^0x82A24E5E
{
