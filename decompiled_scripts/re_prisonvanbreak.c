		...
		if (BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() || iLocal_272)
		{
			...
			switch (iLocal_44)
			{
				...
				case 1:
					...
					if ((!iLocal_264 && !bLocal_282) && func_88())
					{
						...
						func_68(iLocal_234, &(uLocal_241[12]), 1, 0.7f);
						func_68(iLocal_234, &(uLocal_241[13]), 5, 0.7f);
						func_68(iLocal_234, &(uLocal_241[14]), 0, 0.7f);
						func_68(iLocal_234, &(uLocal_241[15]), 4, 0.7f);
					}
					if (!iLocal_262)
					{
						func_66();
...
void func_2()
{
	...
	if (!bLocal_258)
	{
		if ((ENTITY::IS_ENTITY_DEAD(iLocal_220, false) || PED::IS_PED_INJURED(iLocal_220)) || PED::IS_PED_HURT(iLocal_220))
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(joaat("prop_security_case_01")))
			{
				...
				{
					uLocal_299[0] = func_58(iLocal_290[0]);
				}
				bLocal_258 = true;
				func_60(&uLocal_52, 5);
			}
	...
	if (!bLocal_259)
	{
		if ((ENTITY::IS_ENTITY_DEAD(iLocal_221, false) || PED::IS_PED_INJURED(iLocal_221)) || PED::IS_PED_HURT(iLocal_221))
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(joaat("prop_security_case_01")))
			{
				...
				{
					uLocal_299[1] = func_58(iLocal_290[1]);
				}
				bLocal_259 = true;
				func_60(&uLocal_52, 6);
			}
				...
				if (ENTITY::IS_ENTITY_DEAD(iLocal_220, false) || PED::IS_PED_INJURED(iLocal_220))
				{
					if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_220, PLAYER::PLAYER_PED_ID(), true))
					{
						...
						if (!PED::IS_PED_INJURED(iLocal_221))
						{
							...
							func_60(&uLocal_52, 5);
							func_57(&uLocal_52, 5, iLocal_221, "RECSBRobber1", 0, 1);
	...
	else if (!iLocal_264 && !bLocal_47)
	{
		...
		if (((ENTITY::IS_ENTITY_DEAD(iLocal_220, false) && ENTITY::IS_ENTITY_DEAD(iLocal_221, false)) && STREAMING::HAS_MODEL_LOADED(joaat("ambulance"))) && STREAMING::HAS_ANIM_DICT_LOADED("random@countrysiderobbery"))
		{
			...
			{
				func_57(&uLocal_52, 4, iLocal_224[0], "RECSBCop1", 0, 1);
			...
			else if (!PED::IS_PED_INJURED(iLocal_224[1]))
			{
				...
				func_60(&uLocal_52, 4);
				func_57(&uLocal_52, 4, iLocal_224[1], "RECSBCop1", 0, 1);
				func_39(&uLocal_52, "recsbau", "recsb_ntouch", 4, 0, 0, 0);
			}
			else if (!PED::IS_PED_INJURED(iLocal_224[2]))
			{
				...
				func_60(&uLocal_52, 4);
				func_57(&uLocal_52, 4, iLocal_224[2], "RECSBCop1", 0, 1);
				func_39(&uLocal_52, "recsbau", "recsb_ntouch", 4, 0, 0, 0);
			}
			func_3();
			SYSTEM::WAIT(0);
...
void func_13()
{
	...
	{
		func_15(13, SYSTEM::FLOOR(Global_114904.f_10201.f_3853));
	}
...
void func_69(int iParam0)
{
	...
	{
		func_57(&uLocal_52, 4, iParam0, "RECSBCop1", 0, 1);
		...
		if (!PED::IS_PED_INJURED(iLocal_220))
		{
			if (!func_73() && WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 4))
			{
				if (PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_220) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_220))
				{
					...
					{
						iLocal_238++;
						if (!iLocal_239 && !func_71("recsb_theaim"))
						{
							func_3();
							SYSTEM::WAIT(0);
							if (!PED::IS_PED_INJURED(iLocal_220))
		...
		if (!PED::IS_PED_INJURED(iLocal_221))
		{
			if (!func_73() && WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 4))
			{
				if (PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_221) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_221))
				{
					...
					{
						if ((!iLocal_240 && !PED::IS_PED_INJURED(iLocal_220)) && !func_71("recsb_theaim"))
						{
							func_3();
							SYSTEM::WAIT(0);
							if (!PED::IS_PED_INJURED(iLocal_220))
...
int func_79()
{
	switch (func_80(&Global_33835, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
	...
	if ((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 220.6075f, 2615.145f, 35.8465f, 440.8339f, 2684.23f, 72.6324f, 183.125f, false, true, 0) && CAM::IS_SPHERE_VISIBLE(Local_217, 1f)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 325.6556f, 2647.021f, 43.6289f, 30f, 30f, 30f, false, true, 0))
	{
		...
		while (iVar0 < iLocal_224)
		{
			if (!PED::IS_PED_INJURED(iLocal_224[iVar0]))
			{
				...
				if (!HUD::DOES_BLIP_EXIST(iLocal_295[iVar0]))
				{
					iLocal_295[iVar0] = func_86(iLocal_224[iVar0], 0, 145);
		...
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_220, false) || (!PED::IS_PED_INJURED(iLocal_220) && !iLocal_275))
		{
			...
			iLocal_293 = func_86(iLocal_220, 0, 145);
		...
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_221, false) || (!PED::IS_PED_INJURED(iLocal_221) && !iLocal_276))
		{
			...
			iLocal_294 = func_86(iLocal_221, 0, 145);
...
void func_89()
{
	...
	if ((func_88() && !iLocal_262) && !iLocal_264)
	{
...
void func_90(var uParam0, char* sParam1)
{
	if (!PED::IS_PED_INJURED(*uParam0))
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), *uParam0, 4f, 4f, 4f, false, true, 0))
		{
			if (!bLocal_47)
			{
				func_57(&uLocal_52, 4, *uParam0, "RECSBCop1", 0, 1);
	...
	if (bLocal_48)
	{
		if (!iLocal_50)
		{
			...
			if (!PED::IS_PED_INJURED(iLocal_220))
			{
				...
				if (!HUD::DOES_BLIP_EXIST(iLocal_293))
				{
					iLocal_293 = func_86(iLocal_220, 1, 145);
			...
			if (!PED::IS_PED_INJURED(iLocal_221))
			{
				...
				if (!HUD::DOES_BLIP_EXIST(iLocal_294))
				{
					iLocal_294 = func_86(iLocal_221, 1, 145);
		...
		if (!iLocal_51)
		{
			...
			while (iVar0 < iLocal_224)
			{
				if (!PED::IS_PED_INJURED(iLocal_224[iVar0]))
				{
					...
					if (!HUD::DOES_BLIP_EXIST(iLocal_295[iVar0]))
					{
						iLocal_295[iVar0] = func_86(iLocal_224[iVar0], 1, 145);
					}
					TASK::TASK_COMBAT_PED(iLocal_224[iVar0], PLAYER::PLAYER_PED_ID(), 0, 16);
					PED::SET_PED_KEEP_TASK(iLocal_224[iVar0], true);
					PED::REGISTER_TARGET(iLocal_224[iVar0], PLAYER::PLAYER_PED_ID());
...
void func_92()
{
	...
	if ((((STREAMING::HAS_MODEL_LOADED(joaat("s_m_y_ranger_01")) && STREAMING::HAS_MODEL_LOADED(joaat("a_m_y_genstreet_01"))) && STREAMING::HAS_MODEL_LOADED(joaat("s_m_m_paramedic_01"))) && STREAMING::HAS_MODEL_LOADED(joaat("sheriff"))) && STREAMING::HAS_MODEL_LOADED(joaat("phoenix")))
	{
		...
		if (func_52() == 0)
		{
			func_57(&uLocal_52, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
		}
		else if (func_52() == 1)
		{
			func_57(&uLocal_52, 0, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
		}
		else if (func_52() == 2)
		{
			func_57(&uLocal_52, 0, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
		}
		func_57(&uLocal_52, 4, iLocal_224[0], "RECSBCop1", 0, 1);
		func_57(&uLocal_52, 5, iLocal_220, "RECSBRobber1", 0, 1);
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_130()) || Global_113951) || Global_33778) || func_129()) || func_54(8, -1)) || func_128()) || func_127()) || func_126()) || func_125()) || Global_114904.f_7695.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_130()) || Global_33778) || func_129()) || func_54(8, -1)) || func_126()) || func_128()) || func_127()) || func_125()) || Global_114904.f_7695.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_130()) || Global_113951) || Global_33778) || func_129()) || func_54(8, -1)) || func_126()) || func_128()) || func_127()) || func_125()) || Global_114904.f_7695.f_919[iVar0] == 5) || Global_45416 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_130()) || Global_113951) || Global_33778) || func_129()) || func_54(8, -1)) || func_128()) || func_127()) || func_125()) || Global_114904.f_7695.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_130() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_54(8, -1)) || func_125()) || func_124()) || Global_114904.f_7695.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_130()) || func_127()) || Global_113951) || Global_33778) || func_129()) || Global_46094) || func_54(8, -1)) || func_126()) || func_124()) || func_125()) || Global_114904.f_7695.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_150(int iParam0)
{
	...
	if (func_88())
	{
		...
		func_153(30000);
		StringCopy(&cVar0, func_152(Global_114893, 1), 64);
