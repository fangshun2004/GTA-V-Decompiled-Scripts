...
BOOL func_2() // Hash - 0x609BB0C3 ^0xF29F2340
{
	var unk;
...
int func_3(Object* pobParam0, int iParam1) // Hash - 0xFCC291F6 ^0xF4643650
{
	int num;
	var entityCoords;
...
BOOL func_4(int iParam0, char* sParam1, char* sParam2, char* sParam3, var uParam4, var uParam5) // Hash - 0xD2057549 ^0xD2057549
{
	*uParam4 = 9;
	*uParam5 = 0;
...
void func_5(int iParam0, char* sParam1, char* sParam2, char* sParam3) // Hash - 0x7BFAA2D1 ^0xA8915132
{
...
BOOL func_6(int iParam0, char* sParam1, char* sParam2, var uParam3) // Hash - 0x29D23042 ^0xB6CE9018
{
	*uParam3 = 0;
	TEXT_LABEL_ASSIGN_STRING(sParam2, "", 64);
...
void func_7(BOOL bParam0) // Hash - 0x5FE88D2A ^0xA22C291D
{
	if (bParam0)
	{
		func_14();
...
void func_8(int iParam0) // Hash - 0x4066FEF5 ^0x9787FBDA
{
	if (func_12())
		return;
...
BOOL func_9() // Hash - 0xD140D54A ^0xE638D98F
{
...
void func_10(BOOL bParam0, BOOL bParam1) // Hash - 0xF40FC178 ^0xA6F60F17
{
	if (bParam0)
	{
		if (func_13(0))
...
BOOL func_13(int iParam0) // Hash - 0xE8921B44 ^0x4F063755
{
	if (iParam0 == 1)
...
void func_14() // Hash - 0xF8FE2348 ^0xA77911B2
{
...
int func_15() // Hash - 0xA53026BE ^0x50EB77A5
{
...
BOOL func_16() // Hash - 0x3CA1BB47 ^0xB78A1ACB
{
...
void func_17(Ped pedParam0, Cam caParam1, int iParam2, int iParam3, int iParam4) // Hash - 0x227F617F ^0x4B2CEA0E
{
	int num;
	int num2;
	int num3;
...
void func_18(int iParam0, int iParam1, int iParam2, Ped pedParam3, int iParam4) // Hash - 0xCD188BC6 ^0xCD188BC6
{
	func_19(iParam0, iParam1, iParam2, pedParam3, 0, iParam4);
	return;
}

void func_19(int iParam0, int iParam1, int iParam2, Ped pedParam3, int iParam4, int iParam5) // Hash - 0x9F3D8BA2 ^0x9F3D8BA2
{
	int num;
...
int func_20() // Hash - 0x11506CC4 ^0x2E9F5641
{
	int i;
...
BOOL func_21(int iParam0, int iParam1, int iParam2) // Hash - 0x3A30B8C2 ^0x3A30B8C2
{
...
int func_22(int iParam0, int iParam1, int iParam2) // Hash - 0x61F8C119 ^0x1C9B84EC
{
	int i;
...
char* func_23(int iParam0) // Hash - 0x958AD60F ^0x1279DB70
{
	switch (iParam0)
	{
		case 0:
...
void func_24(Ped pedParam0, int iParam1) // Hash - 0x7F8FABC2 ^0x752ACE0C
{
	int num;
	int num2;
...
void func_25(int iParam0, int iParam1, int iParam2, int iParam3) // Hash - 0xB4857222 ^0xB4857222
{
	func_19(iParam0, iParam1, iParam2, 0, iParam3, 1);
	return;
}

int func_26(Ped pedParam0) // Hash - 0x14AF2EDD ^0xC5BC7CD2
{
	int i;
...
int func_27(int iParam0) // Hash - 0x671ED513 ^0x671ED513
{
	int i;
...
int func_28(Ped pedParam0) // Hash - 0x219FA119 ^0x5240A8AF
{
	int i;
...
void func_29(int iParam0, int iParam1, float fParam2, float fParam3, Cam caParam4, BOOL bParam5) // Hash - 0xE2E72367 ^0x8F691389
{
	int gameTimer;
...
float func_30() // Hash - 0x9866E92D ^0x4C32084D
{
	float num;
	int value;
	int value2;
...
int func_31(Ped pedParam0) // Hash - 0xA8AAC40F ^0x96AA47F
{
	int num;
	int num2;
...
int func_32(Ped pedParam0, int iParam1, BOOL bParam2) // Hash - 0x1ECD241B ^0x2C71A0AB
{
	int num;
	int num2;
	int num3;
...
int func_33() // Hash - 0x412B82DF ^0x412B82DF
{
	int i;
...
BOOL func_34(Ped pedParam0) // Hash - 0xD8C74549 ^0xD8C74549
{
	if (pedParam0 == 0)
		return false;
...
int func_36(Ped pedParam0) // Hash - 0xA8AAC40F ^0x96AA47F
{
	int num;
	int num2;
...
BOOL func_37() // Hash - 0xF6AB6D04 ^0x35634F3E
{
	if (!hLocal_73 == 0)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(obLocal_72))
...
BOOL func_38() // Hash - 0x9BF6DAA2 ^0xB6FD0BD5
{
...
int func_39(int iParam0, Entity eParam1) // Hash - 0xD1960A5B ^0x3A103378
{
...
Entity func_40(var uParam0) // Hash - 0xC9D82232 ^0xC9D82232
{
	return uParam0;
}

BOOL func_41(int iParam0, int iParam1) // Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

int func_42() // Hash - 0x35BC7314 ^0x35BC7314
{
	func_43();
...
void func_43() // Hash - 0xD1F2D853 ^0xF9F5FD4D
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_46(Global_113648.f_2365.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_44(num) && !func_48(14) || Global_112599)
			{
...
void func_49() // Hash - 0xCB830ADA ^0x4F0A1B48
{
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
...
void func_50() // Hash - 0x70035002 ^0x70035002
{
	func_51(Global_100404 - 1);
	return;
}

void func_51(int iParam0) // Hash - 0xE49C42EC ^0xE49C42EC
{
	Global_100404 = iParam0;
	return;
}

void func_52() // Hash - 0x850DE8C4 ^0x850DE8C4
{
	func_51(0);
	return;
}

void func_53() // Hash - 0x748208DC ^0x115C66E6
{
	int num;
	BOOL flag;
...
void func_54() // Hash - 0x95853B25 ^0x1F12229D
{
	var unk;
	int num;
	var unk117;
...
void func_56(var uParam0, int iParam1, int iParam2, int iParam3, float fParam4, float fParam5, float fParam6, float fParam7) // Hash - 0xB67DDD9F ^0xE0258F09
{
...
void func_57(var uParam0) // Hash - 0x9000D55C ^0x3177311F
{
	func_56(uParam0, 145, joaat("SCRIPT_TASK_ANY"), joaat("SCRIPT_TASK_ANY"), 0f, 0f, 0f, 0f);
	return;
}

int func_58(int iParam0, var uParam1, var uParam2, char* sParam3) // Hash - 0x36DCAE2A ^0x59910E2E
{
	int num;
...
BOOL func_59(var uParam0) // Hash - 0xF5357FFC ^0xF5357FFC
{
	int num;
	Vector3 entityCoords;
	float num2;
...
BOOL func_60(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Hash - 0x2D46096D ^0xEA41378F
{
	if (bParam6)
...
BOOL func_61(int iParam0, var uParam1, char* sParam2) // Hash - 0xFBF08092 ^0x3A719A9A
{
	var unk;
	int num;
	var unk4;
...
BOOL func_62(int iParam0, int iParam1, var uParam2, var uParam3) // Hash - 0x416CB035 ^0x416CB035
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_63() // Hash - 0x6E373505 ^0x528400E3
{
...
BOOL func_64(int iParam0, var uParam1, var uParam2) // Hash - 0x6BF2FA05 ^0x6BF2FA05
{
	switch (iParam0)
	{
		case 11:
...
char* func_65(int iParam0) // Hash - 0xE6862179 ^0xBA9483E8
{
	switch (iParam0)
	{
...
void func_66() // Hash - 0x9788667F ^0x68EEE6D
{
	if (ENTITY::DOES_ENTITY_EXIST(obLocal_72))
		if (iLocal_82 != -1)
			func_3(&obLocal_72, iLocal_82);
