...
int func_39(int iParam0, Entity eParam1) // Position - 0x2EDC Hash - 0xD1960A5B ^0x3A103378
{
...
Entity func_40(var uParam0) // Position - 0x2FC0 Hash - 0xC9D82232 ^0xC9D82232
{
	return uParam0;
}
...
BOOL func_44(int iParam0) // Position - 0x311C Hash - 0x8907F004 ^0x8907F004
{
	return iParam0 < 3;
}

int func_45(Ped pedParam0) // Position - 0x3128 Hash - 0xAC4E9801 ^0xB379A75F
{
	int i;
	Hash entityModel;
...
Hash func_46(int iParam0) // Position - 0x3165 Hash - 0xADCB9755 ^0xADCB9755
{
	if (func_44(iParam0))
...
Hash func_47(int iParam0) // Position - 0x318A Hash - 0xE4CEEC2C ^0xE4CEEC2C
{
...
void func_49() // Position - 0x31A7 Hash - 0xCB830ADA ^0x200C2612
{
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
...
BOOL func_63() // Position - 0xB208 Hash - 0x6E373505 ^0x528400E3
{
...
char* func_65(int iParam0) // Position - 0xBB95 Hash - 0xE6862179 ^0xBA9483E8
{
	switch (iParam0)
	{
		case 2014101067:
