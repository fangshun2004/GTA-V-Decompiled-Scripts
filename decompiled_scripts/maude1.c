...
void __EntryFunction__()
{
	...
	sLocal_176 = "Trevor";
	sLocal_177 = "Maude";
	sLocal_178 = "maude_chair";
	sLocal_179 = "maude_laptop";
	Local_98 = { ScriptParam_0 };
	func_526(&Local_98);
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Local_98.f_59))
	{
		PED::TAKE_OWNERSHIP_OF_SYNCHRONIZED_SCENE(Local_98.f_59);
		iLocal_164 = Local_98.f_59;
	}
	...
	switch (iLocal_160)
	{
		case 0:
			...
			if (iLocal_161 == 1)
			{
				...
				if (func_17(iLocal_175))
				{
					func_16(&uLocal_180, 3);
					func_15(iLocal_175, 0);
					if (!AUDIO::IS_AMBIENT_SPEECH_PLAYING(iLocal_175))
					{
						if (func_14(iLocal_175, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 35f, 1))
						{
							AUDIO::STOP_PED_SPEAKING(iLocal_175, false);
							func_12(iLocal_175, "GENERIC_FRIGHTENED_HIGH", "MAUDE", 3, 0);
						}
					}
				}
				if (func_10())
		...
		case 1:
			...
			else if (iLocal_161 == 1)
			{
				if (func_17(iLocal_175))
				{
					...
					else if (func_17(iLocal_175))
					{
						if (!func_2(iLocal_175, joaat("script_task_smart_flee_ped")))
						{
							if (!PED::IS_PED_FLEEING(iLocal_175))
							{
								if (!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_175, "special_ped@maude@exit_flee", "female_Flee_Table_Left_Maude", 3))
								{
									PED::SET_PED_FLEE_ATTRIBUTES(iLocal_175, 2, false);
									PED::SET_PED_FLEE_ATTRIBUTES(iLocal_175, 64, false);
									PED::SET_PED_FLEE_ATTRIBUTES(iLocal_175, 128, false);
									PED::SET_PED_FLEE_ATTRIBUTES(iLocal_175, 8, false);
									PED::SET_PED_FLEE_ATTRIBUTES(iLocal_175, 1, false);
									PED::SET_PED_FLEE_ATTRIBUTES(iLocal_175, 32, false);
									PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_175, 5, false);
									PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_175, 17, true);
									TASK::TASK_SMART_FLEE_PED(iLocal_175, PLAYER::PLAYER_PED_ID(), 50f, -1, false, false);
...
int func_10()
{
	...
	if (func_17(iLocal_175))
	{
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_175, "special_ped@maude@base", "base", 3))
		{
			if (!PED::IS_PED_RAGDOLL(iLocal_175) || TASK::IS_PED_GETTING_UP(iLocal_175))
			{
				STREAMING::REQUEST_ANIM_DICT("special_ped@maude@exit_flee");
				if (STREAMING::HAS_ANIM_DICT_LOADED("special_ped@maude@exit_flee"))
				{
					iLocal_167 = PED::CREATE_SYNCHRONIZED_SCENE(2727.4f, 4145.56f, 43.68f, 0f, 0f, -92.17f, 2);
					PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_167, false);
					PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(iLocal_167, false);
					if (func_2(iLocal_175, joaat("script_task_synchronized_scene")))
					{
						ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_175, -1000f, true);
					}
					TASK::TASK_SYNCHRONIZED_SCENE(iLocal_175, iLocal_167, "special_ped@maude@exit_flee", "female_Flee_Table_Left_Maude", 1000f, -4f, 4626, 0, 1000f, 0);
					PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_175, false, false);
					if (func_11(iLocal_171))
					{
						if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_171, "special_ped@maude@base", "base_chair", 3))
						{
							ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_171, -16f, false);
						}
						iVar0 = 0;
						iVar0 += 16;
						iVar0 += 64;
						iVar0 += 512;
						iVar0 += 4096;
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_171, iLocal_167, "Female_Flee_Table_Left_Maude_Chair", "special_ped@maude@exit_flee", 16f, -4f, iVar0, 1000f);
					}
					return 1;
				}
			}
	...
	switch (iLocal_160)
	{
		case 0:
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_173))
			{
				...
				{
					iLocal_173 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(2727.4f, 4145.56f, 43.68f, 10f, joaat("prop_table_03b"), true, false, true);
					if (func_11(iLocal_173))
					{
						ENTITY::SET_ENTITY_COORDS(iLocal_173, 2727.4f, 4145.56f, 43.68f, true, false, false, true);
						ENTITY::SET_ENTITY_HEADING(iLocal_173, -92.17f);
			...
			if (func_17(iLocal_175))
			{
				if (!PED::IS_PED_HEADTRACKING_PED(iLocal_175, PLAYER::PLAYER_PED_ID()))
				{
		...
		case 1:
			...
			if (func_17(iLocal_175))
			{
				Var0 = { ENTITY::GET_ENTITY_COORDS(iLocal_175, false) };
				if (!func_247(0))
				{
					if (SYSTEM::VDIST2(Var0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false)) > 14400f)
					{
						if (!CAM::IS_SPHERE_VISIBLE(Var0, 2.5f) || ENTITY::IS_ENTITY_OCCLUDED(iLocal_175))
						{
							iLocal_160 = 2;
						}
					}
...
void func_29(int iParam0, bool bParam1)
{
	...
	{
		func_201(&(Global_114050[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
...
void func_33()
{
	...
	{
		func_35(13, SYSTEM::FLOOR(Global_114963.f_10203.f_3853));
	}
...
int func_58(int iParam0, int iParam1, int iParam2)
{
	...
	Global_80120[1 /*14*/] = { func_111(iVar0, iParam1, iParam2, -1) };
	...
	else
	{
		...
		Global_80120[1 /*14*/] = { func_111(iVar0, iParam1, uVar31[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_103(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_103(iParam1), Global_80120[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_103(iParam1), Global_80120[1 /*14*/].f_3, Global_80120[1 /*14*/].f_4, 0);
		}
	}
...
int func_59(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_176(iParam0, Global_114963.f_2370.f_539[iVar0 /*65*/].f_64, Global_114963.f_2370.f_539[iVar0 /*65*/].f_63))
		{
...
int func_61(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_80120[1 /*14*/] = { func_111(iVar10, iParam1, iParam2, -1) };
		if (!func_101(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_80120[1 /*14*/] = { func_111(iVar10, iVar0, uVar11[iVar0], -1) };
				if (BitTest(Global_80120[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_80120[1 /*14*/] = { func_111(iVar10, 14, uVar28[iVar1], -1) };
							func_77(iParam0, Global_80120[1 /*14*/].f_12, Global_80120[1 /*14*/].f_3, Global_80120[1 /*14*/].f_4);
							func_93(14);
							if (Global_80118 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_103(iVar0), Global_80120[1 /*14*/].f_3, Global_80120[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_103(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_103(iVar0), Global_80120[1 /*14*/].f_3, Global_80120[1 /*14*/].f_4, iParam4);
						}
						func_93(iVar0);
						if (Global_80118 == 1)
						{
			...
			{
				Global_80120[1 /*14*/] = { func_111(iVar10, iVar0, func_67(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_80120[1 /*14*/] = { func_111(iVar10, 14, uVar69[iVar1], -1) };
			func_77(iParam0, Global_80120[1 /*14*/].f_12, Global_80120[1 /*14*/].f_3, Global_80120[1 /*14*/].f_4);
			func_93(14);
			if (Global_80118 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_103(iParam1), Global_80120[1 /*14*/].f_3, Global_80120[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_103(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_103(iParam1), Global_80120[1 /*14*/].f_3, Global_80120[1 /*14*/].f_4, iParam4);
		}
		if (Global_80118 == 1)
		{
			iVar2 = 0;
...
{
	Global_80120[1 /*14*/] = { func_111(iParam0, iParam1, iParam2, -1) };
...
void func_93(int iParam0)
{
	...
	{
		func_100(iParam0, Global_80120[1 /*14*/].f_5, Global_80120[1 /*14*/].f_2, 2, Global_80120[1 /*14*/].f_1, 1, 0);
	}
	if (BitTest(Global_80120[1 /*14*/].f_6, 1) && BitTest(Global_80120[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
int func_102(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_176(iParam0, Global_114963.f_2370.f_539[iVar0 /*65*/].f_61, Global_114963.f_2370.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_110(&Var1, -99, -99, Global_114963.f_2370.f_539.f_196[0], Global_114963.f_2370.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_110(&Var1, -99, -99, Global_114963.f_2370.f_539.f_196[1], Global_114963.f_2370.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_110(&Var1, -99, -99, Global_114963.f_2370.f_539.f_196[2], Global_114963.f_2370.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_113(int iParam0)
{
	...
	func_114(&(Global_80120[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_98(func_117(iParam1, uParam0->f_2), Global_80117);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), true);
			}
			uVar0 = func_98(func_116(iParam1, uParam0->f_2), Global_80117);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_98(iVar1, Global_80117);
				if (!BitTest(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_121(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				func_114(&(Global_80120[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_114(&(Global_80120[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_114(&(Global_80120[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("outfit_only"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_80318)
		{
			...
			func_114(&(Global_80120[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("outfit_only"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
int func_176(int iParam0, int iParam1, int iParam2)
{
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_176(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_176(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_80120[2 /*14*/] = { func_111(iVar0, 14, iVar4, -1) };
									if (Global_80120[2 /*14*/].f_12 == iVar3)
									{
										if (func_176(iParam0, 14, iVar4))
										{
											if (!func_65(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_80120[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_80120[2 /*14*/] = { func_111(iVar0, iVar2, iVar1, -1) };
						if (!func_65(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_80120[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_80120[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_103(iParam1)) && Global_80120[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_103(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_183()
{
	...
	{
		if (func_178(Global_114963.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_177(PLAYER::PLAYER_PED_ID());
			if (func_180(iVar0) && (!func_119(14) || Global_113909))
			{
...
void func_188(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_189(&sVar32, Var0.f_3, Global_102523, bParam1, bParam2);
	}
}
...
void func_194()
{
	...
	{
		func_183();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_195(Global_114963.f_2370.f_539.f_4321));
	}
	else
	{
...
{
	func_206(iParam0, 1);
	Global_114963.f_18583[iParam0 /*6*/].f_3 = func_205();
		...
		if (bParam2)
		{
			if (!Global_80337)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_10178[iParam1 /*4*/] = { func_232(iParam0) };
					...
					{
						Global_10129[1 /*6*/] = { func_232(iParam0) };
...
{
	if (iLocal_170 < iLocal_168)
	{
		if (!func_20())
		{
			if (SYSTEM::VDIST2(Param3, Param0) < (fParam7 * fParam7))
			{
				if (MISC::GET_GAME_TIMER() - iLocal_169) > (iParam6 + MISC::GET_RANDOM_INT_IN_RANGE(0, 2000))
				{
					func_246(&uLocal_180, 3, iLocal_175, "MAUDE", 0, 1);
					func_244(&uLocal_180, "MAUDEAU", "MAUDE_loiter", 7, 0, 0);
					iLocal_169 = MISC::GET_GAME_TIMER();
					iLocal_170++;
					return 1;
				}
...
int func_247(bool bParam0)
{
	if (func_17(iLocal_175))
	{
		if ((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(iLocal_175) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(iLocal_175)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_OBJECT(iLocal_175))
		{
			return 1;
		}
		if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_171))
				{
					return 1;
				}
			}
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_173))
			{
				if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_173))
				{
					return 1;
				}
			}
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_172))
			{
				if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_172))
				{
					return 1;
				}
			}
		}
		if (PED::HAS_PED_RECEIVED_EVENT(iLocal_175, 61))
		{
			return 1;
		}
		if (PED::IS_PED_RAGDOLL(iLocal_175))
		{
			if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_175, PLAYER::PLAYER_PED_ID(), 3f, 3f, 3f, false, true, 0))
			{
				return 1;
			}
		}
		if (PED::HAS_PED_RECEIVED_EVENT(iLocal_175, 51))
		{
			return 1;
		}
		if (func_255(iLocal_175, 1126825984))
		{
			return 1;
		}
		if (func_248(iLocal_175, 1, 0, 0, 0))
		{
			return 1;
		}
		if (FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(iLocal_175, true), 15f))
		{
			return 1;
		}
		if (PED::HAS_PED_RECEIVED_EVENT(iLocal_175, 73))
		{
			return 1;
		}
		if (bParam0)
...
bool func_257(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_258(&(Local_54[iVar4 /*4*/]), Var1, iParam1, &(Local_54[iVar4 /*4*/].f_3), iParam0, iParam5);
...
void func_266()
{
	...
	switch (iLocal_160)
	{
		case 0:
			...
			if (func_11(iLocal_175))
			{
				if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
				{
					CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED(sLocal_177, iLocal_175, 0);
				}
			}
			func_358();
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
				if (func_355())
				{
					...
					{
						func_348(&Local_98, 0, 1);
						func_347(&iLocal_175, &(Local_98.f_28[0]));
						func_346(&iLocal_171, &(Local_98.f_41[0]));
						func_346(&iLocal_172, &(Local_98.f_41[1]));
						func_345();
						CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(PLAYER::PLAYER_PED_ID(), sLocal_176, 0, 0, 0);
						if (func_11(iLocal_175))
						{
							CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_175, sLocal_177, 0, 0, 0);
						}
						if (func_11(iLocal_171))
						{
							CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_171, sLocal_178, 0, 0, 0);
						}
						if (func_11(iLocal_172))
						{
							CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_172, sLocal_179, 0, 0, 0);
						}
		...
		case 1:
			if (func_11(iLocal_171))
			{
				if (func_17(iLocal_175))
				{
					if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_177, 0) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_178, 0))
					{
						if (STREAMING::HAS_ANIM_DICT_LOADED("special_ped@maude@base"))
						{
							iLocal_164 = PED::CREATE_SYNCHRONIZED_SCENE(2727.4f, 4145.56f, 43.68f, 0f, 0f, -92.17f, 2);
							PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_164, true);
							PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(iLocal_164, false);
							TASK::TASK_SYNCHRONIZED_SCENE(iLocal_175, iLocal_164, "special_ped@maude@base", "base", 1000f, -8f, 4688, 0, 1000f, 0);
							iVar0 = 0;
							iVar0 = 16;
							iVar0 = 64;
							iVar0 = 512;
							iVar0 = 4096;
							ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_171, iLocal_164, "base_chair", "special_ped@maude@base", 1000f, -8f, iVar0, 1000f);
							PED::SET_PED_KEEP_TASK(iLocal_175, true);
						}
					}
				}
			}
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_176, 0))
			{
...
void func_267()
{
	...
	if (!func_11(iVar0))
	{
		iVar0 = VEHICLE::GET_RANDOM_VEHICLE_IN_SPHERE(Local_346, 10f, 0, 16390);
		if (!func_11(iVar0))
		{
			return;
		}
...
void func_280(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (iParam0)
	{
		case 31:
			if (bParam1)
			{
				iLocal_97 = PED::ADD_SCENARIO_BLOCKING_AREA(Var0, Var3, false, true, true, true, 1);
...
void func_281()
{
	...
	if (func_337(Var6, 0))
	{
		...
		Local_346 = { 2719.87f, 4143.46f, 43.46f };
	}
	else
	{
		...
		Local_346 = { 2710.665f, 4149.075f, 42.7026f };
	}
}
...
void func_282(struct<3> Param0, float fParam3, int iParam4, int iParam5)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_105520.f_4))
	{
		...
		{
			if (func_330(24) != Global_105520.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_327(ENTITY::GET_ENTITY_COORDS(Global_105520.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_283(Global_105520.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}
...
void func_284(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_314(&(Global_79127.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, false))
		{
			...
			if (iParam0 == 24)
			{
				Global_114963.f_32759.f_4801 = func_303();
			}
...
void func_285(int iParam0, int iParam1)
{
	...
	func_322(iParam0, &(Global_114963.f_32759.f_5510));
}
...
int func_314(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_321(Global_114963.f_32759.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_321(Global_114963.f_2370.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_321(Global_114963.f_2370.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_317(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)
{
	if (func_314(&(Global_79127.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_319(iParam0);
			func_318(uParam1, &(Global_114963.f_32759.f_69[Global_79127.f_555[0 /*21*/].f_14 /*78*/]));
...
{
	return func_338(Global_105520.f_2890.f_12.f_66, Param0, iParam3);
}
...
void func_345()
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_174))
	{
		...
		if (func_14(PLAYER::PLAYER_PED_ID(), Var0, 150f, 1))
		{
			...
			{
				iLocal_174 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(Var0, 10f, iVar3, true, false, true);
			}
		}
	}
}
...
int func_355()
{
	if ((func_489() || func_31(0)) || func_357())
	{
		return 1;
	}
	if (iLocal_165 == 0)
	{
		if (func_11(Local_98.f_28[0]))
		{
			if (!func_356(PLAYER::PLAYER_PED_ID(), Local_98.f_28[0], 7f, 1))
			{
				CAM::SET_GAMEPLAY_ENTITY_HINT(Local_98.f_28[0], 0f, 0f, 0f, true, -1, 2000, 2000, 0);
				...
				if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
				{
					TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(PLAYER::PLAYER_PED_ID(), Local_98.f_28[0], 0f, 1.2f, 0f, 1f, -1, 0.1f, true);
				}
			...
			else
			{
				if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
				{
					TASK::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), Local_98.f_28[0], 0);
				}
				iLocal_166 = -1;
			}
			TASK::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_98.f_28[0], 4000, 0, 2);
		}
		iLocal_165++;
	}
	else if (iLocal_165 == 1)
	{
		if ((iLocal_166 == -1 || (MISC::GET_GAME_TIMER() - iLocal_166) > 3000) || (func_11(Local_98.f_28[0]) && func_356(PLAYER::PLAYER_PED_ID(), Local_98.f_28[0], 4.5f, 1)))
		{
			return 1;
		}
	}
...
void func_367()
{
	if (Global_96638)
	{
		func_381(&iLocal_345, 2662.644f, 4284.535f, 43.5787f, 19.8376f, 0, 0, 1, 0, 0, joaat("asterope"), 0, 145, 1);
	...
	else
	{
		...
		{
			func_381(&iLocal_345, 2704.078f, 4152.24f, 42.2514f, 175.193f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145, 1);
		}
...
void func_381(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iVar0 == 1)
	{
		if (!func_485(iParam6, iParam7, iParam8, iParam13))
		{
			iVar0 = 0;
		}
	}
		...
		if (Global_114963.f_2370.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var5.f_0)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_114963.f_2370.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_114963.f_2370.f_539.f_2407[0 /*295*/][iParam1 /*98*/], Param2, fParam5, false, false, false);
				...
				func_443(iParam0, &(Global_114963.f_2370.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_114963.f_2370.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_114963.f_2370.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var5.f_0)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_114963.f_2370.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_114963.f_2370.f_539.f_2407[1 /*295*/][iParam1 /*98*/], Param2, fParam5, false, false, false);
				...
				func_443(iParam0, &(Global_114963.f_2370.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_114963.f_2370.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("bodhi2"))
...
void func_383(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_180(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, false))
	{
		...
		{
			func_324(iParam1, &(Global_114963.f_2370.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_114963.f_2370.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_114963.f_20127[iParam0 /*43*/].f_31 = func_386(*iParam1);
				...
				func_384(Global_114963.f_2370.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_114963.f_2370.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_114963.f_20127[iParam0 /*43*/].f_1));
				...
				func_384(Global_114963.f_2370.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_114963.f_20127[iParam0 /*43*/].f_2));
			}
		}
	}
}
...
int func_387(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	if (func_434(1))
	{
		if (func_433(iParam0, 1) && VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("speedo")))
		{
			return 1;
		}
	}
	if ((!func_431(iVar0, bParam1, uParam2) && !func_430(PLAYER::PLAYER_ID())) && !func_402(iParam0))
	{
		return 0;
	}
...
int func_388(int iParam0)
{
	if (iParam0 != func_391())
	{
		if (func_390(iParam0, 1, 1))
		{
			...
			{
				return func_389(Global_2658293[iParam0 /*468*/].f_325.f_8) == 30;
			}
		}
	}
	return 0;
...
int func_393(int iParam0)
{
	if (iParam0 != func_391())
	{
		if (func_390(iParam0, 1, 1))
		{
			if (Global_2658293[iParam0 /*468*/].f_325.f_8 != -1)
			{
				return func_389(Global_2658293[iParam0 /*468*/].f_325.f_8) == 11;
			}
		}
	}
	return 0;
...
int func_396(int iParam0)
{
	if (iParam0 != func_391())
	{
		if (func_390(iParam0, 1, 1))
		{
			if (Global_2658293[iParam0 /*468*/].f_325.f_8 != -1)
			{
				return func_389(Global_2658293[iParam0 /*468*/].f_325.f_8) == 26;
			}
		}
	}
	return 0;
...
int func_397(int iParam0)
{
	if (iParam0 != func_391())
	{
		if (func_390(iParam0, 1, 1))
		{
			if (Global_2658293[iParam0 /*468*/].f_325.f_8 != -1)
			{
				return func_389(Global_2658293[iParam0 /*468*/].f_325.f_8) == 13;
			}
		}
	}
	return 0;
...
int func_398(int iParam0)
{
	if (iParam0 != func_391())
	{
		if (func_390(iParam0, 1, 1))
		{
			if (Global_2658293[iParam0 /*468*/].f_325.f_8 != -1)
			{
				return func_389(Global_2658293[iParam0 /*468*/].f_325.f_8) == 7;
			}
		}
	}
	return 0;
...
{
	if (func_429(PLAYER::PLAYER_ID()) || func_428(PLAYER::PLAYER_ID()))
	{
		if (func_403(iParam0))
		{
			return 1;
...
int func_406(int iParam0)
{
	...
	if (func_430(iParam0) && Global_2658293[iParam0 /*468*/].f_325.f_11 == iParam0)
	{
		return 1;
	}
	return 0;
...
int func_420(int iParam0)
{
	...
	{
		if (func_426() || func_425(PLAYER::PLAYER_ID()))
		{
			return 0;
		}
		if (((func_424(PLAYER::PLAYER_ID(), 1, 0) && Global_1845298[PLAYER::PLAYER_ID() /*881*/].f_260.f_39 > 0) || BitTest(Global_1845298[PLAYER::PLAYER_ID() /*881*/].f_260.f_37, 14)) || BitTest(Global_1845298[PLAYER::PLAYER_ID() /*881*/].f_260.f_37, 11))
		{
			return 0;
		}
		if (DECORATOR::DECOR_IS_REGISTERED_AS_TYPE("Player_Vehicle", 3))
		{
			if (DECORATOR::DECOR_EXIST_ON(iParam0, "Player_Vehicle"))
			{
				if (DECORATOR::DECOR_GET_INT(iParam0, "Player_Vehicle") == NETWORK::NETWORK_HASH_FROM_PLAYER_HANDLE(PLAYER::PLAYER_ID()))
				{
					if (func_422() != -1 && func_422() < 607)
					{
						if (!func_421(iParam0) || ENTITY::GET_ENTITY_MODEL(iParam0) != Global_1583771[func_422() /*143*/].f_66)
						{
							return 1;
						}
...
int func_422()
{
	return Global_2359296[func_423() /*5574*/].f_681.f_2;
}
...
int func_428(int iParam0)
{
	if (iParam0 != func_391())
	{
		if (func_390(iParam0, 1, 1))
		{
			if (Global_2658293[iParam0 /*468*/].f_325.f_8 != -1 && Global_2658293[iParam0 /*468*/].f_325.f_11 != func_391())
			{
				return func_389(Global_2658293[iParam0 /*468*/].f_325.f_8) == 5;
			}
		}
	}
	return 0;
...
int func_429(int iParam0)
{
	if (iParam0 != func_391())
	{
		if (func_390(iParam0, 1, 1))
		{
			if (Global_2658293[iParam0 /*468*/].f_325.f_8 != -1 && Global_2658293[iParam0 /*468*/].f_325.f_11 != func_391())
			{
				return func_389(Global_2658293[iParam0 /*468*/].f_325.f_8) == 8;
			}
		}
	}
	return 0;
...
int func_430(int iParam0)
{
	if (iParam0 != func_391())
	{
		if (func_390(iParam0, 1, 1))
		{
			if (Global_2658293[iParam0 /*468*/].f_325.f_8 != -1)
			{
				return func_389(Global_2658293[iParam0 /*468*/].f_325.f_8) == 9;
			}
		}
	}
	return 0;
...
bool func_434(bool bParam0)
{
	...
	return func_435(PLAYER::PLAYER_ID()) == 0;
}

int func_435(int iParam0)
{
	if (func_439(iParam0) == 373)
	{
		return func_436(iParam0, 373);
	}
	return -1;
}
...
int func_443(int iParam0, var uParam1, var uParam2)
{
	int iVar0;
	int iVar1;
	...
	if (func_448(ENTITY::GET_ENTITY_MODEL(*iParam0)) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_446(*iParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*iParam0, 24, func_446(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_445(iParam0);
	if (func_444(*iParam0))
	{
...
int func_446(int iParam0, int iParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		iVar0 = func_447(iParam0, 38) + 1;
		iVar1 = func_447(iParam0, 24) + 1;
...
int func_447(int iParam0, int iParam1)
{
	...
	while (iVar0 >= 0 && func_449(iParam0, iParam1, iVar0))
	{
		iVar0 = (iVar0 - 1);
	}
	return iVar0;
...
{
	if (func_418(iParam0, 1) && !func_419(iParam0))
	{
		return 1;
	}
	switch (iParam0)
...
{
	if (!func_450() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(iParam0, iParam1, iParam2))
	{
		return 1;
	}
	return 0;
...
void func_452(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_99792[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_99792[iVar0]) == func_315(iParam0, iParam1))
				{
...
void func_453(struct<3> Param0, float fParam3, bool bParam4)
{
	int iVar0;
	...
	while (iVar0 < 68)
	{
		if (func_314(&(Global_79127.f_555[0 /*21*/]), iVar0))
		{
...
void func_454(int iParam0)
{
	...
	if (func_314(&(Global_79127.f_555[0 /*21*/]), iParam0))
	{
		...
		if (BitTest(Global_79127.f_555[0 /*21*/].f_9, 13))
		{
			if (((((iParam0 == 24 && func_211(iParam0, 0)) && Global_80036.f_66 == 0) && Global_114963.f_32759.f_1958[Global_79127.f_555[0 /*21*/].f_14] != 0) && Global_114963.f_32759.f_1958[Global_79127.f_555[0 /*21*/].f_14] > 3) && (!func_455(0, Global_79127.f_555[0 /*21*/].f_12) || !func_455(1, Global_79127.f_555[0 /*21*/].f_12)))
			{
				func_318(&(Global_114963.f_32759.f_69[Global_79127.f_555[0 /*21*/].f_14 /*78*/]), &Global_80036);
...
int func_455(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_456(&(Global_114963.f_32759.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_288(Global_114963.f_32759.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0, -1);
}
...
{
	return func_458(&(Global_108504.f_2890), Param0, fParam3, 0);
}
...
int func_460(int iParam0, struct<3> Param1, bool bParam4)
{
	...
	{
		case joaat("cargobob"):
			if (func_462(iParam0, Global_79127.f_139[38], 0))
			{
				func_454(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_462(iParam0, Global_79127.f_139[43], 1))
			{
				func_454(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_462(iParam0, uVar1[iVar6], 1) && func_461(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
...
void func_463(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		if ((((func_465() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66)) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(iParam0)) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("avenger"))) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, func_400(1)))
		{
			if (!BitTest(uParam1->f_77, 23))
			{
				if (!BitTest(uParam1->f_77, 22) && func_464(iParam0, 5f))
				{
...
int func_465()
{
	...
	if (func_469(7))
	{
		if (func_467(Global_2673273.f_4.f_16) || func_466(Global_2673273.f_4.f_16))
		{
			return 0;
		}
	}
...
{
	return func_470(&(Global_2673273.f_194), iParam0);
}
...
bool func_482()
{
	return func_480(&(Global_108504.f_2890));
}

void func_483()
{
	func_484(&(Global_108504.f_2890));
}
...
int func_485(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam2 == 0 && func_487(Global_108504.f_2890.f_12.f_66))
	{
		return 0;
	}
...
bool func_488()
{
	return func_481(&(Global_108504.f_2890));
}
...
int func_510()
{
	...
	iVar0 = func_511(&(Global_102486.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_514()
{
	...
	{
		if (func_509(&(Global_102486.f_3)) > -1)
		{
			return 1;
		}
	}
