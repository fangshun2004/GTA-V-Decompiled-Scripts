...
void __EntryFunction__()
{
	...
	func_49(&uLocal_62, 1, 0, "EMSDispatch", 0, 1);
	func_48();
	while (true)
	{
		SYSTEM::WAIT(0);
...
void func_7()
{
	...
	{
		case 0:
			if (((((((func_45(130) && func_44(iVar0) != 192) && func_44(iVar0) != 190) && func_44(iVar0) != 191) && func_44(iVar0) != 225) && func_44(iVar0) != 226) && func_44(iVar0) != 227) && !func_34(iVar0))
			{
				if (Global_34050)
				{
					iLocal_234 = 11;
				...
				if (!Global_33874)
				{
					if (func_32())
					{
						if (func_8(&uLocal_62, 130, "LOCAUD", "LOC_CALLQ", iLocal_234, "CELL_601", "LOC_CALLA", "LOC_CALLF", "LOC_CALLP", 0, 0, 0, 0))
						{
							if (!func_6())
							{
					...
					else if (func_8(&uLocal_62, 130, "LOCAUD", "LOC_CALLQ", iLocal_234, "CELL_601", "LOC_CALLA", "LOC_CALLF", "LOC_CALLP", 0, 0, 0, 0))
					{
						if (!func_6())
						{
							SCRIPT::REQUEST_SCRIPT("emergencycall");
...
bool func_8(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8, int iParam9, int iParam10, int iParam11, bool bParam12)
{
	...
	StringCopy(&Global_23129, sParam6, 24);
	StringCopy(&Global_23135, sParam7, 24);
	StringCopy(&Global_23141, sParam8, 24);
...
void func_31(var uParam0, var uParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
{
	if (func_43(iParam0) || func_35(iParam0))
	{
		return 1;
	}
	return 0;
...
{
	Global_34041 = 1;
	StringCopy(&Global_34042, SCRIPT::GET_THIS_SCRIPT_NAME(), 32);
}
