...
BOOL func_2(Any* panParam0) // Hash - 0x93FB423A ^0x93FB423A
{
	const char* str;
	var unk32;
...
struct<2> func_9(int iParam0) // Hash - 0x323E6781 ^0x9D2D032F
{
	var unk;
	var unk3;
...
void func_19() // Hash - 0x429A4038 ^0x35B7C581
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("MISSION_STAT_WATCHER")) > 0)
	{
		if (func_20())
...
void func_23(char* sParam0, int iParam1, Ped pedParam2) // Hash - 0xB566D143 ^0x35A2AF7A
{
...
BOOL func_44(int iParam0, int iParam1, char* sParam2, var uParam3) // Hash - 0x8E372EAA ^0xD47E44F6
{
...
void func_109(int iParam0) // Hash - 0x35AC36F2 ^0x8450D910
{
	int num;
	var textLabel;
...
void func_112(char* sParam0, Any anParam1, int iParam2) // Hash - 0x817AB180 ^0x6F5F76F0
{
...
struct<2> func_114(int iParam0) // Hash - 0x975AC8C9 ^0x81C2BE1C
{
	var unk;
...
void func_115(int iParam0, var uParam1) // Hash - 0x2D8E3F8 ^0x13AB47AA
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_147(const char* sParam0) // Hash - 0x16488C7A ^0x166F3418
{
...
void func_180(int iParam0, var uParam1) // Hash - 0x16CCAA18 ^0xC0E5B981
{
	if (iParam0 == 1)
	{
		if (!func_134(uParam1))
...
BOOL func_192(int iParam0) // Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
		case 5:
...
void func_193(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5) // Hash - 0x9F3CA854 ^0x2E5916D2
{
	switch (*uParam0)
	{
		case 0:
...
BOOL func_195(char* sParam0, int iParam1, BOOL bParam2) // Hash - 0x77297D51 ^0x40DC584A
{
	Global_21726 = 0;
...
void func_196() // Hash - 0xF42BEB19 ^0xA29557DA
{
	if (!func_197())
		return;
...
BOOL func_197() // Hash - 0x7B74B45F ^0xCE052A5D
{
...
BOOL func_198(Player plParam0) // Hash - 0x6E46BC72 ^0x6E46BC72
{
	return func_199(plParam0, 20);
}

BOOL func_199(Player plParam0, int iParam1) // Hash - 0x7CD5054C ^0x870BEA81
{
	return IS_BIT_SET(Global_1894573[plParam0 /*608*/].f_10.f_4, iParam1);
}

void func_200() // Hash - 0xDB58E314 ^0x7207A618
{
	int i;
...
void func_201() // Hash - 0xCD8A4D28 ^0xCD8A4D28
{
...
BOOL func_202() // Hash - 0x9A999369 ^0x4033F7BF
{
	int num;
	int weaponHash;
...
void func_203() // Hash - 0x98476CE1 ^0x250FEB7C
{
	if (func_57(14))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
...
void func_204() // Hash - 0xBE88A374 ^0xEFB5755B
{
	int i;
...
float func_206(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Hash - 0xC22B942A ^0xE0DB8793
{
...
void func_207(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, BOOL bParam9, int iParam10) // Hash - 0x4E1C0216 ^0xB00E8C6B
{
	int taskSequenceId;
	int num;
...
BOOL func_208(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9) // Hash - 0xA74186BF ^0x512FC932
{
	var unk;
...
void func_209(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Hash - 0xF7ECDFD9 ^0x6B079C3E
{
...
void func_211(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Hash - 0xA38693DA ^0xBAAA90B1
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_212(int iParam0, BOOL bParam1) // Hash - 0x3ABFF97A ^0x3ABFF97A
{
	if (iParam0 == -1)
		return;
...
int func_213(int iParam0) // Hash - 0x3F6843D0 ^0x973F28A6
{
	if (Global_78554 == iParam0)
		if (Global_78555 == -1)
...
void func_214(var uParam0, int iParam1) // Hash - 0xA189769D ^0xD7591C4B
{
	BOOL flag;
	int i;
...
void func_216(var uParam0) // Hash - 0x8EEB5116 ^0x2325FF68
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_217(uParam0);
...
void func_217(var uParam0) // Hash - 0x1C509C5B ^0x1C509C5B
{
	BOOL flag;
	int num;
	int i;
...
void func_218(int iParam0) // Hash - 0xD347101A ^0xCC220E7F
{
	if (iParam0 == -1)
		iParam0 = func_170();
...
BOOL func_219(Any* panParam0, BOOL bParam1) // Hash - 0x7D86F6E4 ^0x2F0EA7CC
{
	var unk;
...
void func_220(Ped pedParam0, var uParam1, int iParam2) // Hash - 0xD4C7D099 ^0x162C1E9
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_221(int iParam0) // Hash - 0xD681AEF7 ^0xD681AEF7
{
...
BOOL func_222(var uParam0) // Hash - 0x42F869D4 ^0xFFADB180
{
...
BOOL func_223(var uParam0) // Hash - 0x6329B93C ^0xCBBB8D92
{
...
void func_224(var uParam0) // Hash - 0x2E98ABB1 ^0xFF31A41F
{
	int i;
	int taskSequenceId;
...
void func_225(Object* pobParam0) // Hash - 0x4EAFEE58 ^0x34D7ECA6
{
...
void func_226(var uParam0) // Hash - 0x5209F824 ^0xCFA0F1CA
{
	int i;
...
BOOL func_227(var uParam0, BOOL bParam1, BOOL bParam2) // Hash - 0x53567DCF ^0x584F6887
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_228(Ped pedParam0, Vehicle veParam1) // Hash - 0xFB12ABF0 ^0x730FD205
{
...
BOOL func_229(var uParam0, BOOL bParam1, int iParam2) // Hash - 0xE9BDE167 ^0x20C575FA
{
	int i;
	int num;
...
BOOL func_230(int iParam0) // Hash - 0x9E3DCA43 ^0x9E3DCA43
{
...
BOOL func_231(Ped pedParam0, int iParam1) // Hash - 0x5EA05E45 ^0x7984EB04
{
	float xSize;
...
BOOL func_232(Ped pedParam0, int iParam1) // Hash - 0xF1789D04 ^0x3F9D1900
{
	return func_233(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_233(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Hash - 0x275BB58B ^0x275BB58B
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_234(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Hash - 0xBBBECF07 ^0xBBBECF07
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_235(Ped pedParam0, int iParam1) // Hash - 0xA6273130 ^0xF7D9CDEA
{
...
int func_236() // Hash - 0x1398F041 ^0xCD84FF69
{
	int i;
...
BOOL func_237(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Hash - 0x6EF1707D ^0x8C069CF9
{
	var unk;
...
void func_240(var uParam0) // Hash - 0xA4B72113 ^0x62A5EAE1
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_241(Ped pedParam0, Ped pedParam1) // Hash - 0xAA445031 ^0xEBA3F8CF
{
	int i;
...
BOOL func_242(Ped pedParam0) // Hash - 0xEC80536A ^0x2D4CF2B0
{
...
BOOL func_243(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Hash - 0x5B46DA49 ^0x44F718
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_244(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Hash - 0x1310B579 ^0x2AAFC0CC
{
	float entityCoords;
	float num;
...
BOOL func_245(Ped pedParam0, float fParam1) // Hash - 0xFA3D7088 ^0x33A74060
{
	var outProjectile;
	var outCoords;
...
BOOL func_246(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Hash - 0x3F40E5FA ^0xC3BEFE6A
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_247(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Hash - 0x18BAE105 ^0x60D3B20E
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_248(int iParam0) // Hash - 0x5B443B41 ^0x5B443B41
{
...
void func_249(Vehicle veParam0) // Hash - 0xAD821AF8 ^0x3A9158E6
{
	int taskSequenceId;
...
BOOL func_250(int iParam0) // Hash - 0x6F2BC7EE ^0x6F2BC7EE
{
	if (iParam0 == -1)
		iParam0 = func_170();
...
BOOL func_251(int iParam0) // Hash - 0xDE7BA54D ^0xDE7BA54D
{
...
BOOL func_252() // Hash - 0x29CB2928 ^0xE369A18D
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_253() // Hash - 0x98CCC132 ^0x97B0D6ED
{
	if (Global_97603 != -1)
...
BOOL func_254(int iParam0) // Hash - 0xC2630182 ^0xFBD23031
{
...
BOOL func_255() // Hash - 0x25806CBF ^0x25806CBF
{
...
BOOL func_256(int iParam0) // Hash - 0x1156B580 ^0x34C7FA05
{
	if (func_113(false))
...
void func_257() // Hash - 0xB70CD18F ^0x7CAF6F30
{
	var unk;
	float num;
...
BOOL func_258(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5) // Hash - 0x9A4C1B16 ^0x6EACDAB9
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(pedParam0, bParam5), vParam1) <= fParam4 * fParam4;
}

void func_259(var uParam0) // Hash - 0x8F495B9C ^0xA1B71726
{
	if (func_210(uParam0->f_28[0]))
	{
...
void func_260(var uParam0) // Hash - 0x25247C40 ^0x3EB44957
{
	int i;
...
void func_261(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Hash - 0x6C235EE0 ^0x9E57F206
{
...
void func_264(var uParam0, char* sParam1) // Hash - 0x92325A63 ^0xF754EA24
{
...
void func_265(var uParam0) // Hash - 0x2F6A3876 ^0xD68C672F
{
	int i;
...
BOOL func_266(var uParam0) // Hash - 0x71136E5B ^0x964217D2
{
	uParam0->f_16 = 3;
...
BOOL func_267(var uParam0) // Hash - 0x3ECE7523 ^0x3ECE7523
{
	int num;
	var unk4;
	var unk7;
...
void func_268(Object* pobParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Hash - 0x61F651EE ^0x2FE58679
{
	func_225(pobParam0);
...
void func_269(Vehicle* pveParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5) // Hash - 0x60B41505 ^0x2C4B5209
{
	func_270(pveParam0);
...
void func_270(Vehicle* pveParam0) // Hash - 0x8D18F713 ^0xF71A18A8
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_271(var uParam0) // Hash - 0xC42B20E0 ^0x728F1DAE
{
	int i;
...
BOOL func_272(var uParam0) // Hash - 0x8F06113E ^0x8F06113E
{
	int num;
	var unk5;
	Vector3 vector;
...
void func_273(Ped* ppedParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, ePedType eptParam6) // Hash - 0x616C5024 ^0x190F8C82
{
	func_274(ppedParam0);
...
void func_274(Ped* ppedParam0) // Hash - 0xCA79453F ^0x7BA88177
{
...
BOOL func_275(var uParam0) // Hash - 0xAB8D0D1E ^0xD2836496
{
	int num;
	var unk3;
	float num2;
...
BOOL func_276(Ped* ppedParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5, char* sParam6, int iParam7) // Hash - 0x5E27D69A ^0xE8A3C3CE
{
...
BOOL func_277(Ped* ppedParam0, int iParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Hash - 0xC57592AD ^0x9AA0BE7
{
	Hash model;
...
int func_278(var uParam0, int iParam1) // Hash - 0x5AC42C11 ^0x5AC42C11
{
	int num;
...
BOOL func_279(var uParam0) // Hash - 0xB319BDFA ^0xA1F4DAFB
{
	if (func_223(uParam0))
	{
...
void func_280(var uParam0, char* sParam1, char* sParam2, char* sParam3) // Hash - 0x6EEDFC2 ^0xD51569DC
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
BOOL func_281(var uParam0) // Hash - 0xB788BF34 ^0x2047409E
{
	int num;
	Vector3 vector;
	float heading;
...
void func_282(Object* pobParam0, Hash hParam1) // Hash - 0xB32708AF ^0xB32708AF
{
	var unk;
	float num;
...
BOOL func_284(var uParam0) // Hash - 0x3856D533 ^0xE408A0A9
{
	int num;
	Vector3 vector;
	float heading;
...
BOOL func_285(int iParam0) // Hash - 0x59D2F680 ^0x59D2F680
{
	var unk;
	int num;
...
BOOL func_286(int iParam0) // Hash - 0xC6B32843 ^0xDD5D54EC
{
	const char* string2;
...
BOOL func_287(int iParam0) // Hash - 0x791D84F4 ^0x791D84F4
{
	var unk;
...
BOOL func_288(int iParam0) // Hash - 0xDEAD9A68 ^0xDEAD9A68
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_289(int iParam0, char* sParam1) // Hash - 0xC64245F ^0x76D9DBC9
{
...
BOOL func_290(int iParam0) // Hash - 0x5ADD7F05 ^0x5ADD7F05
{
...
BOOL func_291(int iParam0) // Hash - 0xBB053D24 ^0xBB053D24
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_292(int iParam0) // Hash - 0x5D95A044 ^0x5D95A044
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_293(int iParam0) // Hash - 0x9FFC81CD ^0x47A2AB8B
{
	if (func_251(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
void func_294() // Hash - 0x5631C87C ^0xC54F1B57
{
...
BOOL func_295(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Hash - 0x95B98194 ^0x95B98194
{
	int num;
	int i;
...
BOOL func_296(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Hash - 0xC6B7068B ^0xB9A971A4
{
	int num;
	char* str;
...
BOOL func_297(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Hash - 0x1FB736D4 ^0x234AEAB7
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_298(var uParam0, BOOL bParam1) // Hash - 0x998A732A ^0x8E06AC2
{
	char* str;
...
void func_299(char* sParam0) // Hash - 0xA52CF679 ^0xC94F8C8B
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
		if (func_302(sParam0))
			func_300();
...
void func_300() // Hash - 0xC536DD5 ^0xC536DD5
{
	Global_20591 = 0;
	func_301();
	return;
...
void func_301() // Hash - 0xF6D04E68 ^0x80AE5309
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22736 = 0;
...
BOOL func_302(char* sParam0) // Hash - 0x5CF3EDA6 ^0x878C8302
{
	var string1;
...
int func_304(var uParam0) // Hash - 0x86633390 ^0xD72DCD71
{
	if (func_223(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_305(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Hash - 0x5BE1D1E3 ^0x5BE1D1E3
{
...
void func_306(var uParam0, BOOL bParam1) // Hash - 0xEDC3BD2D ^0xE0B6F056
{
	func_307(&(uParam0->f_41), bParam1);
	return;
}

void func_307(var uParam0, BOOL bParam1) // Hash - 0x9E80EA71 ^0x9E80EA71
{
	int i;
...
void func_308(Object* pobParam0, BOOL bParam1) // Hash - 0xD7EE3E27 ^0xC5769B29
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_309(var uParam0, BOOL bParam1) // Hash - 0xEDC3BD2D ^0xE2474F74
{
	func_310(&(uParam0->f_35), bParam1);
	return;
}

void func_310(var uParam0, BOOL bParam1) // Hash - 0xA98F6284 ^0xA98F6284
{
	int i;
...
void func_311(Vehicle* pveParam0) // Hash - 0xC50F9886 ^0x638B6124
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_312(var uParam0, int iParam1) // Hash - 0xEDC3BD2D ^0xA9A19095
{
	func_313(&(uParam0->f_28), iParam1);
	return;
}

void func_313(var uParam0, int iParam1) // Hash - 0xB72ACFD2 ^0xB72ACFD2
{
	int i;
...
void func_314(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Hash - 0x34362197 ^0xC592197
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_315(int iParam0) // Hash - 0x995C9E2 ^0x995C9E2
{
	if (*iParam0 == -1)
		return;
...
void func_316(char* sParam0) // Hash - 0x54B64147 ^0x56EEAFB9
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_317(var uParam0) // Hash - 0x4CD8BCE8 ^0xBF7578E7
{
	*uParam0 = -1;
...
void func_318() // Hash - 0x554DA35 ^0xCE75B5F6
{
...
Hash func_319(int iParam0) // Hash - 0xBF0B24A5 ^0xBF0B24A5
{
	if (!func_36(iParam0))
		return func_47(iParam0);
	else
