...
void func_3(var uParam0) // Hash - 0x9AE641EB ^0x7AFB1CF7
{
...
void func_9(var uParam0) // Hash - 0x299C2AFC ^0x8594C940
{
	var animDict;
	var animName;
				...
				else
				{
					...
					if (uParam0->f_43.f_5 == -1)
					{
						if (MISC::GET_GAME_TIMER() - uParam0->f_43.f_6 > 150)
							func_54(&(uParam0->f_43.f_5), 4, _("Press ~INPUT_CONTEXT~ to sit down."), 0, 0, 0, 0);
					}
...
void func_10(var uParam0, BOOL bParam1) // Hash - 0x64C0EDC6 ^0xBB04409E
{
...
int func_11(var uParam0) // Hash - 0x890AECBC ^0x6942CB11
{
	int num;
...
void func_16(var uParam0) // Hash - 0x392A29FC ^0x9B21A67C
{
	Vector3 vector;
	float num;
	BOOL flag;
						...
						if (PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL))
							if (flag)
								if (func_17(PLAYER::PLAYER_ID()) == 3)
									func_54(&(uParam0->f_43.f_5), 4, _("Use ~INPUT_SCRIPT_LEFT_AXIS_X~ to change pose.~n~Press ~INPUT_FRONTEND_X~ to watch DJ live stream.~n~Press ~INPUT_SCRIPT_RRIGHT~ to stand up."), 0, 0, 0, 0);
								else if (func_17(PLAYER::PLAYER_ID()) == 2)
									func_54(&(uParam0->f_43.f_5), 4, _("Use ~INPUT_SCRIPT_LEFT_AXIS_X~ to change pose.~n~Press ~INPUT_FRONTEND_X~ to watch DJ live stream.~n~Press ~INPUT_SCRIPT_RRIGHT~ to stand up."), 0, 0, 0, 0);
								else
									func_54(&(uParam0->f_43.f_5), 4, _("Use ~INPUT_SCRIPT_LEFT_AXIS_X~ to change pose.~n~Press ~INPUT_FRONTEND_X~ to watch DJ live stream.~n~Press ~INPUT_SCRIPT_RRIGHT~ to stand up."), 0, 0, 0, 0);
							else
								func_54(&(uParam0->f_43.f_5), 4, _("Use ~INPUT_SCRIPT_LEFT_AXIS_X~ to change pose.~n~Press ~INPUT_SCRIPT_RRIGHT~ to stand up."), 0, 0, 0, 0);
						else if (flag)
							if (func_17(PLAYER::PLAYER_ID()) == 3)
								func_54(&(uParam0->f_43.f_5), 4, _("Use ~INPUT_SCRIPT_LEFT_AXIS_X~ to change pose.~n~Press ~INPUT_FRONTEND_X~ to watch DJ live stream.~n~Press ~INPUT_FRONTEND_RIGHT~ to stand up."), 0, 0, 0, 0);
							else if (func_17(PLAYER::PLAYER_ID()) == 2)
								func_54(&(uParam0->f_43.f_5), 4, _("Use ~INPUT_SCRIPT_LEFT_AXIS_X~ to change pose.~n~Press ~INPUT_FRONTEND_X~ to watch DJ live stream.~n~Press ~INPUT_FRONTEND_RIGHT~ to stand up."), 0, 0, 0, 0);
							else
								func_54(&(uParam0->f_43.f_5), 4, _("Use ~INPUT_SCRIPT_LEFT_AXIS_X~ to change pose.~n~Press ~INPUT_FRONTEND_X~ to watch DJ live stream.~n~Press ~INPUT_FRONTEND_RIGHT~ to stand up."), 0, 0, 0, 0);
						else
							func_54(&(uParam0->f_43.f_5), 4, _("Use ~INPUT_SCRIPT_LEFT_AXIS_X~ to change pose.~n~Press ~INPUT_FRONTEND_RIGHT~ to stand up."), 0, 0, 0, 0);
					else if (uParam0->f_43.f_8 == 2)
						if (PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL))
							if (flag)
								if (func_17(PLAYER::PLAYER_ID()) == 3)
									func_54(&(uParam0->f_43.f_5), 4, _("Press ~INPUT_FRONTEND_X~ to watch DJ live stream.~n~Press ~INPUT_SCRIPT_RRIGHT~ to stand up."), 0, 0, 0, 0);
								else if (func_17(PLAYER::PLAYER_ID()) == 2)
									func_54(&(uParam0->f_43.f_5), 4, _("Press ~INPUT_FRONTEND_X~ to watch DJ live stream.~n~Press ~INPUT_SCRIPT_RRIGHT~ to stand up."), 0, 0, 0, 0);
								else
									func_54(&(uParam0->f_43.f_5), 4, _("Press ~INPUT_FRONTEND_X~ to watch DJ live stream.~n~Press ~INPUT_SCRIPT_RRIGHT~ to stand up."), 0, 0, 0, 0);
							else
								func_54(&(uParam0->f_43.f_5), 4, _("Press ~INPUT_SCRIPT_RRIGHT~ to stand up."), 0, 0, 0, 0);
						else if (flag)
							if (func_17(PLAYER::PLAYER_ID()) == 3)
								func_54(&(uParam0->f_43.f_5), 4, _("Press ~INPUT_FRONTEND_X~ to watch DJ live stream.~n~Press ~INPUT_FRONTEND_RIGHT~ to stand up."), 0, 0, 0, 0);
							else if (func_17(PLAYER::PLAYER_ID()) == 2)
								func_54(&(uParam0->f_43.f_5), 4, _("Press ~INPUT_FRONTEND_X~ to watch DJ live stream.~n~Press ~INPUT_FRONTEND_RIGHT~ to stand up."), 0, 0, 0, 0);
							else
								func_54(&(uParam0->f_43.f_5), 4, _("Press ~INPUT_FRONTEND_X~ to watch DJ live stream.~n~Press ~INPUT_FRONTEND_RIGHT~ to stand up."), 0, 0, 0, 0);
						else
							func_54(&(uParam0->f_43.f_5), 4, _("Press ~INPUT_FRONTEND_RIGHT~ to stand up."), 0, 0, 0, 0);
...
BOOL func_28(var uParam0) // Hash - 0x8C89182D ^0xF0FFC17C
{
	return func_32(&(uParam0->f_43), 9);
}

void func_29(var uParam0) // Hash - 0xBC1B827E ^0xA104473E
{
	var animDict;
	var animnName;
...
void func_30(var uParam0) // Hash - 0x44F03FEE ^0xAAB997B9
{
	var animDict;
...
void func_35(var uParam0) // Hash - 0x7EDCD81E ^0x99FC48D2
{
	int weaponHash;
...
Vector3 func_47(var uParam0) // Hash - 0x5F25677 ^0xAEA2F914
{
	var unk;
...
Vector3 func_48(var uParam0) // Hash - 0x4B9F1C47 ^0x3F10D49F
{
	return uParam0->[uParam0->f_43.f_2 /*14*/].f_8;
}

void func_49(var uParam0, char* sParam1) // Hash - 0x930A1270 ^0x9C3F6873
{
	if (uParam0->f_43.f_8 == 1)
	{
		if (func_12())
...
void func_50(var uParam0, char* sParam1) // Hash - 0x3B4D29F1 ^0x2789B9CF
{
...
void func_51(var uParam0) // Hash - 0xE3D7DFC1 ^0x328F2E7A
{
...
int func_52(var uParam0) // Hash - 0x24A5AB68 ^0x77EB8F04
{
	int randomIntInRange;
...
BOOL func_55(var uParam0) // Hash - 0x320A2490 ^0x50743877
{
...
BOOL func_60(var uParam0) // Hash - 0xFD4DD29C ^0x61A3687E
{
...
BOOL func_64(var uParam0) // Hash - 0xE4EB6954 ^0x64DBD4EC
{
	int i;
...
void func_65(var uParam0, int iParam1) // Hash - 0xD6BCD227 ^0x959B5160
{
...
void func_67(var uParam0) // Hash - 0x3108F719 ^0xA76CAA24
{
	if (uParam0->f_43.f_4 == 6)
	{
	}
...
void func_69(var uParam0) // Hash - 0xFBA1CE25 ^0xF13584FD
{
...
BOOL func_81() // Hash - 0xAEE4B1CC ^0xD177653A
{
...
BOOL func_82() // Hash - 0x9304C87C ^0xC9E09D53
{
	return IS_BIT_SET(Global_1950108.f_4, 10);
}

BOOL func_83() // Hash - 0x6774E22C ^0x60BCC4DE
{
	if (Global_2657589[PLAYER::PLAYER_ID() /*466*/].f_321.f_10 != func_19())
	{
...
void func_84() // Hash - 0xA297303E ^0xA297303E
{
...
void func_85(int iParam0, var uParam1, int iParam2, int iParam3) // Hash - 0x7C15C5A1 ^0x3CB1DCED
{
	var unk;
	float num;
...
Vector3 func_86() // Hash - 0x28CC1A1D ^0x28CC1A1D
{
	return 0.5f, -0.5f, 2f;
}

Vector3 func_87(float fParam0, var uParam1, var uParam2, float fParam3) // Hash - 0x8959C4D1 ^0x8922A2E2
{
	float num;
	float num2;
	float num3;
...
float func_88(int iParam0, float fParam1) // Hash - 0x1E604EEF ^0x1E604EEF
{
	switch (iParam0)
	{
		case 1:
...
Vector3 func_89() // Hash - 0x8664ACB1 ^0x8664ACB1
{
	return -0.5f, -0.5f, 0f;
}

void func_90(int iParam0, var uParam1, var uParam2) // Hash - 0xB54FFF9 ^0xB54FFF9
{
	if (func_12())
	{
		switch (iParam0)
...
void func_91() // Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

int func_92(int iParam0, int iParam1, BOOL bParam2) // Hash - 0x75751681 ^0x9140C9A0
{
	int i;
...
BOOL func_93(BOOL bParam0) // Hash - 0x1CCCE169 ^0x1CCCE169
{
	bParam0;
