...
int func_70()
{
	if (Global_1845135 != func_60())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("base_corridor_seats", Global_1845135, true, 0))
		{
			return 0;
		}
...
void func_71()
{
	...
	iVar0[0] = 0;
	iVar0[1] = 1;
	func_72(5, &uLocal_129, &iVar0);
	iVar0[0] = 2;
	iVar0[1] = 3;
	func_72(6, &uLocal_129, &iVar0);
}
