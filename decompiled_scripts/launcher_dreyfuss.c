...
BOOL func_2(Any* panParam0) // Hash - 0x76C12C4D ^0x76C12C4D
{
	const char* str;
	var unk32;
...
struct<2> func_9(int iParam0) // Hash - 0x323E6781 ^0x49B50301
{
	var unk;
	var unk3;
...
void func_19() // Hash - 0x429A4038 ^0xDB410647
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("MISSION_STAT_WATCHER")) > 0)
	{
		if (func_20())
...
void func_23(char* sParam0, int iParam1, Ped pedParam2) // Hash - 0xB566D143 ^0x122E235C
{
...
BOOL func_44(int iParam0, int iParam1, char* sParam2, var uParam3) // Hash - 0x8E372EAA ^0x90792BB
{
...
void func_109(int iParam0) // Hash - 0x35AC36F2 ^0x593780F9
{
	int num;
	var textLabel;
...
void func_112(char* sParam0, Any anParam1, int iParam2) // Hash - 0x817AB180 ^0xDFFD2EA2
{
...
struct<2> func_114(int iParam0) // Hash - 0x975AC8C9 ^0x90B05E0D
{
	var unk;
...
void func_115(int iParam0, var uParam1) // Hash - 0x2D8E3F8 ^0x5CEB5195
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_148(const char* sParam0) // Hash - 0x16488C7A ^0x7B11A0A8
{
...
int func_174() // Hash - 0xA0BF6673 ^0xB72133C5
{
	if (func_177(2))
	{
...
BOOL func_175(Ped pedParam0, eScriptTaskHash esthParam1) // Hash - 0x5CB13EA9 ^0x50B73240
{
...
float func_176(Ped pedParam0, float fParam1, float fParam2, float fParam3, BOOL bParam4) // Hash - 0xC22B942A ^0xE0DB8793
{
...
BOOL func_177(int iParam0) // Hash - 0x97844555 ^0xADCD6DAA
{
	int num;
...
BOOL func_178() // Hash - 0x4228A1C2 ^0x952FE30F
{
	return Global_100720.f_1;
}

BOOL func_179() // Hash - 0xC20DBA70 ^0xAC4006FB
{
	if (Global_97603 != -1)
...
BOOL func_180() // Hash - 0x3CA1BB47 ^0xB78A1ACB
{
...
BOOL func_181() // Hash - 0xE663B8F6 ^0xE663B8F6
{
	if (Global_78819)
		return true;
...
BOOL func_182() // Hash - 0xD56328D2 ^0xD56328D2
{
	return Global_100733.f_388 > 0;
}

BOOL func_183(int iParam0, int iParam1) // Hash - 0xA14C4D3F ^0xA6034F77
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_185() // Hash - 0x7FE517FE ^0x128A3BC8
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
int func_186(var uParam0, int iParam1) // Hash - 0x4C332810 ^0xCFFAAA23
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_187() // Hash - 0x1DF115D ^0x1DF115D
{
	func_27(&(Global_104212.f_2890), &Global_104212, 0, 1, 1, 0);
	return;
}

BOOL func_188(var uParam0) // Hash - 0xBE0C612E ^0xC181C5F3
{
	float num;
...
void func_189(int iParam0, var uParam1) // Hash - 0x16CCAA18 ^0x3F553D42
{
	if (iParam0 == 1)
	{
		if (!func_135(uParam1))
...
BOOL func_190(BOOL bParam0) // Hash - 0x328D4447 ^0x90410402
{
...
BOOL func_191(Vehicle veParam0) // Hash - 0x7E47BB06 ^0x692E6B64
{
...
void func_196(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Hash - 0xA38693DA ^0xBAAA90B1
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
BOOL func_200() // Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_97990;
}

void func_201(var uParam0) // Hash - 0x8EEB5116 ^0x2325FF68
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_202(uParam0);
...
void func_202(var uParam0) // Hash - 0x1C509C5B ^0x1C509C5B
{
	BOOL flag;
	int num;
	int i;
...
BOOL func_204(Any* panParam0, BOOL bParam1) // Hash - 0x7D86F6E4 ^0x74A45CF0
{
	var unk;
...
BOOL func_216(Ped pedParam0, int iParam1) // Hash - 0x5EA05E45 ^0x7984EB04
{
	float xSize;
...
BOOL func_217(Ped pedParam0, int iParam1) // Hash - 0xF1789D04 ^0x3F9D1900
{
	return func_218(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_218(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Hash - 0x275BB58B ^0x275BB58B
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_219(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Hash - 0xBBBECF07 ^0xBBBECF07
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
BOOL func_222(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Hash - 0x6EF1707D ^0x8C069CF9
{
	var unk;
...
int func_226(Ped pedParam0, Ped pedParam1) // Hash - 0xAA445031 ^0xEBA3F8CF
{
	int i;
...
BOOL func_227(Ped pedParam0) // Hash - 0xEC80536A ^0x2D4CF2B0
{
...
BOOL func_228(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Hash - 0x5B46DA49 ^0x44F718
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_229(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Hash - 0x1310B579 ^0x2AAFC0CC
{
	float entityCoords;
	float num;
...
BOOL func_230(Ped pedParam0, float fParam1) // Hash - 0xFA3D7088 ^0x33A74060
{
	var outProjectile;
	var outCoords;
...
BOOL func_231(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Hash - 0x3F40E5FA ^0xC3BEFE6A
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_232(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Hash - 0x18BAE105 ^0x60D3B20E
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
void func_234(Vehicle veParam0) // Hash - 0xAD821AF8 ^0xE394DAFF
{
	int taskSequenceId;
...
int func_242() // Hash - 0xE62BAA72 ^0x7A2D908
{
...
BOOL func_243(var uParam0) // Hash - 0x14648AE3 ^0xCFE27D19
{
	if (!func_244(uParam0))
		return false;
...
BOOL func_244(var uParam0) // Hash - 0x708E0529 ^0x5A121484
{
	int num;
	int i;
	BOOL flag;
...
void func_245(BOOL bParam0) // Hash - 0x1C0D91BC ^0xBF513161
{
...
void func_246(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Hash - 0xECB6BFBA ^0x4A87976F
{
	if (iParam0 != 198)
	{
		if (Global_78558)
...
void func_247(int iParam0, int iParam1) // Hash - 0xF488CE34 ^0x8C7C4F8D
{
	switch (iParam0)
	{
		case 12:
...
void func_248(int iParam0, BOOL bParam1) // Hash - 0xF0703301 ^0x756A9364
{
	if (bParam1)
...
BOOL func_249(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Hash - 0x72F8706 ^0xBE0DD95D
{
	BOOL flag;
	int num;
	int num2;
...
BOOL func_250() // Hash - 0x6134FBB2 ^0x82030B41
{
...
int func_251() // Hash - 0x21D64237 ^0x21D64237
{
	return Global_32164;
}

int func_252(var uParam0, int iParam1) // Hash - 0x5A2CB71 ^0xD297CB56
{
	int i;
...
void func_253(Vehicle* pveParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5) // Hash - 0x60B41505 ^0x2C4B5209
{
	func_254(pveParam0);
...
BOOL func_258(var uParam0) // Hash - 0xB319BDFA ^0xA1F4DAFB
{
	if (func_208(uParam0))
	{
...
BOOL func_259(var uParam0) // Hash - 0xC42B20E0 ^0x728F1DAE
{
	int i;
...
void func_260(var uParam0, char* sParam1, char* sParam2, int iParam3) // Hash - 0x6EEDFC2 ^0xD51569DC
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
BOOL func_261(int iParam0) // Hash - 0x59D2F680 ^0x59D2F680
{
	var unk;
	int num;
...
BOOL func_262(int iParam0) // Hash - 0xC6B32843 ^0xD0036233
{
	const char* string2;
...
BOOL func_263(int iParam0) // Hash - 0x791D84F4 ^0x791D84F4
{
	var unk;
...
BOOL func_264(int iParam0) // Hash - 0xDEAD9A68 ^0xDEAD9A68
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_265(int iParam0, char* sParam1) // Hash - 0xC64245F ^0xB60B0C68
{
...
BOOL func_266(int iParam0) // Hash - 0x5ADD7F05 ^0x5ADD7F05
{
...
BOOL func_267(int iParam0) // Hash - 0xBB053D24 ^0xBB053D24
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_268(int iParam0) // Hash - 0x5D95A044 ^0x5D95A044
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_269(int iParam0) // Hash - 0x9FFC81CD ^0x47A2AB8B
{
	if (func_236(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
void func_270() // Hash - 0x5631C87C ^0x7D9D855A
{
...
BOOL func_271(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Hash - 0x5B983661 ^0x5B983661
{
	int i;
...
BOOL func_272(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Hash - 0xC6B7068B ^0xB9A971A4
{
	int num;
	char* str;
...
BOOL func_273(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Hash - 0x1FB736D4 ^0x234AEAB7
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_274(var uParam0, BOOL bParam1) // Hash - 0xE2686510 ^0x2CB44D10
{
	char* str;
...
void func_275(char* sParam0) // Hash - 0xA52CF679 ^0xC94F8C8B
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
		if (func_278(sParam0))
			func_276();
...
void func_276() // Hash - 0xC536DD5 ^0xC536DD5
{
	Global_20591 = 0;
	func_277();
	return;
...
void func_277() // Hash - 0xF6D04E68 ^0x80AE5309
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22736 = 0;
...
BOOL func_278(char* sParam0) // Hash - 0x5CF3EDA6 ^0x878C8302
{
	var string1;
...
struct<6> func_279() // Hash - 0xB37EF8EF ^0xB37EF8EF
{
	var unk;
...
int func_280(var uParam0) // Hash - 0x86633390 ^0xD12F3C72
{
	if (func_208(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_281(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Hash - 0x5BE1D1E3 ^0x5BE1D1E3
{
...
void func_282(var uParam0, BOOL bParam1) // Hash - 0xEDC3BD2D ^0xE0B6F056
{
	func_283(&(uParam0->f_41), bParam1);
	return;
}

void func_283(var uParam0, BOOL bParam1) // Hash - 0x9E80EA71 ^0x9E80EA71
{
	int i;
...
void func_284(Object* pobParam0, BOOL bParam1) // Hash - 0xD7EE3E27 ^0xC5769B29
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_285(var uParam0, BOOL bParam1) // Hash - 0xEDC3BD2D ^0xE2474F74
{
	func_286(&(uParam0->f_35), bParam1);
	return;
}

void func_286(var uParam0, BOOL bParam1) // Hash - 0xA98F6284 ^0xA98F6284
{
	int i;
...
void func_287(Vehicle* pveParam0) // Hash - 0xC50F9886 ^0x638B6124
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_288(var uParam0, int iParam1) // Hash - 0xEDC3BD2D ^0xA9A19095
{
	func_289(&(uParam0->f_28), iParam1);
	return;
}

void func_289(var uParam0, int iParam1) // Hash - 0xB72ACFD2 ^0xB72ACFD2
{
	int i;
...
void func_290(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Hash - 0x34362197 ^0xC592197
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_291(Ped* ppedParam0) // Hash - 0xCA79453F ^0x7BA88177
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
void func_292(int iParam0) // Hash - 0x995C9E2 ^0x995C9E2
{
	if (*iParam0 == -1)
		return;
...
void func_293(char* sParam0) // Hash - 0x54B64147 ^0x56EEAFB9
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_294(var uParam0) // Hash - 0x4CD8BCE8 ^0x575B0E79
{
	*uParam0 = -1;
...
void func_295() // Hash - 0x554DA35 ^0x232E29C3
{
...
Hash func_296(int iParam0) // Hash - 0xBF0B24A5 ^0xBF0B24A5
{
	if (!func_36(iParam0))
		return func_47(iParam0);
	else
