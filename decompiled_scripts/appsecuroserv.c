...
int func_230(int iParam0)
{
	...
	if (iVar1 == 0 || iVar1 == 11)
	{
		...
		MONEY::_NETWORK_SPENT_PURCHASE_IMPORTEXPORT_WAREHOUSE(iVar10, &Var17, false, true);
	}
	else
	{
		if (iVar0 > 0)
	...
	*iParam1 = -1;
	...
	if (iVar383 >= 0 && (iVar383 == 0 || (iVar383 > 0 && (func_254() || MONEY::NETWORK_CAN_SPEND_MONEY(iVar383, false, true, false, -1, 0)))))
	{
		...
		if (bVar384 <= 0 || bVar384 > 22)
		{
			...
			MONEY::_NETWORK_SPENT_PURCHASE_WAREHOUSE(iVar381, &Var390, 0, 1);
		}
		else if (iVar383 > 0)
		{
			if (func_254())
			...
			MONEY::_NETWORK_SPENT_UPGRADE_WAREHOUSE(iVar383, &Var390, 0, 1);
		}
		if (func_254())
		{
			func_231(func_236());
