...
void __EntryFunction__()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_113991[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_295(&(Global_113991[Var0.f_0 /*10*/].f_9));
			}
		}
		func_283(&Var0, 1);
	}
	if (!func_280(&iVar64, &Var0, Var61, 5f))
	{
		func_279();
	...
	while (true)
	{
		...
		if (Var0.f_0 == 47)
		{
			func_210(&Var0, Var61, "PAP2AUD", "PAP2_AMB", 3, "BEVERLY", 5000, 1101004800);
		}
		else if (Var0.f_0 == 51)
		{
			func_210(&Var0, Var61, "PAP4AUD", "PAP4_AMB", 3, "BEVERLY", 5000, 1101004800);
		}
		func_209(Var0.f_0);
		func_201(&iLocal_93, &(Var0.f_9), Var61);
		if (func_186(&Var0, 0))
		{
			if (func_185(Var0.f_0))
			{
				func_182(Var0.f_0, &iLocal_95);
			}
			if (!func_2(&Var0))
			{
				func_283(&Var0, 1);
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_200()) || Global_33778) || func_199()) || func_198(8, -1)) || func_196()) || func_102()) || func_197()) || func_195()) || Global_114904.f_7695.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_200()) || Global_113951) || Global_33778) || func_199()) || func_198(8, -1)) || func_196()) || func_102()) || func_197()) || func_195()) || Global_114904.f_7695.f_919[bVar0] == 5) || Global_45416 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_200()) || Global_113951) || Global_33778) || func_199()) || func_198(8, -1)) || func_102()) || func_197()) || func_195()) || Global_114904.f_7695.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_200() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_198(8, -1)) || func_195()) || func_194()) || Global_114904.f_7695.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
...
int func_210(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	var uVar0;
	
	if ((((func_138(PLAYER::PLAYER_PED_ID()) && func_138(iParam0->f_28[0])) && !func_158()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_205(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
		func_213(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
		func_211(&uVar0, cParam4, sParam5, 7, 0, 0);
...
void func_211(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
int func_214(var uParam0, bool bParam1)
{
	...
	if ((func_251(*uParam0) || func_249(*uParam0)) || Global_80526 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
{
	if ((func_250() && Global_102429.f_11 == 6) && iParam0 == func_180(&(Global_102429.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_254(var uParam0)
{
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			{
				func_258(&(uParam0->f_28[1]), iVar0[3], -498.1656f, 228.6284f, 82.09948f, 292.9763f, 26);
			...
			{
				func_258(&(uParam0->f_28[2]), iVar0[4], -498.309f, 227.9112f, 82.106f, 296.4216f, 26);
