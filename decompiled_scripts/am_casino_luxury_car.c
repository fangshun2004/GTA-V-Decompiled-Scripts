...
void func_29(struct<3> Param0)
{
	...
	SCRIPT::TRIGGER_SCRIPT_EVENT(1, &Var0, 5, func_30(1, 1));
}
...
{
	if (!func_94() && VEHICLE::_IS_VEHICLE_MOD_HSW_EXCLUSIVE(uParam0, iParam1, iParam2))
	{
		return 1;
	}
	return 0;
...
void func_138(struct<3> Param0, var uParam3, int iParam4, var uParam5)
{
	...
	*uParam5 = func_139(&Param0, &uParam3, &iParam4);
	...
	Var0.f_6 = iParam4;
	Var0.f_7 = *uParam5;
	SCRIPT::TRIGGER_SCRIPT_EVENT(1, &Var0, 8, func_30(1, 1));
}
