...
BOOL func_69() // Position - 0x1F68 Hash - 0x52E21E9B ^0xD0F85E96
{
...
Hash func_70() // Position - 0x1FEC Hash - 0x90B5165C ^0xB8DD5DC8
{
	switch (func_72())
	{
		case 0:
...
BOOL func_74(int iParam0) // Position - 0x205D Hash - 0xA28ADBB4 ^0x6EB81E64
{
...
int func_83(int iParam0) // Position - 0x219E Hash - 0xEE599357 ^0xEE599357
{
	switch (iParam0)
	{
		case 0:
...
void func_84() // Position - 0x2652 Hash - 0x43275282 ^0x43275282
{
	func_86(&uLocal_111);
	func_85();
	return;
...
void func_85() // Position - 0x2664 Hash - 0xCE5FB49E ^0x214A59D5
{
	SCRIPT::TERMINATE_THIS_THREAD();
	return;
}

void func_86(var uParam0) // Position - 0x2670 Hash - 0x9537D004 ^0x18439461
{
	...
	if (uParam0->f_13 > 2)
	{
		...
		func_87(PLAYER::PLAYER_ID(), true, 0, false);
	}
...
void func_87(Player plParam0, BOOL bParam1, eSetPlayerControlFlags espcfParam2, BOOL bParam3) // Position - 0x26CF Hash - 0xCD788E2C ^0x50180146
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(plParam0) && PLAYER::IS_PLAYER_PLAYING(plParam0) || bParam3 == true)
		{
			...
			if (!flag18)
			{
				...
				else if (flag14 || !func_96(PLAYER::PLAYER_ID(), 0) && !func_95())
...
BOOL func_88(int iParam0) // Position - 0x2B5D Hash - 0xFB453256 ^0xFB453256
{
	return iParam0 == 17;
}

void func_89() // Position - 0x2B6A Hash - 0xBC63612E ^0xBC63612E
{
	var unk;
...
void func_90() // Position - 0x2BB7 Hash - 0x5FEB45C4 ^0x33557962
{
...
BOOL func_91(Ped pedParam0) // Position - 0x2BF5 Hash - 0x93DB01D2 ^0x43DCC591
{
...
void func_92(BOOL bParam0, Ped pedParam1, int iParam2) // Position - 0x2C26 Hash - 0x19FE7AFC ^0x4538006F
{
	int num;
	eViewModeContext i;
	...
	if (num == 0)
	{
		...
		func_93(-2008016205, bParam0);
	}

	return;
}

void func_93(Hash hParam0, BOOL bParam1) // Position - 0x2CF6 Hash - 0x269D56BD ^0xB104E3E4
{
	Hash statName;
...
void func_94() // Position - 0x2D12 Hash - 0xEFF6029E ^0x224AB476
{
	eViewModeContext i;
...
BOOL func_95() // Position - 0x2D6A Hash - 0xA525B2F4 ^0xA525B2F4
{
	return IS_BIT_SET(Global_2621446, 3);
}

BOOL func_96(Player plParam0, int iParam1) // Position - 0x2D78 Hash - 0x5A3B86CC ^0x2CFA58CE
{
	BOOL flag;
...
int func_97(int iParam0, BOOL bParam1) // Position - 0x2DC3 Hash - 0x1DCD393E ^0x1DCD393E
{
	int num;
	int num2;
...
int func_98() // Position - 0x2E04 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1574918;
}

BOOL func_99() // Position - 0x2E10 Hash - 0xEBB0E6F7 ^0x19BAFBE9
{
...
void func_100() // Position - 0x2E41 Hash - 0xE6DF891A ^0x5986E94B
{
...
void func_101() // Position - 0x2E72 Hash - 0xA3BAFAC1 ^0xA3BAFAC1
{
...
void func_102(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x2F46 Hash - 0x86CEDF1 ^0xBC3E84C1
{
	var unk;
	float unk2;
...
Vector3 func_103() // Position - 0x2FD7 Hash - 0x28CC1A1D ^0x28CC1A1D
{
	return 0.5f, -0.5f, 2f;
}

Vector3 func_104(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x2FEA Hash - 0x8959C4D1 ^0x8922A2E2
{
	float num;
	float unk;
	float unk2;
...
float func_105(int iParam0, float fParam1) // Position - 0x302E Hash - 0x1E604EEF ^0x1E604EEF
{
	switch (iParam0)
	{
		case 1:
...
Vector3 func_106() // Position - 0x3067 Hash - 0x8664ACB1 ^0x8664ACB1
{
	return -0.5f, -0.5f, 0f;
}

void func_107(int iParam0, var uParam1, var uParam2) // Position - 0x307A Hash - 0x81D21288 ^0x81D21288
{
	if (func_4())
	{
		switch (iParam0)
...
void func_108() // Position - 0x363A Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

int func_109(int iParam0, int iParam1, BOOL bParam2) // Position - 0x3642 Hash - 0x75751681 ^0x9140C9A0
{
	int i;
...
BOOL func_110(BOOL bParam0) // Position - 0x3758 Hash - 0x1CCCE169 ^0x1CCCE169
{
	bParam0;
	return Global_1575035;
}

int func_111() // Position - 0x3769 Hash - 0xB1738241 ^0xB8EC8417
{
	int unk;
