...
BOOL func_66() // Hash - 0x7E9303CB ^0x5987130E
{
...
int func_77() // Hash - 0x5976C0FC ^0xC3C6644E
{
	return func_78(PLAYER::PLAYER_ID());
}

int func_78(Player plParam0) // Hash - 0x1A54F100 ^0x35DB7B9D
{
	return MISC::GET_BITS_IN_RANGE(Global_2657589[plParam0 /*466*/].f_321.f_3, 28, 31);
}

BOOL func_79(Player plParam0) // Hash - 0x131B8A8 ^0x131B8A8
{
...
BOOL func_80(Player plParam0) // Hash - 0x7C71011F ^0x7C71011F
{
	if (plParam0 != func_53() && func_54(plParam0, true, true))
...
BOOL func_82(Player plParam0) // Hash - 0xDB07D527 ^0x9815AB86
{
	if (plParam0 != func_53())
...
int func_83(int iParam0) // Hash - 0xEE599357 ^0xEE599357
{
	switch (iParam0)
	{
		case 0:
...
void func_84() // Hash - 0x43275282 ^0x43275282
{
	func_86(&uLocal_111);
	func_85();
	return;
...
void func_86(var uParam0) // Hash - 0x9537D004 ^0x18439461
{
	int localSceneFromNetworkId;
...
void func_87(Player plParam0, BOOL bParam1, eSetPlayerControlFlags espcfParam2, BOOL bParam3) // Hash - 0xCD788E2C ^0x50180146
{
...
BOOL func_88(int iParam0) // Hash - 0xFB453256 ^0xFB453256
{
	return iParam0 == 17;
}

void func_89() // Hash - 0xBC63612E ^0xBC63612E
{
	var unk;
...
void func_90() // Hash - 0x5FEB45C4 ^0x33557962
{
...
BOOL func_91(Ped pedParam0) // Hash - 0x93DB01D2 ^0x43DCC591
{
	int scriptTaskStatus;
...
void func_92(BOOL bParam0, Ped pedParam1, int iParam2) // Hash - 0x19FE7AFC ^0x4538006F
{
	int num;
	eViewModeContext i;
...
void func_93(Hash hParam0, BOOL bParam1) // Hash - 0x269D56BD ^0xB104E3E4
{
	Hash statName;
...
void func_94() // Hash - 0xEFF6029E ^0x224AB476
{
	eViewModeContext i;
...
BOOL func_95() // Hash - 0xA525B2F4 ^0xA525B2F4
{
	return IS_BIT_SET(Global_2621446, 3);
}

BOOL func_96(Player plParam0, int iParam1) // Hash - 0x5A3B86CC ^0x2CFA58CE
{
	BOOL flag;
...
int func_97(int iParam0, BOOL bParam1) // Hash - 0x1DCD393E ^0x1DCD393E
{
	int num;
	int num2;
...
int func_98() // Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1574918;
}

BOOL func_99() // Hash - 0xEBB0E6F7 ^0x19BAFBE9
{
...
void func_100() // Hash - 0xE6DF891A ^0x5986E94B
{
...
void func_101() // Hash - 0xA3BAFAC1 ^0xA3BAFAC1
{
...
void func_102(int iParam0, var uParam1, int iParam2, int iParam3) // Hash - 0x86CEDF1 ^0xBC3E84C1
{
	var unk;
	float num;
...
Vector3 func_103() // Hash - 0x28CC1A1D ^0x28CC1A1D
{
	return 0.5f, -0.5f, 2f;
}

Vector3 func_104(float fParam0, var uParam1, var uParam2, float fParam3) // Hash - 0x8959C4D1 ^0x8922A2E2
{
	float num;
	float num2;
	float num3;
...
float func_105(int iParam0, float fParam1) // Hash - 0x1E604EEF ^0x1E604EEF
{
	switch (iParam0)
	{
		case 1:
...
Vector3 func_106() // Hash - 0x8664ACB1 ^0x8664ACB1
{
	return -0.5f, -0.5f, 0f;
}

void func_107(int iParam0, var uParam1, var uParam2) // Hash - 0x81D21288 ^0x81D21288
{
	if (func_4())
	{
		switch (iParam0)
...
int func_109(int iParam0, int iParam1, BOOL bParam2) // Hash - 0x75751681 ^0x9140C9A0
{
	int i;
...
int func_111() // Hash - 0xB1738241 ^0xB8EC8417
{
	int unk;
