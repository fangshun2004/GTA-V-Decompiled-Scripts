...
BOOL func_2(Any* panParam0) // Hash - 0xC41F413B ^0xC41F413B
{
	const char* str;
	var unk32;
...
struct<2> func_9(int iParam0) // Hash - 0x323E6781 ^0xA9561E41
{
	var unk;
	var unk3;
...
void func_19() // Hash - 0x429A4038 ^0xE5FEEC32
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("MISSION_STAT_WATCHER")) > 0)
	{
		if (func_20())
...
void func_23(char* sParam0, int iParam1, Ped pedParam2) // Hash - 0xB566D143 ^0xE5643607
{
...
BOOL func_44(int iParam0, int iParam1, char* sParam2, var uParam3) // Hash - 0x8E372EAA ^0x9FDB5021
{
...
void func_109(int iParam0) // Hash - 0x35AC36F2 ^0x61E52A08
{
	int num;
	var textLabel;
...
void func_112(char* sParam0, Any anParam1, int iParam2) // Hash - 0x817AB180 ^0xE9AA10E4
{
...
struct<2> func_114(int iParam0) // Hash - 0x975AC8C9 ^0x791D905D
{
	var unk;
...
void func_115(int iParam0, var uParam1) // Hash - 0x2D8E3F8 ^0x62FE2856
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_148(const char* sParam0) // Hash - 0x16488C7A ^0xBEB686B
{
...
void func_181(int iParam0, var uParam1) // Hash - 0x16CCAA18 ^0x8427EBA6
{
	if (iParam0 == 1)
	{
		if (!func_135(uParam1))
...
int func_193(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Hash - 0xA74186BF ^0x512FC932
{
	var unk;
...
void func_194(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Hash - 0xF7ECDFD9 ^0x6B079C3E
{
...
void func_195(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Hash - 0xC6B752B2 ^0xC6B752B2
{
...
void func_198(var uParam0, var uParam1, char* sParam2) // Hash - 0x9391CC50 ^0x5DA64EFA
{
...
BOOL func_199(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Hash - 0x384540C1 ^0x384540C1
{
...
BOOL func_200(char* sParam0, int iParam1, BOOL bParam2) // Hash - 0x77297D51 ^0x40DC584A
{
	Global_21726 = 0;
...
void func_201() // Hash - 0xF42BEB19 ^0xA29557DA
{
	if (!func_202())
		return;
...
BOOL func_202() // Hash - 0x7B74B45F ^0xCE052A5D
{
...
BOOL func_203(Player plParam0) // Hash - 0x6E46BC72 ^0x6E46BC72
{
	return func_204(plParam0, 20);
}

BOOL func_204(Player plParam0, int iParam1) // Hash - 0x7CD5054C ^0x870BEA81
{
	return IS_BIT_SET(Global_1894573[plParam0 /*608*/].f_10.f_4, iParam1);
}

void func_205() // Hash - 0xDB58E314 ^0x659F4BC8
{
	int i;
...
void func_206() // Hash - 0xCD8A4D28 ^0xCD8A4D28
{
...
BOOL func_207() // Hash - 0x9A999369 ^0x4033F7BF
{
	int num;
	int weaponHash;
...
void func_208() // Hash - 0x98476CE1 ^0x250FEB7C
{
	if (func_57(14))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
...
void func_209() // Hash - 0xBE88A374 ^0x346CCAD1
{
	int i;
...
float func_210(Ped pedParam0, Entity eParam1, BOOL bParam2) // Hash - 0x7B2C17A2 ^0xDF922C6D
{
	Vector3 entityCoords;
...
BOOL func_219(Any* panParam0, BOOL bParam1) // Hash - 0x7D86F6E4 ^0x10AB4B0E
{
	var unk;
...
void func_249(Vehicle veParam0) // Hash - 0xAD821AF8 ^0x9C3FBF01
{
	int taskSequenceId;
...
BOOL func_257(var uParam0) // Hash - 0x392B1438 ^0xA77E2C2B
{
	switch (*uParam0)
	{
		case 0:
...
BOOL func_258(var uParam0) // Hash - 0x4858DD7B ^0xF4A6DEA3
{
	int num;
	int i;
	BOOL flag;
...
void func_259(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Hash - 0x60B41505 ^0x2C4B5209
{
	func_260(pveParam0);
...
void func_260(Vehicle* pveParam0) // Hash - 0x8D18F713 ^0xF71A18A8
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_261(Ped* ppedParam0, int iParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Hash - 0x5E27D69A ^0xE8A3C3CE
{
...
BOOL func_262(Ped* ppedParam0, int iParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Hash - 0xC57592AD ^0x9AA0BE7
{
	Hash model;
...
int func_263(var uParam0, int iParam1) // Hash - 0x5AC42C11 ^0x5AC42C11
{
	int num;
...
void func_265(var uParam0, char* sParam1, char* sParam2, int iParam3) // Hash - 0x6EEDFC2 ^0xD51569DC
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
BOOL func_266(var uParam0) // Hash - 0xA3C0453 ^0xCBFAD5DF
{
	Hash model;
	BOOL flag;
...
BOOL func_267(int iParam0) // Hash - 0x59D2F680 ^0x59D2F680
{
	var unk;
	int num;
...
BOOL func_268(int iParam0) // Hash - 0xC6B32843 ^0xABD2BF8E
{
	const char* string2;
...
BOOL func_269(int iParam0) // Hash - 0x791D84F4 ^0x791D84F4
{
	var unk;
...
BOOL func_270(int iParam0) // Hash - 0xDEAD9A68 ^0xDEAD9A68
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_271(int iParam0, char* sParam1) // Hash - 0xC64245F ^0xF57CBE1C
{
...
BOOL func_272(int iParam0) // Hash - 0x5ADD7F05 ^0x5ADD7F05
{
...
BOOL func_273(int iParam0) // Hash - 0xBB053D24 ^0xBB053D24
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_274(int iParam0) // Hash - 0x5D95A044 ^0x5D95A044
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_275(int iParam0) // Hash - 0x9FFC81CD ^0x47A2AB8B
{
	if (func_251(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
void func_276() // Hash - 0x5631C87C ^0x727EA67B
{
...
BOOL func_277(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Hash - 0x5B983661 ^0x5B983661
{
	int i;
...
BOOL func_278(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Hash - 0xC6B7068B ^0xB9A971A4
{
	int num;
	char* str;
...
BOOL func_279(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Hash - 0x1FB736D4 ^0x234AEAB7
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_280(var uParam0, BOOL bParam1) // Hash - 0xBF3AD5AF ^0xE88C1936
{
	char* str;
...
void func_281(char* sParam0) // Hash - 0xA52CF679 ^0xC94F8C8B
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
		if (func_284(sParam0))
			func_282();
...
void func_282() // Hash - 0xC536DD5 ^0xC536DD5
{
	Global_20591 = 0;
	func_283();
	return;
...
void func_283() // Hash - 0xF6D04E68 ^0x80AE5309
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_22736 = 0;
...
BOOL func_284(char* sParam0) // Hash - 0x5CF3EDA6 ^0x878C8302
{
	var string1;
...
struct<6> func_285() // Hash - 0xB37EF8EF ^0xB37EF8EF
{
	var unk;
...
void func_286(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Hash - 0x5BE1D1E3 ^0x5BE1D1E3
{
...
void func_287(var uParam0, BOOL bParam1) // Hash - 0xEDC3BD2D ^0xE0B6F056
{
	func_288(&(uParam0->f_41), bParam1);
	return;
}

void func_288(var uParam0, BOOL bParam1) // Hash - 0x9E80EA71 ^0x9E80EA71
{
	int i;
...
void func_289(Object* pobParam0, BOOL bParam1) // Hash - 0xD7EE3E27 ^0xC5769B29
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_290(var uParam0, BOOL bParam1) // Hash - 0xEDC3BD2D ^0xE2474F74
{
	func_291(&(uParam0->f_35), bParam1);
	return;
}

void func_291(var uParam0, BOOL bParam1) // Hash - 0xA98F6284 ^0xA98F6284
{
	int i;
...
void func_292(Vehicle* pveParam0) // Hash - 0xC50F9886 ^0x638B6124
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_293(var uParam0, int iParam1) // Hash - 0xEDC3BD2D ^0xA9A19095
{
	func_294(&(uParam0->f_28), iParam1);
	return;
}

void func_294(var uParam0, int iParam1) // Hash - 0xB72ACFD2 ^0xB72ACFD2
{
	int i;
...
void func_295(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Hash - 0x34362197 ^0xC592197
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_296(Ped* ppedParam0) // Hash - 0xCA79453F ^0x7BA88177
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
void func_297(int iParam0) // Hash - 0x995C9E2 ^0x995C9E2
{
	if (*iParam0 == -1)
		return;
...
void func_298(char* sParam0) // Hash - 0x54B64147 ^0x56EEAFB9
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_299(var uParam0) // Hash - 0x4CD8BCE8 ^0xDB3FB345
{
	*uParam0 = -1;
...
void func_300() // Hash - 0x554DA35 ^0x83743C88
{
...
Hash func_301(int iParam0) // Hash - 0xBF0B24A5 ^0xBF0B24A5
{
	if (!func_36(iParam0))
		return func_47(iParam0);
	else
