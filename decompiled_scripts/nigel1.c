...
void __EntryFunction__()
{
	...
	fLocal_49 = 180f;
	iLocal_52 = 3;
	uLocal_97 = func_395(64);
	uLocal_98 = func_395(63);
	iLocal_99 = joaat("u_m_m_aldinapoli");
	iLocal_100 = joaat("premier");
	...
	if (func_355())
	{
		Global_80583 = 1;
		iLocal_96 = 0;
		while (!func_345(&Local_113))
		{
			SYSTEM::WAIT(0);
		}
		func_344(&Local_113, 0, 1);
		Global_80583 = 0;
	}
	iLocal_342 = func_343();
	func_342();
	while (true)
	{
		...
		func_325(Local_113.f_9, 0, 0, 0, 0, 0);
		switch (iLocal_339)
		{
			case 0:
				func_234();
...
void func_1()
{
	switch (iLocal_340)
	{
		case 0:
			bLocal_341 = false;
			func_233(&uLocal_174, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
			iLocal_340 = 1;
			break;
		...
		case 1:
			if (!bLocal_341)
			{
				bLocal_341 = func_217(&uLocal_174, "NIG1AAU", "NIG1A_COMM", 7, 0, 0, 0);
			}
			else if (!func_216())
			{
				iLocal_340 = 2;
		...
		if (bParam2)
		{
			if (!Global_80337)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_10178[iParam1 /*4*/] = { func_209(iParam0) };
					...
					{
						Global_10129[1 /*6*/] = { func_209(iParam0) };
		...
		case 1:
			switch (iLocal_343)
			{
				case 0:
					...
					{
						if (func_315(Local_113.f_28[0]))
						{
							CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_113.f_28[0], "Nigel", 0, 0, 0);
						}
						if (func_315(Local_113.f_28[1]))
						{
							CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_113.f_28[1], "MRS_Thornhill", 0, 0, 0);
						}
						func_314();
				...
				case 2:
					if (!CUTSCENE::IS_CUTSCENE_PLAYING())
					{
						func_242(1, 1, 1, 1);
						func_344(&Local_113, 0, 1);
						if (!func_315(Local_113.f_35[0]))
						{
							func_238(&(Local_113.f_35[0]), -1084.456f, 787.2556f, 163.986f, 100.8542f, 0, 1);
						}
						if (func_315(Local_113.f_35[0]))
						{
							func_237(Local_113.f_35[0], -1094.484f, 785.5936f, 163.2927f, 102.2748f, 0, 1);
							VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_113.f_35[0], 5f);
							VEHICLE::SET_DISABLE_PRETEND_OCCUPANTS(Local_113.f_35[0], true);
							if (func_315(Local_113.f_28[0]))
							{
								PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_113.f_28[0], joaat("player"));
								TASK::CLEAR_PED_TASKS_IMMEDIATELY(Local_113.f_28[0]);
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_113.f_28[0], true);
								PED::SET_PED_INTO_VEHICLE(Local_113.f_28[0], Local_113.f_35[0], -1);
								PED::SET_PED_KEEP_TASK(Local_113.f_28[0], true);
							}
							if (func_315(Local_113.f_28[1]))
							{
								PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_113.f_28[1], joaat("player"));
								TASK::CLEAR_PED_TASKS_IMMEDIATELY(Local_113.f_28[1]);
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_113.f_28[1], true);
								PED::SET_PED_INTO_VEHICLE(Local_113.f_28[1], Local_113.f_35[0], 0);
								PED::SET_PED_KEEP_TASK(Local_113.f_28[1], true);
							}
							VEHICLE::SET_VEHICLE_ENGINE_ON(Local_113.f_35[0], true, true, false);
							TASK::TASK_VEHICLE_DRIVE_WANDER(Local_113.f_28[0], Local_113.f_35[0], 20f, 786603);
						}
						RECORDING::REPLAY_STOP_EVENT();
						func_236(&(Local_113.f_28[0]), 1, 0, 1);
						func_236(&(Local_113.f_28[1]), 1, 0, 1);
						func_235(&(Local_113.f_35[0]));
						iLocal_339 = 1;
						iLocal_340 = 0;
					}
					break;
...
int func_238(int* iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam6 == 1)
	{
		while (!STREAMING::HAS_MODEL_LOADED(iLocal_100))
		{
			SYSTEM::WAIT(0);
		}
	}
	else if (!STREAMING::HAS_MODEL_LOADED(iLocal_100))
	{
		return 0;
	}
	func_239(iParam0, iLocal_100, Param1, fParam4);
	if (func_315(*iParam0))
	{
...
void func_257(struct<3> Param0, float fParam3, int iParam4, int iParam5)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_105520.f_4))
	{
		...
		{
			if (func_305(24) != Global_105520.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_302(ENTITY::GET_ENTITY_COORDS(Global_105520.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_258(Global_105520.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}
...
void func_259(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_289(&(Global_79127.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, false))
		{
			...
			if (iParam0 == 24)
			{
				Global_114963.f_32759.f_4801 = func_278();
			}
...
void func_260(int iParam0, int iParam1)
{
	...
	func_297(iParam0, &(Global_114963.f_32759.f_5510));
}
...
int func_289(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_296(Global_114963.f_32759.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_296(Global_114963.f_2370.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_296(Global_114963.f_2370.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_292(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)
{
	if (func_289(&(Global_79127.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_294(iParam0);
			func_293(uParam1, &(Global_114963.f_32759.f_69[Global_79127.f_555[0 /*21*/].f_14 /*78*/]));
	...
	if (Global_80592 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_327(Global_80593, Global_80595, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
{
	if (((!func_339(0) || Global_80608) || Global_80596 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_80592)
...
{
	return func_341(iParam0, Global_44921);
}
...
int func_345(var uParam0)
{
	...
	switch (iLocal_96)
	{
		...
		case 2:
			...
			{
				func_239(&(uParam0->f_35[0]), iLocal_100, -1077.959f, 793.9361f, 164.6374f, 172.8563f);
...
void func_346(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 38:
			if (bParam1)
			{
				iLocal_112 = PED::ADD_SCENARIO_BLOCKING_AREA(-577.274f, 270.6505f, 77f, -543.1793f, 315.2973f, 94f, false, true, true, true, 1);
				TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_GUARD_STAND", false);
				TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_CLIPBOARD", false);
				TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_DRIVE_SOLO", false);
		...
		case 39:
			if (bParam1)
			{
				iLocal_112 = PED::ADD_SCENARIO_BLOCKING_AREA(-1073.19f, 342.05f, 63.32832f, -966.24f, 411.05f, 84.82043f, false, true, true, true, 1);
		...
		case 41:
			if (bParam1)
			{
				iLocal_112 = PED::ADD_SCENARIO_BLOCKING_AREA(-1122.202f, 48.5724f, 51.4652f, -1076.233f, 92.1041f, 60.0617f, false, true, true, true, 1);
		...
		case 42:
			if (bParam1)
			{
				iLocal_112 = PED::ADD_SCENARIO_BLOCKING_AREA(-1319.566f, -650.077f, 23.53715f, -1301.789f, -634.0721f, 38.18122f, false, true, true, true, 1);
...
int func_373()
{
	...
	iVar0 = func_374(&(Global_102486.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_377()
{
	...
	{
		if (func_372(&(Global_102486.f_3)) > -1)
		{
			return 1;
		}
	}
