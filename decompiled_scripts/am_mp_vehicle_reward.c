...
void func_394(struct<3> Param0)
{
	...
	SCRIPT::TRIGGER_SCRIPT_EVENT(1, &Var0, 5, func_395(1, 1));
}
...
{
	if (!func_195() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2))
	{
		return 1;
	}
	return 0;
...
void func_479(struct<3> Param0, var uParam3, int iParam4, var uParam5)
{
	...
	*uParam5 = func_480(&Param0, &uParam3, &iParam4);
	...
	Var0.f_6 = iParam4;
	Var0.f_7 = *uParam5;
	SCRIPT::TRIGGER_SCRIPT_EVENT(1, &Var0, 8, func_395(1, 1));
}
