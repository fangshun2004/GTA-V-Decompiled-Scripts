...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (func_71(PLAYER::PLAYER_ID()))
		{
			if (func_70())
			{
				func_67(&iLocal_146, -271.6364f, 289.377f, 103.994f, 63, "MSG_BLP_EL", 0.8f, 0, 0);
			}
			else
			{
				func_66(&iLocal_146);
...
bool func_70()
{
	return BitTest(Global_1950702.f_11, 17);
}
...
int func_71(int iParam0)
{
	if (iParam0 != func_52())
	{
		return Global_1845298[iParam0 /*881*/].f_260.f_524 != 0;
	}
	return 0;
}
...
int func_72()
{
	...
	if (MISC::GET_DISTANCE_BETWEEN_COORDS(func_83(PLAYER::PLAYER_ID()), Global_1950702.f_1323[161 /*3*/], true) >= 150f)
	{
		return 1;
	}
	if (func_75())
...
int func_84(int iParam0)
{
	if (iParam0 != func_52())
	{
		...
		else if ((Global_1575095 && iParam0 == PLAYER::PLAYER_ID()) && func_53(iParam0, 1, 0))
		{
			return Global_2658293[iParam0 /*468*/].f_325.f_8 != -1;
		}
	}
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(iParam0) && (PLAYER::IS_PLAYER_PLAYING(iParam0) || iParam3 == 1))
		{
			...
			if (!bVar20)
			{
				...
				else if (bVar14 || ((!func_102(PLAYER::PLAYER_ID(), 0) && !func_101()) && !func_100(PLAYER::PLAYER_ID())))
				{
			...
			if (bParam1)
			{
				...
				if (!func_96(iVar27) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(iVar27))
				{
					if (!bVar22)
					{
...
void func_97(bool bParam0, int iParam1, int iParam2)
{
	...
	if (iVar0 == 0)
	{
		...
		func_98(joaat("mpply_is_char_spectating"), bParam0);
	}
}
...
void func_109(int iParam0, var uParam1, int iParam2, int iParam3)
{
	...
	uParam1->f_16[iParam2 /*14*/].f_6.f_1 = { func_111(func_112(), fVar3) + Var0 };
	uParam1->f_16[iParam2 /*14*/].f_6.f_4 = { func_111(func_110(), fVar3) + Var0 };
...
Vector3 func_111(struct<3> Param0, float fParam3)
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
