...
void func_1(var uParam0) // Hash - 0x8E2B5D9C ^0x4B1026F3
{
...
void func_2(var uParam0, int iParam1) // Hash - 0x4F8BE4B5 ^0x533746C9
{
	uParam0->f_13 = iParam1;
	return;
}

void func_3(int iParam0) // Hash - 0x78EE7F8F ^0x8F4DB782
{
...
void func_4(var uParam0) // Hash - 0x8FDF8FEB ^0xB6E3D0FD
{
	if (uParam0->f_6 != -1)
	{
		func_5(&(uParam0->f_6));
...
void func_5(var uParam0) // Hash - 0xFE5630E8 ^0xFE5630E8
{
	int num;
...
int func_6(int iParam0) // Hash - 0x7F0E29AD ^0x84091235
{
	int i;
...
void func_7(var uParam0) // Hash - 0x91966747 ^0x6CE9840E
{
	var animDict;
	var animName;
		...
		case 2:
			if (func_56(PLAYER::PLAYER_PED_ID(), &uParam0->f_16[uParam0->f_9 /*14*/]) && func_55(PLAYER::PLAYER_PED_ID(), uParam0->f_16[uParam0->f_9 /*14*/].f_3, uParam0->f_16[uParam0->f_9 /*14*/].f_13))
			{
				if (func_54(uParam0) || func_50(uParam0) || func_49(uParam0) || !func_48(uParam0) || func_46(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_PERFORMING_MELEE_ACTION(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) || IS_BIT_SET(Global_1950108.f_4, 2))
				{
					...
					if (func_50(uParam0))
					{
						func_45(&(uParam0->f_6), 4, _("Too many players near activity."), 0, 0, 0, 0);
					}
					else
					{
						func_5(&(uParam0->f_6));
				...
				else if (uParam0->f_6 == -1)
				{
					if (MISC::GET_GAME_TIMER() - uParam0->f_11 > 150)
						if (func_44(uParam0->f_9) && !Global_262145.f_27071)
							func_45(&(uParam0->f_6), 4, _("Press ~INPUT_CONTEXT~ to sit down, watch TV or play \"Don't Cross The Line\"."), 0, 0, 0, 0);
						else
							func_45(&(uParam0->f_6), 4, _("Press ~INPUT_CONTEXT~ to sit down."), 0, 0, 0, 0);
				}
...
void func_8(var uParam0, BOOL bParam1) // Hash - 0xA743C8AE ^0x192DADA9
{
...
int func_9(var uParam0) // Hash - 0x8A059B4A ^0xCFB4F139
{
	int num;
...
BOOL func_10() // Hash - 0x5976C0FC ^0xC3C6644E
{
	return func_11(PLAYER::PLAYER_ID());
}

BOOL func_11(Player plParam0) // Hash - 0x2281DC14 ^0xFBEE7D11
{
...
int func_12(int iParam0) // Hash - 0x3133C6A9 ^0x3133C6A9
{
	switch (iParam0)
	{
		case 0:
...
var func_13(BOOL bParam0, var uParam1, var uParam2) // Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_14(var uParam0) // Hash - 0x71FEF6ED ^0x56654229
{
	Vector3 vector;
	float num;
				...
				if (uParam0->f_6 == -1)
					if (uParam0->f_1.f_1 == 1 || uParam0->f_1.f_1 == 0)
						if (PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL))
							func_45(&(uParam0->f_6), 4, _("Use ~INPUT_SCRIPT_LEFT_AXIS_X~ to change pose.~n~Press ~INPUT_SCRIPT_RRIGHT~ to stand up."), 0, 0, 0, 0);
						else
							func_45(&(uParam0->f_6), 4, _("Use ~INPUT_SCRIPT_LEFT_AXIS_X~ to change pose.~n~Press ~INPUT_FRONTEND_RIGHT~ to stand up."), 0, 0, 0, 0);
					else if (PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL))
						func_45(&(uParam0->f_6), 4, _("Press ~INPUT_SCRIPT_RRIGHT~ to stand up."), 0, 0, 0, 0);
					else
						func_45(&(uParam0->f_6), 4, _("Press ~INPUT_FRONTEND_RIGHT~ to stand up."), 0, 0, 0, 0);
...
BOOL func_15(BOOL bParam0) // Hash - 0xCE5DD307 ^0xCD1D2820
{
...
BOOL func_16(Ped pedParam0) // Hash - 0x6E21113D ^0x5A7BE662
{
	int weaponHash;
...
BOOL func_17() // Hash - 0x8E975DBA ^0xBE61962E
{
...
BOOL func_18(var uParam0) // Hash - 0x8C89182D ^0x306838ED
{
	return func_23(&(uParam0->f_7), 9);
}

void func_19(var uParam0) // Hash - 0x887F29FE ^0x40C14014
{
	var animDict;
	var animnName;
...
void func_20(var uParam0) // Hash - 0x4063D839 ^0xADBCFF3F
{
	var animDict;
...
BOOL func_21() // Hash - 0x7C772DD7 ^0xEEB28EBB
{
	return IS_BIT_SET(Global_1950108.f_3, 25);
}

void func_22(int* piParam0, int iParam1) // Hash - 0xAEE04633 ^0xC5A9CA3F
{
	MISC::SET_BIT(piParam0, iParam1);
	return;
}

BOOL func_23(var uParam0, int iParam1) // Hash - 0xDDB0D9A1 ^0xDDB0D9A1
{
	return IS_BIT_SET(*uParam0, iParam1);
}

BOOL func_24(float fParam0, float fParam1, float fParam2) // Hash - 0x142F7A4A ^0x142F7A4A
{
	float num;
	float num2;
...
void func_25(var uParam0) // Hash - 0x9B12A959 ^0x85698023
{
	int weaponHash;
...
void func_26() // Hash - 0x9A142650 ^0xE9E53C81
{
	Global_23131.f_6 = 1;
	return;
}

void func_27(BOOL bParam0) // Hash - 0x3BC9F316 ^0x93329F82
{
	if (bParam0)
		if (func_28())
...
BOOL func_28() // Hash - 0xEDAE0057 ^0x5A1A7786
{
	return IS_BIT_SET(Global_2683862.f_2, 11);
}

void func_29() // Hash - 0x4941A993 ^0x296D04CD
{
	MISC::SET_BIT(&Global_8254, 4);
	return;
}

void func_30(int iParam0) // Hash - 0x7E11E9C ^0x544BF257
{
	if (func_36())
		return;
...
void func_33(BOOL bParam0, BOOL bParam1) // Hash - 0xF40FC178 ^0xA6F60F17
{
	if (bParam0)
	{
		if (func_35(0))
...
BOOL func_35(int iParam0) // Hash - 0xE8921B44 ^0x4F063755
{
	if (iParam0 == 1)
...
BOOL func_36() // Hash - 0xC41437CB ^0xC41437CB
{
	return IS_BIT_SET(Global_1962996, 19);
}

Vector3 func_37(var uParam0) // Hash - 0x8B39104F ^0xF54E1DAC
{
	var unk;
...
Vector3 func_38(var uParam0) // Hash - 0x420504C3 ^0xDC7693F8
{
	return uParam0->f_16[uParam0->f_9 /*14*/];
}

void func_39(var uParam0, char* sParam1) // Hash - 0xC4B2A3C8 ^0x683284B9
{
	if (uParam0->f_1.f_1 == 1)
	{
		if (func_10())
...
void func_40(var uParam0, char* sParam1) // Hash - 0x8975B317 ^0xB9B693A0
{
...
void func_41(var uParam0) // Hash - 0x9CDF7BA9 ^0x1CFCDB6E
{
...
int func_42(var uParam0) // Hash - 0x474CDCA0 ^0xE3AE8FD8
{
	int randomIntInRange;
...
int func_43(int iParam0) // Hash - 0x26AB94C2 ^0x26AB94C2
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_44(int iParam0) // Hash - 0xD55999B8 ^0x13BF8162
{
	switch (iParam0)
	{
		case 2:
...
BOOL func_46(Player plParam0) // Hash - 0x1B551CF7 ^0xAB2412A1
{
	return func_47(plParam0) == joaat("WEAPON_MINIGUN");
}

int func_47(Player plParam0) // Hash - 0x9A12FE93 ^0x9A12FE93
{
	return Global_1894573[plParam0 /*608*/].f_585;
}

BOOL func_48(var uParam0) // Hash - 0xC4DC15CC ^0x78623F1
{
	*uParam0(!func_23(&(uParam0->f_7), 5), &uParam0->f_16[uParam0->f_9 /*14*/], uParam0->f_9);
	return StackVal || StackVal;
}

BOOL func_49(var uParam0) // Hash - 0x2ACFA271 ^0xBC9FDE1B
{
	var sizeAndPeds;
	int i;
...
BOOL func_50(var uParam0) // Hash - 0x5A66F202 ^0x4225076A
{
	int i;
	Player playerIndex;
	...
	for (i = 0; i < NETWORK::NETWORK_GET_MAX_NUM_PARTICIPANTS(); i = i + 1)
	{
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(i)))
		{
			...
			if (playerIndex != PLAYER::PLAYER_ID() && func_53(playerIndex, true, true))
...
int func_51(Player plParam0) // Hash - 0x89E9F0BB ^0x89E9F0BB
{
	if (plParam0 != func_52())
...
BOOL func_53(Player plParam0, BOOL bParam1, BOOL bParam2) // Hash - 0x3FF6E4CA ^0xE6B59972
{
	Player player;
...
BOOL func_54(var uParam0) // Hash - 0x5DB3FF9E ^0xC7881261
{
	return uParam0->f_7 & 31 > 0;
}

BOOL func_55(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Hash - 0xAA0785B0 ^0x58869507
{
...
BOOL func_56(Ped pedParam0, var uParam1) // Hash - 0x6712051B ^0x6E11D0BF
{
	return ENTITY::IS_ENTITY_IN_ANGLED_AREA(pedParam0, uParam1->f_6.f_1, uParam1->f_6.f_4, uParam1->f_6, false, true, 0);
}

BOOL func_57(var uParam0) // Hash - 0xC8209414 ^0xCBFFB693
{
	int i;
...
BOOL func_58(int iParam0) // Hash - 0x1F4C0CA3 ^0x1F4C0CA3
{
	switch (iParam0)
	{
		case 1:
...
void func_59(int* piParam0, int iParam1) // Hash - 0xAEE04633 ^0xFF7FBF85
{
	MISC::CLEAR_BIT(piParam0, iParam1);
	return;
}

void func_60(var uParam0) // Hash - 0x7C92BF3B ^0x568F172A
{
	if (uParam0->f_13 == 6)
	{
	}
...
float func_61() // Hash - 0x22FB54B8 ^0x22FB54B8
{
	return 0.13f;
}

void func_62(var uParam0) // Hash - 0xFBA1CE25 ^0xBA375A2E
{
...
void func_63(int* piParam0, int iParam1, BOOL bParam2) // Hash - 0xCE3B1F15 ^0x328D875C
{
	int offset;
...
BOOL func_64() // Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_75693;
}

BOOL func_65() // Hash - 0xBB916174 ^0xBB916174
{
...
void func_66(Blip* pblParam0) // Hash - 0x4C359FE5 ^0xBAF5111C
{
...
void func_67(var uParam0, float fParam1, float fParam2, float fParam3, eBlipSprite ebsParam4, char* sParam5, int iParam6, BOOL bParam7, BOOL bParam8) // Hash - 0x9CCA6EF ^0xD96D0A60
{
...
Blip func_68(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Hash - 0xF4E99477 ^0x29669E98
{
	Blip blip;
...
BOOL func_70() // Hash - 0x87650690 ^0xD7035550
{
	return IS_BIT_SET(Global_1950108.f_11, 17);
}

BOOL func_71(Player plParam0) // Hash - 0x4D4B5ACC ^0x4D4B5ACC
{
	if (plParam0 != func_52())
...
BOOL func_72() // Hash - 0xBD74D16F ^0x25E20843
{
...
BOOL func_73() // Hash - 0xDBD936D3 ^0xDBD936D3
{
	if (func_74() == 0)
		return true;
...
int func_74() // Hash - 0x4228A1C2 ^0x58D4D226
{
	return Global_1574632.f_18;
}

BOOL func_75() // Hash - 0x52E21E9B ^0xD0F85E96
{
...
Hash func_76() // Hash - 0x90B5165C ^0xB8DD5DC8
{
	switch (func_78())
	{
		case 0:
...
Hash func_77() // Hash - 0x61402777 ^0xB9FAC976
{
...
int func_78() // Hash - 0x21D64237 ^0x21D64237
{
	return Global_32163;
}
...
BOOL func_80(int iParam0) // Hash - 0xA28ADBB4 ^0x6EB81E64
{
...
BOOL func_81() // Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_2694524;
}

BOOL func_82() // Hash - 0x974E48B4 ^0x974E48B4
{
	return Global_2683862.f_693;
}

Vector3 func_83(Player plParam0) // Hash - 0x6712BF53 ^0x688D5BEC
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(plParam0), false);
}

BOOL func_84(Player plParam0) // Hash - 0xA439E034 ^0x18C6D29E
{
	if (plParam0 != func_52())
		if (func_53(plParam0, true, true))
			return Global_2657589[plParam0 /*466*/].f_321.f_7 != -1;
		else if (Global_1575060 && plParam0 == PLAYER::PLAYER_ID() && func_53(plParam0, true, false))
			return Global_2657589[plParam0 /*466*/].f_321.f_7 != -1;

	return false;
}

BOOL func_85(Player plParam0) // Hash - 0x3BED6F11 ^0x3BED6F11
{
	if (plParam0 != func_52() && func_53(plParam0, true, true))
		return IS_BIT_SET(Global_2657589[plParam0 /*466*/].f_321, 3);

	return false;
}

void func_86() // Hash - 0xA97B5576 ^0xA97B5576
{
	func_88(&uLocal_113);
	func_66(&uLocal_112);
	func_87();
...
void func_87() // Hash - 0xCE5FB49E ^0x214A59D5
{
	SCRIPT::TERMINATE_THIS_THREAD();
	return;
}

void func_88(var uParam0) // Hash - 0x9537D004 ^0x18439461
{
	int localSceneFromNetworkId;
	...
	if (uParam0->f_13 > 2)
	{
		...
		func_89(PLAYER::PLAYER_ID(), true, 0, false);
	}
...
void func_89(Player plParam0, BOOL bParam1, eSetPlayerControlFlags espcfParam2, BOOL bParam3) // Hash - 0xCD788E2C ^0x50180146
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(plParam0) && PLAYER::IS_PLAYER_PLAYING(plParam0) || bParam3 == true)
		{
			...
			if (!flag18)
			{
				...
				else if (flag14 || !func_98(PLAYER::PLAYER_ID(), 0) && !func_97())
...
BOOL func_90(int iParam0) // Hash - 0xFB453256 ^0xFB453256
{
	return iParam0 == 17;
}

void func_91() // Hash - 0xBC63612E ^0xBC63612E
{
	var unk;
...
void func_92() // Hash - 0x5FEB45C4 ^0x33557962
{
...
BOOL func_93(Ped pedParam0) // Hash - 0x93DB01D2 ^0x43DCC591
{
	int scriptTaskStatus;
...
void func_94(BOOL bParam0, Ped pedParam1, int iParam2) // Hash - 0x19FE7AFC ^0x4538006F
{
	int num;
	eViewModeContext i;
...
void func_95(Hash hParam0, BOOL bParam1) // Hash - 0x269D56BD ^0xB104E3E4
{
	Hash statName;
...
void func_96() // Hash - 0xEFF6029E ^0x224AB476
{
	eViewModeContext i;
...
BOOL func_97() // Hash - 0xA525B2F4 ^0xA525B2F4
{
	return IS_BIT_SET(Global_2621446, 3);
}

BOOL func_98(Player plParam0, int iParam1) // Hash - 0x5A3B86CC ^0x2CFA58CE
{
	BOOL flag;
...
int func_99(int iParam0, BOOL bParam1) // Hash - 0x1DCD393E ^0x1DCD393E
{
	int num;
	int num2;
...
int func_100() // Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1574918;
}

BOOL func_101() // Hash - 0xEBB0E6F7 ^0x19BAFBE9
{
...
void func_102() // Hash - 0x67A21019 ^0x8AD1793C
{
...
void func_103() // Hash - 0xEEEC13C9 ^0xEEEC13C9
{
...
void func_104(int iParam0, var uParam1, int iParam2, int iParam3) // Hash - 0x86CEDF1 ^0xBC3E84C1
{
	var unk;
	float num;
...
Vector3 func_105() // Hash - 0x28CC1A1D ^0x28CC1A1D
{
	return 0.4f, -0.5f, 2f;
}

Vector3 func_106(float fParam0, var uParam1, var uParam2, float fParam3) // Hash - 0x8959C4D1 ^0x8922A2E2
{
	float num;
	float num2;
	float num3;
...
Vector3 func_107() // Hash - 0x8664ACB1 ^0x8664ACB1
{
	return -0.4f, -0.5f, 0f;
}

void func_108(int iParam0, var uParam1, var uParam2) // Hash - 0x9E1BADF3 ^0x9E1BADF3
{
	switch (iParam0)
	{
		case 0:
...
void func_109() // Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

int func_110(int iParam0, int iParam1, BOOL bParam2) // Hash - 0x75751681 ^0x9140C9A0
{
	int i;
...
BOOL func_111(BOOL bParam0) // Hash - 0x1CCCE169 ^0x1CCCE169
{
	bParam0;
