...
void func_1() // Hash - 0xF5785730 ^0xCB34D4A5
{
	func_109(0);
...
void func_2() // Hash - 0xADB1A28A ^0x78281A7F
{
...
void func_3(var uParam0, var uParam1) // Hash - 0x8BC2932B ^0x3DC6EAFB
{
...
int func_4(eHudColour ehcParam0) // Hash - 0x434C2D6E ^0x434C2D6E
{
	int r;
	int g;
	int b;
...
Blip func_5(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Hash - 0xF4E99477 ^0x29669E98
{
	Blip blip;
...
Vector3 func_7(float fParam0, var uParam1, var uParam2) // Hash - 0x772D91C7 ^0x2A750533
{
	float num;
...
BOOL func_8() // Hash - 0xBA519C1 ^0x474027E8
{
	return HUD::GET_PAUSE_MENU_STATE() != 0;
}

void func_9() // Hash - 0xEB0D43DD ^0xEB0D43DD
{
	Global_1574839 = 1;
	return;
}

void func_10(const char* sParam0, BOOL bParam1) // Hash - 0x863FE9CA ^0xD4F511B0
{
...
void func_13() // Hash - 0x8490122 ^0xE0A1F31C
{
...
void func_14(var uParam0, var uParam1) // Hash - 0x48BC390F ^0x45281A45
{
	BOOL flag;
	int i;
	int num;
...
void func_15(int iParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8) // Hash - 0x27A51DEF ^0xFA033CDB
{
	int num;
	int i;
	int j;
...
void func_16(char* sParam0) // Hash - 0x8E2F5FE2 ^0x29D9D432
{
...
void func_17(char* sParam0) // Hash - 0x690E6520 ^0x509C71F3
{
...
BOOL func_21() // Hash - 0x8034D5B3 ^0x6404C51
{
	var position;
...
BOOL func_22() // Hash - 0x3CA1BB47 ^0x894044A3
{
...
BOOL func_23(BOOL bParam0, BOOL bParam1) // Hash - 0x64BEBD7A ^0xE226A347
{
...
BOOL func_26(var uParam0, BOOL bParam1, int iParam2) // Hash - 0x5D26C738 ^0x7D8419D1
{
	var unk;
	Hash hashKey;
	int i;
...
void func_27(int iParam0) // Hash - 0xE47D2A15 ^0xE47D2A15
{
	Global_1655472.f_1163 = iParam0;
	return;
}

void func_28(eControlAction ecaParam0, char* sParam1, int iParam2, BOOL bParam3) // Hash - 0x1F0633B6 ^0x199DA912
{
...
void func_29(int iParam0, char* sParam1, int iParam2) // Hash - 0x8FB9B331 ^0x10C6AC02
{
...
void func_30(int iParam0) // Hash - 0xEAAA7E0E ^0xEAAA7E0E
{
	int i;
	int num;
...
BOOL func_31(char* sParam0, int iParam1, BOOL bParam2) // Hash - 0xF7C7CB5C ^0x1F94FA7F
{
	int num;
	BOOL flag;
	BOOL flag2;
...
void func_33() // Hash - 0xC7D038E6 ^0xC941FE4C
{
...
void func_34() // Hash - 0x28726679 ^0x8BFBE7E6
{
...
void func_35(const char* sParam0) // Hash - 0xAE902D52 ^0xF2628535
{
	if (MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
		return;
...
void func_36() // Hash - 0xE6D3EF94 ^0xBAA3B847
{
	if (IS_BIT_SET(caLocal_160.f_60, 5))
	{
...
void func_38(int iParam0, float fParam1, float fParam2, var uParam3, float fParam4, float fParam5) // Hash - 0x67B79C2D ^0x685E3CE1
{
...
void func_39(int iParam0, int iParam1, int iParam2, int iParam3) // Hash - 0x951898EB ^0xBA1359C7
{
...
void func_40(int iParam0, BOOL bParam1) // Hash - 0x4F96915E ^0xAC76A7E3
{
...
void func_41() // Hash - 0xB9F6935C ^0x6DA190BB
{
	float num;
	var unk4;
	var unk7;
...
void func_42(const char* sParam0, const char* sParam1, int iParam2, const char* sParam3, int iParam4, const char* sParam5, int iParam6, const char* sParam7, int iParam8, const char* sParam9, int iParam10, const char* sParam11, float fParam12, Vector3 vParam13, var uParam14, var uParam15, int iParam16, BOOL bParam17) // Hash - 0xED45F14B ^0x31AC171D
{
	float num;
	Vehicle vehicle;
...
void func_43(Cam caParam0, Vector3 vParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, Entity eParam7) // Hash - 0xA2A96FDD ^0x5BE18C8A
{
...
void func_44(Cam caParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Hash - 0x9E71332F ^0x13BDDA45
{
...
Vector3 func_45(float fParam0, var uParam1, var uParam2, float fParam3) // Hash - 0x8959C4D1 ^0x8922A2E2
{
	float num;
	float num2;
	float num3;
...
struct<4> func_46(Cam caParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, float fParam8, var uParam9) // Hash - 0x3C6588E5 ^0x3FA030F3
{
	float camFov;
	float num;
...
Vector3 func_47(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Hash - 0xE5D85A8D ^0x25642281
{
...
float func_48(float fParam0) // Hash - 0xFE965D16 ^0xFE965D16
{
	while (fParam0 > 180f)
	{
...
void func_50() // Hash - 0x56B527DC ^0x6B7732DA
{
...
void func_51() // Hash - 0xFE470342 ^0x8B72676B
{
	var unk;
	var unk4;
	var unk7;
	...
	if (caLocal_160.f_29)
	{
		if (CAM::IS_SCREEN_FADED_OUT())
		{
			...
			else
			{
				...
				func_61(&(caLocal_160.f_17), false, false);
	...
	if (func_64())
	{
		if (func_52(&(caLocal_160.f_17), uLocal_64.f_8.f_2, false))
		{
			caLocal_160.f_29 = 1;
...
BOOL func_52(var uParam0, int iParam1, BOOL bParam2) // Hash - 0x154EA353 ^0xBFA672B0
{
	if (iParam1 == -1)
		return true;
...
BOOL func_54() // Hash - 0x8DF3D75D ^0x8DF3D75D
{
	return IS_BIT_SET(Global_1962996, 5);
}

void func_55(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Hash - 0x8EB494C3 ^0xB9140A5
{
...
BOOL func_56(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, BOOL bParam6) // Hash - 0x2D46096D ^0xEA41378F
{
	if (bParam6)
...
void func_57(BOOL bParam0) // Hash - 0x871D97D ^0x5B66DDB8
{
	if (bParam0)
	{
...
void func_58(float fParam0, float fParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Hash - 0xD147B833 ^0x4EA72A4D
{
	var unk;
...
float func_59(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Hash - 0x596BEA29 ^0x5FBCDBE5
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_60(var uParam0, var uParam1, var uParam2, float fParam3) // Hash - 0xFC840F79 ^0x19BE733E
{
...
void func_61(var uParam0, BOOL bParam1, BOOL bParam2) // Hash - 0x6A4AB354 ^0xD9372BF4
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !bParam1)
		if (!bParam2)
			*uParam0 = NETWORK::GET_NETWORK_TIME();
...
BOOL func_62(Player plParam0) // Hash - 0x43CB1CB6 ^0x43CB1CB6
{
	if (plParam0 != func_63())
...
Player func_63() // Hash - 0x478900E4 ^0x478900E4
{
	return -1;
}

BOOL func_64() // Hash - 0x14E9F131 ^0x443A55F9
{
	return IS_BIT_SET(Global_2764742, 4) || PAD::IS_DISABLED_CONTROL_JUST_PRESSED(PLAYER_CONTROL, INPUT_SCRIPT_RT);
}

BOOL func_65(int iParam0, float fParam1, float fParam2, float fParam3, var uParam4, var uParam5, var uParam6, float fParam7, float fParam8, float fParam9) // Hash - 0x5CB8EE08 ^0x8BA8EA24
{
	...
	if (func_69())
	{
		...
		{
			func_53(&uLocal_48, false, false);
		}
		else if (func_52(&uLocal_48, 8000, false))
		{
			func_67(&uLocal_48);
			func_66(false);
		}
...
void func_66(BOOL bParam0) // Hash - 0xEF78E4BC ^0x74422542
{
	if (bParam0)
...
void func_67(var uParam0) // Hash - 0xBA5A1D5A ^0x33644ECA
{
	uParam0->f_1 = 0;
	return;
}

BOOL func_68(var uParam0) // Hash - 0xD73B9827 ^0x2D8CE86B
{
	return uParam0->f_1;
}

BOOL func_69() // Hash - 0xDBFB17CA ^0xDBFB17CA
{
	return IS_BIT_SET(Global_1962996, 0);
}

void func_70() // Hash - 0x1A48AC0E ^0x86166B91
{
	BOOL flag;
	eHudColour color;
	...
	{
		flag = func_52(&(caLocal_160.f_22.f_2), 2000, false);
		...
		if (func_64())
		{
			...
			if (flag && func_52(&(caLocal_160.f_17), uLocal_64.f_8.f_2, false))
			{
				func_61(&(caLocal_160.f_17), false, false);
...
void func_71(float fParam0, var uParam1, var uParam2) // Hash - 0x4C8FE354 ^0x4C8FE354
{
	var unk;
...
void func_72(Entity eParam0, BOOL bParam1, eHudColour ehcParam2) // Hash - 0xFCBBF650 ^0x57013B91
{
	float width;
	float height;
...
float func_74(Entity eParam0, Cam caParam1, float fParam2) // Hash - 0x4FC1FFC6 ^0xFFFAC1CB
{
	Vector3 camCoord;
	Vector3 entityCoords;
...
void func_75(var uParam0, char* sParam1, char* sParam2, BOOL bParam3) // Hash - 0x331D01C1 ^0x2DA03EB3
{
	if (*uParam0 == -1)
	{
...
void func_77() // Hash - 0x2504AAF9 ^0xBD9BD9F8
{
	BOOL flag;
	Vehicle vehicle;
	...
	if (func_84(&(caLocal_160.f_22.f_1), caLocal_160.f_22.f_4, &flag))
	{
		if (flag)
		{
			...
			{
				func_61(&(caLocal_160.f_22.f_2), false, false);
				func_76(&(caLocal_160.f_22.f_5));
...
float func_78(Ped pedParam0) // Hash - 0x9E5251D4 ^0x18F88C83
{
	Vector3 entityCoords;
...
void func_79(Entity eParam0) // Hash - 0x1D3051CA ^0x2216257D
{
	Vector3 camCoord;
	Vector3 entityCoords;
...
Vehicle func_81(float fParam0) // Hash - 0x38DC7557 ^0x149F41DE
{
	int playerTeam;
	BOOL flag;
	Player player;
	...
	for (i = 0; i < 32; i = i + 1)
	{
		...
		if (!NETWORK::NETWORK_IS_PLAYER_ACTIVE(player2) || !func_82(player2, true, true) || flag && PLAYER::GET_PLAYER_TEAM(player2) == playerTeam || SYSTEM::VMAG2(caLocal_160.f_4.f_6 - ENTITY::GET_ENTITY_COORDS(playerPed, true)) > num2)
		{
		}
		else
		{
...
BOOL func_82(Player plParam0, BOOL bParam1, BOOL bParam2) // Hash - 0x3FF6E4CA ^0xE6B59972
{
	Player player;
...
void func_83() // Hash - 0x101B75D5 ^0x173F0148
{
	caLocal_160.f_22 = -1;
...
BOOL func_84(var uParam0, Vehicle veParam1, var uParam2) // Hash - 0x90743BDD ^0x551FB9FC
{
	int hit;
	var surfaceNormal;
	var endCoords;
...
void func_85() // Hash - 0xE1337140 ^0x5C5B36CF
{
	BOOL flag;
	BOOL flag2;
	int num;
	...
	flag2 = flag && !func_52(&(caLocal_160.f_19), uLocal_64.f_13.f_2, false);
	...
	if (flag)
	{
		if (flag2)
		{
			...
			num2 = func_94(&(caLocal_160.f_19), false, false);
		}
		else
		{
			num = 1;
	...
	if (!flag2 && func_89())
	{
		...
		if (func_52(&(caLocal_160.f_17), uLocal_64.f_8.f_2, false))
		{
			...
			{
				func_61(&(caLocal_160.f_19), false, false);
...
Vector3 func_86(float fParam0, float fParam1, float fParam2, float fParam3) // Hash - 0x4FCE86D3 ^0x6C545D4E
{
	Vector3 vector;
	float num;
	int i;
...
Vector3 func_87(var uParam0, var uParam1, var uParam2, float fParam3) // Hash - 0x776843CB ^0x5C60566C
{
	var unk;
...
Vector3 func_88(Vector3 vParam0, var uParam1, var uParam2, float fParam3) // Hash - 0x88200B15 ^0xE07B704A
{
	float num;
...
void func_92(int iParam0, int iParam1) // Hash - 0xB94ADBE4 ^0x5A6F4E87
{
	MISC::SET_BIT(&Global_1655472.f_7009[iParam0], iParam1);
	return;
}

BOOL func_93(int iParam0, int iParam1) // Hash - 0x3E555E75 ^0x3E555E75
{
	return IS_BIT_SET(Global_1655472.f_7009[iParam0], iParam1);
}

int func_94(var uParam0, BOOL bParam1, BOOL bParam2) // Hash - 0xAB71C5AE ^0x10186D95
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !bParam1)
		if (!bParam2)
...
BOOL func_95() // Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_75693;
}

void func_96(int iParam0) // Hash - 0xBA4D1065 ^0x931C581B
{
	int num;
...
void func_97(int iParam0) // Hash - 0xC321B74D ^0x4984D2C3
{
	int num;
...
void func_98(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Hash - 0x2989A2A4 ^0xD367A0B5
{
	if (uParam0->f_1 == 0)
	{
...
int func_99(int iParam0, int iParam1) // Hash - 0x20FBB09E ^0x20FBB09E
{
	if (iParam0 > iParam1)
		return iParam1;
...
int func_100(BOOL bParam0, BOOL bParam1) // Hash - 0xE0A3B738 ^0xC93A5156
{
...
BOOL func_101() // Hash - 0x86873A2B ^0xB1A2BBD7
{
	return !func_68(&(caLocal_160.f_19)) || func_52(&(caLocal_160.f_19), uLocal_64.f_13.f_2, false);
}

BOOL func_102(int* piParam0, int iParam1) // Hash - 0xBB2533A ^0x35D5A8D4
{
...
void func_103(int iParam0) // Hash - 0x443C0033 ^0x51D0AAF7
{
	func_102(&iParam0, 0);
	func_102(&iParam0, 1);
	...
	if (func_102(&iParam0, 8))
		if (!MISC::IS_STRING_NULL_OR_EMPTY(&(uLocal_64.f_67)) && func_12(&(uLocal_64.f_67)))
			HUD::CLEAR_HELP(true);
...
void func_104(BOOL bParam0, int iParam1) // Hash - 0x8F233D4 ^0xB55528D0
{
	int num;
...
void func_105(int* piParam0) // Hash - 0x294B53C7 ^0x1978B7FB
{
	if (piParam0->f_9 != 0)
	{
		if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(*piParam0))
...
void func_107(int iParam0) // Hash - 0x89313811 ^0xB381A330
{
	caLocal_160.f_16 = iParam0;
	return;
}

BOOL func_108(Vector3 vParam0, var uParam1, var uParam2, int iParam3) // Hash - 0x8FDF8846 ^0xE8CF89DC
{
...
void func_109(int iParam0) // Hash - 0x7E11E9C ^0x544BF257
{
	if (func_114())
		return;
...
void func_110(int iParam0) // Hash - 0x4066FEF5 ^0x9787FBDA
{
	if (func_114())
		return;
...
BOOL func_111() // Hash - 0xD140D54A ^0xE638D98F
{
...
void func_112(BOOL bParam0, BOOL bParam1) // Hash - 0xF40FC178 ^0xA6F60F17
{
	if (bParam0)
	{
		if (func_113(0))
...
BOOL func_113(int iParam0) // Hash - 0xE8921B44 ^0x4F063755
{
	if (iParam0 == 1)
		if (Global_20383.f_1 > 3)
...
BOOL func_114() // Hash - 0xC41437CB ^0xC41437CB
{
	return IS_BIT_SET(Global_1962996, 19);
}

BOOL func_115() // Hash - 0xB51A7B06 ^0xB65CA2B6
{
	if (uLocal_64.f_94 != 0)
		if (!ENTITY::DOES_ENTITY_EXIST(uLocal_64.f_95) || ENTITY::IS_ENTITY_DEAD(uLocal_64.f_95, false))
			return true;

	if (!func_82(PLAYER::PLAYER_ID(), true, true))
		return true;
...
BOOL func_116() // Hash - 0x52E21E9B ^0xD0F85E96
{
...
Hash func_117() // Hash - 0x90B5165C ^0xB8DD5DC8
{
	switch (func_119())
	{
		case 0:
...
Hash func_118() // Hash - 0x61402777 ^0xB9FAC976
{
...
BOOL func_120() // Hash - 0x974E48B4 ^0x974E48B4
{
	return Global_2683862.f_698;
}

BOOL func_121(int iParam0) // Hash - 0xA28ADBB4 ^0x6EB81E64
{
...
BOOL func_123() // Hash - 0x974E48B4 ^0x974E48B4
{
	return Global_2683862.f_693;
}

void func_124() // Hash - 0x66E327B2 ^0x39BE3C9E
{
	SYSTEM::WAIT(0);
	return;
}

void func_125() // Hash - 0x73355B7C ^0x71D8B018
{
	Ped ped;
	Vehicle vehiclePedIsIn;
	...
	if (func_131(ped) && PED::IS_PED_IN_ANY_VEHICLE(ped, true))
	{
...
void func_126() // Hash - 0xCE5FB49E ^0x214A59D5
{
	SCRIPT::TERMINATE_THIS_THREAD();
	return;
}

void func_127(Blip blParam0) // Hash - 0x4D063234 ^0xF1E82C0
{
...
void func_128() // Hash - 0x33AC001D ^0x2671C198
{
...
void func_129(int iParam0) // Hash - 0xF1DF2755 ^0xF3910FAB
{
	Vehicle vehiclePedIsIn;
...
BOOL func_130() // Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1889629;
}

BOOL func_131(Ped pedParam0) // Hash - 0x3D210083 ^0xF7E7C389
{
...
void func_132(BOOL bParam0) // Hash - 0xE49C42EC ^0xE49C42EC
{
...
void func_134(var uParam0) // Hash - 0x3B57357F ^0xAE8AA886
{
...
void func_135(var uParam0) // Hash - 0xE6C08B48 ^0xCB818583
{
	Ped ped;
	Vehicle vehiclePedIsIn;
...
void func_136() // Hash - 0x9946A6C8 ^0x39677E2E
{
...
void func_137(int iParam0, int iParam1, int iParam2, int iParam3) // Hash - 0x19DB8C7E ^0x968918D7
{
...
void func_138(char* sParam0) // Hash - 0xE85EADE7 ^0xC4F03EDE
{
...
void func_139(float fParam0, float fParam1, float fParam2) // Hash - 0x5707E5DB ^0x1230551
{
...
void func_140(char* sParam0) // Hash - 0xC15FD5FB ^0x44ACD4EC
{
...
void func_141(int iParam0) // Hash - 0x9BBC6741 ^0x473DBE84
{
...
void func_142(int iParam0) // Hash - 0xE97E5456 ^0x7E4D9C7F
{
...
void func_143(int iParam0) // Hash - 0x53739325 ^0x8D99CA7D
{
...
void func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3) // Hash - 0x90D30044 ^0xA99AF570
{
...
void func_145(int* piParam0, int iParam1, BOOL bParam2) // Hash - 0x5F52F40B ^0x60E20412
{
	if (bParam2)
...
void func_146() // Hash - 0x9F4008BE ^0xDDFED9CA
{
...
void func_147(int iParam0, int iParam1) // Hash - 0xA2B68AA3 ^0xB4361D7A
{
...
void func_148(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Hash - 0x5601E81 ^0x3D4A1212
{
...
void func_149() // Hash - 0xD39EBC16 ^0xE54D0827
{
	if (!Global_2672505.f_946.f_10)
...
BOOL func_150() // Hash - 0x8190E5D8 ^0xE5C9F4C2
{
	return Global_2672505.f_946.f_10;
}

void func_151(int iParam0) // Hash - 0xDE6AAD09 ^0x54022284
{
	int num;
