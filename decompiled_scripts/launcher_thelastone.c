...
BOOL func_2(Any* panParam0) // Hash - 0xC1DEC58C ^0xC1DEC58C
{
	const char* str;
	var unk32;
...
struct<2> func_9(int iParam0) // Hash - 0x323E6781 ^0xB3D90795
{
	var unk;
	var unk3;
...
void func_19() // Hash - 0x429A4038 ^0xD806EC2D
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("MISSION_STAT_WATCHER")) > 0)
	{
		if (func_20())
...
void func_23(char* sParam0, int iParam1, Ped pedParam2) // Hash - 0xB566D143 ^0x9522DBF7
{
...
BOOL func_44(int iParam0, int iParam1, char* sParam2, var uParam3) // Hash - 0x8E372EAA ^0x134D188F
{
...
void func_109(int iParam0) // Hash - 0x35AC36F2 ^0x91F9BEAE
{
	int num;
	var textLabel;
...
void func_112(char* sParam0, Any anParam1, int iParam2) // Hash - 0x817AB180 ^0x182CBAEB
{
...
struct<2> func_114(int iParam0) // Hash - 0x975AC8C9 ^0x6C81928A
{
	var unk;
...
void func_115(int iParam0, var uParam1) // Hash - 0x2D8E3F8 ^0xAA665861
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_148(const char* sParam0) // Hash - 0x16488C7A ^0x3A37D80B
{
...
BOOL func_174(var uParam0, int iParam1) // Hash - 0x4C332810 ^0xCFFAAA23
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_175() // Hash - 0x1DF115D ^0x1DF115D
{
	func_27(&(Global_104212.f_2890), &Global_104212, 0, 1, 1, 0);
	return;
}

BOOL func_176(var uParam0) // Hash - 0xBE0C612E ^0xC181C5F3
{
	float num;
...
void func_177(int iParam0, var uParam1) // Hash - 0x16CCAA18 ^0x3DB032C3
{
	if (iParam0 == 1)
	{
		if (!func_135(uParam1))
...
BOOL func_178(BOOL bParam0) // Hash - 0x328D4447 ^0x90410402
{
...
BOOL func_179(Vehicle veParam0) // Hash - 0x7E47BB06 ^0x692E6B64
{
	if (func_132(veParam0))
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
...
BOOL func_180(int iParam0) // Hash - 0x97844555 ^0xADCD6DAA
{
	int num;
...
BOOL func_181() // Hash - 0x4228A1C2 ^0x952FE30F
{
	return Global_100720.f_1;
}

BOOL func_182() // Hash - 0xC20DBA70 ^0xAC4006FB
{
	if (Global_97603 != -1)
...
BOOL func_183() // Hash - 0x3CA1BB47 ^0xB78A1ACB
{
...
BOOL func_184() // Hash - 0xE663B8F6 ^0xE663B8F6
{
	if (Global_78819)
		return true;
...
BOOL func_185() // Hash - 0xD56328D2 ^0xD56328D2
{
	return Global_100733.f_388 > 0;
}

BOOL func_186(int iParam0, int iParam1) // Hash - 0xA14C4D3F ^0xA6034F77
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_187() // Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1575060;
}

BOOL func_188() // Hash - 0x7FE517FE ^0x128A3BC8
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
int func_189(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8) // Hash - 0x4C584A2 ^0xFFF25B04
{
	var unk;
...
BOOL func_190(char* sParam0) // Hash - 0x5CF3EDA6 ^0x878C8302
{
	var string1;
...
struct<6> func_191() // Hash - 0xB37EF8EF ^0xB37EF8EF
{
	var unk;
...
void func_192(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Hash - 0xF7ECDFD9 ^0x6B079C3E
{
...
void func_194(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Hash - 0x6C235EE0 ^0x9E57F206
{
...
float func_195(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Hash - 0xC22B942A ^0xE0DB8793
{
...
void func_196(var uParam0, var uParam1, const char* sParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8, float fParam9, float fParam10, float fParam11) // Hash - 0xD82FABCC ^0x78BFEED
{
	float num;
	float num2;
	float num3;
...
void func_197(int iParam0, BOOL bParam1) // Hash - 0x3ABFF97A ^0x3ABFF97A
{
	if (iParam0 == -1)
		return;
...
int func_198(int iParam0) // Hash - 0x3F6843D0 ^0x973F28A6
{
	if (Global_78554 == iParam0)
		if (Global_78555 == -1)
...
void func_199(var uParam0, int iParam1) // Hash - 0xA189769D ^0xD7591C4B
{
	BOOL flag;
	int i;
...
void func_200(var uParam0) // Hash - 0x8EEB5116 ^0x2325FF68
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_201(uParam0);
...
void func_201(var uParam0) // Hash - 0x1C509C5B ^0x1C509C5B
{
	BOOL flag;
	int num;
	int i;
...
BOOL func_202() // Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_97990;
}

void func_203(int iParam0) // Hash - 0xD347101A ^0xCC220E7F
{
	if (iParam0 == -1)
		iParam0 = func_171();
...
BOOL func_204(Any* panParam0, BOOL bParam1) // Hash - 0x7D86F6E4 ^0x2AF4136D
{
	var unk;
...
void func_205(Ped pedParam0, var uParam1, int iParam2) // Hash - 0xD4C7D099 ^0x162C1E9
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_206(int iParam0) // Hash - 0xD681AEF7 ^0xD681AEF7
{
...
BOOL func_207(var uParam0) // Hash - 0x42F869D4 ^0xFFADB180
{
...
BOOL func_208(var uParam0) // Hash - 0x6329B93C ^0xCBBB8D92
{
...
void func_210(Object* pobParam0) // Hash - 0x4EAFEE58 ^0x34D7ECA6
{
...
void func_211(var uParam0) // Hash - 0x5209F824 ^0xCFA0F1CA
{
	int i;
...
BOOL func_212(var uParam0, BOOL bParam1, BOOL bParam2) // Hash - 0x53567DCF ^0x584F6887
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_213(Ped pedParam0, Vehicle veParam1) // Hash - 0xFB12ABF0 ^0x730FD205
{
...
BOOL func_214(var uParam0, BOOL bParam1, int iParam2) // Hash - 0xE9BDE167 ^0x20C575FA
{
	int i;
	int num;
...
BOOL func_215(int iParam0) // Hash - 0x9E3DCA43 ^0x9E3DCA43
{
...
BOOL func_216(Vehicle veParam0, int iParam1) // Hash - 0x5EA05E45 ^0x7984EB04
{
	float xSize;
...
BOOL func_217(Vehicle veParam0, int iParam1) // Hash - 0xF1789D04 ^0x3F9D1900
{
	return func_218(veParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_218(Vehicle veParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Hash - 0x275BB58B ^0x275BB58B
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_219(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Vehicle veParam6, int iParam7) // Hash - 0xBBBECF07 ^0xBBBECF07
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_220(Ped pedParam0, int iParam1) // Hash - 0xA6273130 ^0xF7D9CDEA
{
...
int func_221() // Hash - 0x1398F041 ^0xCD84FF69
{
	int i;
...
BOOL func_222(Vehicle veParam0, Ped pedParam1, int iParam2, int iParam3) // Hash - 0x6EF1707D ^0x8C069CF9
{
	var unk;
...
float func_223(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Hash - 0x596BEA29 ^0x5FBCDBE5
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_224(float fParam0, var uParam1, var uParam2) // Hash - 0xFB6A39D2 ^0x80C9C759
{
	float num;
	float num2;
...
void func_225(var uParam0) // Hash - 0xA4B72113 ^0x62A5EAE1
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_226(Vehicle veParam0, Ped pedParam1) // Hash - 0xAA445031 ^0xEBA3F8CF
{
	int i;
...
BOOL func_227(Vehicle veParam0) // Hash - 0xEC80536A ^0x2D4CF2B0
{
...
BOOL func_228(Vehicle veParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Hash - 0x5B46DA49 ^0x44F718
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_229(Vehicle veParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Hash - 0x1310B579 ^0x2AAFC0CC
{
	float entityCoords;
	float num;
...
BOOL func_230(Vehicle veParam0, float fParam1) // Hash - 0xFA3D7088 ^0x33A74060
{
	var outProjectile;
	var outCoords;
...
BOOL func_231(Vehicle veParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Hash - 0x3F40E5FA ^0xC3BEFE6A
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_232(Vehicle veParam0, BOOL bParam1, float fParam2, float fParam3) // Hash - 0x18BAE105 ^0x60D3B20E
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_233(int iParam0) // Hash - 0x5B443B41 ^0x5B443B41
{
...
void func_234(Vehicle veParam0) // Hash - 0xAD821AF8 ^0xD86EE5FA
{
	int taskSequenceId;
...
BOOL func_235(int iParam0) // Hash - 0x6F2BC7EE ^0x6F2BC7EE
{
	if (iParam0 == -1)
		iParam0 = func_171();
...
BOOL func_236(int iParam0) // Hash - 0xDE7BA54D ^0xDE7BA54D
{
...
BOOL func_237() // Hash - 0x29CB2928 ^0xE369A18D
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_238() // Hash - 0x98CCC132 ^0x97B0D6ED
{
	if (Global_97603 != -1)
...
BOOL func_239(int iParam0) // Hash - 0xC2630182 ^0xFBD23031
{
...
BOOL func_240() // Hash - 0x25806CBF ^0x25806CBF
{
...
BOOL func_241(int iParam0) // Hash - 0x1156B580 ^0x34C7FA05
{
	if (func_113(false))
...
BOOL func_242(var uParam0) // Hash - 0x14648AE3 ^0x7AB2BAE3
{
	if (!func_243(uParam0))
		return false;
...
BOOL func_243(var uParam0) // Hash - 0x1576D8BE ^0x76599126
{
	int num;
	int i;
	BOOL flag;
...
void func_244(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Hash - 0x60B41505 ^0x2C4B5209
{
	func_245(pveParam0);
...
void func_245(Vehicle* pveParam0) // Hash - 0x8D18F713 ^0xF71A18A8
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_246(var uParam0) // Hash - 0xC42B20E0 ^0x728F1DAE
{
	int i;
...
BOOL func_247(int iParam0) // Hash - 0x59D2F680 ^0x59D2F680
{
	var unk;
	int num;
...
BOOL func_248(int iParam0) // Hash - 0xC6B32843 ^0x7DFD35CC
{
	const char* string2;
...
BOOL func_249(int iParam0) // Hash - 0x791D84F4 ^0x791D84F4
{
	var unk;
...
BOOL func_250(int iParam0) // Hash - 0xDEAD9A68 ^0xDEAD9A68
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_251(int iParam0, char* sParam1) // Hash - 0xC64245F ^0xEA103E4A
{
...
BOOL func_252(int iParam0) // Hash - 0x5ADD7F05 ^0x5ADD7F05
{
...
BOOL func_253(int iParam0) // Hash - 0xBB053D24 ^0xBB053D24
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_254(int iParam0) // Hash - 0x5D95A044 ^0x5D95A044
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_255(int iParam0) // Hash - 0x9FFC81CD ^0x47A2AB8B
{
	if (func_236(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
void func_256() // Hash - 0x5631C87C ^0xC3218671
{
...
BOOL func_257(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Hash - 0x5B983661 ^0x5B983661
{
	int i;
...
BOOL func_258(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Hash - 0xC6B7068B ^0xB9A971A4
{
	int num;
	char* str;
...
BOOL func_259(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Hash - 0x1FB736D4 ^0x234AEAB7
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_260(var uParam0, BOOL bParam1) // Hash - 0xD0C9C1D3 ^0x2C99F672
{
	if (bParam1)
	{
...
int func_261(var uParam0) // Hash - 0x86633390 ^0x30FDF991
{
	if (func_208(uParam0))
	{
...
void func_262(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Hash - 0x5BE1D1E3 ^0x5BE1D1E3
{
...
void func_263(var uParam0, BOOL bParam1) // Hash - 0xEDC3BD2D ^0xE0B6F056
{
	func_264(&(uParam0->f_41), bParam1);
	return;
}

void func_264(var uParam0, BOOL bParam1) // Hash - 0x9E80EA71 ^0x9E80EA71
{
	int i;
...
void func_265(Object* pobParam0, BOOL bParam1) // Hash - 0xD7EE3E27 ^0xC5769B29
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_266(var uParam0, BOOL bParam1) // Hash - 0xEDC3BD2D ^0xE2474F74
{
	func_267(&(uParam0->f_35), bParam1);
	return;
}

void func_267(var uParam0, BOOL bParam1) // Hash - 0xA98F6284 ^0xA98F6284
{
	int i;
...
void func_268(Vehicle* pveParam0) // Hash - 0xC50F9886 ^0x638B6124
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_269(var uParam0, int iParam1) // Hash - 0xEDC3BD2D ^0xA9A19095
{
	func_270(&(uParam0->f_28), iParam1);
	return;
}

void func_270(var uParam0, int iParam1) // Hash - 0xB72ACFD2 ^0xB72ACFD2
{
	int i;
...
void func_271(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Hash - 0x34362197 ^0xC592197
{
...
void func_272(Ped* ppedParam0) // Hash - 0xCA79453F ^0x7BA88177
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_273(int iParam0) // Hash - 0x995C9E2 ^0x995C9E2
{
	if (*iParam0 == -1)
		return;
...
void func_274(char* sParam0) // Hash - 0x54B64147 ^0x56EEAFB9
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_275(var uParam0) // Hash - 0x4CD8BCE8 ^0x4D6074F0
{
	*uParam0 = -1;
...
void func_276() // Hash - 0x554DA35 ^0x738111DB
{
