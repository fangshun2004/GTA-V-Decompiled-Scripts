...
void __EntryFunction__()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_113991[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_281(&(Global_113991[Var0.f_0 /*10*/].f_9));
			}
		}
		func_268(&Var0, 1);
	}
	...
	while (true)
	{
		...
		func_211(Var0.f_0);
		func_204(&iLocal_91, &uLocal_92, &(Var0.f_9), Var61, -1295.84f, 4641.98f, 105.33f, -1301.43f, 4641.21f, 105.62f);
		func_197(&Var0, Var61, "SAS1AUD", "SAS1_AMB", 4, "HUNTER", 10000);
		if (func_182(&Var0, 0))
		{
			if (!func_2(&Var0))
			{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_196()) || Global_33778) || func_195()) || func_194(8, -1)) || func_192()) || func_102()) || func_193()) || func_191()) || Global_114904.f_7695.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_196()) || Global_113951) || Global_33778) || func_195()) || func_194(8, -1)) || func_102()) || func_193()) || func_191()) || Global_114904.f_7695.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_196() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_194(8, -1)) || func_191()) || func_190()) || Global_114904.f_7695.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
...
int func_197(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)
{
	var uVar0;
	...
	if (func_188(2))
	{
		if (!func_158())
		{
			if (((func_138(PLAYER::PLAYER_PED_ID()) && func_138(uParam0->f_28[0])) && (MISC::GET_GAME_TIMER() - uParam0->f_60) > iParam8) && func_203(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f)
			{
				uVar0 = 16;
...
void func_204(int iParam0, var uParam1, char* sParam2, struct<3> Param3, struct<3> Param6, struct<3> Param9)
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam2))
		{
			...
			{
				if (func_203(PLAYER::PLAYER_PED_ID(), Param3, 1) <= 100f)
				{
					func_207(iParam0, 1);
				}
			}
			else
			{
				...
				{
					fVar0 = func_203(PLAYER::PLAYER_PED_ID(), Param6, 1);
					fVar1 = func_203(PLAYER::PLAYER_PED_ID(), Param9, 1);
					fVar2 = (fVar0 - fVar1);
					if (fVar2 < 0f)
					{
						fVar2 = (fVar2 * -1f);
				...
				if (func_203(PLAYER::PLAYER_PED_ID(), Param3, 1) > 120f)
				{
					func_208(iParam0);
				}
			}
...
int func_212(var uParam0, bool bParam1)
{
	...
	func_121(*uParam0, &Var0);
	if ((func_249(*uParam0) || func_247(*uParam0)) || Global_80526 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
int func_251(var uParam0)
{
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_252(&(uParam0->f_35[0]), iVar0[1], -1303.163f, 4648.085f, 104.9664f, 293.1504f);
				if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
				{
